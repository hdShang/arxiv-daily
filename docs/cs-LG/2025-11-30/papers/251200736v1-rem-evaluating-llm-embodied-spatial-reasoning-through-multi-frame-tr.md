...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00736v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00736v1', 'REM: Evaluating LLM Embodied Spatial Reasoning through Multi-Frame Trajectories')" title="添加到收藏夹">☆ 收藏</button>
