...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07730v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07730v2', 'Multistep Quasimetric Learning for Scalable Goal-conditioned Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
