...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08399v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08399v1', 'Aligning by Misaligning: Boundary-aware Curriculum Learning for Multimodal Alignment')" title="添加到收藏夹">☆ 收藏</button>
