...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13729v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.13729v1', 'Composite Classifier-Free Guidance for Multi-Modal Conditioning in Wind Dynamics Super-Resolution')" title="添加到收藏夹">☆ 收藏</button>
