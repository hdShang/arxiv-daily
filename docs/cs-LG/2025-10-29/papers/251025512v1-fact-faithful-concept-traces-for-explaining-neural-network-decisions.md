...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25512v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25512v1', 'FaCT: Faithful Concept Traces for Explaining Neural Network Decisions')" title="添加到收藏夹">☆ 收藏</button>
