...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25616v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25616v1', 'Don\'t Blind Your VLA: Aligning Visual Representations for OOD Generalization')" title="添加到收藏夹">☆ 收藏</button>
