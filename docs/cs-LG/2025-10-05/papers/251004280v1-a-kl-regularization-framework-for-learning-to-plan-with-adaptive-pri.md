...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04280v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04280v1', 'A KL-regularization framework for learning to plan with adaptive priors')" title="添加到收藏夹">☆ 收藏</button>
