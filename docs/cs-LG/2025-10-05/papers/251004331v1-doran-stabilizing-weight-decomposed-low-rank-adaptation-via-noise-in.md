...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04331v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04331v1', 'DoRAN: Stabilizing Weight-Decomposed Low-Rank Adaptation via Noise Injection and Auxiliary Networks')" title="添加到收藏夹">☆ 收藏</button>
