...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.21946" class="toolbar-btn" target="_blank">📄 arXiv: 2506.21946v1</a>
  <a href="https://arxiv.org/pdf/2506.21946.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.21946v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.21946v1', 'Hitchhiking Rides Dataset: Two decades of crowd-sourced records on stochastic traveling')" title="添加到收藏夹">☆ 收藏</button>
...
1. 搭便车作为一种非正式的出行方式，缺乏系统的研究和数据支持，现有方法无法全面捕捉其特征。
2. 本文通过构建一个包含63,000条记录的搭便车数据集，利用众包方式收集信息，系统分析搭便车的时空特征。
3. 通过对数据集的探索性分析，揭示了搭便车者的行为模式和等待时间等关键因素，为未来研究提供了基础。
