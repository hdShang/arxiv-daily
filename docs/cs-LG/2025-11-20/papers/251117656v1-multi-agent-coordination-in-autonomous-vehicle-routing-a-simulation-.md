...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17656v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.17656v1', 'Multi-Agent Coordination in Autonomous Vehicle Routing: A Simulation-Based Study of Communication, Memory, and Routing Loops')" title="添加到收藏夹">☆ 收藏</button>
