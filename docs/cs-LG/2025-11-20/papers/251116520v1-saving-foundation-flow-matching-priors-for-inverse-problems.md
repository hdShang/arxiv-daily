...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16520v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16520v1', 'Saving Foundation Flow-Matching Priors for Inverse Problems')" title="添加到收藏夹">☆ 收藏</button>
