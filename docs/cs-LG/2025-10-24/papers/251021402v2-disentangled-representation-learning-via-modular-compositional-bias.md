...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21402v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21402v2', 'Disentangled Representation Learning via Modular Compositional Bias')" title="添加到收藏夹">☆ 收藏</button>
