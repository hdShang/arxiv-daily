...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15202v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.15202v2', 'Dissecting Mahalanobis: How Feature Geometry and Normalization Shape OOD Detection')" title="添加到收藏夹">☆ 收藏</button>
