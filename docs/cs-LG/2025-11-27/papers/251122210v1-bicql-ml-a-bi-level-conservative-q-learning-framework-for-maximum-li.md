...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22210v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22210v1', 'BiCQL-ML: A Bi-Level Conservative Q-Learning Framework for Maximum Likelihood Inverse Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
