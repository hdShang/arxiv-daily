...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19584v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19584v2', 'Learning Massively Multitask World Models for Continuous Control')" title="添加到收藏夹">☆ 收藏</button>
