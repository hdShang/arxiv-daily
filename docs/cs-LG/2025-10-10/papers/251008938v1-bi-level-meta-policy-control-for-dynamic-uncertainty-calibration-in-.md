...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08938v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08938v1', 'Bi-level Meta-Policy Control for Dynamic Uncertainty Calibration in Evidential Deep Learning')" title="添加到收藏夹">☆ 收藏</button>
