...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13770v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.13770v1', 'Enhancing Semi-Supervised Multi-View Graph Convolutional Networks via Supervised Contrastive Learning and Self-Training')" title="添加到收藏夹">☆ 收藏</button>
