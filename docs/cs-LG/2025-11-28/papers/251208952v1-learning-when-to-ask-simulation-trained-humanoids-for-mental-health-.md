...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.08952v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.08952v1', 'Learning When to Ask: Simulation-Trained Humanoids for Mental-Health Diagnosis')" title="添加到收藏夹">☆ 收藏</button>
