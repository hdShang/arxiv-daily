...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15442v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15442v1', 'Copyright Infringement Risk Reduction via Chain-of-Thought and Task Instruction Prompting')" title="添加到收藏夹">☆ 收藏</button>
