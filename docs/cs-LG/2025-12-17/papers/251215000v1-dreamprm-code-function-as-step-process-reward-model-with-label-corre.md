...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15000v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15000v1', 'DreamPRM-Code: Function-as-Step Process Reward Model with Label Correction for LLM Coding')" title="添加到收藏夹">☆ 收藏</button>
