...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15657v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15657v1', 'SoFlow: Solution Flow Models for One-Step Generative Modeling')" title="添加到收藏夹">☆ 收藏</button>
