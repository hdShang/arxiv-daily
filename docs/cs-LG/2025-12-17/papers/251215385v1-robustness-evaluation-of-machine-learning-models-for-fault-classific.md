...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15385v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15385v1', 'Robustness Evaluation of Machine Learning Models for Fault Classification and Localization In Power System Protection')" title="添加到收藏夹">☆ 收藏</button>
