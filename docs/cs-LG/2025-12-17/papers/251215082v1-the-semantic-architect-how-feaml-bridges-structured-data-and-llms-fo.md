...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15082v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15082v1', 'The Semantic Architect: How FEAML Bridges Structured Data and LLMs for Multi-Label Tasks')" title="添加到收藏夹">☆ 收藏</button>
