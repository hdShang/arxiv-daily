...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15086v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15086v1', 'PIP$^2$ Net: Physics-informed Partition Penalty Deep Operator Network')" title="添加到收藏夹">☆ 收藏</button>
