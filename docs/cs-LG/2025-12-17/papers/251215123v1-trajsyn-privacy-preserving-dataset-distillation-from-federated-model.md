...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15123v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15123v1', 'TrajSyn: Privacy-Preserving Dataset Distillation from Federated Model Trajectories for Server-Side Adversarial Training')" title="添加到收藏夹">☆ 收藏</button>
