...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15606v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15606v1', 'A Teacher-Student Perspective on the Dynamics of Learning Near the Optimal Point')" title="添加到收藏夹">☆ 收藏</button>
