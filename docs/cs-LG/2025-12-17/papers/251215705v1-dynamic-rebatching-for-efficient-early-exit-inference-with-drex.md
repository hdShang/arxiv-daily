...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15705v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15705v1', 'Dynamic Rebatching for Efficient Early-Exit Inference with DREX')" title="添加到收藏夹">☆ 收藏</button>
