...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15521v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15521v1', 'Autonomous Pressure Control in MuVacAS via Deep Reinforcement Learning and Deep Learning Surrogate Models')" title="添加到收藏夹">☆ 收藏</button>
