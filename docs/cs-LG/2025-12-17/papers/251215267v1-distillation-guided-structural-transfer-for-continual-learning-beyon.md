...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15267v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15267v1', 'Distillation-Guided Structural Transfer for Continual Learning Beyond Sparse Distributed Memory')" title="添加到收藏夹">☆ 收藏</button>
