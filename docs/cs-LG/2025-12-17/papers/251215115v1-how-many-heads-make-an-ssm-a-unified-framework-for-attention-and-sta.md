...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15115v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15115v1', 'How Many Heads Make an SSM? A Unified Framework for Attention and State Space Models')" title="添加到收藏夹">☆ 收藏</button>
