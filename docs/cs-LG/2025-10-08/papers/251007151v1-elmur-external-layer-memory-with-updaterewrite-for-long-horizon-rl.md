...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07151v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07151v1', 'ELMUR: External Layer Memory with Update/Rewrite for Long-Horizon RL')" title="添加到收藏夹">☆ 收藏</button>
