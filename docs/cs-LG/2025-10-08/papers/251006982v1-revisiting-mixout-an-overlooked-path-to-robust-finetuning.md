...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06982v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06982v1', 'Revisiting Mixout: An Overlooked Path to Robust Finetuning')" title="添加到收藏夹">☆ 收藏</button>
