...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06913v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06913v1', 'DecompGAIL: Learning Realistic Traffic Behaviors with Decomposed Multi-Agent Generative Adversarial Imitation Learning')" title="添加到收藏夹">☆ 收藏</button>
