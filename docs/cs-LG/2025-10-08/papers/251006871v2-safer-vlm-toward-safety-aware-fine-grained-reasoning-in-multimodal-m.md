...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06871v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06871v2', 'SaFeR-VLM: Toward Safety-aware Fine-grained Reasoning in Multimodal Models')" title="添加到收藏夹">☆ 收藏</button>
