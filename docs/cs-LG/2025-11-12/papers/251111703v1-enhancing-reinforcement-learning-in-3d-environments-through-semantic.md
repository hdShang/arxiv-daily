...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.11703v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.11703v1', 'Enhancing Reinforcement Learning in 3D Environments through Semantic Segmentation: A Case Study in ViZDoom')" title="添加到收藏夹">☆ 收藏</button>
