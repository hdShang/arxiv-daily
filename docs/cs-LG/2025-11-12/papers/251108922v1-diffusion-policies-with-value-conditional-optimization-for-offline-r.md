...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08922v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08922v1', 'Diffusion Policies with Value-Conditional Optimization for Offline Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
