...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.15207" class="toolbar-btn" target="_blank">📄 arXiv: 2509.15207v3</a>
  <a href="https://arxiv.org/pdf/2509.15207.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.15207v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.15207v3', 'FlowRL: Matching Reward Distributions for LLM Reasoning')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有基于奖励最大化的LLM强化学习方法，易过度优化主要奖励信号，忽略多样推理路径。
2. FlowRL通过流量平衡匹配奖励分布，鼓励多样化探索和泛化推理轨迹。
3. 实验表明，FlowRL在数学和代码推理任务上显著优于PPO和GRPO。
