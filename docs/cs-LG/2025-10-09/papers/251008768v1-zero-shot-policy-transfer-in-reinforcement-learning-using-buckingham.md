...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08768v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08768v1', 'Zero-Shot Policy Transfer in Reinforcement Learning using Buckingham\'s Pi Theorem')" title="添加到收藏夹">☆ 收藏</button>
