...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08179v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08179v1', 'Dual-granularity Sinkhorn Distillation for Enhanced Learning from Long-tailed Noisy Data')" title="添加到收藏夹">☆ 收藏</button>
