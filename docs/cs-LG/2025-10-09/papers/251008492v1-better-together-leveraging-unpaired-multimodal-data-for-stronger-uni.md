...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08492v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08492v1', 'Better Together: Leveraging Unpaired Multimodal Data for Stronger Unimodal Models')" title="添加到收藏夹">☆ 收藏</button>
