...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07730v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07730v1', 'DEAS: DEtached value learning with Action Sequence for Scalable Offline RL')" title="添加到收藏夹">☆ 收藏</button>
