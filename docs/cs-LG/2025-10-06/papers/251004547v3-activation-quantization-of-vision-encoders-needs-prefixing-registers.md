...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04547v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04547v3', 'Activation Quantization of Vision Encoders Needs Prefixing Registers')" title="添加到收藏夹">☆ 收藏</button>
