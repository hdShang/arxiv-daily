...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10188v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10188v1', 'INR-Bench: A Unified Benchmark for Implicit Neural Representations in Multi-Domain Regression and Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
