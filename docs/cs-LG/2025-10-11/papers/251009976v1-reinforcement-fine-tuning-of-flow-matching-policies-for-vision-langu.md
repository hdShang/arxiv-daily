...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09976v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09976v1', 'Reinforcement Fine-Tuning of Flow-Matching Policies for Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
