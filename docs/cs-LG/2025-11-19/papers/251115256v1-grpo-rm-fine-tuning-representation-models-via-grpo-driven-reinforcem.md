...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15256v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15256v1', 'GRPO-RM: Fine-Tuning Representation Models via GRPO-Driven Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
