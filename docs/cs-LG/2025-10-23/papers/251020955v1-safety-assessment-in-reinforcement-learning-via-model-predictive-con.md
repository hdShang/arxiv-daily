...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20955v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20955v1', 'Safety Assessment in Reinforcement Learning via Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
