...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17394v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17394v1', 'MILES: Modality-Informed Learning Rate Scheduler for Balancing Multimodal Learning')" title="添加到收藏夹">☆ 收藏</button>
