...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17991v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17991v1', 'Demystifying Transition Matching: When and Why It Can Beat Flow Matching')" title="添加到收藏夹">☆ 收藏</button>
