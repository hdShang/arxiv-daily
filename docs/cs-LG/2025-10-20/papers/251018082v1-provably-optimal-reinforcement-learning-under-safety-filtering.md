...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18082v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.18082v1', 'Provably Optimal Reinforcement Learning under Safety Filtering')" title="添加到收藏夹">☆ 收藏</button>
