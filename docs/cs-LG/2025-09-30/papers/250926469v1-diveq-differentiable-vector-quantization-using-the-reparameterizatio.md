...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.26469" class="toolbar-btn" target="_blank">📄 arXiv: 2509.26469v1</a>
  <a href="https://arxiv.org/pdf/2509.26469.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.26469v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.26469v1', 'DiVeQ: Differentiable Vector Quantization Using the Reparameterization Trick')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有向量量化方法在深度学习中存在硬性分配导致梯度阻塞的问题，影响模型的端到端训练效果。
2. DiVeQ通过引入误差向量来模拟量化失真，保持前向传播的硬性，同时允许梯度流动，从而解决了这一问题。
3. 在VQ-VAE和VQGAN的实验中，DiVeQ和SF-DiVeQ在重建和样本质量上均优于传统量化方法，显示出显著的性能提升。
