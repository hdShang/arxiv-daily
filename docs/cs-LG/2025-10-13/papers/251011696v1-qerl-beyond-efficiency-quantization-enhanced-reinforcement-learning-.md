...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11696v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11696v1', 'QeRL: Beyond Efficiency -- Quantization-enhanced Reinforcement Learning for LLMs')" title="添加到收藏夹">☆ 收藏</button>
