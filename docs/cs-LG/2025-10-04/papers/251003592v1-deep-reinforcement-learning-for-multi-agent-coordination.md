...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03592v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03592v1', 'Deep Reinforcement Learning for Multi-Agent Coordination')" title="添加到收藏夹">☆ 收藏</button>
