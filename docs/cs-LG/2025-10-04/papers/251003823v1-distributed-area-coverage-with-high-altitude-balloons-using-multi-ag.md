...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03823v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03823v1', 'Distributed Area Coverage with High Altitude Balloons Using Multi-Agent Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
