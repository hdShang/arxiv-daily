...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21848v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.21848v1', 'Massively Parallel Imitation Learning of Mouse Forelimb Musculoskeletal Reaching Dynamics')" title="添加到收藏夹">☆ 收藏</button>
