...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00396v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00396v2', 'Time-Series at the Edge: Tiny Separable CNNs for Wearable Gait Detection and Optimal Sensor Placement')" title="添加到收藏夹">☆ 收藏</button>
