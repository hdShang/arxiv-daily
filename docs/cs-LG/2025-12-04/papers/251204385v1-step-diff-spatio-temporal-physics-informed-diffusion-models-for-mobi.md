...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04385v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.04385v1', 'STeP-Diff: Spatio-Temporal Physics-Informed Diffusion Models for Mobile Fine-Grained Pollution Forecasting')" title="添加到收藏夹">☆ 收藏</button>
