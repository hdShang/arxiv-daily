...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14974v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14974v2', 'pi-Flow: Policy-Based Few-Step Generation via Imitation Distillation')" title="添加到收藏夹">☆ 收藏</button>
