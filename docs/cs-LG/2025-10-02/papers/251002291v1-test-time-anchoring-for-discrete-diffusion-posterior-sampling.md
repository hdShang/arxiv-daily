...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02291v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02291v1', 'Test-Time Anchoring for Discrete Diffusion Posterior Sampling')" title="添加到收藏夹">☆ 收藏</button>
