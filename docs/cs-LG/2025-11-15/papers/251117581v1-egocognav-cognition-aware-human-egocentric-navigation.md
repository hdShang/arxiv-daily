...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17581v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.17581v1', 'EgoCogNav: Cognition-aware Human Egocentric Navigation')" title="添加到收藏夹">☆ 收藏</button>
