...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.14417" class="toolbar-btn" target="_blank">📄 arXiv: 2505.14417v1</a>
  <a href="https://arxiv.org/pdf/2505.14417.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.14417v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.14417v1', 'Towards Non-Euclidean Foundation Models: Advancing AI Beyond Euclidean Frameworks')" title="添加到收藏夹">☆ 收藏</button>
...
**🔗 代码/项目**: [PROJECT_PAGE](https://hyperboliclearning.github.io/events/)
...
1. 现有的机器学习架构主要基于欧几里得空间，导致在处理复杂关系时存在局限性。
2. 论文提出将基础模型与非欧几里得几何结合，以更好地表示具有内在几何特性的复杂数据。
3. 通过整合非欧几里得学习，研究显示在搜索和推荐系统中性能显著提升，具体数据尚未披露。
