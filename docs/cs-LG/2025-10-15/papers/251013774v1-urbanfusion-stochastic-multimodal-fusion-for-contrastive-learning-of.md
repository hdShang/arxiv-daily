...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13774v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13774v1', 'UrbanFusion: Stochastic Multimodal Fusion for Contrastive Learning of Robust Spatial Representations')" title="添加到收藏夹">☆ 收藏</button>
