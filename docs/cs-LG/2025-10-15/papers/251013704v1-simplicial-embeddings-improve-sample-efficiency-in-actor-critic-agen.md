...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13704v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13704v1', 'Simplicial Embeddings Improve Sample Efficiency in Actor-Critic Agents')" title="添加到收藏夹">☆ 收藏</button>
