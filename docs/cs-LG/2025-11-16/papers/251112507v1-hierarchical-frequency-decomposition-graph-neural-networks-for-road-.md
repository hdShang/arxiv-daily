...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12507v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12507v1', 'Hierarchical Frequency-Decomposition Graph Neural Networks for Road Network Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
