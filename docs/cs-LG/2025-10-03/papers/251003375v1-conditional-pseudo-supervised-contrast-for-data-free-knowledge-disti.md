...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03375v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03375v1', 'Conditional Pseudo-Supervised Contrast for Data-Free Knowledge Distillation')" title="添加到收藏夹">☆ 收藏</button>
