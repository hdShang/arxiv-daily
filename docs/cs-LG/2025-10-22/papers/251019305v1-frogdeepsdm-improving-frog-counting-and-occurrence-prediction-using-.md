...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19305v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19305v1', 'FrogDeepSDM: Improving Frog Counting and Occurrence Prediction Using Multimodal Data and Pseudo-Absence Imputation')" title="添加到收藏夹">☆ 收藏</button>
