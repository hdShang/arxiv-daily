...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21835v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21835v1', 'A Multimodal, Multitask System for Generating E Commerce Text Listings from Images')" title="添加到收藏夹">☆ 收藏</button>
