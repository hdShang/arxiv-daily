...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19755v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19755v3', 'A Survey on Cache Methods in Diffusion Models: Toward Efficient Multi-Modal Generation')" title="添加到收藏夹">☆ 收藏</button>
