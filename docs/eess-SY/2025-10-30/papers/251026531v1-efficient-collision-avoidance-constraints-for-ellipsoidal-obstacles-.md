...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26531v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26531v1', 'Efficient Collision-Avoidance Constraints for Ellipsoidal Obstacles in Optimal Control: Application to Path-Following MPC and UAVs')" title="添加到收藏夹">☆ 收藏</button>
