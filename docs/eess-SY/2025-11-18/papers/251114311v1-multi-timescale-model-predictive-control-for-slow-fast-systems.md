...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14311v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.14311v1', 'Multi-Timescale Model Predictive Control for Slow-Fast Systems')" title="添加到收藏夹">☆ 收藏</button>
