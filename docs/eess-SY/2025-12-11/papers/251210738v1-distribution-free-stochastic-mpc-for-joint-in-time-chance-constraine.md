...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10738v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10738v1', 'Distribution-Free Stochastic MPC for Joint-in-Time Chance-Constrained Linear Systems')" title="添加到收藏夹">☆ 收藏</button>
