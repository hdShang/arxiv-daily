...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09213v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.09213v1', 'MPC for momentum counter-balanced and zero-impulse contact with a free-spinning satellite')" title="添加到收藏夹">☆ 收藏</button>
