...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04807v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04807v1', 'Efficient Probabilistic Planning with Maximum-Coverage Distributionally Robust Backward Reachable Trees')" title="添加到收藏夹">☆ 收藏</button>
