...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05299v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05299v1', 'ARCAS: An Augmented Reality Collision Avoidance System with SLAM-Based Tracking for Enhancing VRU Safety')" title="添加到收藏夹">☆ 收藏</button>
