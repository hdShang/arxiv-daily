...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15668v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15668v1', 'Enhancing industrial microalgae production through Economic Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
