...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15677v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15677v1', 'Service-Oriented Fast Frequency Response from Flexible Loads and Energy Storage in Low-Inertia Power Systems')" title="添加到收藏夹">☆ 收藏</button>
