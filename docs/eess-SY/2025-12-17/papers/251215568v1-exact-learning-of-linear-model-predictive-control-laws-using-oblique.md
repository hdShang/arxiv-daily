...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15568v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15568v1', 'Exact Learning of Linear Model Predictive Control Laws using Oblique Decision Trees with Linear Predictions')" title="添加到收藏夹">☆ 收藏</button>
