...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16953v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16953v1', 'Safe Payload Transfer with Ship-Mounted Cranes: A Robust Model Predictive Control Approach')" title="添加到收藏夹">☆ 收藏</button>
