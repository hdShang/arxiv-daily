...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19451v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19451v1', 'Strong Duality and Dual Ascent Approach to Continuous-Time Chance-Constrained Stochastic Optimal Control')" title="添加到收藏夹">☆ 收藏</button>
