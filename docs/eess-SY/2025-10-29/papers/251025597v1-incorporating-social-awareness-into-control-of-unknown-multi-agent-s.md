...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25597v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25597v1', 'Incorporating Social Awareness into Control of Unknown Multi-Agent Systems: A Real-Time Spatiotemporal Tubes Approach')" title="添加到收藏夹">☆ 收藏</button>
