...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.17291" class="toolbar-btn" target="_blank">📄 arXiv: 2506.17291v1</a>
  <a href="https://arxiv.org/pdf/2506.17291.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.17291v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.17291v1', 'Evaluation methodology of Model Predictive Controllers for building\'s energy systems')" title="添加到收藏夹">☆ 收藏</button>
...
1. 建筑行业的能源需求巨大，现有控制方法在性能评估上存在不足，难以有效优化能源管理。
2. 本文提出了一种系统化的评估方法，通过全面的测试协议和多样化场景来评估模型预测控制器的性能。
3. 通过实际案例研究，展示了该方法在不同场景下对控制器的测试和排名能力，提供了有效的性能反馈。
