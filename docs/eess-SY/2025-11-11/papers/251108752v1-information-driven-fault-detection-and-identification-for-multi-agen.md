...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08752v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08752v1', 'Information-Driven Fault Detection and Identification for Multi-Agent Spacecraft Systems: Collaborative On-Orbit Inspection Mission')" title="添加到收藏夹">☆ 收藏</button>
