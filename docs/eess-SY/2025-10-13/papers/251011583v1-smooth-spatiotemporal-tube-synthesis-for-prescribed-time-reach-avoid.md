...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11583v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11583v1', 'Smooth Spatiotemporal Tube Synthesis for Prescribed-Time Reach-Avoid-Stay Control')" title="添加到收藏夹">☆ 收藏</button>
