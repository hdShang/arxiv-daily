...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22810v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22810v1', 'Switching control of underactuated multi-channel systems with input constraints for cooperative manipulation')" title="添加到收藏夹">☆ 收藏</button>
