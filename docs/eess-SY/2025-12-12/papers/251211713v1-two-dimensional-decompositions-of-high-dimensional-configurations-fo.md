...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11713v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11713v1', 'Two-dimensional Decompositions of High-dimensional Configurations for Efficient Multi-vehicle Coordination at Intelligent Intersections')" title="添加到收藏夹">☆ 收藏</button>
