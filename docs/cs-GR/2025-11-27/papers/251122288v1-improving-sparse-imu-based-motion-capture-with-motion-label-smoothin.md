...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22288v1" onclick="toggleFavorite(this, '2511.22288v1', 'Improving Sparse IMU-based Motion Capture with Motion Label Smoothing')" title="添加到收藏夹">☆ 收藏</button>
