...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19189v1" onclick="toggleFavorite(this, '2511.19189v1', 'AvatarBrush: Monocular Reconstruction of Gaussian Avatars with Intuitive Local Editing')" title="添加到收藏夹">☆ 收藏</button>
