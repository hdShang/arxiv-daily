...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21697v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.21697v1', 'Detail Enhanced Gaussian Splatting for Large-Scale Volumetric Capture')" title="添加到收藏夹">☆ 收藏</button>
