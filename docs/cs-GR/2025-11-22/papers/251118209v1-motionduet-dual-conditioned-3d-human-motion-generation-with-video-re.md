...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18209v1" onclick="toggleFavorite(this, '2511.18209v1', 'MotionDuet: Dual-Conditioned 3D Human Motion Generation with Video-Regularized Text Learning')" title="添加到收藏夹">☆ 收藏</button>
