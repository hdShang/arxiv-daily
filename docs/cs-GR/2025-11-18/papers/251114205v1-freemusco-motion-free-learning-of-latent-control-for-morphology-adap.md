...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14205v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.14205v1', 'FreeMusco: Motion-Free Learning of Latent Control for Morphology-Adaptive Locomotion in Musculoskeletal Characters')" title="添加到收藏夹">☆ 收藏</button>
