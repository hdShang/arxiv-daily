...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01978v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01978v2', 'ROI-GS: Interest-based Local Quality 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
