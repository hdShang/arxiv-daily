...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02069v3" onclick="toggleFavorite(this, '2510.02069v3', 'Spec-Gloss Surfels and Normal-Diffuse Priors for Relightable Glossy Objects')" title="添加到收藏夹">☆ 收藏</button>
