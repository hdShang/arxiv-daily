...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17101v1" onclick="toggleFavorite(this, '2510.17101v1', 'Shape-aware Inertial Poser: Motion Tracking for Humans with Diverse Shapes Using Sparse Inertial Sensors')" title="添加到收藏夹">☆ 收藏</button>
