...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15908v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15908v1', 'SPHaptics: A Real-Time Bidirectional Haptic Interaction Framework for Coupled Rigid-Soft Body and Lagrangian Fluid Simulation in Virtual Environments')" title="添加到收藏夹">☆ 收藏</button>
