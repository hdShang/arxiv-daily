...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15398v1" onclick="toggleFavorite(this, '2511.15398v1', 'One algebra for all : Geometric Algebra methods for neurosymbolic XR scene authoring, animation and neural rendering')" title="添加到收藏夹">☆ 收藏</button>
