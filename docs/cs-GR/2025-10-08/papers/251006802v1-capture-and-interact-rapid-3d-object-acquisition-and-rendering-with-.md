...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06802v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06802v1', 'Capture and Interact: Rapid 3D Object Acquisition and Rendering with Gaussian Splatting in Unity')" title="添加到收藏夹">☆ 收藏</button>
