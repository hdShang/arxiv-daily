...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.01259" class="toolbar-btn" target="_blank">📄 arXiv: 2511.01259v1</a>
  <a href="https://arxiv.org/pdf/2511.01259.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01259v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01259v1', 'An Adjoint Method for Differentiable Fluid Simulation on Flow Maps')" title="添加到收藏夹">☆ 收藏</button>
...
1. 传统伴随方法在可微流体模拟中需要存储大量中间变量或微分数值步骤，导致计算成本高昂。
2. 论文提出利用正向模拟中的流映射，在反向传播中直接求解伴随方程，避免了对中间步骤的微分和存储。
3. 实验表明，该方法在低内存占用下，能够精确跟踪涡量，并支持需要精确控制涡旋动力学的可微模拟任务。
