...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22712v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22712v1', 'Step2Motion: Locomotion Reconstruction from Pressure Sensing Insoles')" title="添加到收藏夹">☆ 收藏</button>
