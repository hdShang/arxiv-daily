...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10611v1" onclick="toggleFavorite(this, '2510.10611v1', 'HyperAgent: Leveraging Hypergraphs for Topology Optimization in Multi-Agent Communication')" title="添加到收藏夹">☆ 收藏</button>
