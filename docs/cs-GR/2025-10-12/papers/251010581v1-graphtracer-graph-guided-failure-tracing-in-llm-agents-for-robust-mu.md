...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10581v1" onclick="toggleFavorite(this, '2510.10581v1', 'GraphTracer: Graph-Guided Failure Tracing in LLM Agents for Robust Multi-Turn Deep Search')" title="添加到收藏夹">☆ 收藏</button>
