...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01894v1" onclick="toggleFavorite(this, '2511.01894v1', 'LGCC: Enhancing Flow Matching Based Text-Guided Image Editing with Local Gaussian Coupling and Context Consistency')" title="添加到收藏夹">☆ 收藏</button>
