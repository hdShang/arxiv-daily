...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16147v1" onclick="toggleFavorite(this, '2510.16147v1', 'Procedural Scene Programs for Open-Universe Scene Generation: LLM-Free Error Correction via Program Search')" title="添加到收藏夹">☆ 收藏</button>
