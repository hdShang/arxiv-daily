...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15736v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.15736v1', 'Fix False Transparency by Noise Guided Splatting')" title="添加到收藏夹">☆ 收藏</button>
