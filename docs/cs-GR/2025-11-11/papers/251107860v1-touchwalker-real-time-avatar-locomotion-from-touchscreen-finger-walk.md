...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07860v1" onclick="toggleFavorite(this, '2511.07860v1', 'TouchWalker: Real-Time Avatar Locomotion from Touchscreen Finger Walking')" title="添加到收藏夹">☆ 收藏</button>
