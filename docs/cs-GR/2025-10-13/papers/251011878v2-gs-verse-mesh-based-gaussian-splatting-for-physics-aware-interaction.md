...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11878v2" onclick="toggleFavorite(this, '2510.11878v2', 'GS-Verse: Mesh-based Gaussian Splatting for Physics-aware Interaction in Virtual Reality')" title="添加到收藏夹">☆ 收藏</button>
