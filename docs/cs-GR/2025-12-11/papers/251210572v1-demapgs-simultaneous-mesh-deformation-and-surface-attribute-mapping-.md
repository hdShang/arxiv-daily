...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10572v1" onclick="toggleFavorite(this, '2512.10572v1', 'DeMapGS: Simultaneous Mesh Deformation and Surface Attribute Mapping via Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
