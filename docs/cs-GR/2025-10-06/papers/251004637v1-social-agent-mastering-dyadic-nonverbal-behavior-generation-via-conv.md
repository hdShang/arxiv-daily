...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04637v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04637v1', 'Social Agent: Mastering Dyadic Nonverbal Behavior Generation via Conversational LLM Agents')" title="添加到收藏夹">☆ 收藏</button>
