...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05097v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.05097v1', 'Pulp Motion: Framing-aware multimodal camera and human motion generation')" title="添加到收藏夹">☆ 收藏</button>
