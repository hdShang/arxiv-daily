...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03964v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03964v1', 'Enhancing Foveated Rendering with Weighted Reservoir Sampling')" title="添加到收藏夹">☆ 收藏</button>
