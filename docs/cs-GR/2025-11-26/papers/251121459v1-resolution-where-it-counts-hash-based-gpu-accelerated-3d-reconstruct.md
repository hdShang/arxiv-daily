...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21459v1" onclick="toggleFavorite(this, '2511.21459v1', 'Resolution Where It Counts: Hash-based GPU-Accelerated 3D Reconstruction via Variance-Adaptive Voxel Grids')" title="添加到收藏夹">☆ 收藏</button>
