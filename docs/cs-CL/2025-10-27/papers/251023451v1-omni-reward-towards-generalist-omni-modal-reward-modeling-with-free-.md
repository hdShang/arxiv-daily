...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23451v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23451v1', 'Omni-Reward: Towards Generalist Omni-Modal Reward Modeling with Free-Form Preferences')" title="添加到收藏夹">☆ 收藏</button>
