...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03663v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03663v2', 'UNIDOC-BENCH: A Unified Benchmark for Document-Centric Multimodal RAG')" title="添加到收藏夹">☆ 收藏</button>
