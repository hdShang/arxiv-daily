...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.12845v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.12845v1', 'VLURes: Benchmarking VLM Visual and Linguistic Understanding in Low-Resource Languages')" title="添加到收藏夹">☆ 收藏</button>
