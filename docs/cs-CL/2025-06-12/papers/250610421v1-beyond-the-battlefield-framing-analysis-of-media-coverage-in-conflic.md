...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.10421" class="toolbar-btn" target="_blank">📄 arXiv: 2506.10421v1</a>
  <a href="https://arxiv.org/pdf/2506.10421.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.10421v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.10421v1', 'Beyond the Battlefield: Framing Analysis of Media Coverage in Conflict Reporting')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有关于冲突框架的研究多为定性，缺乏深入分析，无法全面揭示媒体报道的潜在偏见。
2. 本文结合框架语义学与大型语言模型，提出了一种计算方法来识别新闻报道中的战争与和平框架。
3. 分析结果显示，战争报道的关注度明显高于和平报道，并且不同地区的媒体在框架上存在显著差异。
