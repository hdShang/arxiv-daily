...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.13259" class="toolbar-btn" target="_blank">📄 arXiv: 2505.13259v3</a>
  <a href="https://arxiv.org/pdf/2505.13259.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.13259v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.13259v3', 'From Automation to Autonomy: A Survey on Large Language Models in Scientific Discovery')" title="添加到收藏夹">☆ 收藏</button>
...
**🔗 代码/项目**: [GITHUB](https://github.com/HKUST-KnowComp/Awesome-LLM-Scientific-Discovery)
...
1. 现有的科学研究方法在自动化程度和自主性方面存在不足，限制了研究效率和创新能力。
2. 论文提出了基于科学方法的三层次分类法，明确了大语言模型在研究中的不同角色及其责任演变。
3. 通过系统性调查，识别了未来研究的关键挑战，如机器人自动化和伦理治理，推动了该领域的发展。
