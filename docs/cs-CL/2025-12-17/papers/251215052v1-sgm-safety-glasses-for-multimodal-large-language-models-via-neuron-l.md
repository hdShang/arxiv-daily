...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15052v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15052v1', 'SGM: Safety Glasses for Multimodal Large Language Models via Neuron-Level Detoxification')" title="添加到收藏夹">☆ 收藏</button>
