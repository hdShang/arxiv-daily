...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15146v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15146v1', 'Beyond Majority Voting: Towards Fine-grained and More Reliable Reward Signal for Test-Time Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
