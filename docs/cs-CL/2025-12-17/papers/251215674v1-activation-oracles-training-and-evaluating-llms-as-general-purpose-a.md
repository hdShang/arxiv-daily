...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15674v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15674v1', 'Activation Oracles: Training and Evaluating LLMs as General-Purpose Activation Explainers')" title="添加到收藏夹">☆ 收藏</button>
