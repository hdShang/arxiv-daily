...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15617v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15617v1', 'Evaluating Metrics for Safety with LLM-as-Judges')" title="添加到收藏夹">☆ 收藏</button>
