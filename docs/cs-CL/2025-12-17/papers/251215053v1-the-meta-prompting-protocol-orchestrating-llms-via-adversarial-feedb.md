...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15053v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15053v1', 'The Meta-Prompting Protocol: Orchestrating LLMs via Adversarial Feedback Loops')" title="添加到收藏夹">☆ 收藏</button>
