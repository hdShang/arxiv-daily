...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15274v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15274v1', 'Well Begun, Half Done: Reinforcement Learning with Prefix Optimization for LLM Reasoning')" title="添加到收藏夹">☆ 收藏</button>
