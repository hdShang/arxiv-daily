...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15163v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15163v1', 'MCP-SafetyBench: A Benchmark for Safety Evaluation of Large Language Models with Real-World MCP Servers')" title="添加到收藏夹">☆ 收藏</button>
