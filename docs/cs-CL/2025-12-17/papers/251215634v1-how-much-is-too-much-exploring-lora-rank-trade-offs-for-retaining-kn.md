...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15634v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15634v1', 'How Much is Too Much? Exploring LoRA Rank Trade-offs for Retaining Knowledge and Domain Robustness')" title="添加到收藏夹">☆ 收藏</button>
