...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15312v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15312v1', 'Evaluating LLMs for Zeolite Synthesis Event Extraction (ZSEE): A Systematic Analysis of Prompting Strategies')" title="添加到收藏夹">☆ 收藏</button>
