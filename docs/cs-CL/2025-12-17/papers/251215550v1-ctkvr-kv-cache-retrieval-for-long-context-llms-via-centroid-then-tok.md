...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15550v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15550v1', 'CTkvr: KV Cache Retrieval for Long-Context LLMs via Centroid then Token Indexing')" title="添加到收藏夹">☆ 收藏</button>
