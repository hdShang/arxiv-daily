...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15653v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15653v1', 'Characterizing Mamba\'s Selective Memory using Auto-Encoders')" title="添加到收藏夹">☆ 收藏</button>
