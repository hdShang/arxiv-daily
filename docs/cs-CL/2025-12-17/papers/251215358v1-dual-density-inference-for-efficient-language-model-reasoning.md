...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15358v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15358v1', 'Dual-Density Inference for Efficient Language Model Reasoning')" title="添加到收藏夹">☆ 收藏</button>
