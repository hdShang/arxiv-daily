...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.21315" class="toolbar-btn" target="_blank">📄 arXiv: 2505.21315v3</a>
  <a href="https://arxiv.org/pdf/2505.21315.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.21315v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.21315v3', 'Charting the Landscape of African NLP: Mapping Progress and Shaping the Road Ahead')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有NLP系统主要支持高资源语言，导致非洲语言的研究和应用受到严重限制。
2. 通过分析884篇研究论文，识别出非洲语言NLP领域的关键趋势和进展。
3. 研究表明，社区主导的倡议和多语言资源的创建正在推动该领域的快速发展。
