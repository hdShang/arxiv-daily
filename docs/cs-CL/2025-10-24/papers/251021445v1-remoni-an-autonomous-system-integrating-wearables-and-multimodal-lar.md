...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21445v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21445v1', 'REMONI: An Autonomous System Integrating Wearables and Multimodal Large Language Models for Enhanced Remote Health Monitoring')" title="添加到收藏夹">☆ 收藏</button>
