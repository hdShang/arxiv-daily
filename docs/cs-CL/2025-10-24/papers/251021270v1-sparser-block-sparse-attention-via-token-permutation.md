...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21270v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21270v1', 'Sparser Block-Sparse Attention via Token Permutation')" title="添加到收藏夹">☆ 收藏</button>
