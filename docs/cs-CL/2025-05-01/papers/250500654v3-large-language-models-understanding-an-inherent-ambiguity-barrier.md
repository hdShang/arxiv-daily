...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.00654" class="toolbar-btn" target="_blank">📄 arXiv: 2505.00654v3</a>
  <a href="https://arxiv.org/pdf/2505.00654.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.00654v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.00654v3', 'Large Language Models Understanding: an Inherent Ambiguity Barrier')" title="添加到收藏夹">☆ 收藏</button>
...
1. 核心问题：当前大型语言模型在理解对话和世界意义方面存在内在的模糊性障碍，导致其无法真正理解所生成的内容。
2. 方法要点：论文通过思维实验和半正式的分析，提出了一个反驳观点，强调模糊性对理解的影响。
3. 实验或效果：虽然未提供具体实验结果，但强调了模糊性障碍的存在对LLMs理解能力的限制。
