...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19585v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19585v2', 'Detecting Latin in Historical Books with Large Language Models: A Multimodal Benchmark')" title="添加到收藏夹">☆ 收藏</button>
