...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06782v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06782v1', 'GPT-5 Model Corrected GPT-4V\'s Chart Reading Errors, Not Prompting')" title="添加到收藏夹">☆ 收藏</button>
