...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2508.06167" class="toolbar-btn" target="_blank">📄 arXiv: 2508.06167v1</a>
  <a href="https://arxiv.org/pdf/2508.06167.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2508.06167v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2508.06167v1', 'Pragmatics beyond humans: meaning, communication, and LLMs')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的语用学理论主要基于人类特定的假设，难以适应大语言模型的预测系统特性。
2. 论文提出人机沟通框架，强调语言作为社会工具的动态性，适应LLMs的特性。
3. 通过引入上下文挫折概念，揭示了用户在与LLMs互动时的共同构建过程，推动语用学理论的调整。
