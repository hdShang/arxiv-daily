...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2507.21075" class="toolbar-btn" target="_blank">📄 arXiv: 2507.21075v1</a>
  <a href="https://arxiv.org/pdf/2507.21075.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2507.21075v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2507.21075v1', 'Can LLMs Reason About Trust?: A Pilot Study')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有方法在理解和推理人际信任方面存在局限，尤其是在动态和复杂的社交环境中。
2. 本文提出利用大型语言模型（LLMs）进行信任推理，通过角色扮演和行动规划来促进信任关系的建立。
3. 实验结果表明，LLMs在信任推理和诱导方面表现出一定的能力，能够有效支持信任关系的构建。
