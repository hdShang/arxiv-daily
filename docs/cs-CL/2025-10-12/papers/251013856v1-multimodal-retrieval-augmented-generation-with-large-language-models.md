...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13856v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13856v1', 'Multimodal Retrieval-Augmented Generation with Large Language Models for Medical VQA')" title="添加到收藏夹">☆ 收藏</button>
