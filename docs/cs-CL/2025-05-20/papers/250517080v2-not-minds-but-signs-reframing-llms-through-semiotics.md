...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.17080" class="toolbar-btn" target="_blank">📄 arXiv: 2505.17080v2</a>
  <a href="https://arxiv.org/pdf/2505.17080.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.17080v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.17080v2', 'Not Minds, but Signs: Reframing LLMs through Semiotics')" title="添加到收藏夹">☆ 收藏</button>
...
1. 当前将大型语言模型视为认知系统的观点存在局限，容易导致对其能力的误解和人性化的倾向。
2. 本文提出从符号学的视角理解LLMs，强调其在符号生成和文化过程中的作用，而非简单的语言理解。
3. 通过理论分析和实际应用案例，展示LLMs如何作为符号代理参与文化生产，促进创造性和批判性对话。
