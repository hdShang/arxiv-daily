...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.23666" class="toolbar-btn" target="_blank">📄 arXiv: 2505.23666v2</a>
  <a href="https://arxiv.org/pdf/2505.23666.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.23666v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.23666v2', 'LoLA: Low-Rank Linear Attention With Sparse Caching')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的变换器模型在推理时，随着上下文长度的增加，计算成本急剧上升，限制了其在终身学习中的应用。
2. LoLA通过将过去的键值对分配到不同的内存系统中，提升了线性注意力的关联记忆能力，且无需额外训练。
3. 实验结果显示，LoLA在关键检索任务中准确率从0.6%提升至97.4%，并且在内存使用上显著优于现有模型。
