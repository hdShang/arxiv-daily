...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11811v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11811v2', 'Enhancing Geo-localization for Crowdsourced Flood Imagery via LLM-Guided Attention')" title="添加到收藏夹">☆ 收藏</button>
