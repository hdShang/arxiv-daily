...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15253v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.15253v1', 'Scaling Beyond Context: A Survey of Multimodal Retrieval-Augmented Generation for Document Understanding')" title="添加到收藏夹">☆ 收藏</button>
