...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01845v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01845v1', 'Model Merging to Maintain Language-Only Performance in Developmentally Plausible Multimodal Models')" title="添加到收藏夹">☆ 收藏</button>
