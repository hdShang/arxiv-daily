...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14949v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14949v1', 'DialectGen: Benchmarking and Improving Dialect Robustness in Multimodal Generation')" title="添加到收藏夹">☆ 收藏</button>
