...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14824v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14824v1', 'Supervised Fine-Tuning or Contrastive Learning? Towards Better Multimodal LLM Reranking')" title="添加到收藏夹">☆ 收藏</button>
