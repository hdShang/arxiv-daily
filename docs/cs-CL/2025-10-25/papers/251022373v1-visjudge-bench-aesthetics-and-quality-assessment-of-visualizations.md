...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22373v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22373v1', 'VisJudge-Bench: Aesthetics and Quality Assessment of Visualizations')" title="添加到收藏夹">☆ 收藏</button>
