...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.22202" class="toolbar-btn" target="_blank">📄 arXiv: 2509.22202v1</a>
  <a href="https://arxiv.org/pdf/2509.22202.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.22202v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.22202v1', 'Library Hallucinations in LLMs: Risk Analysis Grounded in Developer Queries')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有LLM在代码生成中存在库幻觉问题，可能导致安全风险，但缺乏对用户提示变化影响的系统研究。
2. 该研究通过分析真实开发者查询和错误提示，评估不同LLM在库名和成员幻觉方面的表现。
3. 实验揭示LLM对细微提示变化的脆弱性，强调了提示工程在缓解幻觉方面的局限性，并呼吁加强安全防护。
