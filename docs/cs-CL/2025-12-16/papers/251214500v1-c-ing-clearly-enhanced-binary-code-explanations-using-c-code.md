...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.14500v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.14500v1', 'C-ing Clearly: Enhanced Binary Code Explanations using C code')" title="添加到收藏夹">☆ 收藏</button>
