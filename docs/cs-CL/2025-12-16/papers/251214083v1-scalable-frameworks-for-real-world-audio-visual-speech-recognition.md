...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.14083v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.14083v1', 'Scalable Frameworks for Real-World Audio-Visual Speech Recognition')" title="添加到收藏夹">☆ 收藏</button>
