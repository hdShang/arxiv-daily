...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.14345" class="toolbar-btn" target="_blank">📄 arXiv: 2506.14345v1</a>
  <a href="https://arxiv.org/pdf/2506.14345.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.14345v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.14345v1', 'A Vision for Geo-Temporal Deep Research Systems: Towards Comprehensive, Transparent, and Reproducible Geo-Temporal Information Synthesis')" title="添加到收藏夹">☆ 收藏</button>
