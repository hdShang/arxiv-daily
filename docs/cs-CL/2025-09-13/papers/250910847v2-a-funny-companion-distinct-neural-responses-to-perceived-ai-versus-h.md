...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.10847" class="toolbar-btn" target="_blank">📄 arXiv: 2509.10847v2</a>
  <a href="https://arxiv.org/pdf/2509.10847.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.10847v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.10847v2', 'A funny companion: Distinct neural responses to perceived AI- versus human-generated humor')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有研究缺乏对AI幽默的认知神经机制的深入理解，特别是与人类幽默的对比。
2. 本研究利用脑电技术，对比分析了人类和AI生成的幽默对大脑认知和情感反应的影响。
3. 实验表明，人们对AI幽默的认知负荷更低，情绪反应更强烈，且随着时间推移，对AI幽默的接受度更高。
