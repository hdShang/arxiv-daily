...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11196v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11196v2', 'Evaluating Reasoning Faithfulness in Medical Vision-Language Models using Multimodal Perturbations')" title="添加到收藏夹">☆ 收藏</button>
