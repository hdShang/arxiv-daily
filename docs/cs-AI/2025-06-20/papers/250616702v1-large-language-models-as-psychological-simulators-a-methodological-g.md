...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.16702" class="toolbar-btn" target="_blank">📄 arXiv: 2506.16702v1</a>
  <a href="https://arxiv.org/pdf/2506.16702.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.16702v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.16702v1', 'Large Language Models as Psychological Simulators: A Methodological Guide')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有方法缺乏对大型语言模型在心理学研究中的系统性指导，导致研究者难以有效利用其潜力。
2. 论文提出了一个框架，利用LLMs模拟心理角色和认知过程，强调心理学基础的人格开发和模型行为的验证。
3. 通过整合新兴实证证据，论文帮助研究者识别和应对LLMs在心理研究中的挑战，提升研究的有效性。
