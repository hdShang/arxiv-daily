...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10932v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10932v1', 'TabVLA: Targeted Backdoor Attacks on Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
