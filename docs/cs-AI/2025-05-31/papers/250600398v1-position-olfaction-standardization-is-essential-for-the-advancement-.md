...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.00398" class="toolbar-btn" target="_blank">📄 arXiv: 2506.00398v1</a>
  <a href="https://arxiv.org/pdf/2506.00398.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.00398v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.00398v1', 'Position: Olfaction Standardization is Essential for the Advancement of Embodied Artificial Intelligence')" title="添加到收藏夹">☆ 收藏</button>
...
1. 核心问题：现有的AI系统在嗅觉感知方面存在显著缺失，导致其无法全面模拟人类认知。
2. 方法要点：论文主张通过跨学科合作，推动嗅觉研究的标准化，以促进具身人工智能的发展。
3. 实验或效果：呼吁建立嗅觉基准和多模态数据集，以提升机器在复杂环境中的理解和适应能力。
