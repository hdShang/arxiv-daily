...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.00570" class="toolbar-btn" target="_blank">📄 arXiv: 2506.00570v1</a>
  <a href="https://arxiv.org/pdf/2506.00570.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.00570v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.00570v1', 'A &quot;Wenlu&quot; Brain System for Multimodal Cognition and Embodied Decision-Making: A Secure New Architecture for Deep Integration of Foundation Models and Domain Knowledge')" title="添加到收藏夹">☆ 收藏</button>
...
1. 核心问题：现有方法在复杂应用中难以有效整合语言理解与领域知识，导致决策效率低下。
2. 方法要点：提出“文露”系统，通过安全融合私有知识与公共模型，实现多模态数据的统一处理与闭环决策。
3. 实验或效果：相较于现有方案，“文露”在多模态处理和隐私保护等方面表现出显著优势，提升了决策支持的效率与准确性。
