...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.10963" class="toolbar-btn" target="_blank">📄 arXiv: 2509.10963v1</a>
  <a href="https://arxiv.org/pdf/2509.10963.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.10963v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.10963v1', 'Testing for LLM response differences: the case of a composite null consisting of semantically irrelevant query perturbations')" title="添加到收藏夹">☆ 收藏</button>
...
1. 传统统计假设检验在评估LLM时，易受语义无关扰动影响，导致对等价查询产生不同响应。
2. 论文提出一种新的检验程序，考虑一组语义相似的查询，以提高对语义扰动的鲁棒性。
3. 论文分析了二元响应情况，证明了该检验方法在渐近意义下的有效性和一致性，并讨论了实际应用。
