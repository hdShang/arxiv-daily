...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26967v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26967v1', 'Using Salient Object Detection to Identify Manipulative Cookie Banners that Circumvent GDPR')" title="添加到收藏夹">☆ 收藏</button>
