...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22990v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22990v2', 'USF-MAE: Ultrasound Self-Supervised Foundation Model with Masked Autoencoding')" title="添加到收藏夹">☆ 收藏</button>
