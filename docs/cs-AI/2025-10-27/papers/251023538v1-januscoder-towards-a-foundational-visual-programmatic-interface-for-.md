...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23538v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23538v1', 'JanusCoder: Towards a Foundational Visual-Programmatic Interface for Code Intelligence')" title="添加到收藏夹">☆ 收藏</button>
