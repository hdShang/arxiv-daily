...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06471v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06471v2', 'GHOST: Solving the Traveling Salesman Problem on Graphs of Convex Sets')" title="添加到收藏夹">☆ 收藏</button>
