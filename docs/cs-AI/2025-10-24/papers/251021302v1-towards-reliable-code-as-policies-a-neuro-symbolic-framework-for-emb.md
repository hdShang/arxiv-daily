...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21302v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21302v1', 'Towards Reliable Code-as-Policies: A Neuro-Symbolic Framework for Embodied Task Planning')" title="添加到收藏夹">☆ 收藏</button>
