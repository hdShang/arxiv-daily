...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00020v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00020v1', 'Multimodal Detection of Fake Reviews using BERT and ResNet-50')" title="添加到收藏夹">☆ 收藏</button>
