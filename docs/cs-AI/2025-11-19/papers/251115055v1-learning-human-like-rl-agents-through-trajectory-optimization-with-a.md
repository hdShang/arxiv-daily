...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15055v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15055v1', 'Learning Human-Like RL Agents Through Trajectory Optimization With Action Quantization')" title="添加到收藏夹">☆ 收藏</button>
