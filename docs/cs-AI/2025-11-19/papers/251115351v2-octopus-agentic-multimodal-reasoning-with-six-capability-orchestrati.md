...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15351v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15351v2', 'Octopus: Agentic Multimodal Reasoning with Six-Capability Orchestration')" title="添加到收藏夹">☆ 收藏</button>
