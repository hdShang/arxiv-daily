...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2507.01061" class="toolbar-btn" target="_blank">📄 arXiv: 2507.01061v2</a>
  <a href="https://arxiv.org/pdf/2507.01061.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2507.01061v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2507.01061v2', 'Epitome: Pioneering an Experimental Platform for AI-Social Science Integration')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有社会科学实验缺乏有效整合人工智能技术的工具，导致人机交互研究的效率和质量不足。
2. Epitome平台通过七个核心模块，提供从基础模型到用户反馈的全面实验解决方案，促进跨学科研究。
3. 通过复制三项经典社会科学实验，Epitome展示了其在简化复杂实验设计和提高结果可靠性方面的潜力。
