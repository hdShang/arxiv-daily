...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2506.22231" class="toolbar-btn" target="_blank">📄 arXiv: 2506.22231v1</a>
  <a href="https://arxiv.org/pdf/2506.22231.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2506.22231v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2506.22231v1', 'Adapting University Policies for Generative AI: Opportunities, Challenges, and Policy Solutions in Higher Education')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的教育评估方法在面对生成性AI的使用时，面临学术诚信和公平性等重大挑战。
2. 论文提出通过重新设计评估方式、加强培训和实施多层次政策来应对生成性AI带来的问题。
3. 研究表明，近47%的学生使用LLMs，且现有检测工具的准确率为88%，显示出政策适应的紧迫性。
