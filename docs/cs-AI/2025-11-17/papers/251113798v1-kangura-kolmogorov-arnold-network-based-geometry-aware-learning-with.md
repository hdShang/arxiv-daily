...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13798v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13798v1', 'KANGURA: Kolmogorov-Arnold Network-Based Geometry-Aware Learning with Unified Representation Attention for 3D Modeling of Complex Structures')" title="添加到收藏夹">☆ 收藏</button>
