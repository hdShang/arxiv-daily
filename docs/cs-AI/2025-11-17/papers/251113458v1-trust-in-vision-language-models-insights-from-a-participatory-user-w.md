...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13458v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13458v1', 'Trust in Vision-Language Models: Insights from a Participatory User Workshop')" title="添加到收藏夹">☆ 收藏</button>
