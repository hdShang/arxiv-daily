...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14515v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.14515v2', 'IMSE: Efficient U-Net-based Speech Enhancement using Inception Depthwise Convolution and Amplitude-Aware Linear Attention')" title="添加到收藏夹">☆ 收藏</button>
