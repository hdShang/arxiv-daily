...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16183v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16183v1', 'FOOTPASS: A Multi-Modal Multi-Agent Tactical Context Dataset for Play-by-Play Action Spotting in Soccer Broadcast Videos')" title="添加到收藏夹">☆ 收藏</button>
