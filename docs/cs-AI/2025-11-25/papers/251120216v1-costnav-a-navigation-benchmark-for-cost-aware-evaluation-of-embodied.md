...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20216v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20216v1', 'CostNav: A Navigation Benchmark for Cost-Aware Evaluation of Embodied Agents')" title="添加到收藏夹">☆ 收藏</button>
