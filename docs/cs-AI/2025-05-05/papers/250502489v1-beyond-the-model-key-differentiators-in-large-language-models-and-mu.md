...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.02489" class="toolbar-btn" target="_blank">📄 arXiv: 2505.02489v1</a>
  <a href="https://arxiv.org/pdf/2505.02489.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.02489v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.02489v1', 'Beyond the model: Key differentiators in large language models and multi-agent services')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的生成式AI模型在能力上趋于相似，单纯依赖大型语言模型已无法满足市场需求。
2. 论文提出优化AI服务生态系统的思路，强调数据质量、计算效率等多个维度的重要性。
3. 通过对比分析，论文展示了优化后的AI服务在效率和盈利性方面的显著提升。
