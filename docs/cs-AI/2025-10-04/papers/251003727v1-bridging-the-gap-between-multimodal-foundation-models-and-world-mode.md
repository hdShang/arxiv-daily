...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03727v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03727v1', 'Bridging the Gap Between Multimodal Foundation Models and World Models')" title="添加到收藏夹">☆ 收藏</button>
