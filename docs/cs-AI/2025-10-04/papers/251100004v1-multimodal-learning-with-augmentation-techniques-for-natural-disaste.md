...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00004v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00004v1', 'Multimodal Learning with Augmentation Techniques for Natural Disaster Assessment')" title="添加到收藏夹">☆ 收藏</button>
