...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01531v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01531v1', 'Information Seeking for Robust Decision Making under Partial Observability')" title="添加到收藏夹">☆ 收藏</button>
