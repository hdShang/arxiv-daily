...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06235v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06235v1', 'Stacked Regression using Off-the-shelf, Stimulus-tuned and Fine-tuned Neural Networks for Predicting fMRI Brain Responses to Movies (Algonauts 2025 Report)')" title="添加到收藏夹">☆ 收藏</button>
