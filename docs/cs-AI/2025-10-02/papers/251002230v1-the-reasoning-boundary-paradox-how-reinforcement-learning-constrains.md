...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02230v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02230v1', 'The Reasoning Boundary Paradox: How Reinforcement Learning Constrains Language Models')" title="添加到收藏夹">☆ 收藏</button>
