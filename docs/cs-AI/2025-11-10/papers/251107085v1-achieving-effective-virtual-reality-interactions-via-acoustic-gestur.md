...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07085v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07085v1', 'Achieving Effective Virtual Reality Interactions via Acoustic Gesture Recognition based on Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
