...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16376v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16376v1', 'Conformal Prediction in The Loop: A Feedback-Based Uncertainty Model for Trajectory Optimization')" title="添加到收藏夹">☆ 收藏</button>
