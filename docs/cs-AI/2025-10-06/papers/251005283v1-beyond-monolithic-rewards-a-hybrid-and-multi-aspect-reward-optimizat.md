...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05283v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.05283v1', 'Beyond Monolithic Rewards: A Hybrid and Multi-Aspect Reward Optimization for MLLM Alignment')" title="添加到收藏夹">☆ 收藏</button>
