...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14340v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14340v1', 'A Density-Informed Multimodal Artificial Intelligence Framework for Improving Breast Cancer Detection Across All Breast Densities')" title="添加到收藏夹">☆ 收藏</button>
