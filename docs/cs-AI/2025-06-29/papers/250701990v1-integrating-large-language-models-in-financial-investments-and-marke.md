...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2507.01990" class="toolbar-btn" target="_blank">📄 arXiv: 2507.01990v1</a>
  <a href="https://arxiv.org/pdf/2507.01990.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2507.01990v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2507.01990v1', 'Integrating Large Language Models in Financial Investments and Market Analysis: A Survey')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有金融投资方法多依赖于传统的定量模型和技术指标，缺乏对大规模非结构化数据的有效处理能力。
2. 本文提出了将大型语言模型整合进金融决策过程的框架，提升了数据分析和实时决策的能力。
3. 通过对现有研究的系统回顾，本文展示了LLMs在金融市场中的应用潜力及其面临的挑战。
