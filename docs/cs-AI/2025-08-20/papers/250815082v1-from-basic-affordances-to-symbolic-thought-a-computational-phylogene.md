...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2508.15082" class="toolbar-btn" target="_blank">📄 arXiv: 2508.15082v1</a>
  <a href="https://arxiv.org/pdf/2508.15082.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2508.15082v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2508.15082v1', 'From Basic Affordances to Symbolic Thought: A Computational Phylogenesis of Biological Intelligence')" title="添加到收藏夹">☆ 收藏</button>
...
**DOI**: [10.1037/rev0000592](https://doi.org/10.1037/rev0000592)
...
1. 核心问题：现有研究未能充分解释人类大脑如何实现符号思维，特别是动态绑定的局限性。
2. 方法要点：提出多角色绑定和多对应关系的层次整合作为实现符号思维的必要条件，构建相应的认知架构进行验证。
3. 实验或效果：通过17个模拟实验，结果表明多角色谓词和结构映射是符号思维的最低要求，验证了理论假设。
