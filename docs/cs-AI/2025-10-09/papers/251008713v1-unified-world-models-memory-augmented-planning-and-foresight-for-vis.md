...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08713v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08713v1', 'Unified World Models: Memory-Augmented Planning and Foresight for Visual Navigation')" title="添加到收藏夹">☆ 收藏</button>
