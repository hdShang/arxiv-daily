...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07681v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07681v2', 'Curriculum Learning with Synthetic Data for Enhanced Pulmonary Nodule Detection in Chest Radiographs')" title="添加到收藏夹">☆ 收藏</button>
