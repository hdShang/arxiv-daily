...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19396v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19396v1', 'Real-Time Object Tracking with On-Device Deep Learning for Adaptive Beamforming in Dynamic Acoustic Environments')" title="添加到收藏夹">☆ 收藏</button>
