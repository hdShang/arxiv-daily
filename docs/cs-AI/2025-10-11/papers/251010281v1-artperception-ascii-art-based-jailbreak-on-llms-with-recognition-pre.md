...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10281v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10281v1', 'ArtPerception: ASCII Art-based Jailbreak on LLMs with Recognition Pre-test')" title="添加到收藏夹">☆ 收藏</button>
