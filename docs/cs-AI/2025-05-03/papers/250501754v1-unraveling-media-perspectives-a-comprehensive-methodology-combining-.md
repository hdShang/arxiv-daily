...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.01754" class="toolbar-btn" target="_blank">📄 arXiv: 2505.01754v1</a>
  <a href="https://arxiv.org/pdf/2505.01754.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.01754v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.01754v1', 'Unraveling Media Perspectives: A Comprehensive Methodology Combining Large Language Models, Topic Modeling, Sentiment Analysis, and Ontology Learning to Analyse Media Bias')" title="添加到收藏夹">☆ 收藏</button>
...
**DOI**: [10.1007/s42001-025-00372-0](https://doi.org/10.1007/s42001-025-00372-0)
...
1. 现有的媒体偏见分析方法往往存在可扩展性不足和偏见识别不全面的问题。
2. 论文提出了一种结合大语言模型、主题建模、情感分析和本体学习的方法，旨在全面分析媒体偏见。
3. 通过三个案例研究，验证了该方法在不同新闻源中识别偏见的有效性，提升了分析的准确性和深度。
