...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26023v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26023v2', 'Large Language Model-assisted Autonomous Vehicle Recovery from Immobilization')" title="添加到收藏夹">☆ 收藏</button>
