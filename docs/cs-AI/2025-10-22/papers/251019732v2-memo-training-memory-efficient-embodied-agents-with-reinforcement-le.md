...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19732v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19732v2', 'Memo: Training Memory-Efficient Embodied Agents with Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
