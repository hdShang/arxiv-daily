...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.21674" class="toolbar-btn" target="_blank">📄 arXiv: 2505.21674v1</a>
  <a href="https://arxiv.org/pdf/2505.21674.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.21674v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.21674v1', 'Make Planning Research Rigorous Again!')" title="添加到收藏夹">☆ 收藏</button>
...
1. 当前大语言模型的规划研究缺乏严谨的设计与评估，容易重复历史错误。
2. 论文建议将自动规划社区的经验与工具整合进LLM规划者的设计中，以提升其有效性。
3. 通过避免已知的陷阱，能够显著推动LLM规划者的发展与规划领域的整体进步。
