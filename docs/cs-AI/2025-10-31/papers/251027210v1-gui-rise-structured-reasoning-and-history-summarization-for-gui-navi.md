...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27210v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27210v1', 'GUI-Rise: Structured Reasoning and History Summarization for GUI Navigation')" title="添加到收藏夹">☆ 收藏</button>
