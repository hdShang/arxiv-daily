...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27623v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27623v1', 'Visual Backdoor Attacks on MLLM Embodied Decision Making via Contrastive Trigger Learning')" title="添加到收藏夹">☆ 收藏</button>
