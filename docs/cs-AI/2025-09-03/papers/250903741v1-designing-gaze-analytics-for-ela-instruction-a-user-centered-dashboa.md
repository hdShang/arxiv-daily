...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.03741" class="toolbar-btn" target="_blank">📄 arXiv: 2509.03741v1</a>
  <a href="https://arxiv.org/pdf/2509.03741.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.03741v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.03741v1', 'Designing Gaze Analytics for ELA Instruction: A User-Centered Dashboard with Conversational AI Support')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的课堂教育技术在利用眼动追踪数据时面临数据解释和可及性不足的问题，限制了其在教学中的应用。
2. 论文提出了一种用户中心的设计方法，开发了一个注视分析仪表盘，结合对话代理以支持自然语言交互，降低理解门槛。
3. 研究表明，注视分析在结合熟悉的可视化和叙事结构后，能够有效支持教学反思和决策，提高了教师和学生的参与度。
