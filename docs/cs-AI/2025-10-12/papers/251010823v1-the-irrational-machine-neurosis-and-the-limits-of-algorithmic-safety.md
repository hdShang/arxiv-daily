...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10823v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10823v1', 'The Irrational Machine: Neurosis and the Limits of Algorithmic Safety')" title="添加到收藏夹">☆ 收藏</button>
