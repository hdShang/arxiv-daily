...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11754v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11754v1', 'Zero-Shot Large Language Model Agents for Fully Automated Radiotherapy Treatment Planning')" title="添加到收藏夹">☆ 收藏</button>
