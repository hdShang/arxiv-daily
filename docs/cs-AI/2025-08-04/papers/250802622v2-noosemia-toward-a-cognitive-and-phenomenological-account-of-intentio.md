...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2508.02622" class="toolbar-btn" target="_blank">📄 arXiv: 2508.02622v2</a>
  <a href="https://arxiv.org/pdf/2508.02622.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2508.02622v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2508.02622v2', 'Noosemia: toward a Cognitive and Phenomenological Account of Intentionality Attribution in Human-Generative AI Interaction')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有方法未能充分解释用户如何在与生成性AI互动中归属意向性和能动性。
2. 论文提出Noosemia框架，强调语言表现和技术复杂性在意向性归属中的作用。
3. 通过分析Noosemia与其他现象的关系，揭示了人机交互中的独特认知模式。
