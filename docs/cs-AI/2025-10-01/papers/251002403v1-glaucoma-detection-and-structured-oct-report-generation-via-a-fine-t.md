...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02403v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02403v1', 'Glaucoma Detection and Structured OCT Report Generation via a Fine-tuned Multimodal Large Language Model')" title="添加到收藏夹">☆ 收藏</button>
