...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17771v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17771v1', 'Seeing but Not Believing: Probing the Disconnect Between Visual Attention and Answer Correctness in VLMs')" title="添加到收藏夹">☆ 收藏</button>
