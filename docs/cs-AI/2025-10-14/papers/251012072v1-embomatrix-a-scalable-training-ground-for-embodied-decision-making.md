...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.12072v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.12072v1', 'EmboMatrix: A Scalable Training-Ground for Embodied Decision-Making')" title="添加到收藏夹">☆ 收藏</button>
