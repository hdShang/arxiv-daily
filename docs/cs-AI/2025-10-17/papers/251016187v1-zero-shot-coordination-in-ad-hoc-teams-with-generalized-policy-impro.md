...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16187v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16187v1', 'Zero-Shot Coordination in Ad Hoc Teams with Generalized Policy Improvement and Difference Rewards')" title="添加到收藏夹">☆ 收藏</button>
