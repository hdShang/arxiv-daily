...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15489v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15489v1', 'Nemotron-Math: Efficient Long-Context Distillation of Mathematical Reasoning from Multi-Mode Supervision')" title="添加到收藏夹">☆ 收藏</button>
