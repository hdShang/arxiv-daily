...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15149v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15149v1', 'Offline Multi-Task Multi-Objective Data-Driven Evolutionary Algorithm with Language Surrogate Model and Implicit Q-Learning')" title="添加到收藏夹">☆ 收藏</button>
