...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15089v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15089v1', 'Beyond Fast and Slow: Cognitive-Inspired Elastic Reasoning for Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
