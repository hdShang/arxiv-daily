...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15388v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15388v1', 'Bilateral Spatial Reasoning about Street Networks: Graph-based RAG with Qualitative Spatial Representations')" title="添加到收藏夹">☆ 收藏</button>
