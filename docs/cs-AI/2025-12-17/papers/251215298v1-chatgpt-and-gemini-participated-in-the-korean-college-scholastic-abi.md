...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15298v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15298v1', 'ChatGPT and Gemini participated in the Korean College Scholastic Ability Test -- Earth Science I')" title="添加到收藏夹">☆ 收藏</button>
