...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15033v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15033v1', 'Beyond Accuracy: A Geometric Stability Analysis of Large Language Models in Chess Evaluation')" title="添加到收藏夹">☆ 收藏</button>
