...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15663v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15663v1', 'Explaining the Reasoning of Large Language Models Using Attribution Graphs')" title="添加到收藏夹">☆ 收藏</button>
