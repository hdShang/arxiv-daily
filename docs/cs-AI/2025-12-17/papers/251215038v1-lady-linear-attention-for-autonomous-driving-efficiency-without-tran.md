...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15038v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15038v1', 'LADY: Linear Attention for Autonomous Driving Efficiency without Transformers')" title="添加到收藏夹">☆ 收藏</button>
