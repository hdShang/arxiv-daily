...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19986v1" onclick="toggleFavorite(this, '2510.19986v1', 'Automating Iconclass: LLMs and RAG for Large-Scale Classification of Religious Woodcuts')" title="添加到收藏夹">☆ 收藏</button>
