...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19273v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19273v1', 'MobiAct: Efficient MAV Action Recognition Using MobileNetV4 with Contrastive Learning and Knowledge Distillation')" title="添加到收藏夹">☆ 收藏</button>
