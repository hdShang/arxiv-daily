...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19333v2" onclick="toggleFavorite(this, '2510.19333v2', 'A Training-Free Framework for Open-Vocabulary Image Segmentation and Recognition with EfficientNet and CLIP')" title="添加到收藏夹">☆ 收藏</button>
