...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19451v1" onclick="toggleFavorite(this, '2510.19451v1', 'Reasoning Like Experts: Leveraging Multimodal Large Language Models for Drawing-based Psychoanalysis')" title="添加到收藏夹">☆ 收藏</button>
