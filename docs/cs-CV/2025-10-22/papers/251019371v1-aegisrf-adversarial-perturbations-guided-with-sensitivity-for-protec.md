...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19371v1" onclick="toggleFavorite(this, '2510.19371v1', 'AegisRF: Adversarial Perturbations Guided with Sensitivity for Protecting Intellectual Property of Neural Radiance Fields')" title="添加到收藏夹">☆ 收藏</button>
