...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21842v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21842v1', 'Modal Aphasia: Can Unified Multimodal Models Describe Images From Memory?')" title="添加到收藏夹">☆ 收藏</button>
