...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21850v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21850v1', 'SCoPE VLM: Selective Context Processing for Efficient Document Navigation in Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
