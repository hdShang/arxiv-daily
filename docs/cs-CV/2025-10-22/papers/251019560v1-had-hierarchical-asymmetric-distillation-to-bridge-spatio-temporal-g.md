...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19560v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19560v1', 'HAD: Hierarchical Asymmetric Distillation to Bridge Spatio-Temporal Gaps in Event-Based Object Tracking')" title="添加到收藏夹">☆ 收藏</button>
