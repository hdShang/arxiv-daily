...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19622v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19622v2', 'Augmenting Moment Retrieval: Zero-Dependency Two-Stage Learning')" title="添加到收藏夹">☆ 收藏</button>
