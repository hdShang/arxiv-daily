...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19592v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19592v1', 'Decomposed Attention Fusion in MLLMs for Training-Free Video Reasoning Segmentation')" title="添加到收藏夹">☆ 收藏</button>
