...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00503v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00503v1', 'Diff4Splat: Controllable 4D Scene Generation with Latent Dynamic Reconstruction Models')" title="添加到收藏夹">☆ 收藏</button>
