...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00653v1" onclick="toggleFavorite(this, '2511.00653v1', 'Benchmarking individual tree segmentation using multispectral airborne laser scanning data: the FGI-EMIT dataset')" title="添加到收藏夹">☆ 收藏</button>
