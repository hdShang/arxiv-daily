...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00396v3" onclick="toggleFavorite(this, '2511.00396v3', 'Saliency-R1: Incentivizing Unified Saliency Reasoning Capability in MLLM with Confidence-Guided Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
