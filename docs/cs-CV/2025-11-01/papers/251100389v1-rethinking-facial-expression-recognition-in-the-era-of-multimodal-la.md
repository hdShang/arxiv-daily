...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00389v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00389v1', 'Rethinking Facial Expression Recognition in the Era of Multimodal Large Language Models: Benchmark, Datasets, and Beyond')" title="添加到收藏夹">☆ 收藏</button>
