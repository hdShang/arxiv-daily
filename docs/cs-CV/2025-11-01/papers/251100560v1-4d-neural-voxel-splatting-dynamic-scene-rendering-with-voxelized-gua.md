...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00560v1" onclick="toggleFavorite(this, '2511.00560v1', '4D Neural Voxel Splatting: Dynamic Scene Rendering with Voxelized Guassian Splatting')" title="添加到收藏夹">☆ 收藏</button>
