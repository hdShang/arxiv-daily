...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00456v4" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00456v4', 'Weakly Supervised Pneumonia Localization from Chest X-Rays Using Deep Neural Network and Grad-CAM Explanations')" title="添加到收藏夹">☆ 收藏</button>
