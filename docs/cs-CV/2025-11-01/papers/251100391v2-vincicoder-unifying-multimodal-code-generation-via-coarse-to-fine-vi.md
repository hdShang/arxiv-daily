...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00391v2" onclick="toggleFavorite(this, '2511.00391v2', 'VinciCoder: Unifying Multimodal Code Generation via Coarse-to-fine Visual Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
