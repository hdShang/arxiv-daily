...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00413v1" onclick="toggleFavorite(this, '2512.00413v1', 'SplatFont3D: Structure-Aware Text-to-3D Artistic Font Generation with Part-Level Style Control')" title="添加到收藏夹">☆ 收藏</button>
