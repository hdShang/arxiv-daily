...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00493v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00493v1', 'CC-FMO: Camera-Conditioned Zero-Shot Single Image to 3D Scene Generation with Foundation Model Orchestration')" title="添加到收藏夹">☆ 收藏</button>
