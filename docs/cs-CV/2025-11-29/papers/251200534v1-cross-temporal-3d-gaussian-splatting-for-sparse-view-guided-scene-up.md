...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00534v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00534v1', 'Cross-Temporal 3D Gaussian Splatting for Sparse-View Guided Scene Update')" title="添加到收藏夹">☆ 收藏</button>
