...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00647v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00647v2', 'MambaScope: Coarse-to-Fine Scoping for Efficient Vision Mamba')" title="添加到收藏夹">☆ 收藏</button>
