...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00582v1" onclick="toggleFavorite(this, '2512.00582v1', 'SatireDecoder: Visual Cascaded Decoupling for Enhancing Satirical Image Comprehension')" title="添加到收藏夹">☆ 收藏</button>
