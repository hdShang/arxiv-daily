...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00425v1" onclick="toggleFavorite(this, '2512.00425v1', 'What about gravity in video generation? Post-Training Newton\'s Laws with Verifiable Rewards')" title="添加到收藏夹">☆ 收藏</button>
