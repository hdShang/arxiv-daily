...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14716v1" onclick="toggleFavorite(this, '2511.14716v1', 'Diffusion As Self-Distillation: End-to-End Latent Diffusion In One Model')" title="添加到收藏夹">☆ 收藏</button>
