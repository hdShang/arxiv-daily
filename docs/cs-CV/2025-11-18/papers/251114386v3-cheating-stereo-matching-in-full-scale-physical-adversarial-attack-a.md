...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14386v3" onclick="toggleFavorite(this, '2511.14386v3', 'Cheating Stereo Matching in Full-scale: Physical Adversarial Attack against Binocular Depth Estimation in Autonomous Driving')" title="添加到收藏夹">☆ 收藏</button>
