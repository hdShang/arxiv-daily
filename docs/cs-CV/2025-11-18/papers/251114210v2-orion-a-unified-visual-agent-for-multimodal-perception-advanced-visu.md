...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14210v2" onclick="toggleFavorite(this, '2511.14210v2', 'Orion: A Unified Visual Agent for Multimodal Perception, Advanced Visual Reasoning and Execution')" title="添加到收藏夹">☆ 收藏</button>
