...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14238v1" onclick="toggleFavorite(this, '2511.14238v1', 'Enhancing Generalization of Depth Estimation Foundation Model via Weakly-Supervised Adaptation with Regularization')" title="添加到收藏夹">☆ 收藏</button>
