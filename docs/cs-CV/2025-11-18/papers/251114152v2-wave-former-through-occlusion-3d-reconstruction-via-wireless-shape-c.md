...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14152v2" onclick="toggleFavorite(this, '2511.14152v2', 'Wave-Former: Through-Occlusion 3D Reconstruction via Wireless Shape Completion')" title="添加到收藏夹">☆ 收藏</button>
