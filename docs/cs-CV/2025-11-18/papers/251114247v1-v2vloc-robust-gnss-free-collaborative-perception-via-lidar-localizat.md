...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14247v1" onclick="toggleFavorite(this, '2511.14247v1', 'V2VLoc: Robust GNSS-Free Collaborative Perception via LiDAR Localization')" title="添加到收藏夹">☆ 收藏</button>
