...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14654v1" onclick="toggleFavorite(this, '2511.14654v1', 'Improving segmentation of retinal arteries and veins using cardiac signal in doppler holograms')" title="添加到收藏夹">☆ 收藏</button>
