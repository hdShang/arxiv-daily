...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14270v2" onclick="toggleFavorite(this, '2511.14270v2', 'Gaussian Splatting-based Low-Rank Tensor Representation for Multi-Dimensional Image Recovery')" title="添加到收藏夹">☆ 收藏</button>
