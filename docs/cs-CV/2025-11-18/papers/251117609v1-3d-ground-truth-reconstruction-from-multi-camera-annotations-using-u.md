...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17609v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.17609v1', '3D Ground Truth Reconstruction from Multi-Camera Annotations Using UKF')" title="添加到收藏夹">☆ 收藏</button>
