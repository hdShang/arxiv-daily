...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14927v1" onclick="toggleFavorite(this, '2511.14927v1', 'CPSL: Representing Volumetric Video via Content-Promoted Scene Layers')" title="添加到收藏夹">☆ 收藏</button>
