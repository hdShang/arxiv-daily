...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14149v1" onclick="toggleFavorite(this, '2511.14149v1', 'iGaussian: Real-Time Camera Pose Estimation via Feed-Forward 3D Gaussian Splatting Inversion')" title="添加到收藏夹">☆ 收藏</button>
