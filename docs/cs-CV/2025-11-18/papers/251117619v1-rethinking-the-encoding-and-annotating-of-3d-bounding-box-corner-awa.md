...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17619v1" onclick="toggleFavorite(this, '2511.17619v1', 'Rethinking the Encoding and Annotating of 3D Bounding Box: Corner-Aware 3D Object Detection from Point Clouds')" title="添加到收藏夹">☆ 收藏</button>
