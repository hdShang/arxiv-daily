...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14100v1" onclick="toggleFavorite(this, '2511.14100v1', 'Text-Driven Reasoning Video Editing via Reinforcement Learning on Digital Twin Representations')" title="添加到收藏夹">☆ 收藏</button>
