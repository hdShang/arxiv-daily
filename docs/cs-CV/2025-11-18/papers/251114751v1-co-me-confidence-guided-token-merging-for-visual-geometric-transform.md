...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14751v1" onclick="toggleFavorite(this, '2511.14751v1', 'Co-Me: Confidence-Guided Token Merging for Visual Geometric Transformers')" title="添加到收藏夹">☆ 收藏</button>
