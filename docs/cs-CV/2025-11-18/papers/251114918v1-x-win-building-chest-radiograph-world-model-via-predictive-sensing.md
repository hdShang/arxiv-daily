...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14918v1" onclick="toggleFavorite(this, '2511.14918v1', 'X-WIN: Building Chest Radiograph World Model via Predictive Sensing')" title="添加到收藏夹">☆ 收藏</button>
