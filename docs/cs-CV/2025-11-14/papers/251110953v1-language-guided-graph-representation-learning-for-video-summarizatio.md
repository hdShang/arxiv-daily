...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10953v1" onclick="toggleFavorite(this, '2511.10953v1', 'Language-Guided Graph Representation Learning for Video Summarization')" title="添加到收藏夹">☆ 收藏</button>
