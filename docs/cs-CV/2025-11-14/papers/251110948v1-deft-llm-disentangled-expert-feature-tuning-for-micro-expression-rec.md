...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10948v1" onclick="toggleFavorite(this, '2511.10948v1', 'DEFT-LLM: Disentangled Expert Feature Tuning for Micro-Expression Recognition')" title="添加到收藏夹">☆ 收藏</button>
