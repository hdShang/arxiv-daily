...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.01214v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.01214v1', 'M4-BLIP: Advancing Multi-Modal Media Manipulation Detection through Face-Enhanced Local Analysis')" title="添加到收藏夹">☆ 收藏</button>
