...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10671v1" onclick="toggleFavorite(this, '2510.10671v1', 'Image-to-Video Transfer Learning based on Image-Language Foundation Models: A Comprehensive Survey')" title="添加到收藏夹">☆ 收藏</button>
