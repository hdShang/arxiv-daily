...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10663v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10663v1', 'Scalable Face Security Vision Foundation Model for Deepfake, Diffusion, and Spoofing Detection')" title="添加到收藏夹">☆ 收藏</button>
