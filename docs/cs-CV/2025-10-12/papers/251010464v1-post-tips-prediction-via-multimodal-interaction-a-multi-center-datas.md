...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10464v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10464v1', 'Post-TIPS Prediction via Multimodal Interaction: A Multi-Center Dataset and Framework for Survival, Complication, and Portal Pressure Assessment')" title="添加到收藏夹">☆ 收藏</button>
