...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10422v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10422v1', 'Towards Cybersickness Severity Classification from VR Gameplay Videos Using Transfer Learning and Temporal Modeling')" title="添加到收藏夹">☆ 收藏</button>
