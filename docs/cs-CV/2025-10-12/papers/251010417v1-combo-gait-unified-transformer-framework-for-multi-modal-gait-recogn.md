...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10417v1" onclick="toggleFavorite(this, '2510.10417v1', 'Combo-Gait: Unified Transformer Framework for Multi-Modal Gait Recognition and Attribute Analysis')" title="添加到收藏夹">☆ 收藏</button>
