...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10577v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10577v1', 'Injecting Frame-Event Complementary Fusion into Diffusion for Optical Flow in Challenging Scenes')" title="添加到收藏夹">☆ 收藏</button>
