...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10487v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10487v1', 'Towards Self-Refinement of Vision-Language Models with Triangular Consistency')" title="添加到收藏夹">☆ 收藏</button>
