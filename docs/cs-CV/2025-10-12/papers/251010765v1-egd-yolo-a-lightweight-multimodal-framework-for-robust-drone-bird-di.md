...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10765v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10765v1', 'EGD-YOLO: A Lightweight Multimodal Framework for Robust Drone-Bird Discrimination via Ghost-Enhanced YOLOv8n and EMA Attention under Adverse Condition')" title="添加到收藏夹">☆ 收藏</button>
