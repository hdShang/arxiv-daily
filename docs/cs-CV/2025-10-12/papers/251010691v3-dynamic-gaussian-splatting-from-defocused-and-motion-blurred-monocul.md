...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10691v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10691v3', 'Dynamic Gaussian Splatting from Defocused and Motion-blurred Monocular Videos')" title="添加到收藏夹">☆ 收藏</button>
