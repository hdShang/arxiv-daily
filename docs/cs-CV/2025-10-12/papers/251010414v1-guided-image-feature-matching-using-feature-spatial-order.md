...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10414v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10414v1', 'Guided Image Feature Matching using Feature Spatial Order')" title="添加到收藏夹">☆ 收藏</button>
