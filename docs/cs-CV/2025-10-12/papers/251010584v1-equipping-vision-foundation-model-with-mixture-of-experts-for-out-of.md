...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10584v1" onclick="toggleFavorite(this, '2510.10584v1', 'Equipping Vision Foundation Model with Mixture of Experts for Out-of-Distribution Detection')" title="添加到收藏夹">☆ 收藏</button>
