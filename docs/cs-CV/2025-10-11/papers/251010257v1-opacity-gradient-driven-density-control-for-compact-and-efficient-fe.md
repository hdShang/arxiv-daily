...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10257v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10257v1', 'Opacity-Gradient Driven Density Control for Compact and Efficient Few-Shot 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
