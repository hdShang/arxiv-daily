...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10097v2" onclick="toggleFavorite(this, '2510.10097v2', 'Gesplat: Robust Pose-Free 3D Reconstruction via Geometry-Guided Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
