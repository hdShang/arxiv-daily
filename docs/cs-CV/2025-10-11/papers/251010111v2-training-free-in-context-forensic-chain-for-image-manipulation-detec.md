...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10111v2" onclick="toggleFavorite(this, '2510.10111v2', 'Training-Free In-Context Forensic Chain for Image Manipulation Detection and Localization')" title="添加到收藏夹">☆ 收藏</button>
