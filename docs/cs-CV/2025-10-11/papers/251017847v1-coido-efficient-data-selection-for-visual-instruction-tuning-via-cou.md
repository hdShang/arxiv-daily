...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17847v1" onclick="toggleFavorite(this, '2510.17847v1', 'CoIDO: Efficient Data Selection for Visual Instruction Tuning via Coupled Importance-Diversity Optimization')" title="添加到收藏夹">☆ 收藏</button>
