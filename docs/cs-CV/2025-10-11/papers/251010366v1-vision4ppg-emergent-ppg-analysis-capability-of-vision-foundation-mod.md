...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10366v1" onclick="toggleFavorite(this, '2510.10366v1', 'Vision4PPG: Emergent PPG Analysis Capability of Vision Foundation Models for Vital Signs like Blood Pressure')" title="添加到收藏夹">☆ 收藏</button>
