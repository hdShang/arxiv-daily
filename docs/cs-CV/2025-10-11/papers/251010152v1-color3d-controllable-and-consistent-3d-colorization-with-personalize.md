...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10152v1" onclick="toggleFavorite(this, '2510.10152v1', 'Color3D: Controllable and Consistent 3D Colorization with Personalized Colorizer')" title="添加到收藏夹">☆ 收藏</button>
