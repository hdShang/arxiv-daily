...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09936v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09936v1', 'Semi-disentangled spatiotemporal implicit neural representations of longitudinal neuroimaging data for trajectory classification')" title="添加到收藏夹">☆ 收藏</button>
