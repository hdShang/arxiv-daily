...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10022v1" onclick="toggleFavorite(this, '2510.10022v1', 'Q-Adapter: Visual Query Adapter for Extracting Textually-related Features in Video Captioning')" title="添加到收藏夹">☆ 收藏</button>
