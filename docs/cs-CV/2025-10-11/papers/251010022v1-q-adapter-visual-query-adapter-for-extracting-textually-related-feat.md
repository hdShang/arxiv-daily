...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.10022" target="_blank" class="toolbar-btn">arXiv: 2510.10022v1</a>
    <a href="https://arxiv.org/pdf/2510.10022.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10022v1" 
            onclick="toggleFavorite(this, '2510.10022v1', 'Q-Adapter: Visual Query Adapter for Extracting Textually-related Features in Video Captioning')" title="收藏">
      ☆ 收藏
    </button>
