...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13652v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13652v1', 'EditCast3D: Single-Frame-Guided 3D Editing with Video Propagation and View Selection')" title="添加到收藏夹">☆ 收藏</button>
