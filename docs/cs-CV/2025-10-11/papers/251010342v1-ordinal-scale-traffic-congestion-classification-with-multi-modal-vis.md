...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10342v1" onclick="toggleFavorite(this, '2510.10342v1', 'Ordinal Scale Traffic Congestion Classification with Multi-Modal Vision-Language and Motion Analysis')" title="添加到收藏夹">☆ 收藏</button>
