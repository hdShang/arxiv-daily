...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09981v1" onclick="toggleFavorite(this, '2510.09981v1', 'Scaling Traffic Insights with AI and Language Model-Powered Camera Systems for Data-Driven Transportation Decision Making')" title="添加到收藏夹">☆ 收藏</button>
