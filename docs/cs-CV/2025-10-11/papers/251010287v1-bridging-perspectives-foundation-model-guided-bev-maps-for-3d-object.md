...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10287v1" onclick="toggleFavorite(this, '2510.10287v1', 'Bridging Perspectives: Foundation Model Guided BEV Maps for 3D Object Detection and Tracking')" title="添加到收藏夹">☆ 收藏</button>
