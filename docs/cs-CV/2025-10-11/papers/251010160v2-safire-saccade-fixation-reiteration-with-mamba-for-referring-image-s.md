...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10160v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10160v2', 'SaFiRe: Saccade-Fixation Reiteration with Mamba for Referring Image Segmentation')" title="添加到收藏夹">☆ 收藏</button>
