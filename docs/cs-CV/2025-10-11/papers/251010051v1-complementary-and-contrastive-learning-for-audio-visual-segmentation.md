...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10051v1" onclick="toggleFavorite(this, '2510.10051v1', 'Complementary and Contrastive Learning for Audio-Visual Segmentation')" title="添加到收藏夹">☆ 收藏</button>
