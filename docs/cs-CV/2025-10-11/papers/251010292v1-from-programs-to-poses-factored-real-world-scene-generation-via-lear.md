...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10292v1" onclick="toggleFavorite(this, '2510.10292v1', 'From Programs to Poses: Factored Real-World Scene Generation via Learned Program Libraries')" title="添加到收藏夹">☆ 收藏</button>
