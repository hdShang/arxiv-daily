...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10011v1" onclick="toggleFavorite(this, '2510.10011v1', 'MIMO: A medical vision language model with visual referring multimodal input and pixel grounding multimodal output')" title="添加到收藏夹">☆ 收藏</button>
