...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18187v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.18187v1', 'VelocityNet: Real-Time Crowd Anomaly Detection via Person-Specific Velocity Analysis')" title="添加到收藏夹">☆ 收藏</button>
