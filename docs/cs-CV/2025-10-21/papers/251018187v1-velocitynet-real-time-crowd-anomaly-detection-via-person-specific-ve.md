...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.18187" target="_blank" class="toolbar-btn">arXiv: 2510.18187v1</a>
    <a href="https://arxiv.org/pdf/2510.18187.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18187v1" 
            onclick="toggleFavorite(this, '2510.18187v1', 'VelocityNet: Real-Time Crowd Anomaly Detection via Person-Specific Velocity Analysis')" title="收藏">
      ☆ 收藏
    </button>
