...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18256v1" onclick="toggleFavorite(this, '2510.18256v1', 'Hyperbolic Space Learning Method Leveraging Temporal Motion Priors for Human Mesh Recovery')" title="添加到收藏夹">☆ 收藏</button>
