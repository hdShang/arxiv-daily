...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18244v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.18244v1', 'BlendCLIP: Bridging Synthetic and Real Domains for Zero-Shot 3D Object Classification with Multimodal Pretraining')" title="添加到收藏夹">☆ 收藏</button>
