...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18267v1" onclick="toggleFavorite(this, '2510.18267v1', 'Latent-Info and Low-Dimensional Learning for Human Mesh Recovery and Parallel Optimization')" title="添加到收藏夹">☆ 收藏</button>
