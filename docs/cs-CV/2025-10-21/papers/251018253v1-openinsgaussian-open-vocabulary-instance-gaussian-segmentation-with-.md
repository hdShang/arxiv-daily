...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18253v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.18253v1', 'OpenInsGaussian: Open-vocabulary Instance Gaussian Segmentation with Context-aware Cross-view Fusion')" title="添加到收藏夹">☆ 收藏</button>
