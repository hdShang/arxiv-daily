...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00520v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.00520v1', 'CardioBench: Do Echocardiography Foundation Models Generalize Beyond the Lab?')" title="添加到收藏夹">☆ 收藏</button>
