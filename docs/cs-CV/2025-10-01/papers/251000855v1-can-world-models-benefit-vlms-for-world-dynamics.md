...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00855v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.00855v1', 'Can World Models Benefit VLMs for World Dynamics?')" title="添加到收藏夹">☆ 收藏</button>
