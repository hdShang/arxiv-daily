...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01009v1" onclick="toggleFavorite(this, '2510.01009v1', 'POVQA: Preference-Optimized Video Question Answering with Rationales for Data Efficiency')" title="添加到收藏夹">☆ 收藏</button>
