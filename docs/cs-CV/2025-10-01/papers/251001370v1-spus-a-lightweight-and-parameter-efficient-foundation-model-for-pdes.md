...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01370v1" onclick="toggleFavorite(this, '2510.01370v1', 'SPUS: A Lightweight and Parameter-Efficient Foundation Model for PDEs')" title="添加到收藏夹">☆ 收藏</button>
