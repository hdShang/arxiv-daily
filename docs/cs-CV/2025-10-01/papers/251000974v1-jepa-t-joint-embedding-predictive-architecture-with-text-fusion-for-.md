...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00974v1" onclick="toggleFavorite(this, '2510.00974v1', 'JEPA-T: Joint-Embedding Predictive Architecture with Text Fusion for Image Generation')" title="添加到收藏夹">☆ 收藏</button>
