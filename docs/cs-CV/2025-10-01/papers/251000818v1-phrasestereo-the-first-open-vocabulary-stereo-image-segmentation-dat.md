...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00818v1" onclick="toggleFavorite(this, '2510.00818v1', 'PhraseStereo: The First Open-Vocabulary Stereo Image Segmentation Dataset')" title="添加到收藏夹">☆ 收藏</button>
