...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00862v1" onclick="toggleFavorite(this, '2510.00862v1', 'Gather-Scatter Mamba: Accelerating Propagation with Efficient State Space Model')" title="添加到收藏夹">☆ 收藏</button>
