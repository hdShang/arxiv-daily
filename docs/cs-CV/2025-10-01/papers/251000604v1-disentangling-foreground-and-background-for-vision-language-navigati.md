...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00604v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.00604v1', 'Disentangling Foreground and Background for vision-Language Navigation via Online Augmentation')" title="添加到收藏夹">☆ 收藏</button>
