...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00797v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.00797v1', 'Solar PV Installation Potential Assessment on Building Facades Based on Vision and Language Foundation Models')" title="添加到收藏夹">☆ 收藏</button>
