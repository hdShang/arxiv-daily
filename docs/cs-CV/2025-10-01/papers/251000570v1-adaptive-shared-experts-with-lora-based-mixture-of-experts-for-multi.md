...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00570v1" onclick="toggleFavorite(this, '2510.00570v1', 'Adaptive Shared Experts with LoRA-Based Mixture of Experts for Multi-Task Learning')" title="添加到收藏夹">☆ 收藏</button>
