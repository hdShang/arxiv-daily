...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12425v1" onclick="toggleFavorite(this, '2512.12425v1', 'BokehDepth: Enhancing Monocular Depth Estimation through Bokeh Generation')" title="添加到收藏夹">☆ 收藏</button>
