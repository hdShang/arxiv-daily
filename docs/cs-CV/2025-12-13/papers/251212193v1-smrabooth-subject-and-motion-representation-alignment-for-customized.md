...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12193v1" onclick="toggleFavorite(this, '2512.12193v1', 'SMRABooth: Subject and Motion Representation Alignment for Customized Video Generation')" title="添加到收藏夹">☆ 收藏</button>
