...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12205v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.12205v1', 'A Multi-Year Urban Streetlight Imagery Dataset for Visual Monitoring and Spatio-Temporal Drift Detection')" title="添加到收藏夹">☆ 收藏</button>
