...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12208v1" onclick="toggleFavorite(this, '2512.12208v1', 'A Hybrid Deep Learning Framework for Emotion Recognition in Children with Autism During NAO Robot-Mediated Interaction')" title="添加到收藏夹">☆ 收藏</button>
