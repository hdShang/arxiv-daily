...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.09443" class="toolbar-btn" target="_blank">📄 arXiv: 2511.09443v1</a>
  <a href="https://arxiv.org/pdf/2511.09443.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09443v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09443v1', 'BronchOpt : Vision-Based Pose Optimization with Fine-Tuned Foundation Models for Accurate Bronchoscopy Navigation')" title="添加到收藏夹">☆ 收藏</button>
