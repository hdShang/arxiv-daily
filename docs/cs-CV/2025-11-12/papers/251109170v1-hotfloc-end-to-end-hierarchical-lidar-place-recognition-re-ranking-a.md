...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09170v1" onclick="toggleFavorite(this, '2511.09170v1', 'HOTFLoc++: End-to-End Hierarchical LiDAR Place Recognition, Re-Ranking, and 6-DoF Metric Localisation in Forests')" title="添加到收藏夹">☆ 收藏</button>
