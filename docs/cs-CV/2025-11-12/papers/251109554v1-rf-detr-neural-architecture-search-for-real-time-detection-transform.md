...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09554v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09554v1', 'RF-DETR: Neural Architecture Search for Real-Time Detection Transformers')" title="添加到收藏夹">☆ 收藏</button>
