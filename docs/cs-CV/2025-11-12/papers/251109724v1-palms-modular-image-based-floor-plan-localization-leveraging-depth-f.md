...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09724v1" onclick="toggleFavorite(this, '2511.09724v1', 'PALMS+: Modular Image-Based Floor Plan Localization Leveraging Depth Foundation Model')" title="添加到收藏夹">☆ 收藏</button>
