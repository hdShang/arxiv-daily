...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09147v2" onclick="toggleFavorite(this, '2511.09147v2', 'PressTrack-HMR: Pressure-Based Top-Down Multi-Person Global Human Mesh Recovery')" title="添加到收藏夹">☆ 收藏</button>
