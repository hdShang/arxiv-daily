...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08910v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08910v1', 'OG-PCL: Efficient Sparse Point Cloud Processing for Human Activity Recognition')" title="添加到收藏夹">☆ 收藏</button>
