...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08872v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08872v1', 'SasMamba: A Lightweight Structure-Aware Stride State Space Model for 3D Human Pose Estimation')" title="添加到收藏夹">☆ 收藏</button>
