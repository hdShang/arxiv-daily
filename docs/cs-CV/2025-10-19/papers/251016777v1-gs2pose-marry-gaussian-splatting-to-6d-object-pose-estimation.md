...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16777v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16777v1', 'GS2POSE: Marry Gaussian Splatting to 6D Object Pose Estimation')" title="添加到收藏夹">☆ 收藏</button>
