...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16926v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16926v3', 'Res-Bench: Benchmarking the Robustness of Multimodal Large Language Models to Dynamic Resolution Input')" title="添加到收藏夹">☆ 收藏</button>
