...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16776v1" onclick="toggleFavorite(this, '2510.16776v1', 'EMRRG: Efficient Fine-Tuning Pre-trained X-ray Mamba Networks for Radiology Report Generation')" title="添加到收藏夹">☆ 收藏</button>
