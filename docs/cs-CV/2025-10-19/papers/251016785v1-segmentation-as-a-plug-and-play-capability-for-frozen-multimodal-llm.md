...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16785v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16785v1', 'Segmentation as A Plug-and-Play Capability for Frozen Multimodal LLMs')" title="添加到收藏夹">☆ 收藏</button>
