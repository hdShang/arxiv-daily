...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16888v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16888v3', 'Uniworld-V2: Reinforce Image Editing with Diffusion Negative-aware Finetuning and MLLM Implicit Feedback')" title="添加到收藏夹">☆ 收藏</button>
