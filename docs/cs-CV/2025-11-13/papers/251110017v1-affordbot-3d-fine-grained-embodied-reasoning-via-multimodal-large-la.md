...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10017v1" onclick="toggleFavorite(this, '2511.10017v1', 'AffordBot: 3D Fine-grained Embodied Reasoning via Multimodal Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
