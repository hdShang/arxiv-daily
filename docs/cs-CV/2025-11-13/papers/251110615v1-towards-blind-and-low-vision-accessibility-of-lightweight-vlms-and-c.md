...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10615v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.10615v1', 'Towards Blind and Low-Vision Accessibility of Lightweight VLMs and Custom LLM-Evals')" title="添加到收藏夹">☆ 收藏</button>
