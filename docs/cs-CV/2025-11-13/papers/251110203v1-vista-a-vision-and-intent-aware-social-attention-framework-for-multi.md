...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10203v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.10203v1', 'VISTA: A Vision and Intent-Aware Social Attention Framework for Multi-Agent Trajectory Prediction')" title="添加到收藏夹">☆ 收藏</button>
