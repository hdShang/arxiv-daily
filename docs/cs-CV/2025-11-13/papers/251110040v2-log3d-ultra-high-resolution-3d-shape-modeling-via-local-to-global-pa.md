...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10040v2" onclick="toggleFavorite(this, '2511.10040v2', 'LoG3D: Ultra-High-Resolution 3D Shape Modeling via Local-to-Global Partitioning')" title="添加到收藏夹">☆ 收藏</button>
