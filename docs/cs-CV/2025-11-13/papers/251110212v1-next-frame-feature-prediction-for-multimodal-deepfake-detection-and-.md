...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10212v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.10212v1', 'Next-Frame Feature Prediction for Multimodal Deepfake Detection and Temporal Localization')" title="添加到收藏夹">☆ 收藏</button>
