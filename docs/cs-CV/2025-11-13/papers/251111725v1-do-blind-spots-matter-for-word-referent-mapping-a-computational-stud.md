...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.11725v1" onclick="toggleFavorite(this, '2511.11725v1', 'Do Blind Spots Matter for Word-Referent Mapping? A Computational Study with Infant Egocentric Video')" title="添加到收藏夹">☆ 收藏</button>
