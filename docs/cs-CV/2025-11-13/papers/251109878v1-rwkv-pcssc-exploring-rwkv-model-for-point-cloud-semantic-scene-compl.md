...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09878v1" onclick="toggleFavorite(this, '2511.09878v1', 'RWKV-PCSSC: Exploring RWKV Model for Point Cloud Semantic Scene Completion')" title="添加到收藏夹">☆ 收藏</button>
