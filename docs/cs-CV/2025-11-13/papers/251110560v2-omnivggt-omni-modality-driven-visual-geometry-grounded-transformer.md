...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10560v2" onclick="toggleFavorite(this, '2511.10560v2', 'OmniVGGT: Omni-Modality Driven Visual Geometry Grounded Transformer')" title="添加到收藏夹">☆ 收藏</button>
