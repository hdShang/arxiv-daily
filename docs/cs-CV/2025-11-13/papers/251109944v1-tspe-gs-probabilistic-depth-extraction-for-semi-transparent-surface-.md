...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09944v1" onclick="toggleFavorite(this, '2511.09944v1', 'TSPE-GS: Probabilistic Depth Extraction for Semi-Transparent Surface Reconstruction via 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
