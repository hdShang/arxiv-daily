...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10316v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.10316v1', 'Depth-Consistent 3D Gaussian Splatting via Physical Defocus Modeling and Multi-View Geometric Supervision')" title="添加到收藏夹">☆ 收藏</button>
