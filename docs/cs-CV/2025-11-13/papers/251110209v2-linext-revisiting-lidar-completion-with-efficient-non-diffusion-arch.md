...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10209v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.10209v2', 'LiNeXt: Revisiting LiDAR Completion with Efficient Non-Diffusion Architectures')" title="添加到收藏夹">☆ 收藏</button>
