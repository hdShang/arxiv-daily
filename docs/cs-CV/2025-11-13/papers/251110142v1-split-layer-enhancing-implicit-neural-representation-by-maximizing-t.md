...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10142v1" onclick="toggleFavorite(this, '2511.10142v1', 'Split-Layer: Enhancing Implicit Neural Representation by Maximizing the Dimensionality of Feature Space')" title="添加到收藏夹">☆ 收藏</button>
