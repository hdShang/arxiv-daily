...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10107v1" onclick="toggleFavorite(this, '2511.10107v1', 'RobIA: Robust Instance-aware Continual Test-time Adaptation for Deep Stereo')" title="添加到收藏夹">☆ 收藏</button>
