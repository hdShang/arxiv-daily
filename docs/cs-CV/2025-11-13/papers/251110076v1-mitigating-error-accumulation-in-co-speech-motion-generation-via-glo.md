...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10076v1" onclick="toggleFavorite(this, '2511.10076v1', 'Mitigating Error Accumulation in Co-Speech Motion Generation via Global Rotation Diffusion and Multi-Level Constraints')" title="添加到收藏夹">☆ 收藏</button>
