...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02922v1" onclick="toggleFavorite(this, '2510.02922v1', 'Multimodal Carotid Risk Stratification with Large Vision-Language Models: Benchmarking, Fine-Tuning, and Clinical Insights')" title="添加到收藏夹">☆ 收藏</button>
