...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03224v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03224v1', 'Test-Time Defense Against Adversarial Attacks via Stochastic Resonance of Latent Ensembles')" title="添加到收藏夹">☆ 收藏</button>
