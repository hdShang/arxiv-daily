...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03545v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03545v1', 'SketchPlan: Diffusion Based Drone Planning From Human Sketches')" title="添加到收藏夹">☆ 收藏</button>
