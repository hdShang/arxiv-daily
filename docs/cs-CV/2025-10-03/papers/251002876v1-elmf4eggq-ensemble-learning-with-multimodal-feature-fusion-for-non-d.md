...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02876v1" onclick="toggleFavorite(this, '2510.02876v1', 'ELMF4EggQ: Ensemble Learning with Multimodal Feature Fusion for Non-Destructive Egg Quality Assessment')" title="添加到收藏夹">☆ 收藏</button>
