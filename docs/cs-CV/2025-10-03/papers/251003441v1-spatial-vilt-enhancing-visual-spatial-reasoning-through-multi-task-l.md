...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03441v1" onclick="toggleFavorite(this, '2510.03441v1', 'Spatial-ViLT: Enhancing Visual Spatial Reasoning through Multi-Task Learning')" title="添加到收藏夹">☆ 收藏</button>
