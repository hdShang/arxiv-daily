...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02987v1" onclick="toggleFavorite(this, '2510.02987v1', 'TIT-Score: Evaluating Long-Prompt Based Text-to-Image Alignment via Text-to-Image-to-Text Consistency')" title="添加到收藏夹">☆ 收藏</button>
