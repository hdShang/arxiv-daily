...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03135v2" onclick="toggleFavorite(this, '2510.03135v2', 'Mask2IV: Interaction-Centric Video Generation via Mask Trajectories')" title="添加到收藏夹">☆ 收藏</button>
