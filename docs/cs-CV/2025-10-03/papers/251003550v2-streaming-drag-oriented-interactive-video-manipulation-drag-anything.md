...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03550v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03550v2', 'Streaming Drag-Oriented Interactive Video Manipulation: Drag Anything, Anytime!')" title="添加到收藏夹">☆ 收藏</button>
