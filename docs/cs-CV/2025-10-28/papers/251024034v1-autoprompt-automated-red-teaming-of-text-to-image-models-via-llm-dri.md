...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.24034v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.24034v1', 'AutoPrompt: Automated Red-Teaming of Text-to-Image Models via LLM-Driven Adversarial Prompts')" title="添加到收藏夹">☆ 收藏</button>
