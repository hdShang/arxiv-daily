...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04949v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.04949v1', 'DeepForgeSeal: Latent Space-Driven Semi-Fragile Watermarking for Deepfake Detection Using Multi-Agent Adversarial Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
