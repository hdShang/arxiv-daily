...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03853v1" onclick="toggleFavorite(this, '2510.03853v1', 'UGround: Towards Unified Visual Grounding with Unrolled Transformers')" title="添加到收藏夹">☆ 收藏</button>
