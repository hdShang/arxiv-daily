...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03606v1" onclick="toggleFavorite(this, '2510.03606v1', 'Unsupervised Transformer Pre-Training for Images: Self-Distillation, Mean Teachers, and Random Crops')" title="添加到收藏夹">☆ 收藏</button>
