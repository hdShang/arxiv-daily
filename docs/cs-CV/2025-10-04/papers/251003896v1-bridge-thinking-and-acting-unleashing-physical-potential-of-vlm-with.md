...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03896v1" onclick="toggleFavorite(this, '2510.03896v1', 'Bridge Thinking and Acting: Unleashing Physical Potential of VLM with Generalizable Action Expert')" title="添加到收藏夹">☆ 收藏</button>
