...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03858v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03858v1', 'Cross-View Open-Vocabulary Object Detection in Aerial Imagery')" title="添加到收藏夹">☆ 收藏</button>
