...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25263v2" onclick="toggleFavorite(this, '2510.25263v2', 'LangHOPS: Language Grounded Hierarchical Open-Vocabulary Part Segmentation')" title="添加到收藏夹">☆ 收藏</button>
