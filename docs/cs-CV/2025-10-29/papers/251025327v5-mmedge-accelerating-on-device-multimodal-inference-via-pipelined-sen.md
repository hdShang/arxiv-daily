...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25327v5" onclick="toggleFavorite(this, '2510.25327v5', 'MMEdge: Accelerating On-device Multimodal Inference via Pipelined Sensing and Encoding')" title="添加到收藏夹">☆ 收藏</button>
