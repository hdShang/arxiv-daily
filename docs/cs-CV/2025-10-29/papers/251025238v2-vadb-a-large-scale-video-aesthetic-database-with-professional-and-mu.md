...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25238v2" onclick="toggleFavorite(this, '2510.25238v2', 'VADB: A Large-Scale Video Aesthetic Database with Professional and Multi-Dimensional Annotations')" title="添加到收藏夹">☆ 收藏</button>
