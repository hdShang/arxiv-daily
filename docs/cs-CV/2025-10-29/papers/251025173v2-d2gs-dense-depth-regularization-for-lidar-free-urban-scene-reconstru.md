...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25173v2" onclick="toggleFavorite(this, '2510.25173v2', 'D$^2$GS: Dense Depth Regularization for LiDAR-free Urban Scene Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
