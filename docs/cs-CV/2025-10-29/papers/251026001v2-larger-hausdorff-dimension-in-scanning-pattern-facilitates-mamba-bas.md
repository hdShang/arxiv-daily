...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26001v2" onclick="toggleFavorite(this, '2510.26001v2', 'Larger Hausdorff Dimension in Scanning Pattern Facilitates Mamba-Based Methods in Low-Light Image Enhancement')" title="添加到收藏夹">☆ 收藏</button>
