...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25332v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25332v1', 'StreamingCoT: A Dataset for Temporal Dynamics and Multimodal Chain-of-Thought Reasoning in Streaming VideoQA')" title="添加到收藏夹">☆ 收藏</button>
