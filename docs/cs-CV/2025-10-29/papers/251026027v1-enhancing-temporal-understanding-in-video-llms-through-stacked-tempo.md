...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26027v1" onclick="toggleFavorite(this, '2510.26027v1', 'Enhancing Temporal Understanding in Video-LLMs through Stacked Temporal Attention in Vision Encoders')" title="添加到收藏夹">☆ 收藏</button>
