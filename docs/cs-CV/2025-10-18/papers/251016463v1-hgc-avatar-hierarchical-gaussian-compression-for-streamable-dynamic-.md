...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16463v1" onclick="toggleFavorite(this, '2510.16463v1', 'HGC-Avatar: Hierarchical Gaussian Compression for Streamable Dynamic 3D Avatars')" title="添加到收藏夹">☆ 收藏</button>
