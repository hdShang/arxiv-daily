...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16505v2" onclick="toggleFavorite(this, '2510.16505v2', 'PRISMM-Bench: A Benchmark of Peer-Review Grounded Multimodal Inconsistencies')" title="添加到收藏夹">☆ 收藏</button>
