...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16643v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16643v1', 'Structured Interfaces for Automated Reasoning with 3D Scene Graphs')" title="添加到收藏夹">☆ 收藏</button>
