...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16290v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16290v1', 'Cerberus: Real-Time Video Anomaly Detection via Cascaded Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
