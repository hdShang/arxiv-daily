...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16450v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16450v1', 'Instance-Aware Pseudo-Labeling and Class-Focused Contrastive Learning for Weakly Supervised Domain Adaptive Segmentation of Electron Microscopy')" title="添加到收藏夹">☆ 收藏</button>
