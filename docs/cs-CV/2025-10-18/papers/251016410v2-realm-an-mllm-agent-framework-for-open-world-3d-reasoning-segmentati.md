...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16410v2" onclick="toggleFavorite(this, '2510.16410v2', 'REALM: An MLLM-Agent Framework for Open World 3D Reasoning Segmentation and Editing on Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
