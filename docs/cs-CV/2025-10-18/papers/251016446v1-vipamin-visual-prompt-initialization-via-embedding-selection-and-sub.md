...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16446v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16446v1', 'VIPAMIN: Visual Prompt Initialization via Embedding Selection and Subspace Expansion')" title="添加到收藏夹">☆ 收藏</button>
