...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16664v1" onclick="toggleFavorite(this, '2510.16664v1', 'HYDRA: HYbrid knowledge Distillation and spectral Reconstruction Algorithm for high channel hyperspectral camera applications')" title="添加到收藏夹">☆ 收藏</button>
