...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06830v1" onclick="toggleFavorite(this, '2511.06830v1', 'MUGSQA: Novel Multi-Uncertainty-Based Gaussian Splatting Quality Assessment Method, Dataset, and Benchmarks')" title="添加到收藏夹">☆ 收藏</button>
