...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06717v2" onclick="toggleFavorite(this, '2511.06717v2', 'MRT: Learning Compact Representations with Mixed RWKV-Transformer for Extreme Image Compression')" title="添加到收藏夹">☆ 收藏</button>
