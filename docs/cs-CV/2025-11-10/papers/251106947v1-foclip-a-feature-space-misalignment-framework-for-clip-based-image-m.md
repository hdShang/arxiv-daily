...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06947v1" onclick="toggleFavorite(this, '2511.06947v1', 'FoCLIP: A Feature-Space Misalignment Framework for CLIP-Based Image Manipulation and Detection')" title="添加到收藏夹">☆ 收藏</button>
