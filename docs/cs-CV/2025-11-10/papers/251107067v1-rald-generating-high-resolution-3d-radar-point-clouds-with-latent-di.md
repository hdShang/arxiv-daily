...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07067v1" onclick="toggleFavorite(this, '2511.07067v1', 'RaLD: Generating High-Resolution 3D Radar Point Clouds with Latent Diffusion')" title="添加到收藏夹">☆ 收藏</button>
