...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07029v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07029v1', 'Certified L2-Norm Robustness of 3D Point Cloud Recognition in the Frequency Domain')" title="添加到收藏夹">☆ 收藏</button>
