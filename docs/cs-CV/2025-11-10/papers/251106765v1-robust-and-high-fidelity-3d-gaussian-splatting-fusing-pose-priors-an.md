...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06765v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06765v1', 'Robust and High-Fidelity 3D Gaussian Splatting: Fusing Pose Priors and Geometry Constraints for Texture-Deficient Outdoor Scenes')" title="添加到收藏夹">☆ 收藏</button>
