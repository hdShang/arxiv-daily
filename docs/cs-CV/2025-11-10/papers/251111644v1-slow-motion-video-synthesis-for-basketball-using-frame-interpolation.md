...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.11644v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.11644v1', 'Slow - Motion Video Synthesis for Basketball Using Frame Interpolation')" title="添加到收藏夹">☆ 收藏</button>
