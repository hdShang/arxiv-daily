...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07040v2" onclick="toggleFavorite(this, '2511.07040v2', '3D-ANC: Adaptive Neural Collapse for Robust 3D Point Cloud Recognition')" title="添加到收藏夹">☆ 收藏</button>
