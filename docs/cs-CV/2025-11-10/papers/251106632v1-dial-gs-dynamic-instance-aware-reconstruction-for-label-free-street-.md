...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06632v1" onclick="toggleFavorite(this, '2511.06632v1', 'DIAL-GS: Dynamic Instance Aware Reconstruction for Label-free Street Scenes with 4D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
