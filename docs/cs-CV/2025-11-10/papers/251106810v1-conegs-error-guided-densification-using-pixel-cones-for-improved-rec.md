...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06810v1" onclick="toggleFavorite(this, '2511.06810v1', 'ConeGS: Error-Guided Densification Using Pixel Cones for Improved Reconstruction with Fewer Primitives')" title="添加到收藏夹">☆ 收藏</button>
