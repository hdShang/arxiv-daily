...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.06734" class="toolbar-btn" target="_blank">📄 arXiv: 2511.06734v1</a>
  <a href="https://arxiv.org/pdf/2511.06734.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06734v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06734v1', 'Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning')" title="添加到收藏夹">☆ 收藏</button>
