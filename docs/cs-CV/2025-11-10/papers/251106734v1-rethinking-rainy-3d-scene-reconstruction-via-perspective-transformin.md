...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06734v1" onclick="toggleFavorite(this, '2511.06734v1', 'Rethinking Rainy 3D Scene Reconstruction via Perspective Transforming and Brightness Tuning')" title="添加到收藏夹">☆ 收藏</button>
