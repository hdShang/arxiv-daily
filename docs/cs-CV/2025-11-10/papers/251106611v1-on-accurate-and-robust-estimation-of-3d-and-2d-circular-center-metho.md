...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06611v1" onclick="toggleFavorite(this, '2511.06611v1', 'On Accurate and Robust Estimation of 3D and 2D Circular Center: Method and Application to Camera-Lidar Calibration')" title="添加到收藏夹">☆ 收藏</button>
