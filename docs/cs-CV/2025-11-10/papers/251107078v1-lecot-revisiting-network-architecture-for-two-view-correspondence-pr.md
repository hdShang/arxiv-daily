...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07078v1" onclick="toggleFavorite(this, '2511.07078v1', 'LeCoT: revisiting network architecture for two-view correspondence pruning')" title="添加到收藏夹">☆ 收藏</button>
