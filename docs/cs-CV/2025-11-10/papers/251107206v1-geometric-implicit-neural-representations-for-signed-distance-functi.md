...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07206v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07206v1', 'Geometric implicit neural representations for signed distance functions')" title="添加到收藏夹">☆ 收藏</button>
