...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07222v1" onclick="toggleFavorite(this, '2511.07222v1', 'Omni-View: Unlocking How Generation Facilitates Understanding in Unified 3D Model based on Multiview images')" title="添加到收藏夹">☆ 收藏</button>
