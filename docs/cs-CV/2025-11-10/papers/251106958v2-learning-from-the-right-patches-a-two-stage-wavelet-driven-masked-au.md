...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06958v2" onclick="toggleFavorite(this, '2511.06958v2', 'Learning from the Right Patches: A Two-Stage Wavelet-Driven Masked Autoencoder for Histopathology Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
