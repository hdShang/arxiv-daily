...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00908v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00908v1', 'GraphGeo: Multi-Agent Debate Framework for Visual Geo-localization with Heterogeneous Graph Neural Networks')" title="添加到收藏夹">☆ 收藏</button>
