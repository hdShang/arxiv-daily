...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15775v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.15775v1', 'SANR: Scene-Aware Neural Representation for Light Field Image Compression with Rate-Distortion Optimization')" title="添加到收藏夹">☆ 收藏</button>
