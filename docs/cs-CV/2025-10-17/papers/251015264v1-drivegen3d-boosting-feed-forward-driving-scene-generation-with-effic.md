...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15264v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.15264v1', 'DriveGen3D: Boosting Feed-Forward Driving Scene Generation with Efficient Video Diffusion')" title="添加到收藏夹">☆ 收藏</button>
