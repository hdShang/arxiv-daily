...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15440v1" onclick="toggleFavorite(this, '2510.15440v1', 'Select Less, Reason More: Prioritizing Evidence Purity for Video Reasoning')" title="添加到收藏夹">☆ 收藏</button>
