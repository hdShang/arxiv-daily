...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21769v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21769v1', 'H2OFlow: Grounding Human-Object Affordances with 3D Generative Models and Dense Diffused Flows')" title="添加到收藏夹">☆ 收藏</button>
