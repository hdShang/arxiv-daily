...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15398v2" onclick="toggleFavorite(this, '2510.15398v2', 'MARIS: Marine Open-Vocabulary Instance Segmentation with Geometric Enhancement and Semantic Alignment')" title="添加到收藏夹">☆ 收藏</button>
