...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16220v1" onclick="toggleFavorite(this, '2510.16220v1', 'VM-BeautyNet: A Synergistic Ensemble of Vision Transformer and Mamba for Facial Beauty Prediction')" title="添加到收藏夹">☆ 收藏</button>
