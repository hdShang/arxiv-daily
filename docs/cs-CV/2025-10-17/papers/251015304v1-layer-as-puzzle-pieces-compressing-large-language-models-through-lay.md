...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15304v1" onclick="toggleFavorite(this, '2510.15304v1', 'Layer as Puzzle Pieces: Compressing Large Language Models through Layer Concatenation')" title="添加到收藏夹">☆ 收藏</button>
