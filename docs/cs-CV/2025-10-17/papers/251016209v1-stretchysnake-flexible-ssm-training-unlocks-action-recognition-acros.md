...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16209v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16209v1', 'StretchySnake: Flexible SSM Training Unlocks Action Recognition Across Spatio-Temporal Scales')" title="添加到收藏夹">☆ 收藏</button>
