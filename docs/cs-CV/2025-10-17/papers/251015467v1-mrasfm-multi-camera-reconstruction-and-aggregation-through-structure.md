...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15467v1" onclick="toggleFavorite(this, '2510.15467v1', 'MRASfM: Multi-Camera Reconstruction and Aggregation through Structure-from-Motion in Driving Scenes')" title="添加到收藏夹">☆ 收藏</button>
