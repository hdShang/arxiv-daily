...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15564v1" onclick="toggleFavorite(this, '2510.15564v1', 'Imaginarium: Vision-guided High-Quality 3D Scene Layout Generation')" title="添加到收藏夹">☆ 收藏</button>
