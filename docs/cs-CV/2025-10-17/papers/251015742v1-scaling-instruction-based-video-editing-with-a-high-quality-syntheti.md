...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15742v1" onclick="toggleFavorite(this, '2510.15742v1', 'Scaling Instruction-Based Video Editing with a High-Quality Synthetic Dataset')" title="添加到收藏夹">☆ 收藏</button>
