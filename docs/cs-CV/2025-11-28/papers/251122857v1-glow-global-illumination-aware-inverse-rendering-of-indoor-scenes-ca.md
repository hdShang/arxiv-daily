...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22857v1" onclick="toggleFavorite(this, '2511.22857v1', 'GLOW: Global Illumination-Aware Inverse Rendering of Indoor Scenes Captured with Dynamic Co-Located Light & Camera')" title="添加到收藏夹">☆ 收藏</button>
