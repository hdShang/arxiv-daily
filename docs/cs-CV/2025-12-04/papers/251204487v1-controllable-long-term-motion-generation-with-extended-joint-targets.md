...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04487v1" onclick="toggleFavorite(this, '2512.04487v1', 'Controllable Long-term Motion Generation with Extended Joint Targets')" title="添加到收藏夹">☆ 收藏</button>
