...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04619v1" onclick="toggleFavorite(this, '2512.04619v1', 'Denoise to Track: Harnessing Video Diffusion Priors for Robust Correspondence')" title="添加到收藏夹">☆ 收藏</button>
