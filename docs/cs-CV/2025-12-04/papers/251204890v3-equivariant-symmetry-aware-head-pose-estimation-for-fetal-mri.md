...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04890v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.04890v3', 'Equivariant symmetry-aware head pose estimation for fetal MRI')" title="添加到收藏夹">☆ 收藏</button>
