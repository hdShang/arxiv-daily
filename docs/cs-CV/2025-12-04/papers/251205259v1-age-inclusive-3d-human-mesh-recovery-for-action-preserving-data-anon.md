...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05259v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05259v1', 'Age-Inclusive 3D Human Mesh Recovery for Action-Preserving Data Anonymization')" title="添加到收藏夹">☆ 收藏</button>
