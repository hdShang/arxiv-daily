...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04943v1" onclick="toggleFavorite(this, '2512.04943v1', 'Towards Adaptive Fusion of Multimodal Deep Networks for Human Action Recognition')" title="添加到收藏夹">☆ 收藏</button>
