...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04511v1" onclick="toggleFavorite(this, '2512.04511v1', 'DuGI-MAE: Improving Infrared Mask Autoencoders via Dual-Domain Guidance')" title="添加到收藏夹">☆ 收藏</button>
