...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04815v1" onclick="toggleFavorite(this, '2512.04815v1', 'RobustSplat++: Decoupling Densification, Dynamics, and Illumination for In-the-Wild 3DGS')" title="添加到收藏夹">☆ 收藏</button>
