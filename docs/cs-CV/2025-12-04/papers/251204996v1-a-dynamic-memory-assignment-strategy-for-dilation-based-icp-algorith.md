...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04996v1" onclick="toggleFavorite(this, '2512.04996v1', 'A dynamic memory assignment strategy for dilation-based ICP algorithm on embedded GPUs')" title="添加到收藏夹">☆ 收藏</button>
