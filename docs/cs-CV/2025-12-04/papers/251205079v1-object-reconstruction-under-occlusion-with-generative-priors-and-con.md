...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05079v1" onclick="toggleFavorite(this, '2512.05079v1', 'Object Reconstruction under Occlusion with Generative Priors and Contact-induced Constraints')" title="添加到收藏夹">☆ 收藏</button>
