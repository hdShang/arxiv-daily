...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05113v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05113v2', 'Splannequin: Freezing Monocular Mannequin-Challenge Footage with Dual-Detection Splatting')" title="添加到收藏夹">☆ 收藏</button>
