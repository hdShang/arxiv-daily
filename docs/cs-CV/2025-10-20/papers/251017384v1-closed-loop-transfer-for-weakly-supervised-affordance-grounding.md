...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17384v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17384v1', 'Closed-Loop Transfer for Weakly-supervised Affordance Grounding')" title="添加到收藏夹">☆ 收藏</button>
