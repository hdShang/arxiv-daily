...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18123v1" onclick="toggleFavorite(this, '2510.18123v1', 'SafeCoop: Unravelling Full Stack Safety in Agentic Collaborative Driving')" title="添加到收藏夹">☆ 收藏</button>
