...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17790v2" onclick="toggleFavorite(this, '2510.17790v2', 'UltraCUA: A Foundation Model for Computer Use Agents with Hybrid Action')" title="添加到收藏夹">☆ 收藏</button>
