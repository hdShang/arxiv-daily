...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17274v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17274v1', 'Enhanced Motion Forecasting with Plug-and-Play Multimodal Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
