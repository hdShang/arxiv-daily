...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17479v1" onclick="toggleFavorite(this, '2510.17479v1', 'Initialize to Generalize: A Stronger Initialization Pipeline for Sparse-View 3DGS')" title="添加到收藏夹">☆ 收藏</button>
