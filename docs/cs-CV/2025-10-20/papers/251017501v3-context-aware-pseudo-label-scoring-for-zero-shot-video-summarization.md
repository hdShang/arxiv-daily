...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17501v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17501v3', 'Context-Aware Pseudo-Label Scoring for Zero-Shot Video Summarization')" title="添加到收藏夹">☆ 收藏</button>
