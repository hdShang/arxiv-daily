...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17482v3" onclick="toggleFavorite(this, '2510.17482v3', 'SparseWorld: A Flexible, Adaptive, and Efficient 4D Occupancy World Model Powered by Sparse and Dynamic Queries')" title="添加到收藏夹">☆ 收藏</button>
