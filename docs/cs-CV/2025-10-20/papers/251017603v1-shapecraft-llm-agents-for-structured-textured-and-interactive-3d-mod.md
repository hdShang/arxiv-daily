...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17603v1" onclick="toggleFavorite(this, '2510.17603v1', 'ShapeCraft: LLM Agents for Structured, Textured and Interactive 3D Modeling')" title="添加到收藏夹">☆ 收藏</button>
