...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17157v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17157v1', 'GACO-CAD: Geometry-Augmented and Conciseness-Optimized CAD Model Generation from Single Image')" title="添加到收藏夹">☆ 收藏</button>
