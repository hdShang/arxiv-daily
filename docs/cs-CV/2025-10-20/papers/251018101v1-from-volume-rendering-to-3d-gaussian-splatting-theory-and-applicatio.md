...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18101v1" onclick="toggleFavorite(this, '2510.18101v1', 'From Volume Rendering to 3D Gaussian Splatting: Theory and Applications')" title="添加到收藏夹">☆ 收藏</button>
