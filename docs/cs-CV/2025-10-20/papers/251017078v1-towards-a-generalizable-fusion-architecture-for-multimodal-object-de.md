...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17078v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17078v1', 'Towards a Generalizable Fusion Architecture for Multimodal Object Detection')" title="添加到收藏夹">☆ 收藏</button>
