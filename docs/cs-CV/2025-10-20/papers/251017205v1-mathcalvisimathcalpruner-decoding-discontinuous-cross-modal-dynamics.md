...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17205v1" onclick="toggleFavorite(this, '2510.17205v1', '$\mathcal{V}isi\mathcal{P}runer$: Decoding Discontinuous Cross-Modal Dynamics for Efficient Multimodal LLMs')" title="添加到收藏夹">☆ 收藏</button>
