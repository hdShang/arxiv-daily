...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17684v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17684v1', 'Intelligent Communication Mixture-of-Experts Boosted-Medical Image Segmentation Foundation Model')" title="添加到收藏夹">☆ 收藏</button>
