...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17617v1" onclick="toggleFavorite(this, '2510.17617v1', 'ImaGGen: Zero-Shot Generation of Co-Speech Semantic Gestures Grounded in Language and Image Input')" title="添加到收藏夹">☆ 收藏</button>
