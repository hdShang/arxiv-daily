...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18016v2" onclick="toggleFavorite(this, '2510.18016v2', 'ViBED-Net: Video Based Engagement Detection Network Using Face-Aware and Scene-Aware Spatiotemporal Cues')" title="添加到收藏夹">☆ 收藏</button>
