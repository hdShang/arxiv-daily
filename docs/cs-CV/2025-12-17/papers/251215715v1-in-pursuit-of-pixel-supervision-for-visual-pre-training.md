...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15715v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15715v1', 'In Pursuit of Pixel Supervision for Visual Pre-training')" title="添加到收藏夹">☆ 收藏</button>
