...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15069v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15069v1', 'PMMD: A pose-guided multi-view multi-modal diffusion for person generation')" title="添加到收藏夹">☆ 收藏</button>
