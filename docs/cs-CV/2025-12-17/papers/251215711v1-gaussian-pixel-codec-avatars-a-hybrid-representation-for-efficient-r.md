...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15711v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15711v1', 'Gaussian Pixel Codec Avatars: A Hybrid Representation for Efficient Rendering')" title="添加到收藏夹">☆ 收藏</button>
