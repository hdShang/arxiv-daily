...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15713v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15713v1', 'DiffusionVL: Translating Any Autoregressive Models into Diffusion Vision Language Models')" title="添加到收藏夹">☆ 收藏</button>
