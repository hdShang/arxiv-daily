...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15340v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15340v1', 'Towards Seamless Interaction: Causal Turn-Level Modeling of Interactive 3D Conversational Head Dynamics')" title="添加到收藏夹">☆ 收藏</button>
