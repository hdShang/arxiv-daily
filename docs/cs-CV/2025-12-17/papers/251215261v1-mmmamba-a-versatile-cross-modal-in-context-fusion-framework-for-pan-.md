...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15261v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15261v1', 'MMMamba: A Versatile Cross-Modal In Context Fusion Framework for Pan-Sharpening and Zero-Shot Image Enhancement')" title="添加到收藏夹">☆ 收藏</button>
