...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15707v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15707v1', 'GateFusion: Hierarchical Gated Cross-Modal Fusion for Active Speaker Detection')" title="添加到收藏夹">☆ 收藏</button>
