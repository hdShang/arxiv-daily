...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15577v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15577v1', 'MoonSeg3R: Monocular Online Zero-Shot Segment Anything in 3D with Reconstructive Foundation Priors')" title="添加到收藏夹">☆ 收藏</button>
