...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15528v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15528v1', 'EmoCaliber: Advancing Reliable Visual Emotion Comprehension via Confidence Verbalization and Calibration')" title="添加到收藏夹">☆ 收藏</button>
