...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15508v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15508v1', 'Off The Grid: Detection of Primitives for Feed-Forward 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
