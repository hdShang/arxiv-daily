...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15410v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15410v1', 'Preserving Marker Specificity with Lightweight Channel-Independent Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
