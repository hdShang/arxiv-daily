...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15396v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15396v1', 'SMART: Semantic Matching Contrastive Learning for Partially View-Aligned Clustering')" title="添加到收藏夹">☆ 收藏</button>
