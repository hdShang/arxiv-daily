...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15512v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15512v1', 'VAAS: Vision-Attention Anomaly Scoring for Image Manipulation Detection in Digital Forensics')" title="添加到收藏夹">☆ 收藏</button>
