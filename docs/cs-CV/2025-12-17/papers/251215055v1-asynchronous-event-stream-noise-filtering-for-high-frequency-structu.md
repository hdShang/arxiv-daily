...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15055v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15055v1', 'Asynchronous Event Stream Noise Filtering for High-frequency Structure Deformation Measurement')" title="添加到收藏夹">☆ 收藏</button>
