...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15560v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15560v1', 'GRAN-TED: Generating Robust, Aligned, and Nuanced Text Embedding for Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
