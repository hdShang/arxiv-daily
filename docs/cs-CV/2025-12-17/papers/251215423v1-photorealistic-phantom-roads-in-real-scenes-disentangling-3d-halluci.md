...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15423v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15423v1', 'Photorealistic Phantom Roads in Real Scenes: Disentangling 3D Hallucinations from Physical Geometry')" title="添加到收藏夹">☆ 收藏</button>
