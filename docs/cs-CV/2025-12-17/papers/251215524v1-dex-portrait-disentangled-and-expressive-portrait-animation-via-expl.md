...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15524v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15524v1', 'DeX-Portrait: Disentangled and Expressive Portrait Animation via Explicit and Latent Motion Representations')" title="添加到收藏夹">☆ 收藏</button>
