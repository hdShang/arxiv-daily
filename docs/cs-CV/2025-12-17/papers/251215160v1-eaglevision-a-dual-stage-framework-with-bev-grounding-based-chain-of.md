...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15160v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15160v1', 'EagleVision: A Dual-Stage Framework with BEV-grounding-based Chain-of-Thought for Spatial Intelligence')" title="添加到收藏夹">☆ 收藏</button>
