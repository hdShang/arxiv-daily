...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15581v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15581v1', 'IMKD: Intensity-Aware Multi-Level Knowledge Distillation for Camera-Radar Fusion')" title="添加到收藏夹">☆ 收藏</button>
