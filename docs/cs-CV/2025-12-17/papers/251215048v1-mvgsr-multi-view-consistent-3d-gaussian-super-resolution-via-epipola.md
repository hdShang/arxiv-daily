...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15048v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15048v1', 'MVGSR: Multi-View Consistent 3D Gaussian Super-Resolution via Epipolar Guidance')" title="添加到收藏夹">☆ 收藏</button>
