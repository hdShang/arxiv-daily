...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10369v1" onclick="toggleFavorite(this, '2512.10369v1', 'Breaking the Vicious Cycle: Coherent 3D Gaussian Splatting from Sparse and Motion-Blurred Views')" title="添加到收藏夹">☆ 收藏</button>
