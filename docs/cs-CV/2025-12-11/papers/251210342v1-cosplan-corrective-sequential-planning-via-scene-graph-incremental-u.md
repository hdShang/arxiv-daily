...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10342v1" onclick="toggleFavorite(this, '2512.10342v1', 'CoSPlan: Corrective Sequential Planning via Scene Graph Incremental Updates')" title="添加到收藏夹">☆ 收藏</button>
