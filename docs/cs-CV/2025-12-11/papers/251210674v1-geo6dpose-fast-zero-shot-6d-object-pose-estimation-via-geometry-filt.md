...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10674v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10674v1', 'Geo6DPose: Fast Zero-Shot 6D Object Pose Estimation via Geometry-Filtered Feature Matching')" title="添加到收藏夹">☆ 收藏</button>
