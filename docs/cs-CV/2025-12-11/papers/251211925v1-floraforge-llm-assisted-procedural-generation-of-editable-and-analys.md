...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11925v1" onclick="toggleFavorite(this, '2512.11925v1', 'FloraForge: LLM-Assisted Procedural Generation of Editable and Analysis-Ready 3D Plant Geometric Models For Agricultural Applications')" title="添加到收藏夹">☆ 收藏</button>
