...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10660v1" onclick="toggleFavorite(this, '2512.10660v1', 'NaviHydra: Controllable Navigation-guided End-to-end Autonomous Driving with Hydra-distillation')" title="添加到收藏夹">☆ 收藏</button>
