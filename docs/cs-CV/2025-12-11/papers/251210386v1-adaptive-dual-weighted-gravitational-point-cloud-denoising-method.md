...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10386v1" onclick="toggleFavorite(this, '2512.10386v1', 'Adaptive Dual-Weighted Gravitational Point Cloud Denoising Method')" title="添加到收藏夹">☆ 收藏</button>
