...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10840v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10840v1', 'PoseGAM: Robust Unseen Object Pose Estimation via Geometry-Aware Multi-View Reasoning')" title="添加到收藏夹">☆ 收藏</button>
