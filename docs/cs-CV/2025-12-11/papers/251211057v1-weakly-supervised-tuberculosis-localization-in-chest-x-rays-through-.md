...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11057v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11057v1', 'Weakly Supervised Tuberculosis Localization in Chest X-rays through Knowledge Distillation')" title="添加到收藏夹">☆ 收藏</button>
