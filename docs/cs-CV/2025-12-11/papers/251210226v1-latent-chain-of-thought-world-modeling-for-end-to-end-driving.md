...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10226v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10226v1', 'Latent Chain-of-Thought World Modeling for End-to-End Driving')" title="添加到收藏夹">☆ 收藏</button>
