...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10293v1" onclick="toggleFavorite(this, '2512.10293v1', 'Physically Aware 360$^\circ$ View Generation from a Single Image using Disentangled Scene Embeddings')" title="添加到收藏夹">☆ 收藏</button>
