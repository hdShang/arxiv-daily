...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10267v1" onclick="toggleFavorite(this, '2512.10267v1', 'Long-LRM++: Preserving Fine Details in Feed-Forward Wide-Coverage Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
