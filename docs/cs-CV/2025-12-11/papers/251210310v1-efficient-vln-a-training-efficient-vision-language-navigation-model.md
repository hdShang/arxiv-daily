...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10310v1" onclick="toggleFavorite(this, '2512.10310v1', 'Efficient-VLN: A Training-Efficient Vision-Language Navigation Model')" title="添加到收藏夹">☆ 收藏</button>
