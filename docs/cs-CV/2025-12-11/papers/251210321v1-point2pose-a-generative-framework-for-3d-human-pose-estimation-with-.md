...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10321v1" onclick="toggleFavorite(this, '2512.10321v1', 'Point2Pose: A Generative Framework for 3D Human Pose Estimation with Multi-View Point Cloud Dataset')" title="添加到收藏夹">☆ 收藏</button>
