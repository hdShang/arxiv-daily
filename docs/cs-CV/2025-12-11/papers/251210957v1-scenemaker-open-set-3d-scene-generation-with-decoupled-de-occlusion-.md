...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10957v1" onclick="toggleFavorite(this, '2512.10957v1', 'SceneMaker: Open-set 3D Scene Generation with Decoupled De-occlusion and Pose Estimation Model')" title="添加到收藏夹">☆ 收藏</button>
