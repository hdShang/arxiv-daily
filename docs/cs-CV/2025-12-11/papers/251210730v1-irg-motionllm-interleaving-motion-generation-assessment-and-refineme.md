...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10730v1" onclick="toggleFavorite(this, '2512.10730v1', 'IRG-MotionLLM: Interleaving Motion Generation, Assessment and Refinement for Text-to-Motion Generation')" title="添加到收藏夹">☆ 收藏</button>
