...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11061v1" onclick="toggleFavorite(this, '2512.11061v1', 'VDAWorld: World Modelling via VLM-Directed Abstraction and Simulation')" title="添加到收藏夹">☆ 收藏</button>
