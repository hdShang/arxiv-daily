...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10939v1" onclick="toggleFavorite(this, '2512.10939v1', 'GaussianHeadTalk: Wobble-Free 3D Talking Heads with Audio Driven Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
