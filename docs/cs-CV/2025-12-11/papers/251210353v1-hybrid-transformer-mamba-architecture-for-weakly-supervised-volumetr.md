...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10353v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10353v1', 'Hybrid Transformer-Mamba Architecture for Weakly Supervised Volumetric Medical Segmentation')" title="添加到收藏夹">☆ 收藏</button>
