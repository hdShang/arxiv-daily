...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10376v1" onclick="toggleFavorite(this, '2512.10376v1', 'RaLiFlow: Scene Flow Estimation with 4D Radar and LiDAR Point Clouds')" title="添加到收藏夹">☆ 收藏</button>
