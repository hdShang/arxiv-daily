...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10683v1" onclick="toggleFavorite(this, '2512.10683v1', 'Optimal transport unlocks end-to-end learning for single-molecule localization')" title="添加到收藏夹">☆ 收藏</button>
