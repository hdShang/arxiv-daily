...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10498v1" onclick="toggleFavorite(this, '2512.10498v1', 'Robust Shape from Focus via Multiscale Directional Dilated Laplacian and Recurrent Network')" title="添加到收藏夹">☆ 收藏</button>
