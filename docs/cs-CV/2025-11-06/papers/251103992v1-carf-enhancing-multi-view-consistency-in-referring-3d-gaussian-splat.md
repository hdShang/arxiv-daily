...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03992v1" onclick="toggleFavorite(this, '2511.03992v1', 'CaRF: Enhancing Multi-View Consistency in Referring 3D Gaussian Splatting Segmentation')" title="添加到收藏夹">☆ 收藏</button>
