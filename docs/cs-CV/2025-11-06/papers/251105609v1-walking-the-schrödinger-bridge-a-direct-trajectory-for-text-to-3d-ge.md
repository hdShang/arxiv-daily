...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05609v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.05609v1', 'Walking the Schrödinger Bridge: A Direct Trajectory for Text-to-3D Generation')" title="添加到收藏夹">☆ 收藏</button>
