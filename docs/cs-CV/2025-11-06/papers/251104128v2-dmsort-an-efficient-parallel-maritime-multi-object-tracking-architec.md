...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04128v2" onclick="toggleFavorite(this, '2511.04128v2', 'DMSORT: An efficient parallel maritime multi-object tracking architecture for unmanned vessel platforms')" title="添加到收藏夹">☆ 收藏</button>
