...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.04128" class="toolbar-btn" target="_blank">📄 arXiv: 2511.04128v2</a>
  <a href="https://arxiv.org/pdf/2511.04128.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04128v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.04128v2', 'DMSORT: An efficient parallel maritime multi-object tracking architecture for unmanned vessel platforms')" title="添加到收藏夹">☆ 收藏</button>
