...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03950v1" onclick="toggleFavorite(this, '2511.03950v1', 'Improving Multi-View Reconstruction via Texture-Guided Gaussian-Mesh Joint Optimization')" title="添加到收藏夹">☆ 收藏</button>
