...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04595v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.04595v1', 'UniSplat: Unified Spatio-Temporal Fusion via 3D Latent Scaffolds for Dynamic Driving Scene Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
