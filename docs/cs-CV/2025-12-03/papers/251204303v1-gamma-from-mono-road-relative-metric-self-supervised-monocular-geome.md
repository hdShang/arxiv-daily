...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2512.04303" class="toolbar-btn" target="_blank">📄 arXiv: 2512.04303v1</a>
  <a href="https://arxiv.org/pdf/2512.04303.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04303v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.04303v1', 'Gamma-from-Mono: Road-Relative, Metric, Self-Supervised Monocular Geometry for Vehicular Applications')" title="添加到收藏夹">☆ 收藏</button>
