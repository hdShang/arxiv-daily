...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03848v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03848v1', 'PULSE: A Unified Multi-Task Architecture for Cardiac Segmentation, Diagnosis, and Few-Shot Cross-Modality Clinical Adaptation')" title="添加到收藏夹">☆ 收藏</button>
