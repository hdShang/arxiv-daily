...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03566v1" onclick="toggleFavorite(this, '2512.03566v1', 'GAOT: Generating Articulated Objects Through Text-Guided Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
