...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04012v1" onclick="toggleFavorite(this, '2512.04012v1', 'Emergent Outlier View Rejection in Visual Geometry Grounded Transformers')" title="添加到收藏夹">☆ 收藏</button>
