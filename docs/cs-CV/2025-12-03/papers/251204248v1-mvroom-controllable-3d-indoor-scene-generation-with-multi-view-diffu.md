...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04248v1" onclick="toggleFavorite(this, '2512.04248v1', 'MVRoom: Controllable 3D Indoor Scene Generation with Multi-View Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
