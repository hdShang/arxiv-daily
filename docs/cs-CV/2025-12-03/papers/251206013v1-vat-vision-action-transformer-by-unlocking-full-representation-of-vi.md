...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06013v1" onclick="toggleFavorite(this, '2512.06013v1', 'VAT: Vision Action Transformer by Unlocking Full Representation of ViT')" title="添加到收藏夹">☆ 收藏</button>
