...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03724v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03724v2', 'PosA-VLA: Enhancing Action Generation via Pose-Conditioned Anchor Attention')" title="添加到收藏夹">☆ 收藏</button>
