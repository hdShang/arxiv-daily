...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03520v1" onclick="toggleFavorite(this, '2512.03520v1', 'FloodDiffusion: Tailored Diffusion Forcing for Streaming Motion Generation')" title="添加到收藏夹">☆ 收藏</button>
