...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03619v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03619v2', 'LAMP: Language-Assisted Motion Planning for Controllable Video Generation')" title="添加到收藏夹">☆ 收藏</button>
