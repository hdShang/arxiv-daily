...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11524v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11524v1', 'Super-Resolved Canopy Height Mapping from Sentinel-2 Time Series Using LiDAR HD Reference Data across Metropolitan France')" title="添加到收藏夹">☆ 收藏</button>
