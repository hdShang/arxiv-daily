...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11215v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11215v1', 'SmokeBench: Evaluating Multimodal Large Language Models for Wildfire Smoke Detection')" title="添加到收藏夹">☆ 收藏</button>
