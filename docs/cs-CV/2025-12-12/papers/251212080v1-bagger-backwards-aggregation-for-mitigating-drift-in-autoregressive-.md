...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12080v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.12080v1', 'BAgger: Backwards Aggregation for Mitigating Drift in Autoregressive Video Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
