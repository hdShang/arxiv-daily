...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11799v1" onclick="toggleFavorite(this, '2512.11799v1', 'V-RGBX: Video Editing with Accurate Controls over Intrinsic Properties')" title="添加到收藏夹">☆ 收藏</button>
