...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11189v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11189v1', 'Multi-task Learning with Extended Temporal Shift Module for Temporal Action Localization')" title="添加到收藏夹">☆ 收藏</button>
