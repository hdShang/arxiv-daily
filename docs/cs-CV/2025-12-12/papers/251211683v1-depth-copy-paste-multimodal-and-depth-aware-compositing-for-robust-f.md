...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11683v1" onclick="toggleFavorite(this, '2512.11683v1', 'Depth-Copy-Paste: Multimodal and Depth-Aware Compositing for Robust Face Detection')" title="添加到收藏夹">☆ 收藏</button>
