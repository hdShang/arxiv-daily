...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11465v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11465v1', 'DOS: Distilling Observable Softmaps of Zipfian Prototypes for Self-Supervised Point Representation')" title="添加到收藏夹">☆ 收藏</button>
