...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11800v1" onclick="toggleFavorite(this, '2512.11800v1', 'Moment-Based 3D Gaussian Splatting: Resolving Volumetric Occlusion with Order-Independent Transmittance')" title="添加到收藏夹">☆ 收藏</button>
