...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12013v1" onclick="toggleFavorite(this, '2512.12013v1', 'Exploring Spatial-Temporal Representation via Star Graph for mmWave Radar-based Human Activity Recognition')" title="添加到收藏夹">☆ 收藏</button>
