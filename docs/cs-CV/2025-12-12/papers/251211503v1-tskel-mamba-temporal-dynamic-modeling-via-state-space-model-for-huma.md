...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11503v1" onclick="toggleFavorite(this, '2512.11503v1', 'TSkel-Mamba: Temporal Dynamic Modeling via State Space Model for Human Skeleton-based Action Recognition')" title="添加到收藏夹">☆ 收藏</button>
