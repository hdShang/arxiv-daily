...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11225v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11225v1', 'VFMF: World Modeling by Forecasting Vision Foundation Model Features')" title="添加到收藏夹">☆ 收藏</button>
