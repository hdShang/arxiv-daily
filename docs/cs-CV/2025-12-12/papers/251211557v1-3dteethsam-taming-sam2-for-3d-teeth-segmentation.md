...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11557v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11557v1', '3DTeethSAM: Taming SAM2 for 3D Teeth Segmentation')" title="添加到收藏夹">☆ 收藏</button>
