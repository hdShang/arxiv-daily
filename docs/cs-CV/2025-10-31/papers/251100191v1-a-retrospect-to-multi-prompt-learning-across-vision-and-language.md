...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00191v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00191v1', 'A Retrospect to Multi-prompt Learning across Vision and Language')" title="添加到收藏夹">☆ 收藏</button>
