...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27219v1" onclick="toggleFavorite(this, '2510.27219v1', 'SpecAware: A Spectral-Content Aware Foundation Model for Unifying Multi-Sensor Learning in Hyperspectral Remote Sensing Mapping')" title="添加到收藏夹">☆ 收藏</button>
