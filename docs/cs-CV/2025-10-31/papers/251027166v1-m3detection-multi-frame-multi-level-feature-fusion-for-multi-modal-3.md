...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27166v1" onclick="toggleFavorite(this, '2510.27166v1', 'M^3Detection: Multi-Frame Multi-Level Feature Fusion for Multi-Modal 3D Object Detection with Camera and 4D Imaging Radar')" title="添加到收藏夹">☆ 收藏</button>
