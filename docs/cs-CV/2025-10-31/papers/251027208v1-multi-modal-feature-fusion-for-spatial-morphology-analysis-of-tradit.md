...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27208v1" onclick="toggleFavorite(this, '2510.27208v1', 'Multi-Modal Feature Fusion for Spatial Morphology Analysis of Traditional Villages via Hierarchical Graph Neural Networks')" title="添加到收藏夹">☆ 收藏</button>
