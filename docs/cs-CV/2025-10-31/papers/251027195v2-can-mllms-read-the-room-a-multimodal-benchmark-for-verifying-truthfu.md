...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27195v2" onclick="toggleFavorite(this, '2510.27195v2', 'Can MLLMs Read the Room? A Multimodal Benchmark for Verifying Truthfulness in Multi-Party Social Interactions')" title="添加到收藏夹">☆ 收藏</button>
