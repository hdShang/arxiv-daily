...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27647v1" onclick="toggleFavorite(this, '2510.27647v1', 'NegoCollab: A Common Representation Negotiation Approach for Heterogeneous Collaborative Perception')" title="添加到收藏夹">☆ 收藏</button>
