...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00260v1" onclick="toggleFavorite(this, '2511.00260v1', 'MambaNetLK: Enhancing Colonoscopy Point Cloud Registration with Mamba')" title="添加到收藏夹">☆ 收藏</button>
