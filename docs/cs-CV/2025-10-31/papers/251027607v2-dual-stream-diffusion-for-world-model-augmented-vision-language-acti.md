...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27607v2" onclick="toggleFavorite(this, '2510.27607v2', 'Dual-Stream Diffusion for World-Model Augmented Vision-Language-Action Model')" title="添加到收藏夹">☆ 收藏</button>
