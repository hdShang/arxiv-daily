...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27547v1" onclick="toggleFavorite(this, '2510.27547v1', 'MapSAM2: Adapting SAM2 for Automatic Segmentation of Historical Map Images and Time Series')" title="添加到收藏夹">☆ 收藏</button>
