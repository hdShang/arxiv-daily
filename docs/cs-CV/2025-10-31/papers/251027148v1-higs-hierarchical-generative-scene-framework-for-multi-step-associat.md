...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27148v1" onclick="toggleFavorite(this, '2510.27148v1', 'HiGS: Hierarchical Generative Scene Framework for Multi-Step Associative Semantic Spatial Composition')" title="添加到收藏夹">☆ 收藏</button>
