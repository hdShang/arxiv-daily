...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27632v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27632v1', 'Sketch-to-Layout: Sketch-Guided Multimodal Layout Generation')" title="添加到收藏夹">☆ 收藏</button>
