...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27318v1" onclick="toggleFavorite(this, '2510.27318v1', 'SAGS: Self-Adaptive Alias-Free Gaussian Splatting for Dynamic Surgical Endoscopic Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
