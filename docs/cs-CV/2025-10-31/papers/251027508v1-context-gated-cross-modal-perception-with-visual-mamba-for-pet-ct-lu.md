...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27508v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27508v1', 'Context-Gated Cross-Modal Perception with Visual Mamba for PET-CT Lung Tumor Segmentation')" title="添加到收藏夹">☆ 收藏</button>
