...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27179v1" onclick="toggleFavorite(this, '2510.27179v1', 'SilhouetteTell: Practical Video Identification Leveraging Blurred Recordings of Video Subtitles')" title="添加到收藏夹">☆ 收藏</button>
