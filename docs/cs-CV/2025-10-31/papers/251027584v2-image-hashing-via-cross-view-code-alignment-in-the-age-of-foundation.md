...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27584v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27584v2', 'Image Hashing via Cross-View Code Alignment in the Age of Foundation Models')" title="添加到收藏夹">☆ 收藏</button>
