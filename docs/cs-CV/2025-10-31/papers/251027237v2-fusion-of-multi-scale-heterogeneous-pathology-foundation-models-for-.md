...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27237v2" onclick="toggleFavorite(this, '2510.27237v2', 'Fusion of Multi-scale Heterogeneous Pathology Foundation Models for Whole Slide Image Analysis')" title="添加到收藏夹">☆ 收藏</button>
