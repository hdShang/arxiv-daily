...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27684v1" onclick="toggleFavorite(this, '2510.27684v1', 'Phased DMD: Few-step Distribution Matching Distillation via Score Matching within Subintervals')" title="添加到收藏夹">☆ 收藏</button>
