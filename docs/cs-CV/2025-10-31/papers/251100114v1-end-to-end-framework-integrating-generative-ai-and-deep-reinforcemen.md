...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00114v1" onclick="toggleFavorite(this, '2511.00114v1', 'End-to-End Framework Integrating Generative AI and Deep Reinforcement Learning for Autonomous Ultrasound Scanning')" title="添加到收藏夹">☆ 收藏</button>
