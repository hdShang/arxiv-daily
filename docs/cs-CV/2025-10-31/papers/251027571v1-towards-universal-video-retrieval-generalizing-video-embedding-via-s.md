...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27571v1" onclick="toggleFavorite(this, '2510.27571v1', 'Towards Universal Video Retrieval: Generalizing Video Embedding via Synthesized Multimodal Pyramid Curriculum')" title="添加到收藏夹">☆ 收藏</button>
