...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00927v1" onclick="toggleFavorite(this, '2512.00927v1', 'LAHNet: Local Attentive Hashing Network for Point Cloud Registration')" title="添加到收藏夹">☆ 收藏</button>
