...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00877v1" onclick="toggleFavorite(this, '2512.00877v1', 'Feed-Forward 3D Gaussian Splatting Compression with Long-Context Modeling')" title="添加到收藏夹">☆ 收藏</button>
