...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00794v1" onclick="toggleFavorite(this, '2512.00794v1', 'PolarGS: Polarimetric Cues for Ambiguity-Free Gaussian Splatting with Accurate Geometry Recovery')" title="添加到收藏夹">☆ 收藏</button>
