...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.01094v1" onclick="toggleFavorite(this, '2512.01094v1', 'Accelerating Inference of Masked Image Generators via Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
