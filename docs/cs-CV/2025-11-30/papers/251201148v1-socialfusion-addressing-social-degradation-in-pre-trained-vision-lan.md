...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.01148v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.01148v1', 'SocialFusion: Addressing Social Degradation in Pre-trained Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
