...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00995v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00995v1', 'S2AM3D: Scale-controllable Part Segmentation of 3D Point Cloud')" title="添加到收藏夹">☆ 收藏</button>
