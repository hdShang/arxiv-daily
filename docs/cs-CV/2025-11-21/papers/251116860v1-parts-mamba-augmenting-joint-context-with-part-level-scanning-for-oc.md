...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16860v1" onclick="toggleFavorite(this, '2511.16860v1', 'Parts-Mamba: Augmenting Joint Context with Part-Level Scanning for Occluded Human Skeleton')" title="添加到收藏夹">☆ 收藏</button>
