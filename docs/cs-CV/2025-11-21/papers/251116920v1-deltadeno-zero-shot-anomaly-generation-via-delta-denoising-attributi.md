...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16920v1" onclick="toggleFavorite(this, '2511.16920v1', 'DeltaDeno: Zero-Shot Anomaly Generation via Delta-Denoising Attribution')" title="添加到收藏夹">☆ 收藏</button>
