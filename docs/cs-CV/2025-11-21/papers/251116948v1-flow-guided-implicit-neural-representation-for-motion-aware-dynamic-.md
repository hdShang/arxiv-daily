...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16948v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16948v1', 'Flow-Guided Implicit Neural Representation for Motion-Aware Dynamic MRI Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
