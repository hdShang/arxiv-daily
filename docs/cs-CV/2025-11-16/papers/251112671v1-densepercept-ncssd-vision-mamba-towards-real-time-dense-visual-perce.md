...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12671v1" onclick="toggleFavorite(this, '2511.12671v1', 'DensePercept-NCSSD: Vision Mamba towards Real-time Dense Visual Perception with Non-Causal State Space Duality')" title="添加到收藏夹">☆ 收藏</button>
