...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12449v1" onclick="toggleFavorite(this, '2511.12449v1', 'MOON2.0: Dynamic Modality-balanced Multimodal Representation Learning for E-commerce Product Understanding')" title="添加到收藏夹">☆ 收藏</button>
