...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12627v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12627v1', 'C3Net: Context-Contrast Network for Camouflaged Object Detection')" title="添加到收藏夹">☆ 收藏</button>
