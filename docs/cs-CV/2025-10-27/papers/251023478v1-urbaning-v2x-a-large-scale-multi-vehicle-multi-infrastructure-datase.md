...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23478v1" onclick="toggleFavorite(this, '2510.23478v1', 'UrbanIng-V2X: A Large-Scale Multi-Vehicle, Multi-Infrastructure Dataset Across Multiple Intersections for Cooperative Perception')" title="添加到收藏夹">☆ 收藏</button>
