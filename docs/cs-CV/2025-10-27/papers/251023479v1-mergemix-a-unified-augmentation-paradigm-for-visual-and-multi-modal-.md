...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23479v1" onclick="toggleFavorite(this, '2510.23479v1', 'MergeMix: A Unified Augmentation Paradigm for Visual and Multi-Modal Understanding')" title="添加到收藏夹">☆ 收藏</button>
