...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23894v1" onclick="toggleFavorite(this, '2510.23894v1', 'Improving Visual Discriminability of CLIP for Training-Free Open-Vocabulary Semantic Segmentation')" title="添加到收藏夹">☆ 收藏</button>
