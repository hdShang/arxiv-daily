...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23497v2" onclick="toggleFavorite(this, '2510.23497v2', 'VOLD: Reasoning Transfer from LLMs to Vision-Language Models via On-Policy Distillation')" title="添加到收藏夹">☆ 收藏</button>
