...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23151v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23151v1', 'AG-Fusion: adaptive gated multimodal fusion for 3d object detection in complex scenes')" title="添加到收藏夹">☆ 收藏</button>
