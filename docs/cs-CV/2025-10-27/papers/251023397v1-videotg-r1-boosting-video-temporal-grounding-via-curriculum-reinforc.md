...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23397v1" onclick="toggleFavorite(this, '2510.23397v1', 'VideoTG-R1: Boosting Video Temporal Grounding via Curriculum Reinforcement Learning on Reflected Boundary Annotations')" title="添加到收藏夹">☆ 收藏</button>
