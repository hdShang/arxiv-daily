...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23205v1" onclick="toggleFavorite(this, '2510.23205v1', 'VR-Drive: Viewpoint-Robust End-to-End Driving with Feed-Forward 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
