...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23145v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23145v1', 'Implicit Modeling for Transferability Estimation of Vision Foundation Models')" title="添加到收藏夹">☆ 收藏</button>
