...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23574v1" onclick="toggleFavorite(this, '2510.23574v1', 'More Than Generation: Unifying Generation and Depth Estimation via Text-to-Image Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
