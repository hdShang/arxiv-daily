...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23494v1" onclick="toggleFavorite(this, '2510.23494v1', 'Yesnt: Are Diffusion Relighting Models Ready for Capture Stage Compositing? A Hybrid Alternative to Bridge the Gap')" title="添加到收藏夹">☆ 收藏</button>
