...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23043v1" onclick="toggleFavorite(this, '2510.23043v1', 'HieraMamba: Video Temporal Grounding via Hierarchical Anchor-Mamba Pooling')" title="添加到收藏夹">☆ 收藏</button>
