...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22937v1" onclick="toggleFavorite(this, '2510.22937v1', 'Bi-Encoder Contrastive Learning for Fingerprint and Iris Biometrics')" title="添加到收藏夹">☆ 收藏</button>
