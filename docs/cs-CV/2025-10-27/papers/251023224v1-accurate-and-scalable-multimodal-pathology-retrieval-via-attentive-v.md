...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23224v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23224v1', 'Accurate and Scalable Multimodal Pathology Retrieval via Attentive Vision-Language Alignment')" title="添加到收藏夹">☆ 收藏</button>
