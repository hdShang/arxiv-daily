...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2510.20285" class="toolbar-btn" target="_blank">📄 arXiv: 2510.20285v2</a>
  <a href="https://arxiv.org/pdf/2510.20285.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20285v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20285v2', 'DMC$^3$: Dual-Modal Counterfactual Contrastive Construction for Egocentric Video Question Answering')" title="添加到收藏夹">☆ 收藏</button>
