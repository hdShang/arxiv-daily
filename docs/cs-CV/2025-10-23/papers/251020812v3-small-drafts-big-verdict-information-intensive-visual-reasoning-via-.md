...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20812v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20812v3', 'Small Drafts, Big Verdict: Information-Intensive Visual Reasoning via Speculation')" title="添加到收藏夹">☆ 收藏</button>
