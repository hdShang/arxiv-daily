...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21867v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21867v1', 'Addressing Corner Cases in Autonomous Driving: A World Model-based Approach with Mixture of Experts and LLMs')" title="添加到收藏夹">☆ 收藏</button>
