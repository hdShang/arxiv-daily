...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20807v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20807v1', 'Video Prediction of Dynamic Physical Simulations With Pixel-Space Spatiotemporal Transformers')" title="添加到收藏夹">☆ 收藏</button>
