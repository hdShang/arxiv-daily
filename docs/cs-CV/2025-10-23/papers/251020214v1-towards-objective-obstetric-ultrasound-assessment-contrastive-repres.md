...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20214v1" onclick="toggleFavorite(this, '2510.20214v1', 'Towards Objective Obstetric Ultrasound Assessment: Contrastive Representation Learning for Fetal Movement Detection')" title="添加到收藏夹">☆ 收藏</button>
