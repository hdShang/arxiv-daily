...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20165v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20165v1', 'IB-GAN: Disentangled Representation Learning with Information Bottleneck Generative Adversarial Networks')" title="添加到收藏夹">☆ 收藏</button>
