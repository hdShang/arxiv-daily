...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20287v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20287v1', 'Breakdance Video classification in the age of Generative AI')" title="添加到收藏夹">☆ 收藏</button>
