...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21501v1" onclick="toggleFavorite(this, '2510.21501v1', 'GranViT: A Fine-Grained Vision Model With Autoregressive Perception For MLLMs')" title="添加到收藏夹">☆ 收藏</button>
