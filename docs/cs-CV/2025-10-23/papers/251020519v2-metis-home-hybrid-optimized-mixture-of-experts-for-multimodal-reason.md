...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20519v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20519v2', 'Metis-HOME: Hybrid Optimized Mixture-of-Experts for Multimodal Reasoning')" title="添加到收藏夹">☆ 收藏</button>
