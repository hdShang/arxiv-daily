...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20206v1" onclick="toggleFavorite(this, '2510.20206v1', 'RAPO++: Cross-Stage Prompt Optimization for Text-to-Video Generation via Data Alignment and Test-Time Scaling')" title="添加到收藏夹">☆ 收藏</button>
