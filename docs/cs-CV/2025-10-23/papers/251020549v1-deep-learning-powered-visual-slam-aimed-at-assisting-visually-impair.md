...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20549v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20549v1', 'Deep Learning-Powered Visual SLAM Aimed at Assisting Visually Impaired Navigation')" title="添加到收藏夹">☆ 收藏</button>
