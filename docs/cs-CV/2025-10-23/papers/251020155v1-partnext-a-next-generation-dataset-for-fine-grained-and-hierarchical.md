...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20155v1" onclick="toggleFavorite(this, '2510.20155v1', 'PartNeXt: A Next-Generation Dataset for Fine-Grained and Hierarchical 3D Part Understanding')" title="添加到收藏夹">☆ 收藏</button>
