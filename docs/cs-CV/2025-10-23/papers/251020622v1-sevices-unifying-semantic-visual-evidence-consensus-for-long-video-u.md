...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20622v1" onclick="toggleFavorite(this, '2510.20622v1', 'SeViCES: Unifying Semantic-Visual Evidence Consensus for Long Video Understanding')" title="添加到收藏夹">☆ 收藏</button>
