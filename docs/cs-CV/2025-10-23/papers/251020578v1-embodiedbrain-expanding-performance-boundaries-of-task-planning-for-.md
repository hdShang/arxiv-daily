...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20578v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20578v1', 'EmbodiedBrain: Expanding Performance Boundaries of Task Planning for Embodied Intelligence')" title="添加到收藏夹">☆ 收藏</button>
