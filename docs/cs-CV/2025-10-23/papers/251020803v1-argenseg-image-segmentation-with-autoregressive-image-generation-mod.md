...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20803v1" onclick="toggleFavorite(this, '2510.20803v1', 'ARGenSeg: Image Segmentation with Autoregressive Image Generation Model')" title="添加到收藏夹">☆ 收藏</button>
