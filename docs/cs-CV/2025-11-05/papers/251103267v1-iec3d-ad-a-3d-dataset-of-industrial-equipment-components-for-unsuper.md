...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03267v1" onclick="toggleFavorite(this, '2511.03267v1', 'IEC3D-AD: A 3D Dataset of Industrial Equipment Components for Unsupervised Point Cloud Anomaly Detection')" title="添加到收藏夹">☆ 收藏</button>
