...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03099v1" onclick="toggleFavorite(this, '2511.03099v1', 'DentalSplat: Dental Occlusion Novel View Synthesis from Sparse Intra-Oral Photographs')" title="添加到收藏夹">☆ 收藏</button>
