...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12895v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12895v1', 'Reconstructing 3D Scenes in Native High Dynamic Range')" title="添加到收藏夹">☆ 收藏</button>
