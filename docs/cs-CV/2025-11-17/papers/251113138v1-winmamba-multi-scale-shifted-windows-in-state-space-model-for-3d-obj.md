...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13138v1" onclick="toggleFavorite(this, '2511.13138v1', 'WinMamba: Multi-Scale Shifted Windows in State Space Model for 3D Object Detection')" title="添加到收藏夹">☆ 收藏</button>
