...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13264v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13264v2', 'SymGS : Leveraging Local Symmetries for 3D Gaussian Splatting Compression')" title="添加到收藏夹">☆ 收藏</button>
