...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13545v1" onclick="toggleFavorite(this, '2511.13545v1', 'Robust Defense Strategies for Multimodal Contrastive Learning: Efficient Fine-tuning Against Backdoor Attacks')" title="添加到收藏夹">☆ 收藏</button>
