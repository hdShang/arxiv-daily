...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12908v1" onclick="toggleFavorite(this, '2511.12908v1', 'DeepSport: A Multimodal Large Language Model for Comprehensive Sports Video Reasoning via Agentic Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
