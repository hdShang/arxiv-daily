...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12976v1" onclick="toggleFavorite(this, '2511.12976v1', 'MCAQ-YOLO: Morphological Complexity-Aware Quantization for Efficient Object Detection with Curriculum Learning')" title="添加到收藏夹">☆ 收藏</button>
