...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13121v1" onclick="toggleFavorite(this, '2511.13121v1', 'CloseUpShot: Close-up Novel View Synthesis from Sparse-views via Point-conditioned Diffusion Model')" title="添加到收藏夹">☆ 收藏</button>
