...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13115v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13115v2', 'A Lightweight 3D Anomaly Detection Method with Rotationally Invariant Features')" title="添加到收藏夹">☆ 收藏</button>
