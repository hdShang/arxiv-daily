...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12940v1" onclick="toggleFavorite(this, '2511.12940v1', 'Recurrent Autoregressive Diffusion: Global Memory Meets Local Attention')" title="添加到收藏夹">☆ 收藏</button>
