...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13278v2" onclick="toggleFavorite(this, '2511.13278v2', 'SF-Recon: Simplification-Free Lightweight Building Reconstruction via 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
