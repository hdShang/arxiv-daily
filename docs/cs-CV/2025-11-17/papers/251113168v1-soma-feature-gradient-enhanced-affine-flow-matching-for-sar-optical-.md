...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13168v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13168v1', 'SOMA: Feature Gradient Enhanced Affine-Flow Matching for SAR-Optical Registration')" title="添加到收藏夹">☆ 收藏</button>
