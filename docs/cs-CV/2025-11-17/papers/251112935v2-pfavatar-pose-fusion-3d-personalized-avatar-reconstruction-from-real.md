...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12935v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12935v2', 'PFAvatar: Pose-Fusion 3D Personalized Avatar Reconstruction from Real-World Outfit-of-the-Day Photos')" title="添加到收藏夹">☆ 收藏</button>
