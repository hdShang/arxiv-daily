...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13039v1" onclick="toggleFavorite(this, '2511.13039v1', 'MGCA-Net: Multi-Grained Category-Aware Network for Open-Vocabulary Temporal Action Localization')" title="添加到收藏夹">☆ 收藏</button>
