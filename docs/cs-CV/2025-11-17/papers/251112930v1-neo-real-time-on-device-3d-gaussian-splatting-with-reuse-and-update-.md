...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12930v1" onclick="toggleFavorite(this, '2511.12930v1', 'Neo: Real-Time On-Device 3D Gaussian Splatting with Reuse-and-Update Sorting Acceleration')" title="添加到收藏夹">☆ 收藏</button>
