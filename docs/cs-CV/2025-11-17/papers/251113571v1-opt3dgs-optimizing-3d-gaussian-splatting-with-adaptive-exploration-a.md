...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13571v1" onclick="toggleFavorite(this, '2511.13571v1', 'Opt3DGS: Optimizing 3D Gaussian Splatting with Adaptive Exploration and Curvature-Aware Exploitation')" title="添加到收藏夹">☆ 收藏</button>
