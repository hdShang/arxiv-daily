...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13924v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13924v1', 'Start Small, Think Big: Curriculum-based Relative Policy Optimization for Visual Grounding')" title="添加到收藏夹">☆ 收藏</button>
