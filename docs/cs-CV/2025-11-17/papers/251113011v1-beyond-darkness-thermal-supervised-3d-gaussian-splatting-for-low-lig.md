...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13011v1" onclick="toggleFavorite(this, '2511.13011v1', 'Beyond Darkness: Thermal-Supervised 3D Gaussian Splatting for Low-Light Novel View Synthesis')" title="添加到收藏夹">☆ 收藏</button>
