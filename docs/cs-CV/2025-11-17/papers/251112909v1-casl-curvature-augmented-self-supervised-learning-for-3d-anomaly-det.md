...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12909v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12909v1', 'CASL: Curvature-Augmented Self-supervised Learning for 3D Anomaly Detection')" title="添加到收藏夹">☆ 收藏</button>
