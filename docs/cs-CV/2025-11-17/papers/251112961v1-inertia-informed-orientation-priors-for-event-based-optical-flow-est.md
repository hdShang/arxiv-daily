...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12961v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12961v1', 'Inertia-Informed Orientation Priors for Event-Based Optical Flow Estimation')" title="添加到收藏夹">☆ 收藏</button>
