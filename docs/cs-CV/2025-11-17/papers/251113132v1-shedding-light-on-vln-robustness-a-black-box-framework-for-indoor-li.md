...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13132v1" onclick="toggleFavorite(this, '2511.13132v1', 'Shedding Light on VLN Robustness: A Black-box Framework for Indoor Lighting-based Adversarial Attack')" title="添加到收藏夹">☆ 收藏</button>
