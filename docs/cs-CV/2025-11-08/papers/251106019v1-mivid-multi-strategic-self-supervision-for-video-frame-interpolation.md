...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06019v1" onclick="toggleFavorite(this, '2511.06019v1', 'MiVID: Multi-Strategic Self-Supervision for Video Frame Interpolation using Diffusion Model')" title="添加到收藏夹">☆ 收藏</button>
