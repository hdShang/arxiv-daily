...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05996v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.05996v1', 'Exploring Category-level Articulated Object Pose Tracking on SE(3) Manifolds')" title="添加到收藏夹">☆ 收藏</button>
