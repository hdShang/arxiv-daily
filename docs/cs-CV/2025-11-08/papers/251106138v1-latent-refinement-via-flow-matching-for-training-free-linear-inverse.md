...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06138v1" onclick="toggleFavorite(this, '2511.06138v1', 'Latent Refinement via Flow Matching for Training-free Linear Inverse Problem Solving')" title="添加到收藏夹">☆ 收藏</button>
