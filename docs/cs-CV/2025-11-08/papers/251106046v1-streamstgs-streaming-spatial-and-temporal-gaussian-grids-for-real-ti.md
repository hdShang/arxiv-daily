...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06046v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06046v1', 'StreamSTGS: Streaming Spatial and Temporal Gaussian Grids for Real-Time Free-Viewpoint Video')" title="添加到收藏夹">☆ 收藏</button>
