...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05866v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.05866v1', 'Light-Field Dataset for Disparity Based Depth Estimation')" title="添加到收藏夹">☆ 收藏</button>
