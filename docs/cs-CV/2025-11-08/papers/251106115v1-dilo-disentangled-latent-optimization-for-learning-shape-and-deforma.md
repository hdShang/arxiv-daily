...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06115v1" onclick="toggleFavorite(this, '2511.06115v1', 'DiLO: Disentangled Latent Optimization for Learning Shape and Deformation in Grouped Deforming 3D Objects')" title="添加到收藏夹">☆ 收藏</button>
