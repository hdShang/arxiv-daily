...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05946v1" onclick="toggleFavorite(this, '2511.05946v1', 'Reperio-rPPG: Relational Temporal Graph Neural Networks for Periodicity Learning in Remote Physiological Measurement')" title="添加到收藏夹">☆ 收藏</button>
