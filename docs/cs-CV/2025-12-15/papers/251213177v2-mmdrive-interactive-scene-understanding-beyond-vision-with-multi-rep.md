...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13177v2" onclick="toggleFavorite(this, '2512.13177v2', 'MMDrive: Interactive Scene Understanding Beyond Vision with Multi-representational Fusion')" title="添加到收藏夹">☆ 收藏</button>
