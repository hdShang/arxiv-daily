...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13411v1" onclick="toggleFavorite(this, '2512.13411v1', 'Computer vision training dataset generation for robotic environments using Gaussian splatting')" title="添加到收藏夹">☆ 收藏</button>
