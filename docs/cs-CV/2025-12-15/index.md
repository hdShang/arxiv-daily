---
layout: default
title: arXiv 中文要点汇总 - cs.CV - 2025-12-15
---
...
<tr>
  ...
  <td>StarryGazer：利用单目深度估计模型实现领域无关的单深度图像补全</td>
  <td class="tags-cell"><span class="paper-tag">depth estimation</span> <span class="paper-tag">monocular depth</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13147v1" data-paper-url="./papers/251213147v1-starrygazer-leveraging-monocular-depth-estimation-models-for-domain-.html" onclick="toggleFavorite(this, '2512.13147v1', 'StarryGazer: Leveraging Monocular Depth Estimation Models for Domain-Agnostic Single Depth Image Completion')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>2</td>
  ...
  <td>提出基于神经纹理Surfel的新视角合成方法，在稀疏几何下实现实时渲染。</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13796v1" data-paper-url="./papers/251213796v1-nexels-neurally-textured-surfels-for-real-time-novel-view-synthesis-.html" onclick="toggleFavorite(this, '2512.13796v1', 'Nexels: Neurally-Textured Surfels for Real-Time Novel View Synthesis with Sparse Geometries')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>3</td>
  ...
  <td>提出Charge数据集，用于高质量新视角合成的综合基准测试。</td>
  <td class="tags-cell"><span class="paper-tag">novel view synthesis</span> <span class="paper-tag">scene reconstruction</span> <span class="paper-tag">optical flow</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13639v1" data-paper-url="./papers/251213639v1-charge-a-comprehensive-novel-view-synthesis-benchmark-and-dataset-to.html" onclick="toggleFavorite(this, '2512.13639v1', 'Charge: A Comprehensive Novel View Synthesis Benchmark and Dataset to Bind Them All')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>4</td>
  ...
  <td>提出基于高斯溅射的机器人环境计算机视觉训练数据集生成流程</td>
  <td class="tags-cell"><span class="paper-tag">3D gaussian splatting</span> <span class="paper-tag">3DGS</span> <span class="paper-tag">gaussian splatting</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13411v1" data-paper-url="./papers/251213411v1-computer-vision-training-dataset-generation-for-robotic-environments.html" onclick="toggleFavorite(this, '2512.13411v1', 'Computer vision training dataset generation for robotic environments using Gaussian splatting')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>5</td>
  ...
  <td>MMDrive：提出多模态融合的交互式场景理解框架，超越视觉局限</td>
  <td class="tags-cell"><span class="paper-tag">scene understanding</span> <span class="paper-tag">point cloud</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13177v2" data-paper-url="./papers/251213177v2-mmdrive-interactive-scene-understanding-beyond-vision-with-multi-rep.html" onclick="toggleFavorite(this, '2512.13177v2', 'MMDrive: Interactive Scene Understanding Beyond Vision with Multi-representational Fusion')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>6</td>
  ...
  <td>提出TWLR框架，利用文本引导的弱监督学习进行糖尿病视网膜病变分级与病灶定位。</td>
  <td class="tags-cell"><span class="paper-tag">localization</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13008v1" data-paper-url="./papers/251213008v1-twlr-text-guided-weakly-supervised-lesion-localization-and-severity-.html" onclick="toggleFavorite(this, '2512.13008v1', 'TWLR: Text-Guided Weakly-Supervised Lesion Localization and Severity Regression for Explainable Diabetic Retinopathy Grading')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>7</td>
  ...
  <td>提出LASER以解决流媒体4D重建中的训练需求问题</td>
  <td class="tags-cell"><span class="paper-tag">pose estimation</span> <span class="paper-tag">VGGT</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13680v1" data-paper-url="./papers/251213680v1-laser-layer-wise-scale-alignment-for-training-free-streaming-4d-reco.html" onclick="toggleFavorite(this, '2512.13680v1', 'LASER: Layer-wise Scale Alignment for Training-Free Streaming 4D Reconstruction')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>8</td>
  ...
  <td>LitePT：一种更轻量但更强大的点云Transformer，通过卷积与注意力机制的有效结合提升性能。</td>
  <td class="tags-cell"><span class="paper-tag">point cloud</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13689v1" data-paper-url="./papers/251213689v1-litept-lighter-yet-stronger-point-transformer.html" onclick="toggleFavorite(this, '2512.13689v1', 'LitePT: Lighter Yet Stronger Point Transformer')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>9</td>
  ...
  <td>I-Scene：利用预训练3D实例生成器实现可泛化的隐式场景空间学习</td>
  <td class="tags-cell"><span class="paper-tag">scene understanding</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13683v1" data-paper-url="./papers/251213683v1-i-scene-3d-instance-models-are-implicit-generalizable-spatial-learne.html" onclick="toggleFavorite(this, '2512.13683v1', 'I-Scene: 3D Instance Models are Implicit Generalizable Spatial Learners')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>10</td>
  ...
  <td class="tags-cell"><span class="paper-tag">scene understanding</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13122v1" data-paper-url="./papers/251213122v1-dept3r-joint-dense-point-tracking-and-3d-reconstruction-of-dynamic-s.html" onclick="toggleFavorite(this, '2512.13122v1', 'DePT3R: Joint Dense Point Tracking and 3D Reconstruction of Dynamic Scenes in a Single Forward Pass')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>11</td>
  ...
  <td class="tags-cell"><span class="paper-tag">point cloud</span></td>
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.12984v1" data-paper-url="./papers/251212984v1-vorolight-learning-quality-volumetric-voronoi-meshes-from-general-in.html" onclick="toggleFavorite(this, '2512.12984v1', 'VoroLight: Learning Quality Volumetric Voronoi Meshes from General Inputs')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13030v1" data-paper-url="./papers/251213030v1-motus-a-unified-latent-action-world-model.html" onclick="toggleFavorite(this, '2512.13030v1', 'Motus: A Unified Latent Action World Model')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>13</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13684v1" data-paper-url="./papers/251213684v1-recurrent-video-masked-autoencoders.html" onclick="toggleFavorite(this, '2512.13684v1', 'Recurrent Video Masked Autoencoders')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>14</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13636v2" data-paper-url="./papers/251213636v2-minddrive-a-vision-language-action-model-for-autonomous-driving-via-.html" onclick="toggleFavorite(this, '2512.13636v2', 'MindDrive: A Vision-Language-Action Model for Autonomous Driving via Online Reinforcement Learning')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>15</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13434v1" data-paper-url="./papers/251213434v1-self-supervised-ultrasound-representation-learning-for-renal-anomaly.html" onclick="toggleFavorite(this, '2512.13434v1', 'Self-Supervised Ultrasound Representation Learning for Renal Anomaly Prediction in Prenatal Imaging')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>16</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13874v1" data-paper-url="./papers/251213874v1-sage-training-smart-any-horizon-agents-for-long-video-reasoning-with.html" onclick="toggleFavorite(this, '2512.13874v1', 'SAGE: Training Smart Any-Horizon Agents for Long Video Reasoning with Reinforcement Learning')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>17</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13604v1" data-paper-url="./papers/251213604v1-longvie-2-multimodal-controllable-ultra-long-video-world-model.html" onclick="toggleFavorite(this, '2512.13604v1', 'LongVie 2: Multimodal Controllable Ultra-Long Video World Model')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>18</td>
  ...
  <td class="tags-cell"><span class="paper-tag">reinforcement learning</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13095v1" data-paper-url="./papers/251213095v1-adhint-adaptive-hints-with-difficulty-priors-for-reinforcement-learn.html" onclick="toggleFavorite(this, '2512.13095v1', 'ADHint: Adaptive Hints with Difficulty Priors for Reinforcement Learning')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>19</td>
  ...
  <td>✅</td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13421v1" data-paper-url="./papers/251213421v1-rectok-reconstruction-distillation-along-rectified-flow.html" onclick="toggleFavorite(this, '2512.13421v1', 'RecTok: Reconstruction Distillation along Rectified Flow')" title="添加到收藏夹">☆</button></td>
</tr>
<tr>
  <td>20</td>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13671v1" data-paper-url="./papers/251213671v1-agentiad-tool-augmented-single-agent-for-industrial-anomaly-detectio.html" onclick="toggleFavorite(this, '2512.13671v1', 'AgentIAD: Tool-Augmented Single-Agent for Industrial Anomaly Detection')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13840v1" data-paper-url="./papers/251213840v1-molingo-motion-language-alignment-for-text-to-motion-generation.html" onclick="toggleFavorite(this, '2512.13840v1', 'MoLingo: Motion-Language Alignment for Text-to-Motion Generation')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13665v1" data-paper-url="./papers/251213665v1-grab-3d-detecting-ai-generated-videos-from-3d-geometric-temporal-con.html" onclick="toggleFavorite(this, '2512.13665v1', 'Grab-3D: Detecting AI-Generated Videos from 3D Geometric Temporal Consistency')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td class="tags-cell"><span class="paper-tag">collaborative motion</span></td>
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13560v1" data-paper-url="./papers/251213560v1-3d-human-human-interaction-anomaly-detection.html" onclick="toggleFavorite(this, '2512.13560v1', '3D Human-Human Interaction Anomaly Detection')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
...
<tr>
  ...
  <td></td>
  <td><button class="favorite-btn" data-arxiv-id="2512.13313v1" data-paper-url="./papers/251213313v1-klingavatar-20-technical-report.html" onclick="toggleFavorite(this, '2512.13313v1', 'KlingAvatar 2.0 Technical Report')" title="添加到收藏夹">☆</button></td>
</tr>
</tbody>
</table>
