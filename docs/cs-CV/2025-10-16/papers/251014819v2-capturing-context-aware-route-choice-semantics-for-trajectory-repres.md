...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14819v2" onclick="toggleFavorite(this, '2510.14819v2', 'Capturing Context-Aware Route Choice Semantics for Trajectory Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
