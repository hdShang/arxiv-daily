...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14304v1" onclick="toggleFavorite(this, '2510.14304v1', 'Watermarking for Factuality: Guiding Vision-Language Models Toward Truth via Tri-layer Contrastive Decoding')" title="添加到收藏夹">☆ 收藏</button>
