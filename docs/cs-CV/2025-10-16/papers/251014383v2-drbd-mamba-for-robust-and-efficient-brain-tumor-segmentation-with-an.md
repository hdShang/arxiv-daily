...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14383v2" onclick="toggleFavorite(this, '2510.14383v2', 'DRBD-Mamba for Robust and Efficient Brain Tumor Segmentation with Analytical Insights')" title="添加到收藏夹">☆ 收藏</button>
