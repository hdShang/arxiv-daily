...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14349v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14349v3', 'Vision-Centric Activation and Coordination for Multimodal Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
