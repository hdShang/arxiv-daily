...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14605v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14605v2', 'Knowledge-based Visual Question Answer with Multimodal Processing, Retrieval and Filtering')" title="添加到收藏夹">☆ 收藏</button>
