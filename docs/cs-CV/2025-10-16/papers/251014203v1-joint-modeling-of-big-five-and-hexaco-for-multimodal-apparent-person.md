...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14203v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14203v1', 'Joint Modeling of Big Five and HEXACO for Multimodal Apparent Personality-trait Recognition')" title="添加到收藏夹">☆ 收藏</button>
