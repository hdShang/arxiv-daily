...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2510.16036" class="toolbar-btn" target="_blank">📄 arXiv: 2510.16036v1</a>
  <a href="https://arxiv.org/pdf/2510.16036.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16036v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16036v1', 'IAD-GPT: Advancing Visual Knowledge in Multimodal Large Language Model for Industrial Anomaly Detection')" title="添加到收藏夹">☆ 收藏</button>
