...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14672v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14672v1', 'VTimeCoT: Thinking by Drawing for Video Temporal Grounding and Reasoning')" title="添加到收藏夹">☆ 收藏</button>
