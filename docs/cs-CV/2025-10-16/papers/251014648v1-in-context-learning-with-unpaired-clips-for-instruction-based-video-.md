...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14648v1" onclick="toggleFavorite(this, '2510.14648v1', 'In-Context Learning with Unpaired Clips for Instruction-based Video Editing')" title="添加到收藏夹">☆ 收藏</button>
