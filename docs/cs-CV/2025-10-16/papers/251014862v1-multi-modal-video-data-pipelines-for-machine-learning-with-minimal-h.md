...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14862v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14862v1', 'Multi-modal video data-pipelines for machine learning with minimal human supervision')" title="添加到收藏夹">☆ 收藏</button>
