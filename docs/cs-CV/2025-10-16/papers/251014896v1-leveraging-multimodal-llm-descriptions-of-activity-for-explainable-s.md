...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14896v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14896v1', 'Leveraging Multimodal LLM Descriptions of Activity for Explainable Semi-Supervised Video Anomaly Detection')" title="添加到收藏夹">☆ 收藏</button>
