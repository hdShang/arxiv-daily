...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14958v1" onclick="toggleFavorite(this, '2510.14958v1', 'MathCanvas: Intrinsic Visual Chain-of-Thought for Multimodal Mathematical Reasoning')" title="添加到收藏夹">☆ 收藏</button>
