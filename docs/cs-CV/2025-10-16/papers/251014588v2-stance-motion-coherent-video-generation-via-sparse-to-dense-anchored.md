...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14588v2" onclick="toggleFavorite(this, '2510.14588v2', 'STANCE: Motion Coherent Video Generation Via Sparse-to-Dense Anchored Encoding')" title="添加到收藏夹">☆ 收藏</button>
