...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14564v1" onclick="toggleFavorite(this, '2510.14564v1', 'BalanceGS: Algorithm-System Co-design for Efficient 3D Gaussian Splatting Training on GPU')" title="添加到收藏夹">☆ 收藏</button>
