...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14661v1" onclick="toggleFavorite(this, '2510.14661v1', 'EuroMineNet: A Multitemporal Sentinel-2 Benchmark for Spatiotemporal Mining Footprint Analysis in the European Union (2015-2024)')" title="添加到收藏夹">☆ 收藏</button>
