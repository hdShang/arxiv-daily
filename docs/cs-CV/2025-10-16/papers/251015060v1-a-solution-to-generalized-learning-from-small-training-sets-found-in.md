...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15060v1" onclick="toggleFavorite(this, '2510.15060v1', 'A solution to generalized learning from small training sets found in everyday infant experiences')" title="添加到收藏夹">☆ 收藏</button>
