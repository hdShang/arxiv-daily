...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14904v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14904v2', 'MaskCaptioner: Learning to Jointly Segment and Caption Object Trajectories in Videos')" title="添加到收藏夹">☆ 收藏</button>
