...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14741v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14741v2', 'DEXTER: Diffusion-Guided EXplanations with TExtual Reasoning for Vision Models')" title="添加到收藏夹">☆ 收藏</button>
