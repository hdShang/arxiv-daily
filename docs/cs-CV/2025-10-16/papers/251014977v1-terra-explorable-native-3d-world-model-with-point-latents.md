...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14977v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14977v1', 'Terra: Explorable Native 3D World Model with Point Latents')" title="添加到收藏夹">☆ 收藏</button>
