...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15041v1" onclick="toggleFavorite(this, '2510.15041v1', 'Generalized Dynamics Generation towards Scannable Physical World Model')" title="添加到收藏夹">☆ 收藏</button>
