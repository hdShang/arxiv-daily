...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14836v1" onclick="toggleFavorite(this, '2510.14836v1', 'QDepth-VLA: Quantized Depth Prediction as Auxiliary Supervision for Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
