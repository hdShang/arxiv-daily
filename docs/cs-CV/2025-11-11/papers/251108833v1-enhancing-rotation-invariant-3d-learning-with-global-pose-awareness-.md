...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08833v1" onclick="toggleFavorite(this, '2511.08833v1', 'Enhancing Rotation-Invariant 3D Learning with Global Pose Awareness and Attention Mechanisms')" title="添加到收藏夹">☆ 收藏</button>
