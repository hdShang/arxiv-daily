...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08480v1" onclick="toggleFavorite(this, '2511.08480v1', 'Compression then Matching: An Efficient Pre-training Paradigm for Multimodal Embedding')" title="添加到收藏夹">☆ 收藏</button>
