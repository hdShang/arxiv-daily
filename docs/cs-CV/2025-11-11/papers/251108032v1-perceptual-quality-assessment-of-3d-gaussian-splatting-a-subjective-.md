...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08032v1" onclick="toggleFavorite(this, '2511.08032v1', 'Perceptual Quality Assessment of 3D Gaussian Splatting: A Subjective Dataset and Prediction Metric')" title="添加到收藏夹">☆ 收藏</button>
