...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07823v1" onclick="toggleFavorite(this, '2511.07823v1', 'CloudMamba: Grouped Selective State Spaces for Point Cloud Analysis')" title="添加到收藏夹">☆ 收藏</button>
