...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07819v1" onclick="toggleFavorite(this, '2511.07819v1', 'Human Motion Synthesis in 3D Scenes via Unified Scene Semantic Occupancy')" title="添加到收藏夹">☆ 收藏</button>
