...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07710v3" onclick="toggleFavorite(this, '2511.07710v3', 'Cross Modal Fine-Grained Alignment via Granularity-Aware and Region-Uncertain Modeling')" title="添加到收藏夹">☆ 收藏</button>
