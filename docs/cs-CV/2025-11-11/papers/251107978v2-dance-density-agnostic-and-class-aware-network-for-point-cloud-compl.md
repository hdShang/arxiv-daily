...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07978v2" onclick="toggleFavorite(this, '2511.07978v2', 'DANCE: Density-agnostic and Class-aware Network for Point Cloud Completion')" title="添加到收藏夹">☆ 收藏</button>
