...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08258v1" onclick="toggleFavorite(this, '2511.08258v1', 'Top2Ground: A Height-Aware Dual Conditioning Diffusion Model for Robust Aerial-to-Ground View Generation')" title="添加到收藏夹">☆ 收藏</button>
