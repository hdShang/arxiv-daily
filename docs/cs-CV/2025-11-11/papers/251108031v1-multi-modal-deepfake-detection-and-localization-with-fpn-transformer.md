...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08031v1" onclick="toggleFavorite(this, '2511.08031v1', 'Multi-modal Deepfake Detection and Localization with FPN-Transformer')" title="添加到收藏夹">☆ 收藏</button>
