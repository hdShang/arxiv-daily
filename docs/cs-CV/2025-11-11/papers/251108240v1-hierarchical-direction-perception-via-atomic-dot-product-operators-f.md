...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08240v1" onclick="toggleFavorite(this, '2511.08240v1', 'Hierarchical Direction Perception via Atomic Dot-Product Operators for Rotation-Invariant Point Clouds Learning')" title="添加到收藏夹">☆ 收藏</button>
