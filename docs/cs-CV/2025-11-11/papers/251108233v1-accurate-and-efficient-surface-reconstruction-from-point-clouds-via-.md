...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08233v1" onclick="toggleFavorite(this, '2511.08233v1', 'Accurate and Efficient Surface Reconstruction from Point Clouds via Geometry-Aware Local Adaptation')" title="添加到收藏夹">☆ 收藏</button>
