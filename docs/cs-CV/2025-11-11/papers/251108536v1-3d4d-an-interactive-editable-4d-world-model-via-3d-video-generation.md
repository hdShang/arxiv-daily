...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08536v1" onclick="toggleFavorite(this, '2511.08536v1', '3D4D: An Interactive, Editable, 4D World Model via 3D Video Generation')" title="添加到收藏夹">☆ 收藏</button>
