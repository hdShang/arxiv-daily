...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07808v2" onclick="toggleFavorite(this, '2511.07808v2', 'DI3CL: Contrastive Learning With Dynamic Instances and Contour Consistency for SAR Land-Cover Classification Foundation Model')" title="添加到收藏夹">☆ 收藏</button>
