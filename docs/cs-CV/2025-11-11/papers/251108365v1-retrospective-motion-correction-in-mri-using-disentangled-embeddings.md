...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08365v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08365v1', 'Retrospective motion correction in MRI using disentangled embeddings')" title="添加到收藏夹">☆ 收藏</button>
