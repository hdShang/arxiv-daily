...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08036v1" onclick="toggleFavorite(this, '2511.08036v1', 'WEDepth: Efficient Adaptation of World Knowledge for Monocular Depth Estimation')" title="添加到收藏夹">☆ 收藏</button>
