...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08294v2" onclick="toggleFavorite(this, '2511.08294v2', 'SkelSplat: Robust Multi-view 3D Human Pose Estimation with Differentiable Gaussian Rendering')" title="添加到收藏夹">☆ 收藏</button>
