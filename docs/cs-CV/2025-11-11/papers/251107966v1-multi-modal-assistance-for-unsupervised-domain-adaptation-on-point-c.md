...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07966v1" onclick="toggleFavorite(this, '2511.07966v1', 'Multi-Modal Assistance for Unsupervised Domain Adaptation on Point Cloud 3D Object Detection')" title="添加到收藏夹">☆ 收藏</button>
