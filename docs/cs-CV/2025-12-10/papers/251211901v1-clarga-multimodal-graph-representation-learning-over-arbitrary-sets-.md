...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11901v1" onclick="toggleFavorite(this, '2512.11901v1', 'CLARGA: Multimodal Graph Representation Learning over Arbitrary Sets of Modalities')" title="添加到收藏夹">☆ 收藏</button>
