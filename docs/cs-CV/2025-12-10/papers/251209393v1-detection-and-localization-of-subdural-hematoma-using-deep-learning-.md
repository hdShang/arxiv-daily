...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09393v1" onclick="toggleFavorite(this, '2512.09393v1', 'Detection and Localization of Subdural Hematoma Using Deep Learning on Computed Tomography')" title="添加到收藏夹">☆ 收藏</button>
