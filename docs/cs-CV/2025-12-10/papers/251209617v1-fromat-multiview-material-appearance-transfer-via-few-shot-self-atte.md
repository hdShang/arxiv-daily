...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09617v1" onclick="toggleFavorite(this, '2512.09617v1', 'FROMAT: Multiview Material Appearance Transfer via Few-Shot Self-Attention Adaptation')" title="添加到收藏夹">☆ 收藏</button>
