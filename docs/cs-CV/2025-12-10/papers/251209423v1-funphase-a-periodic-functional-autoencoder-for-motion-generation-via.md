...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09423v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.09423v1', 'FunPhase: A Periodic Functional Autoencoder for Motion Generation via Phase Manifolds')" title="添加到收藏夹">☆ 收藏</button>
