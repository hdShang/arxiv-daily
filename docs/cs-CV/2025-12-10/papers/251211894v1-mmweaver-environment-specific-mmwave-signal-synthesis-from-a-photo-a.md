...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11894v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11894v1', 'mmWEAVER: Environment-Specific mmWave Signal Synthesis from a Photo and Activity Description')" title="添加到收藏夹">☆ 收藏</button>
