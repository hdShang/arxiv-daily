...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09646v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.09646v1', 'VHOI: Controllable Video Generation of Human-Object Interactions from Sparse Trajectories via Motion Densification')" title="添加到收藏夹">☆ 收藏</button>
