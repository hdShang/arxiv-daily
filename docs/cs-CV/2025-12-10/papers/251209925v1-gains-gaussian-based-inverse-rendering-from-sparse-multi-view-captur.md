...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09925v1" onclick="toggleFavorite(this, '2512.09925v1', 'GAINS: Gaussian-based Inverse Rendering from Sparse Multi-View Captures')" title="添加到收藏夹">☆ 收藏</button>
