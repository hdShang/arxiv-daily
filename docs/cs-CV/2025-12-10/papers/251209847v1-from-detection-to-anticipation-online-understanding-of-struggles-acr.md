...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09847v1" onclick="toggleFavorite(this, '2512.09847v1', 'From Detection to Anticipation: Online Understanding of Struggles across Various Tasks and Activities')" title="添加到收藏夹">☆ 收藏</button>
