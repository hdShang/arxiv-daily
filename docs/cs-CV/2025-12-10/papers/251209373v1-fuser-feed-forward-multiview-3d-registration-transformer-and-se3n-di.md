...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09373v1" onclick="toggleFavorite(this, '2512.09373v1', 'FUSER: Feed-Forward MUltiview 3D Registration Transformer and SE(3)$^N$ Diffusion Refinement')" title="添加到收藏夹">☆ 收藏</button>
