...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15580v3" onclick="toggleFavorite(this, '2511.15580v3', 'CompTrack: Information Bottleneck-Guided Low-Rank Dynamic Token Compression for Point Cloud Tracking')" title="添加到收藏夹">☆ 收藏</button>
