...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15567v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15567v1', 'Computer-Use Agents as Judges for Generative User Interface')" title="添加到收藏夹">☆ 收藏</button>
