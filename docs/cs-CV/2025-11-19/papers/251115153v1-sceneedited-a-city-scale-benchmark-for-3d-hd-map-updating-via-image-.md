...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15153v1" onclick="toggleFavorite(this, '2511.15153v1', 'SceneEdited: A City-Scale Benchmark for 3D HD Map Updating via Image-Guided Change Detection')" title="添加到收藏夹">☆ 收藏</button>
