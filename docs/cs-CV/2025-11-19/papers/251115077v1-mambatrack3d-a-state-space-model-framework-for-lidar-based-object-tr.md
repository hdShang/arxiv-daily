...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15077v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15077v1', 'MambaTrack3D: A State Space Model Framework for LiDAR-Based Object Tracking under High Temporal Variation')" title="添加到收藏夹">☆ 收藏</button>
