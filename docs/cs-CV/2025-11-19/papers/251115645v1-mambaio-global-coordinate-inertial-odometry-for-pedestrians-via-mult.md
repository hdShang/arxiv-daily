...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15645v1" onclick="toggleFavorite(this, '2511.15645v1', 'MambaIO: Global-Coordinate Inertial Odometry for Pedestrians via Multi-Scale Frequency-Decoupled Modeling')" title="添加到收藏夹">☆ 收藏</button>
