...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15066v1" onclick="toggleFavorite(this, '2511.15066v1', 'BokehFlow: Depth-Free Controllable Bokeh Rendering via Flow Matching')" title="添加到收藏夹">☆ 收藏</button>
