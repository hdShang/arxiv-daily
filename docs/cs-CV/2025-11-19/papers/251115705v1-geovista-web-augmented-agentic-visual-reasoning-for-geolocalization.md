...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15705v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15705v1', 'GeoVista: Web-Augmented Agentic Visual Reasoning for Geolocalization')" title="添加到收藏夹">☆ 收藏</button>
