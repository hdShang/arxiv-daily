...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13390v1" onclick="toggleFavorite(this, '2510.13390v1', 'Generalizing WiFi Gesture Recognition via Large-Model-Aware Semantic Distillation and Alignment')" title="添加到收藏夹">☆ 收藏</button>
