...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13186v4" onclick="toggleFavorite(this, '2510.13186v4', 'STT-GS: Sample-Then-Transmit Edge Gaussian Splatting with Joint Client Selection and Power Control')" title="添加到收藏夹">☆ 收藏</button>
