...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13675v2" onclick="toggleFavorite(this, '2510.13675v2', 'Seeing and Knowing in the Wild: Open-domain Visual Entity Recognition with Large-scale Knowledge Graphs via Contrastive Learning')" title="添加到收藏夹">☆ 收藏</button>
