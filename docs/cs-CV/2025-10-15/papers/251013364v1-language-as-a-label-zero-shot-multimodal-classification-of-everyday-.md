...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13364v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13364v1', 'Language as a Label: Zero-Shot Multimodal Classification of Everyday Postures under Data Scarcity')" title="添加到收藏夹">☆ 收藏</button>
