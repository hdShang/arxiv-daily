...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13643v1" onclick="toggleFavorite(this, '2510.13643v1', 'Towards Adversarial Robustness and Uncertainty Quantification in DINOv2-based Few-Shot Anomaly Detection')" title="添加到收藏夹">☆ 收藏</button>
