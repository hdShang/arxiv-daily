...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13381v1" onclick="toggleFavorite(this, '2510.13381v1', 'Leveraging 2D Priors and SDF Guidance for Dynamic Urban Scene Rendering')" title="添加到收藏夹">☆ 收藏</button>
