...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13802v1" onclick="toggleFavorite(this, '2510.13802v1', 'Trace Anything: Representing Any Video in 4D via Trajectory Fields')" title="添加到收藏夹">☆ 收藏</button>
