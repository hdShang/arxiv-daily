...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13237v1" onclick="toggleFavorite(this, '2510.13237v1', 'Model-agnostic Adversarial Attack and Defense for Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
