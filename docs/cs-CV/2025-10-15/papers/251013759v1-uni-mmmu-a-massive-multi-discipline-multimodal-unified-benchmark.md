...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13759v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13759v1', 'Uni-MMMU: A Massive Multi-discipline Multimodal Unified Benchmark')" title="添加到收藏夹">☆ 收藏</button>
