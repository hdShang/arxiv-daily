...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13756v1" onclick="toggleFavorite(this, '2510.13756v1', 'RECODE: Reasoning Through Code Generation for Visual Question Answering')" title="添加到收藏夹">☆ 收藏</button>
