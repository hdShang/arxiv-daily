...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13310v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13310v1', 'InstantSfM: Fully Sparse and Parallel Structure-from-Motion')" title="添加到收藏夹">☆ 收藏</button>
