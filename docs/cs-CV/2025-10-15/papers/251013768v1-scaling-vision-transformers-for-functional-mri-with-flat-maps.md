...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13768v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13768v1', 'Scaling Vision Transformers for Functional MRI with Flat Maps')" title="添加到收藏夹">☆ 收藏</button>
