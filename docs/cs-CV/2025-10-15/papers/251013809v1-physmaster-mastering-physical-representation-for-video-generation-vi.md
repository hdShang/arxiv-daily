...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13809v1" onclick="toggleFavorite(this, '2510.13809v1', 'PhysMaster: Mastering Physical Representation for Video Generation via Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
