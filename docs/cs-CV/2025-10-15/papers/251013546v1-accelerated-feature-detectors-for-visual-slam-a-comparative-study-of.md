...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13546v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13546v1', 'Accelerated Feature Detectors for Visual SLAM: A Comparative Study of FPGA vs GPU')" title="添加到收藏夹">☆ 收藏</button>
