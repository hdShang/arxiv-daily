...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.13565" target="_blank" class="toolbar-btn">arXiv: 2510.13565v1</a>
    <a href="https://arxiv.org/pdf/2510.13565.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13565v1" 
            onclick="toggleFavorite(this, '2510.13565v1', 'XD-RCDepth: Lightweight Radar-Camera Depth Estimation with Explainability-Aligned and Distribution-Aware Distillation')" title="收藏">
      ☆ 收藏
    </button>
