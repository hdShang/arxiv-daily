...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13747v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13747v2', 'InteractiveOmni: A Unified Omni-modal Model for Audio-Visual Multi-turn Dialogue')" title="添加到收藏夹">☆ 收藏</button>
