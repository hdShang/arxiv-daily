...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13208v1" onclick="toggleFavorite(this, '2510.13208v1', 'MimicParts: Part-aware Style Injection for Speech-Driven 3D Motion Generation')" title="添加到收藏夹">☆ 收藏</button>
