...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13137v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13137v2', 'Real-Time Sign Language to text Translation using Deep Learning: A Comparative study of LSTM and 3D CNN')" title="添加到收藏夹">☆ 收藏</button>
