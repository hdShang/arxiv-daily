...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13702v1" onclick="toggleFavorite(this, '2510.13702v1', 'MVCustom: Multi-View Customized Diffusion via Geometric Latent Rendering and Completion')" title="添加到收藏夹">☆ 收藏</button>
