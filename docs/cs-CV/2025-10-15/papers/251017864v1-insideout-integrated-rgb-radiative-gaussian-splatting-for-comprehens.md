...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17864v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17864v1', 'InsideOut: Integrated RGB-Radiative Gaussian Splatting for Comprehensive 3D Object Representation')" title="添加到收藏夹">☆ 收藏</button>
