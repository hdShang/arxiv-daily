...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06245v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06245v1', 'Gait Recognition via Collaborating Discriminative and Generative Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
