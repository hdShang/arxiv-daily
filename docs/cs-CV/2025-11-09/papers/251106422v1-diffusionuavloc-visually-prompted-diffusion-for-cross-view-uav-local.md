...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06422v1" onclick="toggleFavorite(this, '2511.06422v1', 'DiffusionUavLoc: Visually Prompted Diffusion for Cross-View UAV Localization')" title="添加到收藏夹">☆ 收藏</button>
