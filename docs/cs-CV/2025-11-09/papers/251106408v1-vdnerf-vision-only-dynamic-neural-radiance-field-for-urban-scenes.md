...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06408v1" onclick="toggleFavorite(this, '2511.06408v1', 'VDNeRF: Vision-only Dynamic Neural Radiance Field for Urban Scenes')" title="添加到收藏夹">☆ 收藏</button>
