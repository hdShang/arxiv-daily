...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06261v2" onclick="toggleFavorite(this, '2511.06261v2', 'Robust Nearest Neighbour Retrieval Using Targeted Manifold Manipulation')" title="添加到收藏夹">☆ 收藏</button>
