...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06310v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06310v1', 'Adaptive 3D Reconstruction via Diffusion Priors and Forward Curvature-Matching Likelihood Updates')" title="添加到收藏夹">☆ 收藏</button>
