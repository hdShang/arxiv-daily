...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06299v3" onclick="toggleFavorite(this, '2511.06299v3', 'Physics-Informed Deformable Gaussian Splatting: Towards Unified Constitutive Laws for Time-Evolving Material Field')" title="添加到收藏夹">☆ 收藏</button>
