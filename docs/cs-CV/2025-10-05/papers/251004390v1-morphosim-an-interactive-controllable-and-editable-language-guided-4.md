...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04390v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04390v1', 'MorphoSim: An Interactive, Controllable, and Editable Language-guided 4D World Simulator')" title="添加到收藏夹">☆ 收藏</button>
