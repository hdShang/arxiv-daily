...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04039v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04039v1', '\textsc{GUI-Spotlight}: Adaptive Iterative Focus Refinement for Enhanced GUI Visual Grounding')" title="添加到收藏夹">☆ 收藏</button>
