...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04057v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04057v1', 'MetaFind: Scene-Aware 3D Asset Retrieval for Coherent Metaverse Scene Generation')" title="添加到收藏夹">☆ 收藏</button>
