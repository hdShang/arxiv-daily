...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04145v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04145v1', 'Automating construction safety inspections using a multi-modal vision-language RAG framework')" title="添加到收藏夹">☆ 收藏</button>
