...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2510.27047" class="toolbar-btn" target="_blank">📄 arXiv: 2510.27047v1</a>
  <a href="https://arxiv.org/pdf/2510.27047.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27047v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27047v1', 'AD-SAM: Fine-Tuning the Segment Anything Vision Foundation Model for Autonomous Driving Perception')" title="添加到收藏夹">☆ 收藏</button>
