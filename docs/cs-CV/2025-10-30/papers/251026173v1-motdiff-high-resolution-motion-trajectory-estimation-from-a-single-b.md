...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26173v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26173v1', 'MoTDiff: High-resolution Motion Trajectory estimation from a single blurred image using Diffusion models')" title="添加到收藏夹">☆ 收藏</button>
