...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.26173" target="_blank" class="toolbar-btn">arXiv: 2510.26173v1</a>
    <a href="https://arxiv.org/pdf/2510.26173.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26173v1" 
            onclick="toggleFavorite(this, '2510.26173v1', 'MoTDiff: High-resolution Motion Trajectory estimation from a single blurred image using Diffusion models')" title="收藏">
      ☆ 收藏
    </button>
