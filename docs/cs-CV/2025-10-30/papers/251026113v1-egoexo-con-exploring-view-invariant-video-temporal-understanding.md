...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26113v1" onclick="toggleFavorite(this, '2510.26113v1', 'EgoExo-Con: Exploring View-Invariant Video Temporal Understanding')" title="添加到收藏夹">☆ 收藏</button>
