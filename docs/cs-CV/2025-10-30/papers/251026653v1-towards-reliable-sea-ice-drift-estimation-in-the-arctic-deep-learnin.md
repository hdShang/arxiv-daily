...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26653v1" onclick="toggleFavorite(this, '2510.26653v1', 'Towards Reliable Sea Ice Drift Estimation in the Arctic Deep Learning Optical Flow on RADARSAT-2')" title="添加到收藏夹">☆ 收藏</button>
