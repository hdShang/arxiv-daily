...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26794v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26794v1', 'The Quest for Generalizable Motion Generation: Data, Model, and Evaluation')" title="添加到收藏夹">☆ 收藏</button>
