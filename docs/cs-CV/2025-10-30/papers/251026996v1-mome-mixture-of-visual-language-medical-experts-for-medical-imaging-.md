...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26996v1" onclick="toggleFavorite(this, '2510.26996v1', 'MoME: Mixture of Visual Language Medical Experts for Medical Imaging Segmentation')" title="添加到收藏夹">☆ 收藏</button>
