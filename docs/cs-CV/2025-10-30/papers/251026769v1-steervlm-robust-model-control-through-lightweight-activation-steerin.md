...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26769v1" onclick="toggleFavorite(this, '2510.26769v1', 'SteerVLM: Robust Model Control through Lightweight Activation Steering for Vision Language Models')" title="添加到收藏夹">☆ 收藏</button>
