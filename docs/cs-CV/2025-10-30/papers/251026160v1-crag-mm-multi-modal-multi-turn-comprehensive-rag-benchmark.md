...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26160v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26160v1', 'CRAG-MM: Multi-modal Multi-turn Comprehensive RAG Benchmark')" title="添加到收藏夹">☆ 收藏</button>
