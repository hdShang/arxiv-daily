...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26117v1" onclick="toggleFavorite(this, '2510.26117v1', 'JOGS: Joint Optimization of Pose Estimation and 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
