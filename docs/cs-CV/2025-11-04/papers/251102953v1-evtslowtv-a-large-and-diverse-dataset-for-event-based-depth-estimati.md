...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02953v1" onclick="toggleFavorite(this, '2511.02953v1', 'EvtSlowTV -- A Large and Diverse Dataset for Event-Based Depth Estimation')" title="添加到收藏夹">☆ 收藏</button>
