...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05575v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.05575v1', 'DiffSwap++: 3D Latent-Controlled Diffusion for Identity-Preserving Face Swapping')" title="添加到收藏夹">☆ 收藏</button>
