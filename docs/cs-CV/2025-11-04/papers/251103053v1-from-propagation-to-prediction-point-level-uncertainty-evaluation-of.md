...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03053v1" onclick="toggleFavorite(this, '2511.03053v1', 'From Propagation to Prediction: Point-level Uncertainty Evaluation of MLS Point Clouds under Limited Ground Truth')" title="添加到收藏夹">☆ 收藏</button>
