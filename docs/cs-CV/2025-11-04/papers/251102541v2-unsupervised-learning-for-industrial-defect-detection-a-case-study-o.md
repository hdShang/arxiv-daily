...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02541v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.02541v2', 'Unsupervised Learning for Industrial Defect Detection: A Case Study on Shearographic Data')" title="添加到收藏夹">☆ 收藏</button>
