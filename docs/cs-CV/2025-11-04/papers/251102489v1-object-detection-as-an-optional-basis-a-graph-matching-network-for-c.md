...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02489v1" onclick="toggleFavorite(this, '2511.02489v1', 'Object Detection as an Optional Basis: A Graph Matching Network for Cross-View UAV Localization')" title="添加到收藏夹">☆ 收藏</button>
