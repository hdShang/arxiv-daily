...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02510v1" onclick="toggleFavorite(this, '2511.02510v1', 'LiteVoxel: Low-memory Intelligent Thresholding for Efficient Voxel Rasterization')" title="添加到收藏夹">☆ 收藏</button>
