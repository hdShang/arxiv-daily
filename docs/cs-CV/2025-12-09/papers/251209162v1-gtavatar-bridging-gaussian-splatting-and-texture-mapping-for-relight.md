...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09162v1" onclick="toggleFavorite(this, '2512.09162v1', 'GTAvatar: Bridging Gaussian Splatting and Texture Mapping for Relightable and Editable Gaussian Avatars')" title="添加到收藏夹">☆ 收藏</button>
