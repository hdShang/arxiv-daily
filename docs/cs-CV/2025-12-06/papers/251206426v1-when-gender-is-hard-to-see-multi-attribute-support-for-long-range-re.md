...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06426v1" onclick="toggleFavorite(this, '2512.06426v1', 'When Gender is Hard to See: Multi-Attribute Support for Long-Range Recognition')" title="添加到收藏夹">☆ 收藏</button>
