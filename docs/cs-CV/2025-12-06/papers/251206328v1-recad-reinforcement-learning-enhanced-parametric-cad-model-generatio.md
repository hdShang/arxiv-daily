...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06328v1" onclick="toggleFavorite(this, '2512.06328v1', 'ReCAD: Reinforcement Learning Enhanced Parametric CAD Model Generation with Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
