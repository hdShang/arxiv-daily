...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06368v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06368v2', 'HuPrior3R: Incorporating Human Priors for Better 3D Dynamic Reconstruction from Monocular Videos')" title="添加到收藏夹">☆ 收藏</button>
