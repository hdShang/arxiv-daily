...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06565v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06565v1', 'GNC-Pose: Geometry-Aware GNC-PnP for Accurate 6D Pose Estimation')" title="添加到收藏夹">☆ 收藏</button>
