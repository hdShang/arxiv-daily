...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06373v1" onclick="toggleFavorite(this, '2512.06373v1', 'VG-Refiner: Towards Tool-Refined Referring Grounded Reasoning via Agentic Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
