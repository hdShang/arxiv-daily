...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11017v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11017v1', 'High-Resolution Spatiotemporal Modeling with Global-Local State Space Models for Video-Based Human Pose Estimation')" title="添加到收藏夹">☆ 收藏</button>
