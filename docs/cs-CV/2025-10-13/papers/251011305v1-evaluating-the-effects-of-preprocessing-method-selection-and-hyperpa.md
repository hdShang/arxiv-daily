...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2510.11305" class="toolbar-btn" target="_blank">📄 arXiv: 2510.11305v1</a>
  <a href="https://arxiv.org/pdf/2510.11305.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11305v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11305v1', 'Evaluating the effects of preprocessing, method selection, and hyperparameter tuning on SAR-based flood mapping and water depth estimation')" title="添加到收藏夹">☆ 收藏</button>
