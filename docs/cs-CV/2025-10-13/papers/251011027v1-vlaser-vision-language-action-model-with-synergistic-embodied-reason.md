...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11027v1" onclick="toggleFavorite(this, '2510.11027v1', 'Vlaser: Vision-Language-Action Model with Synergistic Embodied Reasoning')" title="添加到收藏夹">☆ 收藏</button>
