...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11718v1" onclick="toggleFavorite(this, '2510.11718v1', 'CodePlot-CoT: Mathematical Visual Reasoning by Thinking with Code-Driven Images')" title="添加到收藏夹">☆ 收藏</button>
