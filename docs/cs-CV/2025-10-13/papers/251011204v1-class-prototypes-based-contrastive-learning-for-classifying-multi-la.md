...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11204v1" onclick="toggleFavorite(this, '2510.11204v1', 'Class Prototypes based Contrastive Learning for Classifying Multi-Label and Fine-Grained Educational Videos')" title="添加到收藏夹">☆ 收藏</button>
