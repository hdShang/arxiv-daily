...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11649v1" onclick="toggleFavorite(this, '2510.11649v1', 'PhySIC: Physically Plausible 3D Human-Scene Interaction and Contact from a Single Image')" title="添加到收藏夹">☆ 收藏</button>
