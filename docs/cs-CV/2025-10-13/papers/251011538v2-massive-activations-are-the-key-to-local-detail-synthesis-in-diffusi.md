...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11538v2" onclick="toggleFavorite(this, '2510.11538v2', 'Massive Activations are the Key to Local Detail Synthesis in Diffusion Transformers')" title="添加到收藏夹">☆ 收藏</button>
