...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11565v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11565v1', 'SNAP: Towards Segmenting Anything in Any Point Cloud')" title="添加到收藏夹">☆ 收藏</button>
