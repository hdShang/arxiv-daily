...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11605v1" onclick="toggleFavorite(this, '2510.11605v1', 'ACE-G: Improving Generalization of Scene Coordinate Regression Through Query Pre-Training')" title="添加到收藏夹">☆ 收藏</button>
