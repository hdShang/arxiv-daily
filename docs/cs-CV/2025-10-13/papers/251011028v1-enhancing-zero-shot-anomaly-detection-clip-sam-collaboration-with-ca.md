...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11028v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11028v1', 'Enhancing Zero-Shot Anomaly Detection: CLIP-SAM Collaboration with Cascaded Prompts')" title="添加到收藏夹">☆ 收藏</button>
