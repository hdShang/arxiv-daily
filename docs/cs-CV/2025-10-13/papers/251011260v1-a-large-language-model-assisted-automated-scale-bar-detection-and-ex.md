...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11260v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11260v1', 'A Large-Language-Model Assisted Automated Scale Bar Detection and Extraction Framework for Scanning Electron Microscopic Images')" title="添加到收藏夹">☆ 收藏</button>
