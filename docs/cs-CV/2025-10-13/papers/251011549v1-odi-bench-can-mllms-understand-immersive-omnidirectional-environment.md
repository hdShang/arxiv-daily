...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11549v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11549v1', 'ODI-Bench: Can MLLMs Understand Immersive Omnidirectional Environments?')" title="添加到收藏夹">☆ 收藏</button>
