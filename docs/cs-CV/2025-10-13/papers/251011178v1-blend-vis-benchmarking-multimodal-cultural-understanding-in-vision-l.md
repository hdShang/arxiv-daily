...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11178v1" onclick="toggleFavorite(this, '2510.11178v1', 'BLEnD-Vis: Benchmarking Multimodal Cultural Understanding in Vision Language Models')" title="添加到收藏夹">☆ 收藏</button>
