...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11387v2" onclick="toggleFavorite(this, '2510.11387v2', 'MaterialRefGS: Reflective Gaussian Splatting with Multi-view Consistent Material Inference')" title="添加到收藏夹">☆ 收藏</button>
