...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11096v1" onclick="toggleFavorite(this, '2510.11096v1', 'CoDefend: Cross-Modal Collaborative Defense via Diffusion Purification and Prompt Optimization')" title="添加到收藏夹">☆ 收藏</button>
