...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11176v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11176v1', 'G2L:From Giga-Scale to Cancer-Specific Large-Scale Pathology Foundation Models via Knowledge Distillation')" title="添加到收藏夹">☆ 收藏</button>
