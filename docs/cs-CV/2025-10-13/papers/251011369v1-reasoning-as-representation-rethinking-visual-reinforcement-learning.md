...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11369v1" onclick="toggleFavorite(this, '2510.11369v1', 'Reasoning as Representation: Rethinking Visual Reinforcement Learning in Image Quality Assessment')" title="添加到收藏夹">☆ 收藏</button>
