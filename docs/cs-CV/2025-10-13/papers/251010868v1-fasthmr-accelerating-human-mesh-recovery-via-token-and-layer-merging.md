...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10868v1" onclick="toggleFavorite(this, '2510.10868v1', 'FastHMR: Accelerating Human Mesh Recovery via Token and Layer Merging with Diffusion Decoding')" title="添加到收藏夹">☆ 收藏</button>
