...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11631v1" onclick="toggleFavorite(this, '2510.11631v1', 'EvoCAD: Evolutionary CAD Code Generation with Vision Language Models')" title="添加到收藏夹">☆ 收藏</button>
