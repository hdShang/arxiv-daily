...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10933v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10933v1', 'DKPMV: Dense Keypoints Fusion from Multi-View RGB Frames for 6D Pose Estimation of Textureless Objects')" title="添加到收藏夹">☆ 收藏</button>
