...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11112v1" onclick="toggleFavorite(this, '2510.11112v1', 'Multimodal Disease Progression Modeling via Spatiotemporal Disentanglement and Multiscale Alignment')" title="添加到收藏夹">☆ 收藏</button>
