...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11473v2" onclick="toggleFavorite(this, '2510.11473v2', 'VA-GS: Enhancing the Geometric Representation of Gaussian Splatting via View Alignment')" title="添加到收藏夹">☆ 收藏</button>
