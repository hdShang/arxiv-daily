...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11496v2" onclick="toggleFavorite(this, '2510.11496v2', 'AndesVL Technical Report: An Efficient Mobile-side Multimodal Large Language Model')" title="添加到收藏夹">☆ 收藏</button>
