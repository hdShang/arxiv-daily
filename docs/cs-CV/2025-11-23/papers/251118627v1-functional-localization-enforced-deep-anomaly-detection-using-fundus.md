...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18627v1" onclick="toggleFavorite(this, '2511.18627v1', 'Functional Localization Enforced Deep Anomaly Detection Using Fundus Images')" title="添加到收藏夹">☆ 收藏</button>
