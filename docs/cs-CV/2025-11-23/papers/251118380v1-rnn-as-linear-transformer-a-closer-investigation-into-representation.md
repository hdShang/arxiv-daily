...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18380v1" onclick="toggleFavorite(this, '2511.18380v1', 'RNN as Linear Transformer: A Closer Investigation into Representational Potentials of Visual Mamba Models')" title="添加到收藏夹">☆ 收藏</button>
