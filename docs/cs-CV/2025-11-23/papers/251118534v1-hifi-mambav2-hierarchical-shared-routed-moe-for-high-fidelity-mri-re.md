...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18534v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.18534v1', 'HiFi-MambaV2: Hierarchical Shared-Routed MoE for High-Fidelity MRI Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
