...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18386v1" onclick="toggleFavorite(this, '2511.18386v1', 'SegSplat: Feed-forward Gaussian Splatting and Open-Set Semantic Segmentation')" title="添加到收藏夹">☆ 收藏</button>
