...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21051v1" onclick="toggleFavorite(this, '2511.21051v1', 'MUSE: Manipulating Unified Framework for Synthesizing Emotions in Images via Test-Time Optimization')" title="添加到收藏夹">☆ 收藏</button>
