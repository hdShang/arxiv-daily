...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21113v1" onclick="toggleFavorite(this, '2511.21113v1', 'FaithFusion: Harmonizing Reconstruction and Generation via Pixel-wise Information Gain')" title="添加到收藏夹">☆ 收藏</button>
