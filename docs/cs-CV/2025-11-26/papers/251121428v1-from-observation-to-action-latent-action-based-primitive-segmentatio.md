...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21428v1" onclick="toggleFavorite(this, '2511.21428v1', 'From Observation to Action: Latent Action-based Primitive Segmentation for VLA Pre-training in Industrial Settings')" title="添加到收藏夹">☆ 收藏</button>
