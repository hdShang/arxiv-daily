...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00086v1" onclick="toggleFavorite(this, '2512.00086v1', 'Multi-modal On-Device Learning for Monocular Depth Estimation on Ultra-low-power MCUs')" title="添加到收藏夹">☆ 收藏</button>
