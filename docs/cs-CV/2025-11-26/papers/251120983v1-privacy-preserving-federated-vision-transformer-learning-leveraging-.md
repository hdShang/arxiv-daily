...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20983v1" onclick="toggleFavorite(this, '2511.20983v1', 'Privacy-Preserving Federated Vision Transformer Learning Leveraging Lightweight Homomorphic Encryption in Medical AI')" title="添加到收藏夹">☆ 收藏</button>
