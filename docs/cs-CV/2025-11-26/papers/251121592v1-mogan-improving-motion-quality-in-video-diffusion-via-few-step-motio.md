...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21592v1" onclick="toggleFavorite(this, '2511.21592v1', 'MoGAN: Improving Motion Quality in Video Diffusion via Few-Step Motion Adversarial Post-Training')" title="添加到收藏夹">☆ 收藏</button>
