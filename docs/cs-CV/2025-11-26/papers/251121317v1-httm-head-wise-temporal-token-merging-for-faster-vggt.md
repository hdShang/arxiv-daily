...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21317v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.21317v1', 'HTTM: Head-wise Temporal Token Merging for Faster VGGT')" title="添加到收藏夹">☆ 收藏</button>
