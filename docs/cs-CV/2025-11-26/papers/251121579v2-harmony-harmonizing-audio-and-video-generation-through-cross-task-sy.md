...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21579v2" onclick="toggleFavorite(this, '2511.21579v2', 'Harmony: Harmonizing Audio and Video Generation through Cross-Task Synergy')" title="添加到收藏夹">☆ 收藏</button>
