...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21265v1" onclick="toggleFavorite(this, '2511.21265v1', 'Unlocking Zero-shot Potential of Semi-dense Image Matching via Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
