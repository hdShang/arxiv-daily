...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21490v1" onclick="toggleFavorite(this, '2511.21490v1', 'Merge and Bound: Direct Manipulations on Weights for Class Incremental Learning')" title="添加到收藏夹">☆ 收藏</button>
