...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21902v1" onclick="toggleFavorite(this, '2511.21902v1', 'PathReasoning: A multimodal reasoning agent for query-based ROI navigation on whole-slide images')" title="添加到收藏夹">☆ 收藏</button>
