...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06642v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06642v1', 'Masked Autoencoder Pretraining on Strong-Lensing Images for Joint Dark-Matter Model Classification and Super-Resolution')" title="添加到收藏夹">☆ 收藏</button>
