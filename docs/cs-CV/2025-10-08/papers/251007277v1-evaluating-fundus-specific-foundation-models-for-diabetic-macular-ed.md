...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07277v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07277v1', 'Evaluating Fundus-Specific Foundation Models for Diabetic Macular Edema Detection')" title="添加到收藏夹">☆ 收藏</button>
