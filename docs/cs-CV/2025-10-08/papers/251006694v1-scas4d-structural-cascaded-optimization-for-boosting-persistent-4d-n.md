...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06694v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06694v1', 'SCas4D: Structural Cascaded Optimization for Boosting Persistent 4D Novel View Synthesis')" title="添加到收藏夹">☆ 收藏</button>
