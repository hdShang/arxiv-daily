...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06743v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06743v1', 'Evaluating LLMs for Historical Document OCR: A Methodological Framework for Digital Humanities')" title="添加到收藏夹">☆ 收藏</button>
