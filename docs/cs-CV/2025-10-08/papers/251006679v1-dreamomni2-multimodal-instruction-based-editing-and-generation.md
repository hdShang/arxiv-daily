...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06679v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06679v1', 'DreamOmni2: Multimodal Instruction-based Editing and Generation')" title="添加到收藏夹">☆ 收藏</button>
