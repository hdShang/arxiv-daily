...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07313v1" onclick="toggleFavorite(this, '2510.07313v1', 'WristWorld: Generating Wrist-Views via 4D World Models for Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
