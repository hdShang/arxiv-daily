...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06638v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06638v2', 'Implicit-Knowledge Visual Question Answering with Structured Reasoning Traces')" title="添加到收藏夹">☆ 收藏</button>
