...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07316v2" onclick="toggleFavorite(this, '2510.07316v2', 'Pixel-Perfect Depth with Semantics-Prompted Diffusion Transformers')" title="添加到收藏夹">☆ 收藏</button>
