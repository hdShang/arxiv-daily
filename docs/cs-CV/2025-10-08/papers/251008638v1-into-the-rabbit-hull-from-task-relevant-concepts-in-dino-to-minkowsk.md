...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08638v1" onclick="toggleFavorite(this, '2510.08638v1', 'Into the Rabbit Hull: From Task-Relevant Concepts in DINO to Minkowski Geometry')" title="添加到收藏夹">☆ 收藏</button>
