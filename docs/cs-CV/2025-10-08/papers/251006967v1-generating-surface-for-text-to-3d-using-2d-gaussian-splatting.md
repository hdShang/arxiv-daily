...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06967v1" onclick="toggleFavorite(this, '2510.06967v1', 'Generating Surface for Text-to-3D using 2D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
