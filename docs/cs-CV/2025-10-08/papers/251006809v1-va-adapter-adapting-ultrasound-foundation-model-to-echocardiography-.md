...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06809v1" onclick="toggleFavorite(this, '2510.06809v1', 'VA-Adapter: Adapting Ultrasound Foundation Model to Echocardiography Probe Guidance')" title="添加到收藏夹">☆ 收藏</button>
