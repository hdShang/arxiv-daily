...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06746v1" onclick="toggleFavorite(this, '2510.06746v1', 'DeRainMamba: A Frequency-Aware State Space Model with Detail Enhancement for Image Deraining')" title="添加到收藏夹">☆ 收藏</button>
