...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08631v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08631v1', 'Out-of-Distribution Detection in LiDAR Semantic Segmentation Using Epistemic Uncertainty from Hierarchical GMMs')" title="添加到收藏夹">☆ 收藏</button>
