...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07119v2" onclick="toggleFavorite(this, '2510.07119v2', 'MoRe: Monocular Geometry Refinement via Graph Optimization for Cross-View Consistency')" title="添加到收藏夹">☆ 收藏</button>
