...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07143v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07143v1', 'Are We Using the Right Benchmark: An Evaluation Framework for Visual Token Compression Methods')" title="添加到收藏夹">☆ 收藏</button>
