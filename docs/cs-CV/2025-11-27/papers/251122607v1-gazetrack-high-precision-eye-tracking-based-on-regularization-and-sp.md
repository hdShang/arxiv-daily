...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22607v1" onclick="toggleFavorite(this, '2511.22607v1', 'GazeTrack: High-Precision Eye Tracking Based on Regularization and Spatial Computing')" title="添加到收藏夹">☆ 收藏</button>
