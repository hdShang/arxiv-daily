...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22521v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22521v1', 'DocVAL: Validated Chain-of-Thought Distillation for Grounded Document VQA')" title="添加到收藏夹">☆ 收藏</button>
