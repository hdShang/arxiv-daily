...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22327v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22327v1', 'Content Adaptive Encoding For Interactive Game Streaming')" title="添加到收藏夹">☆ 收藏</button>
