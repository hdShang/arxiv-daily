...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22488v1" onclick="toggleFavorite(this, '2511.22488v1', 'AI killed the video star. Audio-driven diffusion model for expressive talking head generation')" title="添加到收藏夹">☆ 收藏</button>
