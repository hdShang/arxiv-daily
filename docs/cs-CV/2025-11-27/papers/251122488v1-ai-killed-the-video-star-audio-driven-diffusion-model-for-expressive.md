...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.22488" class="toolbar-btn" target="_blank">📄 arXiv: 2511.22488v1</a>
  <a href="https://arxiv.org/pdf/2511.22488.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22488v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22488v1', 'AI killed the video star. Audio-driven diffusion model for expressive talking head generation')" title="添加到收藏夹">☆ 收藏</button>
