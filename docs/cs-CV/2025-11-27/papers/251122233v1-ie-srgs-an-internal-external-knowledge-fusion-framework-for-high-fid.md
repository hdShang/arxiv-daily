...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22233v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22233v1', 'IE-SRGS: An Internal-External Knowledge Fusion Framework for High-Fidelity 3D Gaussian Splatting Super-Resolution')" title="添加到收藏夹">☆ 收藏</button>
