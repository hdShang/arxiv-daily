...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22167v1" onclick="toggleFavorite(this, '2511.22167v1', 'IMTalker: Efficient Audio-driven Talking Face Generation with Implicit Motion Transfer')" title="添加到收藏夹">☆ 收藏</button>
