...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22704v1" onclick="toggleFavorite(this, '2511.22704v1', 'Splat-SAP: Feed-Forward Gaussian Splatting for Human-Centered Scene with Scale-Aware Point Map Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
