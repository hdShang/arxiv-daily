...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22134v1" onclick="toggleFavorite(this, '2511.22134v1', 'DualVLA: Building a Generalizable Embodied Agent via Partial Decoupling of Reasoning and Action')" title="添加到收藏夹">☆ 收藏</button>
