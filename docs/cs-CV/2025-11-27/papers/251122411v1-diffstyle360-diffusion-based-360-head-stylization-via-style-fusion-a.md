...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22411v1" onclick="toggleFavorite(this, '2511.22411v1', 'DiffStyle360: Diffusion-Based 360° Head Stylization via Style Fusion Attention')" title="添加到收藏夹">☆ 收藏</button>
