...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16301v2" onclick="toggleFavorite(this, '2511.16301v2', 'Upsample Anything: A Simple and Hard to Beat Baseline for Feature Upsampling')" title="添加到收藏夹">☆ 收藏</button>
