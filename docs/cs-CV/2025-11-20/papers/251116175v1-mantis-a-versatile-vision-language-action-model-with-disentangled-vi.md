...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16175v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16175v1', 'Mantis: A Versatile Vision-Language-Action Model with Disentangled Visual Foresight')" title="添加到收藏夹">☆ 收藏</button>
