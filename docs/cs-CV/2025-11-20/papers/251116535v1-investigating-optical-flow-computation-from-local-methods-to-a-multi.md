...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16535v1" onclick="toggleFavorite(this, '2511.16535v1', 'Investigating Optical Flow Computation: From Local Methods to a Multiresolution Horn-Schunck Implementation with Bilinear Interpolation')" title="添加到收藏夹">☆ 收藏</button>
