...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16650v1" onclick="toggleFavorite(this, '2511.16650v1', 'Late-decoupled 3D Hierarchical Semantic Segmentation with Semantic Prototype Discrimination based Bi-branch Supervision')" title="添加到收藏夹">☆ 收藏</button>
