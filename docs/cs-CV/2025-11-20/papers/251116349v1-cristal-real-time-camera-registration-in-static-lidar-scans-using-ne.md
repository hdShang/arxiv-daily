...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16349v1" onclick="toggleFavorite(this, '2511.16349v1', 'CRISTAL: Real-time Camera Registration in Static LiDAR Scans using Neural Rendering')" title="添加到收藏夹">☆ 收藏</button>
