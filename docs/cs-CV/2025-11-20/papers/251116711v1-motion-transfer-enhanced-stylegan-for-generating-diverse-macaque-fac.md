...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16711v1" onclick="toggleFavorite(this, '2511.16711v1', 'Motion Transfer-Enhanced StyleGAN for Generating Diverse Macaque Facial Expressions')" title="添加到收藏夹">☆ 收藏</button>
