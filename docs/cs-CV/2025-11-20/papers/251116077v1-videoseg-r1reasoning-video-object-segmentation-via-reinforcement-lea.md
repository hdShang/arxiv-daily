...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16077v1" onclick="toggleFavorite(this, '2511.16077v1', 'VideoSeg-R1:Reasoning Video Object Segmentation via Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
