...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16221v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16221v1', 'Can MLLMs Read the Room? A Multimodal Benchmark for Assessing Deception in Multi-Party Social Interactions')" title="添加到收藏夹">☆ 收藏</button>
