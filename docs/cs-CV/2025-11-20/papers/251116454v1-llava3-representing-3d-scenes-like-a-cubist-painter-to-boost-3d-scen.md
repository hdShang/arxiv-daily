...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16454v1" onclick="toggleFavorite(this, '2511.16454v1', 'LLaVA$^3$: Representing 3D Scenes like a Cubist Painter to Boost 3D Scene Understanding of VLMs')" title="添加到收藏夹">☆ 收藏</button>
