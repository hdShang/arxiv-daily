...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16428v1" onclick="toggleFavorite(this, '2511.16428v1', 'CylinderDepth: Cylindrical Spatial Attention for Multi-View Consistent Self-Supervised Surround Depth Estimation')" title="添加到收藏夹">☆ 收藏</button>
