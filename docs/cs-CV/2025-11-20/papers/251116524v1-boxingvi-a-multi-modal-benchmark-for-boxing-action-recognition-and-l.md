...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16524v1" onclick="toggleFavorite(this, '2511.16524v1', 'BoxingVI: A Multi-Modal Benchmark for Boxing Action Recognition and Localization')" title="添加到收藏夹">☆ 收藏</button>
