...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16203v3" onclick="toggleFavorite(this, '2511.16203v3', 'When Alignment Fails: Multimodal Adversarial Attacks on Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
