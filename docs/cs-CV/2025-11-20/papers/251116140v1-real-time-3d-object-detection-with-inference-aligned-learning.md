...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16140v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16140v1', 'Real-Time 3D Object Detection with Inference-Aligned Learning')" title="添加到收藏夹">☆ 收藏</button>
