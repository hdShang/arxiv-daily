...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16542v1" onclick="toggleFavorite(this, '2511.16542v1', 'EOGS++: Earth Observation Gaussian Splatting with Internal Camera Refinement and Direct Panchromatic Rendering')" title="添加到收藏夹">☆ 收藏</button>
