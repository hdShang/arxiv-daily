...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01502v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01502v1', 'Discriminately Treating Motion Components Evolves Joint Depth and Ego-Motion Learning')" title="添加到收藏夹">☆ 收藏</button>
