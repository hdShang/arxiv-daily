...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05553v1" onclick="toggleFavorite(this, '2511.05553v1', 'EVLP:Learning Unified Embodied Vision-Language Planner with Reinforced Supervised Fine-Tuning')" title="添加到收藏夹">☆ 收藏</button>
