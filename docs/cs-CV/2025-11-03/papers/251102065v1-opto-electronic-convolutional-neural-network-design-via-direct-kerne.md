...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02065v1" onclick="toggleFavorite(this, '2511.02065v1', 'Opto-Electronic Convolutional Neural Network Design Via Direct Kernel Optimization')" title="添加到收藏夹">☆ 收藏</button>
