...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01399v1" onclick="toggleFavorite(this, '2511.01399v1', 'Semantic BIM enrichment for firefighting assets: Fire-ART dataset and panoramic image-based 3D reconstruction')" title="添加到收藏夹">☆ 收藏</button>
