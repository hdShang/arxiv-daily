...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01571v1" onclick="toggleFavorite(this, '2511.01571v1', 'PixelVLA: Advancing Pixel-level Understanding in Vision-Language-Action Model')" title="添加到收藏夹">☆ 收藏</button>
