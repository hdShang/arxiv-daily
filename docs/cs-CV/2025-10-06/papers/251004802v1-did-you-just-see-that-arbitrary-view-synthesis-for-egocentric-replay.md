...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.04802" target="_blank" class="toolbar-btn">arXiv: 2510.04802v1</a>
    <a href="https://arxiv.org/pdf/2510.04802.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04802v1" 
            onclick="toggleFavorite(this, '2510.04802v1', 'Did you just see that? Arbitrary view synthesis for egocentric replay of operating room workflows from ambient sensors')" title="收藏">
      ☆ 收藏
    </button>
