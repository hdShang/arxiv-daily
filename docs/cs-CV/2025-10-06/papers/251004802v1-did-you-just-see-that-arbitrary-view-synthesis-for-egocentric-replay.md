...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04802v1" onclick="toggleFavorite(this, '2510.04802v1', 'Did you just see that? Arbitrary view synthesis for egocentric replay of operating room workflows from ambient sensors')" title="添加到收藏夹">☆ 收藏</button>
