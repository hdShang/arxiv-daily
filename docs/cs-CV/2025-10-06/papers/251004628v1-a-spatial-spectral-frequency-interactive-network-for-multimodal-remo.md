...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04628v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04628v1', 'A Spatial-Spectral-Frequency Interactive Network for Multimodal Remote Sensing Classification')" title="添加到收藏夹">☆ 收藏</button>
