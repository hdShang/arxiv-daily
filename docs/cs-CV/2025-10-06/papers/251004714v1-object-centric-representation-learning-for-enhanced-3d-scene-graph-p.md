...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04714v1" onclick="toggleFavorite(this, '2510.04714v1', 'Object-Centric Representation Learning for Enhanced 3D Scene Graph Prediction')" title="添加到收藏夹">☆ 收藏</button>
