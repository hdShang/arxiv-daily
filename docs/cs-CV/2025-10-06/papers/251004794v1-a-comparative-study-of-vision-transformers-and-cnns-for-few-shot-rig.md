...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04794v1" onclick="toggleFavorite(this, '2510.04794v1', 'A Comparative Study of Vision Transformers and CNNs for Few-Shot Rigid Transformation and Fundamental Matrix Estimation')" title="添加到收藏夹">☆ 收藏</button>
