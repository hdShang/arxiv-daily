...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04477v1" onclick="toggleFavorite(this, '2510.04477v1', 'MedCLM: Learning to Localize and Reason via a CoT-Curriculum in Medical Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
