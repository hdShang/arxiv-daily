...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04723v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04723v1', 'Benchmark on Monocular Metric Depth Estimation in Wildlife Setting')" title="添加到收藏夹">☆ 收藏</button>
