...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04648v1" onclick="toggleFavorite(this, '2510.04648v1', 'EduPersona: Benchmarking Subjective Ability Boundaries of Virtual Student Agents')" title="添加到收藏夹">☆ 收藏</button>
