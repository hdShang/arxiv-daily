...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05034v6" onclick="toggleFavorite(this, '2510.05034v6', 'Video-LMM Post-Training: A Deep Dive into Video Reasoning with Large Multimodal Models')" title="添加到收藏夹">☆ 收藏</button>
