...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04854v1" onclick="toggleFavorite(this, '2510.04854v1', 'Read the Room: Inferring Social Context Through Dyadic Interaction Recognition in Cyber-physical-social Infrastructure Systems')" title="添加到收藏夹">☆ 收藏</button>
