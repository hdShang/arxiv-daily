...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08096v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08096v1', 'Efficient Label Refinement for Face Parsing Under Extreme Poses Using 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
