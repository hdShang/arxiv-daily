...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08555v1" onclick="toggleFavorite(this, '2510.08555v1', 'VideoCanvas: Unified Video Completion from Arbitrary Spatiotemporal Patches via In-Context Conditioning')" title="添加到收藏夹">☆ 收藏</button>
