...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08673v1" onclick="toggleFavorite(this, '2510.08673v1', 'Thinking with Camera: A Unified Multimodal Model for Camera-Centric Understanding and Generation')" title="添加到收藏夹">☆ 收藏</button>
