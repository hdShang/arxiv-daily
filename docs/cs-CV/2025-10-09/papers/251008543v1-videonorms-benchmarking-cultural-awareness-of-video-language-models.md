...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08543v1" onclick="toggleFavorite(this, '2510.08543v1', 'VideoNorms: Benchmarking Cultural Awareness of Video Language Models')" title="添加到收藏夹">☆ 收藏</button>
