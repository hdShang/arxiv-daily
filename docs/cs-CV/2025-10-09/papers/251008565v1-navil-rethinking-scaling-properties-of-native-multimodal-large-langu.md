...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08565v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08565v1', 'NaViL: Rethinking Scaling Properties of Native Multimodal Large Language Models under Data Constraints')" title="添加到收藏夹">☆ 收藏</button>
