...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.07810" target="_blank" class="toolbar-btn">arXiv: 2510.07810v3</a>
    <a href="https://arxiv.org/pdf/2510.07810.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07810v3" 
            onclick="toggleFavorite(this, '2510.07810v3', 'FMANet: A Novel Dual-Phase Optical Flow Approach with Fusion Motion Attention Network for Robust Micro-expression Recognition')" title="收藏">
      ☆ 收藏
    </button>
