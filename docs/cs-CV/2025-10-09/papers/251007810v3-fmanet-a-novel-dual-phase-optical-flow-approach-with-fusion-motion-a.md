...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07810v3" onclick="toggleFavorite(this, '2510.07810v3', 'FMANet: A Novel Dual-Phase Optical Flow Approach with Fusion Motion Attention Network for Robust Micro-expression Recognition')" title="添加到收藏夹">☆ 收藏</button>
