...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08482v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08482v2', 'The Visual Iconicity Challenge: Evaluating Vision-Language Models on Sign Language Form-Meaning Mapping')" title="添加到收藏夹">☆ 收藏</button>
