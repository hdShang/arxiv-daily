...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2510.08157" class="toolbar-btn" target="_blank">📄 arXiv: 2510.08157v1</a>
  <a href="https://arxiv.org/pdf/2510.08157.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08157v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08157v1', 'Beyond Textual CoT: Interleaved Text-Image Chains with Deep Confidence Reasoning for Image Editing')" title="添加到收藏夹">☆ 收藏</button>
