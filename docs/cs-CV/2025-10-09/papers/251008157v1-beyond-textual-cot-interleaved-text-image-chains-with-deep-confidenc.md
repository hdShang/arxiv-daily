...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08157v1" onclick="toggleFavorite(this, '2510.08157v1', 'Beyond Textual CoT: Interleaved Text-Image Chains with Deep Confidence Reasoning for Image Editing')" title="添加到收藏夹">☆ 收藏</button>
