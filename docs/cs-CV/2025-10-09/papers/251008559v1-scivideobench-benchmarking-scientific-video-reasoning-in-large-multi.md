...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08559v1" onclick="toggleFavorite(this, '2510.08559v1', 'SciVideoBench: Benchmarking Scientific Video Reasoning in Large Multimodal Models')" title="添加到收藏夹">☆ 收藏</button>
