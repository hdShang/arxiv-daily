...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07953v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07953v1', 'SimCast: Enhancing Precipitation Nowcasting with Short-to-Long Term Knowledge Distillation')" title="添加到收藏夹">☆ 收藏</button>
