...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08260v1" onclick="toggleFavorite(this, '2510.08260v1', 'Fine-grained text-driven dual-human motion generation via dynamic hierarchical interaction')" title="添加到收藏夹">☆ 收藏</button>
