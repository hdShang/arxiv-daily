...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08759v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08759v1', 'BEAR: Benchmarking and Enhancing Multimodal Language Models for Atomic Embodied Capabilities')" title="添加到收藏夹">☆ 收藏</button>
