...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08849v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08849v1', 'FOLK: Fast Open-Vocabulary 3D Instance Segmentation via Label-guided Knowledge Distillation')" title="添加到收藏夹">☆ 收藏</button>
