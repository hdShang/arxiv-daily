...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.08849" target="_blank" class="toolbar-btn">arXiv: 2510.08849v1</a>
    <a href="https://arxiv.org/pdf/2510.08849.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08849v1" 
            onclick="toggleFavorite(this, '2510.08849v1', 'FOLK: Fast Open-Vocabulary 3D Instance Segmentation via Label-guided Knowledge Distillation')" title="收藏">
      ☆ 收藏
    </button>
