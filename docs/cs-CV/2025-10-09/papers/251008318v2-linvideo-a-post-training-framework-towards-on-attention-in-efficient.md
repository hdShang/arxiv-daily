...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08318v2" onclick="toggleFavorite(this, '2510.08318v2', 'LinVideo: A Post-Training Framework towards O(n) Attention in Efficient Video Generation')" title="添加到收藏夹">☆ 收藏</button>
