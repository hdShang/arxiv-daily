...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08138v1" onclick="toggleFavorite(this, '2510.08138v1', 'Improving Temporal Understanding Logic Consistency in Video-Language Models via Attention Enhancement')" title="添加到收藏夹">☆ 收藏</button>
