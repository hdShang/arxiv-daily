...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08551v1" onclick="toggleFavorite(this, '2510.08551v1', 'ARTDECO: Towards Efficient and High-Fidelity On-the-Fly 3D Reconstruction with Structured Scene Representation')" title="添加到收藏夹">☆ 收藏</button>
