...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08485v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08485v1', 'InstructX: Towards Unified Visual Editing with MLLM Guidance')" title="添加到收藏夹">☆ 收藏</button>
