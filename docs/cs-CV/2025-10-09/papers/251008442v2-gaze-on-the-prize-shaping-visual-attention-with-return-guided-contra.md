...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08442v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08442v2', 'Gaze on the Prize: Shaping Visual Attention with Return-Guided Contrastive Learning')" title="添加到收藏夹">☆ 收藏</button>
