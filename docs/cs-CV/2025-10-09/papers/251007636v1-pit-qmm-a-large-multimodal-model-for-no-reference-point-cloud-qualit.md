...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07636v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07636v1', 'PIT-QMM: A Large Multimodal Model For No-Reference Point Cloud Quality Assessment')" title="添加到收藏夹">☆ 收藏</button>
