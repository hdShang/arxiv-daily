...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08553v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08553v1', 'Dream to Recall: Imagination-Guided Experience Retrieval for Memory-Persistent Vision-and-Language Navigation')" title="添加到收藏夹">☆ 收藏</button>
