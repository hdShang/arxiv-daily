...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12304v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12304v1', 'LiDAR-GS++:Improving LiDAR Gaussian Reconstruction via Diffusion Priors')" title="添加到收藏夹">☆ 收藏</button>
