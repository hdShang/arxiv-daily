...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12054v1" onclick="toggleFavorite(this, '2511.12054v1', 'UniABG: Unified Adversarial View Bridging and Graph Correspondence for Unsupervised Cross-View Geo-Localization')" title="添加到收藏夹">☆ 收藏</button>
