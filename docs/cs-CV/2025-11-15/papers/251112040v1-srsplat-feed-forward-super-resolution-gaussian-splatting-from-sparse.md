...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12040v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12040v1', 'SRSplat: Feed-Forward Super-Resolution Gaussian Splatting from Sparse Multi-View Images')" title="添加到收藏夹">☆ 收藏</button>
