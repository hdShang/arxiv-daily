...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12365v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12365v1', 'Constructing and Interpreting Digital Twin Representations for Visual Reasoning via Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
