...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12061v1" onclick="toggleFavorite(this, '2511.12061v1', 'MovSemCL: Movement-Semantics Contrastive Learning for Trajectory Similarity')" title="添加到收藏夹">☆ 收藏</button>
