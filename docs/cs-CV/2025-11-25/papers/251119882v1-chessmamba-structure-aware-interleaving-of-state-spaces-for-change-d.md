...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19882v1" onclick="toggleFavorite(this, '2511.19882v1', 'ChessMamba: Structure-Aware Interleaving of State Spaces for Change Detection in Remote Sensing Images')" title="添加到收藏夹">☆ 收藏</button>
