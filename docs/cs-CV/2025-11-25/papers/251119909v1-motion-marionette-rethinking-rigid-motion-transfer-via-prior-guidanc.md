...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19909v1" onclick="toggleFavorite(this, '2511.19909v1', 'Motion Marionette: Rethinking Rigid Motion Transfer via Prior Guidance')" title="添加到收藏夹">☆ 收藏</button>
