...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20157v3" onclick="toggleFavorite(this, '2511.20157v3', 'SKEL-CF: Coarse-to-Fine Biomechanical Skeleton and Surface Mesh Recovery')" title="添加到收藏夹">☆ 收藏</button>
