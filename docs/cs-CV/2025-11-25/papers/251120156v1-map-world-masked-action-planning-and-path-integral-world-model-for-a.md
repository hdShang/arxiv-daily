...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20156v1" onclick="toggleFavorite(this, '2511.20156v1', 'Map-World: Masked Action planning and Path-Integral World Model for Autonomous Driving')" title="添加到收藏夹">☆ 收藏</button>
