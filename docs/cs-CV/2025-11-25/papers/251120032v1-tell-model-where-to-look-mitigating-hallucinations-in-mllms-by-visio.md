...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20032v1" onclick="toggleFavorite(this, '2511.20032v1', 'Tell Model Where to Look: Mitigating Hallucinations in MLLMs by Vision-Guided Attention')" title="添加到收藏夹">☆ 收藏</button>
