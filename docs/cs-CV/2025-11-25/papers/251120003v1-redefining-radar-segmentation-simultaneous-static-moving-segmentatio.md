...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20003v1" onclick="toggleFavorite(this, '2511.20003v1', 'Redefining Radar Segmentation: Simultaneous Static-Moving Segmentation and Ego-Motion Estimation using Radar Point Clouds')" title="添加到收藏夹">☆ 收藏</button>
