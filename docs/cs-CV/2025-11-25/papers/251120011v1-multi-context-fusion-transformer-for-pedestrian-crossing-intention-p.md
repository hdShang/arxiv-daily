...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20011v1" onclick="toggleFavorite(this, '2511.20011v1', 'Multi-Context Fusion Transformer for Pedestrian Crossing Intention Prediction in Urban Environments')" title="添加到收藏夹">☆ 收藏</button>
