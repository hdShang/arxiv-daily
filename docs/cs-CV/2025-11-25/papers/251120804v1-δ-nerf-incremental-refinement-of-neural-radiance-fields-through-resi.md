...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20804v1" onclick="toggleFavorite(this, '2511.20804v1', '$Δ$-NeRF: Incremental Refinement of Neural Radiance Fields through Residual Control and Knowledge Transfer')" title="添加到收藏夹">☆ 收藏</button>
