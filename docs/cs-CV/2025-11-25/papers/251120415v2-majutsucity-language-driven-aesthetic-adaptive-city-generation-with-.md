...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20415v2" onclick="toggleFavorite(this, '2511.20415v2', 'MajutsuCity: Language-driven Aesthetic-adaptive City Generation with Controllable 3D Assets and Layouts')" title="添加到收藏夹">☆ 收藏</button>
