...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20620v1" onclick="toggleFavorite(this, '2511.20620v1', 'Wanderland: Geometrically Grounded Simulation for Open-World Embodied AI')" title="添加到收藏夹">☆ 收藏</button>
