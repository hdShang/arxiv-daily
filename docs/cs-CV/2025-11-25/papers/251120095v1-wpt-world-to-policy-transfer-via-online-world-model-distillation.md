...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20095v1" onclick="toggleFavorite(this, '2511.20095v1', 'WPT: World-to-Policy Transfer via Online World Model Distillation')" title="添加到收藏夹">☆ 收藏</button>
