...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20366v2" onclick="toggleFavorite(this, '2511.20366v2', 'VGGTFace: Topologically Consistent Facial Geometry Reconstruction in the Wild')" title="添加到收藏夹">☆ 收藏</button>
