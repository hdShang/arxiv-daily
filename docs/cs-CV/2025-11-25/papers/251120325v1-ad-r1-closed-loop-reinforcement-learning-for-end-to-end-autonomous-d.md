...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20325v1" onclick="toggleFavorite(this, '2511.20325v1', 'AD-R1: Closed-Loop Reinforcement Learning for End-to-End Autonomous Driving with Impartial World Models')" title="添加到收藏夹">☆ 收藏</button>
