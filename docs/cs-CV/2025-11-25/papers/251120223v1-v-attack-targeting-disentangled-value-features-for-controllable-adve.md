...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20223v1" onclick="toggleFavorite(this, '2511.20223v1', 'V-Attack: Targeting Disentangled Value Features for Controllable Adversarial Attacks on LVLMs')" title="添加到收藏夹">☆ 收藏</button>
