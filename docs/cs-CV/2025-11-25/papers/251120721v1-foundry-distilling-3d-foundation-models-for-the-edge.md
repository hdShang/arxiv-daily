...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20721v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20721v1', 'Foundry: Distilling 3D Foundation Models for the Edge')" title="添加到收藏夹">☆ 收藏</button>
