...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19827v1" onclick="toggleFavorite(this, '2511.19827v1', 'ReDirector: Creating Any-Length Video Retakes with Rotary Camera Encoding')" title="添加到收藏夹">☆ 收藏</button>
