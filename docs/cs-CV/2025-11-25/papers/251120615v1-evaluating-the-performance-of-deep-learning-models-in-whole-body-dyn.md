...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.20615" class="toolbar-btn" target="_blank">📄 arXiv: 2511.20615v1</a>
  <a href="https://arxiv.org/pdf/2511.20615.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20615v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20615v1', 'Evaluating the Performance of Deep Learning Models in Whole-body Dynamic 3D Posture Prediction During Load-reaching Activities')" title="添加到收藏夹">☆ 收藏</button>
