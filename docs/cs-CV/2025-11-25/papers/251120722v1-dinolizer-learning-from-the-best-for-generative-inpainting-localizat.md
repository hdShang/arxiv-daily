...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20722v1" onclick="toggleFavorite(this, '2511.20722v1', 'DinoLizer: Learning from the Best for Generative Inpainting Localization')" title="添加到收藏夹">☆ 收藏</button>
