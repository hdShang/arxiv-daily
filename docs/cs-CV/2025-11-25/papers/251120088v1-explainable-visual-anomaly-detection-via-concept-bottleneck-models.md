...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20088v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20088v1', 'Explainable Visual Anomaly Detection via Concept Bottleneck Models')" title="添加到收藏夹">☆ 收藏</button>
