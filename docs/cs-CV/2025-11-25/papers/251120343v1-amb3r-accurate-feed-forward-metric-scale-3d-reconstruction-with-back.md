...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20343v1" onclick="toggleFavorite(this, '2511.20343v1', 'AMB3R: Accurate Feed-forward Metric-scale 3D Reconstruction with Backend')" title="添加到收藏夹">☆ 收藏</button>
