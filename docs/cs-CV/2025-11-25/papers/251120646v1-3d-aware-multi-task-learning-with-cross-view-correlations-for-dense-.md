...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20646v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20646v1', '3D-Aware Multi-Task Learning with Cross-View Correlations for Dense Scene Understanding')" title="添加到收藏夹">☆ 收藏</button>
