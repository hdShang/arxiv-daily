...
<div class="paper-toolbar">
  ...
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09320v1" 
            onclick="toggleFavorite(this, '2510.09320v1', 'Hybrid-grained Feature Aggregation with Coarse-to-fine Language Guidance for Self-supervised Monocular Depth Estimation')" title="收藏">
      ☆ 收藏
    </button>
