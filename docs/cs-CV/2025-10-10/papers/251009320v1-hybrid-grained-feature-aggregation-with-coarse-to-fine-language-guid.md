...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09320v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09320v1', 'Hybrid-grained Feature Aggregation with Coarse-to-fine Language Guidance for Self-supervised Monocular Depth Estimation')" title="添加到收藏夹">☆ 收藏</button>
