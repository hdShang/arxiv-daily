...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09367v1" onclick="toggleFavorite(this, '2510.09367v1', 'Minkowski-MambaNet: A Point Cloud Framework with Selective State Space Models for Forest Biomass Quantification')" title="添加到收藏夹">☆ 收藏</button>
