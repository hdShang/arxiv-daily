...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08919v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08919v1', 'PHyCLIP: $\ell_1$-Product of Hyperbolic Factors Unifies Hierarchy and Compositionality in Vision-Language Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
