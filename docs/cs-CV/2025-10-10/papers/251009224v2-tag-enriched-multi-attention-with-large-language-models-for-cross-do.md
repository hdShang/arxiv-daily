...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09224v2" onclick="toggleFavorite(this, '2510.09224v2', 'Tag-Enriched Multi-Attention with Large Language Models for Cross-Domain Sequential Recommendation')" title="添加到收藏夹">☆ 收藏</button>
