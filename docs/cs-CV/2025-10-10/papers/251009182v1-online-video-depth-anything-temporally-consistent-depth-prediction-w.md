...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09182v1" onclick="toggleFavorite(this, '2510.09182v1', 'Online Video Depth Anything: Temporally-Consistent Depth Prediction with Low Memory Consumption')" title="添加到收藏夹">☆ 收藏</button>
