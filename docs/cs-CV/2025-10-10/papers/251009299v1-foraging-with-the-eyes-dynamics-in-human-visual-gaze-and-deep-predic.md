...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09299v1" onclick="toggleFavorite(this, '2510.09299v1', 'Foraging with the Eyes: Dynamics in Human Visual Gaze and Deep Predictive Modeling')" title="添加到收藏夹">☆ 收藏</button>
