...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09537v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09537v1', 'FLOWING: Implicit Neural Flows for Structure-Preserving Morphing')" title="添加到收藏夹">☆ 收藏</button>
