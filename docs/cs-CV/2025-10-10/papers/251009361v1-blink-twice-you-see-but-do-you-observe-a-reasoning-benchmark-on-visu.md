...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09361v1" onclick="toggleFavorite(this, '2510.09361v1', 'BLINK-Twice: You see, but do you observe? A Reasoning Benchmark on Visual Perception')" title="添加到收藏夹">☆ 收藏</button>
