...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09364v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09364v1', 'Visibility-Aware Densification for 3D Gaussian Splatting in Dynamic Urban Scenes')" title="添加到收藏夹">☆ 收藏</button>
