...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09903v1" onclick="toggleFavorite(this, '2510.09903v1', 'An uncertainty-aware framework for data-efficient multi-view animal pose estimation')" title="添加到收藏夹">☆ 收藏</button>
