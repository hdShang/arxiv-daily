...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09358v1" onclick="toggleFavorite(this, '2510.09358v1', 'Boosting Multi-modal Keyphrase Prediction with Dynamic Chain-of-Thought in Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
