...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08936v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08936v1', 'RO-Bench: Large-scale robustness evaluation of MLLMs with text-driven counterfactual videos')" title="添加到收藏夹">☆ 收藏</button>
