...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09121v2" onclick="toggleFavorite(this, '2510.09121v2', 'MSDM: Generating Task-Specific Pathology Images with a Multimodal Conditioned Diffusion Model for Cell and Nuclei Segmentation')" title="添加到收藏夹">☆ 收藏</button>
