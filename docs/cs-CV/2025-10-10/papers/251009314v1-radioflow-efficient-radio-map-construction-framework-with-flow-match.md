...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09314v1" onclick="toggleFavorite(this, '2510.09314v1', 'RadioFlow: Efficient Radio Map Construction Framework with Flow Matching')" title="添加到收藏夹">☆ 收藏</button>
