...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09008v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09008v1', 'On Epistemic Uncertainty of Visual Tokens for Object Hallucinations in Large Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
