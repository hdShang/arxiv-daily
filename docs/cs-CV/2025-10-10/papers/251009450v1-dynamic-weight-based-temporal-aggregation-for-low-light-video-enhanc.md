...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09450v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09450v1', 'Dynamic Weight-based Temporal Aggregation for Low-light Video Enhancement')" title="添加到收藏夹">☆ 收藏</button>
