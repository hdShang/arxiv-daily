...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09881v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09881v1', 'LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates')" title="添加到收藏夹">☆ 收藏</button>
