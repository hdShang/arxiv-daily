...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09269v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09269v1', 'Goal-oriented Backdoor Attack against Vision-Language-Action Models via Physical Objects')" title="添加到收藏夹">☆ 收藏</button>
