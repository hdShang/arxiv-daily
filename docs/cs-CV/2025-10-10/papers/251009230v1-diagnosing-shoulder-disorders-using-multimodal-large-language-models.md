...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09230v1" onclick="toggleFavorite(this, '2510.09230v1', 'Diagnosing Shoulder Disorders Using Multimodal Large Language Models and Consumer-Grade Cameras')" title="添加到收藏夹">☆ 收藏</button>
