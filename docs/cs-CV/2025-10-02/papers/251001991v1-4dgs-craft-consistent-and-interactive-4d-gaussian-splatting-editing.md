...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01991v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01991v1', '4DGS-Craft: Consistent and Interactive 4D Gaussian Splatting Editing')" title="添加到收藏夹">☆ 收藏</button>
