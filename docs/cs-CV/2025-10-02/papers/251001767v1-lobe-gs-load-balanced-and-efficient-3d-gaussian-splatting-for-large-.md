...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01767v1" onclick="toggleFavorite(this, '2510.01767v1', 'LOBE-GS: Load-Balanced and Efficient 3D Gaussian Splatting for Large-Scale Scene Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
