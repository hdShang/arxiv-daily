...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02240v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02240v1', 'RewardMap: Tackling Sparse Rewards in Fine-grained Visual Reasoning via Multi-Stage Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
