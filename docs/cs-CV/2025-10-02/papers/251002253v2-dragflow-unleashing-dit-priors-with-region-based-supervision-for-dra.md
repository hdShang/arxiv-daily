...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02253v2" onclick="toggleFavorite(this, '2510.02253v2', 'DragFlow: Unleashing DiT Priors with Region Based Supervision for Drag Editing')" title="添加到收藏夹">☆ 收藏</button>
