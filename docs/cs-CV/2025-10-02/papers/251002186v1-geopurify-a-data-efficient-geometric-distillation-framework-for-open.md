...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02186v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02186v1', 'GeoPurify: A Data-Efficient Geometric Distillation Framework for Open-Vocabulary 3D Segmentation')" title="添加到收藏夹">☆ 收藏</button>
