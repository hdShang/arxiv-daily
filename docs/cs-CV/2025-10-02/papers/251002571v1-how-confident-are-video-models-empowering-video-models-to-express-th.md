...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02571v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02571v1', 'How Confident are Video Models? Empowering Video Models to Express their Uncertainty')" title="添加到收藏夹">☆ 收藏</button>
