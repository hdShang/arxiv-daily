...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02284v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02284v2', 'Learning to Generate Rigid Body Interactions with Video Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
