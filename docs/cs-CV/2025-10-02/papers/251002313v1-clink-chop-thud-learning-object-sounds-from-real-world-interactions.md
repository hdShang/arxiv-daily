...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02313v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02313v1', 'Clink! Chop! Thud! -- Learning Object Sounds from Real-World Interactions')" title="添加到收藏夹">☆ 收藏</button>
