...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.06235" target="_blank" class="toolbar-btn">arXiv: 2510.06235v1</a>
    <a href="https://arxiv.org/pdf/2510.06235.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06235v1" 
            onclick="toggleFavorite(this, '2510.06235v1', 'Stacked Regression using Off-the-shelf, Stimulus-tuned and Fine-tuned Neural Networks for Predicting fMRI Brain Responses to Movies (Algonauts 2025 Report)')" title="收藏">
      ☆ 收藏
    </button>
