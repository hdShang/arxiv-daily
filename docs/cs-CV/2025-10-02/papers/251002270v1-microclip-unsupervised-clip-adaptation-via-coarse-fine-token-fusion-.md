...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02270v1" onclick="toggleFavorite(this, '2510.02270v1', 'microCLIP: Unsupervised CLIP Adaptation via Coarse-Fine Token Fusion for Fine-Grained Image Classification')" title="添加到收藏夹">☆ 收藏</button>
