...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02034v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02034v1', 'GaussianMorphing: Mesh-Guided 3D Gaussians for Semantic-Aware Object Morphing')" title="添加到收藏夹">☆ 收藏</button>
