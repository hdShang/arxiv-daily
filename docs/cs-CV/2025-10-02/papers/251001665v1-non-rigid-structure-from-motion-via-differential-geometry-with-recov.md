...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01665v1" onclick="toggleFavorite(this, '2510.01665v1', 'Non-Rigid Structure-from-Motion via Differential Geometry with Recoverable Conformal Scale')" title="添加到收藏夹">☆ 收藏</button>
