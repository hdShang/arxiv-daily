...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02314v1" onclick="toggleFavorite(this, '2510.02314v1', 'StealthAttack: Robust 3D Gaussian Splatting Poisoning via Density-Guided Illusions')" title="添加到收藏夹">☆ 收藏</button>
