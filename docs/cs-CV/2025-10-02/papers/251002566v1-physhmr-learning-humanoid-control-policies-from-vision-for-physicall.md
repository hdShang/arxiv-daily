...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02566v1" onclick="toggleFavorite(this, '2510.02566v1', 'PhysHMR: Learning Humanoid Control Policies from Vision for Physically Plausible Human Motion Reconstruction')" title="添加到收藏夹">☆ 收藏</button>
