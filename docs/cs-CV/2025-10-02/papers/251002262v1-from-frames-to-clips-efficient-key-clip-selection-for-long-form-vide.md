...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02262v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02262v1', 'From Frames to Clips: Efficient Key Clip Selection for Long-Form Video Understanding')" title="添加到收藏夹">☆ 收藏</button>
