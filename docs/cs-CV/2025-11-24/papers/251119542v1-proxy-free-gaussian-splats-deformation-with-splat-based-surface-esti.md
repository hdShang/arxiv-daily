...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19542v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19542v1', 'Proxy-Free Gaussian Splats Deformation with Splat-Based Surface Estimation')" title="添加到收藏夹">☆ 收藏</button>
