...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19235v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19235v1', 'IDSplat: Instance-Decomposed 3D Gaussian Splatting for Driving Scenes')" title="添加到收藏夹">☆ 收藏</button>
