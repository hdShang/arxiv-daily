...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19526v1" onclick="toggleFavorite(this, '2511.19526v1', 'Perceptual Taxonomy: Evaluating and Guiding Hierarchical Scene Reasoning in Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
