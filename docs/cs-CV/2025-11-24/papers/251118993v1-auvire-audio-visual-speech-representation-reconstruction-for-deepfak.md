...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18993v1" onclick="toggleFavorite(this, '2511.18993v1', 'AuViRe: Audio-visual Speech Representation Reconstruction for Deepfake Temporal Localization')" title="添加到收藏夹">☆ 收藏</button>
