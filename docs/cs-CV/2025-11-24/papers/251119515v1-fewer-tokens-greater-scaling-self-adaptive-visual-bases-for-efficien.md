...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19515v1" onclick="toggleFavorite(this, '2511.19515v1', 'Fewer Tokens, Greater Scaling: Self-Adaptive Visual Bases for Efficient and Expansive Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
