...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18766v1" onclick="toggleFavorite(this, '2511.18766v1', 'Unsupervised Multi-View Visual Anomaly Detection via Progressive Homography-Guided Alignment')" title="添加到收藏夹">☆ 收藏</button>
