...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19684v1" onclick="toggleFavorite(this, '2511.19684v1', 'IndEgo: A Dataset of Industrial Scenarios and Collaborative Work for Egocentric Assistants')" title="添加到收藏夹">☆ 收藏</button>
