...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19436v1" onclick="toggleFavorite(this, '2511.19436v1', 'VDC-Agent: When Video Detailed Captioners Evolve Themselves via Agentic Self-Reflection')" title="添加到收藏夹">☆ 收藏</button>
