...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18801v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.18801v1', 'PartDiffuser: Part-wise 3D Mesh Generation via Discrete Diffusion')" title="添加到收藏夹">☆ 收藏</button>
