...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05710v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05710v1', 'Manifold-Aware Point Cloud Completion via Geodesic-Attentive Hierarchical Feature Learning')" title="添加到收藏夹">☆ 收藏</button>
