...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06065v1" onclick="toggleFavorite(this, '2512.06065v1', 'EgoEdit: Dataset, Real-Time Streaming Model, and Benchmark for Egocentric Video Editing')" title="添加到收藏夹">☆ 收藏</button>
