...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06158v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06158v1', 'Tracking-Guided 4D Generation: Foundation-Tracker Motion Priors for 3D Model Animation')" title="添加到收藏夹">☆ 收藏</button>
