...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05354v1" onclick="toggleFavorite(this, '2512.05354v1', 'SplatPainter: Interactive Authoring of 3D Gaussians from 2D Edits via Test-Time Training')" title="添加到收藏夹">☆ 收藏</button>
