...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05446v1" onclick="toggleFavorite(this, '2512.05446v1', 'TED-4DGS: Temporally Activated and Embedding-based Deformation for 4DGS Compression')" title="添加到收藏夹">☆ 收藏</button>
