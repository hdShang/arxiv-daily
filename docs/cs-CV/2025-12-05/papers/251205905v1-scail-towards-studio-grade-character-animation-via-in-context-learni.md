...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05905v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05905v1', 'SCAIL: Towards Studio-Grade Character Animation via In-Context Learning of 3D-Consistent Pose Representations')" title="添加到收藏夹">☆ 收藏</button>
