...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06080v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06080v1', 'Shoot-Bounce-3D: Single-Shot Occlusion-Aware 3D from Lidar by Decomposing Two-Bounce Light')" title="添加到收藏夹">☆ 收藏</button>
