...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05610v1" onclick="toggleFavorite(this, '2512.05610v1', 'NormalView: sensor-agnostic tree species classification from backpack and aerial lidar data using geometric projections')" title="添加到收藏夹">☆ 收藏</button>
