...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05663v1" onclick="toggleFavorite(this, '2512.05663v1', 'LeAD-M3D: Leveraging Asymmetric Distillation for Real-time Monocular 3D Detection')" title="添加到收藏夹">☆ 收藏</button>
