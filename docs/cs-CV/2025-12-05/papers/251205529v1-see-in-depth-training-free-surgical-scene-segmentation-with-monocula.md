...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05529v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05529v1', 'See in Depth: Training-Free Surgical Scene Segmentation with Monocular Depth Priors')" title="添加到收藏夹">☆ 收藏</button>
