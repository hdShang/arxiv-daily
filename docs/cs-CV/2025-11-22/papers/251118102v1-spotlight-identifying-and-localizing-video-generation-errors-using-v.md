...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18102v1" onclick="toggleFavorite(this, '2511.18102v1', 'Spotlight: Identifying and Localizing Video Generation Errors Using VLMs')" title="添加到收藏夹">☆ 收藏</button>
