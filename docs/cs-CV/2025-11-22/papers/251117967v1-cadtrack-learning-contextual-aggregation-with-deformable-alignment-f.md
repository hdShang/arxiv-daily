...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17967v1" onclick="toggleFavorite(this, '2511.17967v1', 'CADTrack: Learning Contextual Aggregation with Deformable Alignment for Robust RGBT Tracking')" title="添加到收藏夹">☆ 收藏</button>
