...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17918v1" onclick="toggleFavorite(this, '2511.17918v1', 'Frequency-Adaptive Sharpness Regularization for Improving 3D Gaussian Splatting Generalization')" title="添加到收藏夹">☆ 收藏</button>
