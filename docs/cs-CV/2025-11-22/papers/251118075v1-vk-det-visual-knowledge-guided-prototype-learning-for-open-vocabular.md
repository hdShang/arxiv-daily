...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18075v1" onclick="toggleFavorite(this, '2511.18075v1', 'VK-Det: Visual Knowledge Guided Prototype Learning for Open-Vocabulary Aerial Object Detection')" title="添加到收藏夹">☆ 收藏</button>
