...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17927v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.17927v1', 'PA-FAS: Towards Interpretable and Generalizable Multimodal Face Anti-Spoofing via Path-Augmented Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
