...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18115v1" onclick="toggleFavorite(this, '2511.18115v1', 'Muskie: Multi-view Masked Image Modeling for 3D Vision Pre-training')" title="添加到收藏夹">☆ 收藏</button>
