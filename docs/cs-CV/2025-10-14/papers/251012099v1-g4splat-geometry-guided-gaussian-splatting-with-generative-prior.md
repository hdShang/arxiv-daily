...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.12099v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.12099v1', 'G4Splat: Geometry-Guided Gaussian Splatting with Generative Prior')" title="添加到收藏夹">☆ 收藏</button>
