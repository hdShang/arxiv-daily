...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.12089v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.12089v2', 'Playmate2: Training-Free Multi-Character Audio-Driven Animation via Diffusion Transformer with Reward Feedback')" title="添加到收藏夹">☆ 收藏</button>
