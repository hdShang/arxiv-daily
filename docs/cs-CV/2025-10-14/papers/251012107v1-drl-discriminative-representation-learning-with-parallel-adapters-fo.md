...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.12107v1" onclick="toggleFavorite(this, '2510.12107v1', 'DRL: Discriminative Representation Learning with Parallel Adapters for Class Incremental Learning')" title="添加到收藏夹">☆ 收藏</button>
