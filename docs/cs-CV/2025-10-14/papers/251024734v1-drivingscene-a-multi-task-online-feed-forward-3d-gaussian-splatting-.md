...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.24734" target="_blank" class="toolbar-btn">arXiv: 2510.24734v1</a>
    <a href="https://arxiv.org/pdf/2510.24734.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.24734v1" 
            onclick="toggleFavorite(this, '2510.24734v1', 'DrivingScene: A Multi-Task Online Feed-Forward 3D Gaussian Splatting Method for Dynamic Driving Scenes')" title="收藏">
      ☆ 收藏
    </button>
