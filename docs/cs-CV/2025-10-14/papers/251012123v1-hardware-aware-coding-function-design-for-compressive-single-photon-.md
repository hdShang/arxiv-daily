...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.12123v1" onclick="toggleFavorite(this, '2510.12123v1', 'Hardware-aware Coding Function Design for Compressive Single-Photon 3D Cameras')" title="添加到收藏夹">☆ 收藏</button>
