...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.14222v1" onclick="toggleFavorite(this, '2512.14222v1', 'History-Enhanced Two-Stage Transformer for Aerial Vision-and-Language Navigation')" title="添加到收藏夹">☆ 收藏</button>
