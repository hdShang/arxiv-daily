...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.14274v1" onclick="toggleFavorite(this, '2512.14274v1', 'TUN: Detecting Significant Points in Persistence Diagrams with Deep Learning')" title="添加到收藏夹">☆ 收藏</button>
