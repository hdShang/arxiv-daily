...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.14236v1" onclick="toggleFavorite(this, '2512.14236v1', 'Elastic3D: Controllable Stereo Video Conversion with Guided Latent Decoding')" title="添加到收藏夹">☆ 收藏</button>
