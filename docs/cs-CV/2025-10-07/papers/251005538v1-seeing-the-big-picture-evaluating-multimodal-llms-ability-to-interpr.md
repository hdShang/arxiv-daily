...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05538v1" onclick="toggleFavorite(this, '2510.05538v1', 'Seeing the Big Picture: Evaluating Multimodal LLMs\' Ability to Interpret and Grade Handwritten Student Work')" title="添加到收藏夹">☆ 收藏</button>
