...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22718v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22718v1', 'Edge Collaborative Gaussian Splatting with Integrated Rendering and Communication')" title="添加到收藏夹">☆ 收藏</button>
