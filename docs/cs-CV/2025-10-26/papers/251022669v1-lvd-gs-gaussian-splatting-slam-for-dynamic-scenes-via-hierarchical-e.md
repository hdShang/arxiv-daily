...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22669v1" onclick="toggleFavorite(this, '2510.22669v1', 'LVD-GS: Gaussian Splatting SLAM for Dynamic Scenes via Hierarchical Explicit-Implicit Representation Collaboration Rendering')" title="添加到收藏夹">☆ 收藏</button>
