...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22473v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22473v1', 'DynaPose4D: High-Quality 4D Dynamic Content Generation via Pose Alignment Loss')" title="添加到收藏夹">☆ 收藏</button>
