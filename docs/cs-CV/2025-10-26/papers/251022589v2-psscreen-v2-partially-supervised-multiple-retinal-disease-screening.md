...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22589v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22589v2', 'PSScreen V2: Partially Supervised Multiple Retinal Disease Screening')" title="添加到收藏夹">☆ 收藏</button>
