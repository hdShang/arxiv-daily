...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22827v2" onclick="toggleFavorite(this, '2510.22827v2', 'FairJudge: MLLM Judging for Social Attributes and Prompt Image Alignment')" title="添加到收藏夹">☆ 收藏</button>
