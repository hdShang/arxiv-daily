...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22829v1" onclick="toggleFavorite(this, '2510.22829v1', 'LLM-based Fusion of Multi-modal Features for Commercial Memorability Prediction')" title="添加到收藏夹">☆ 收藏</button>
