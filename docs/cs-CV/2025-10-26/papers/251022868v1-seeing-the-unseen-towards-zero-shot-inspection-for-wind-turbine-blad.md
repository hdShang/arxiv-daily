...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22868v1" onclick="toggleFavorite(this, '2510.22868v1', 'Seeing the Unseen: Towards Zero-Shot Inspection for Wind Turbine Blades using Knowledge-Augmented Vision Language Models')" title="添加到收藏夹">☆ 收藏</button>
