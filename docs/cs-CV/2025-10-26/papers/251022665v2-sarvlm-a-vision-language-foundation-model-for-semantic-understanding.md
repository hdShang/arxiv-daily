...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22665v2" onclick="toggleFavorite(this, '2510.22665v2', 'SARVLM: A Vision Language Foundation Model for Semantic Understanding and Target Recognition in SAR Imagery')" title="添加到收藏夹">☆ 收藏</button>
