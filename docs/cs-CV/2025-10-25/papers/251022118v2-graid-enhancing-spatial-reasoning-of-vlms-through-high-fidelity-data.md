...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22118v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22118v2', 'GRAID: Enhancing Spatial Reasoning of VLMs Through High-Fidelity Data Generation')" title="添加到收藏夹">☆ 收藏</button>
