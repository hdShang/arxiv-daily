...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22319v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22319v2', 'GRPO-Guard: Mitigating Implicit Over-Optimization in Flow Matching via Regulated Clipping')" title="添加到收藏夹">☆ 收藏</button>
