...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22161v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22161v1', 'I2-NeRF: Learning Neural Radiance Fields Under Physically-Grounded Media Interactions')" title="添加到收藏夹">☆ 收藏</button>
