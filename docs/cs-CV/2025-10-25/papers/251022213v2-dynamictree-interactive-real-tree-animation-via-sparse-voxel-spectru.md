...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22213v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22213v2', 'DynamicTree: Interactive Real Tree Animation via Sparse Voxel Spectrum')" title="添加到收藏夹">☆ 收藏</button>
