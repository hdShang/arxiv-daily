...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22282v1" onclick="toggleFavorite(this, '2510.22282v1', 'CityRiSE: Reasoning Urban Socio-Economic Status in Vision-Language Models via Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
