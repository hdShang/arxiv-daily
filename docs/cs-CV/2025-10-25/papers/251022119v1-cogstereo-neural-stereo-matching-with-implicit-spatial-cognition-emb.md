...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22119v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22119v1', 'CogStereo: Neural Stereo Matching with Implicit Spatial Cognition Embedding')" title="添加到收藏夹">☆ 收藏</button>
