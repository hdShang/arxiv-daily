...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22171v2" onclick="toggleFavorite(this, '2510.22171v2', 'HARMONY: Hidden Activation Representations and Model Output-Aware Uncertainty Estimation for Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
