...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.24777v1" onclick="toggleFavorite(this, '2510.24777v1', 'Cross-Enhanced Multimodal Fusion of Eye-Tracking and Facial Features for Alzheimer\'s Disease Diagnosis')" title="添加到收藏夹">☆ 收藏</button>
