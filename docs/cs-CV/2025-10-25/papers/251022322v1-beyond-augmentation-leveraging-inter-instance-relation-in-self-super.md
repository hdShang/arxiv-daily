...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22322v1" onclick="toggleFavorite(this, '2510.22322v1', 'Beyond Augmentation: Leveraging Inter-Instance Relation in Self-Supervised Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
