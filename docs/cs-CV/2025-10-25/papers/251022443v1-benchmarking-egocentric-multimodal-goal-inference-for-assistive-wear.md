...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22443v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22443v1', 'Benchmarking Egocentric Multimodal Goal Inference for Assistive Wearable Agents')" title="添加到收藏夹">☆ 收藏</button>
