...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21079v1" onclick="toggleFavorite(this, '2510.21079v1', 'WaveSeg: Enhancing Segmentation Precision via High-Frequency Prior and Mamba-Driven Spectrum Decomposition')" title="添加到收藏夹">☆ 收藏</button>
