...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21182v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21182v1', 'KBE-DME: Dynamic Multimodal Evaluation via Knowledge Enhanced Benchmark Evolution')" title="添加到收藏夹">☆ 收藏</button>
