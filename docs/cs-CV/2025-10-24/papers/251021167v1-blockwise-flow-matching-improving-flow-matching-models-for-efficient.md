...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21167v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21167v1', 'Blockwise Flow Matching: Improving Flow Matching Models For Efficient High-Quality Generation')" title="添加到收藏夹">☆ 收藏</button>
