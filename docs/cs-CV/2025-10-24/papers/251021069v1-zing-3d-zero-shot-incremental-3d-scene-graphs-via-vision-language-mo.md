...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21069v1" onclick="toggleFavorite(this, '2510.21069v1', 'ZING-3D: Zero-shot Incremental 3D Scene Graphs via Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
