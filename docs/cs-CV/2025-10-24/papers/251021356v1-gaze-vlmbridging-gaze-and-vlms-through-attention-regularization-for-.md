...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21356v1" onclick="toggleFavorite(this, '2510.21356v1', 'Gaze-VLM:Bridging Gaze and VLMs through Attention Regularization for Egocentric Understanding')" title="添加到收藏夹">☆ 收藏</button>
