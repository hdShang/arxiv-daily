...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21441v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21441v1', 'OpenHype: Hyperbolic Embeddings for Hierarchical Open-Vocabulary Radiance Fields')" title="添加到收藏夹">☆ 收藏</button>
