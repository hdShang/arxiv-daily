...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21512v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21512v1', 'Towards a Golden Classifier-Free Guidance Path via Foresight Fixed Point Iterations')" title="添加到收藏夹">☆ 收藏</button>
