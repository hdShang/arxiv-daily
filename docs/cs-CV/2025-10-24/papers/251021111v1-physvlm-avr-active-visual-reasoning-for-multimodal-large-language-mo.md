...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21111v1" onclick="toggleFavorite(this, '2510.21111v1', 'PhysVLM-AVR: Active Visual Reasoning for Multimodal Large Language Models in Physical Environments')" title="添加到收藏夹">☆ 收藏</button>
