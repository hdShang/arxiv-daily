...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21160v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21160v1', 'Towards Physics-informed Spatial Intelligence with Human Priors: An Autonomous Driving Pilot Study')" title="添加到收藏夹">☆ 收藏</button>
