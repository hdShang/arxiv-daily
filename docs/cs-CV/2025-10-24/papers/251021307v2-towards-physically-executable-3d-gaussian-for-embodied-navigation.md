...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21307v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21307v2', 'Towards Physically Executable 3D Gaussian for Embodied Navigation')" title="添加到收藏夹">☆ 收藏</button>
