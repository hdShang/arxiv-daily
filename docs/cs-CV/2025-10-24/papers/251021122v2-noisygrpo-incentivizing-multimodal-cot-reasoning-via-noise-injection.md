...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21122v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21122v2', 'NoisyGRPO: Incentivizing Multimodal CoT Reasoning via Noise Injection and Bayesian Estimation')" title="添加到收藏夹">☆ 收藏</button>
