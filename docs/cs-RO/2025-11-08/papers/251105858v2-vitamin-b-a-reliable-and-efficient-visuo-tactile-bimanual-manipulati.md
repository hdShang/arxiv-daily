...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05858v2" onclick="toggleFavorite(this, '2511.05858v2', 'ViTaMIn-B: A Reliable and Efficient Visuo-Tactile Bimanual Manipulation Interface')" title="添加到收藏夹">☆ 收藏</button>
