...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.05855v1" onclick="toggleFavorite(this, '2511.05855v1', 'Gentle Manipulation Policy Learning via Demonstrations from VLM Planned Atomic Skills')" title="添加到收藏夹">☆ 收藏</button>
