...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20974v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20974v2', 'Robust Point Cloud Reinforcement Learning via PCA-Based Canonicalization')" title="添加到收藏夹">☆ 收藏</button>
