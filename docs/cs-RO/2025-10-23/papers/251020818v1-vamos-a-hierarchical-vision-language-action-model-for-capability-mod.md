...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20818v1" onclick="toggleFavorite(this, '2510.20818v1', 'VAMOS: A Hierarchical Vision-Language-Action Model for Capability-Modulated and Steerable Navigation')" title="添加到收藏夹">☆ 收藏</button>
