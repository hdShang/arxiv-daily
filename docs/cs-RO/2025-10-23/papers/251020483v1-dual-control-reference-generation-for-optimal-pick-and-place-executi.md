...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20483v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20483v1', 'Dual Control Reference Generation for Optimal Pick-and-Place Execution under Payload Uncertainty')" title="添加到收藏夹">☆ 收藏</button>
