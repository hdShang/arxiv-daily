...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20884v1" onclick="toggleFavorite(this, '2510.20884v1', 'ROPES: Robotic Pose Estimation via Score-Based Causal Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
