...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20774v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20774v2', 'FieldGen: From Teleoperated Pre-Manipulation Trajectories to Field-Guided Data Generation')" title="添加到收藏夹">☆ 收藏</button>
