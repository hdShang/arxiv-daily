...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20965v1" onclick="toggleFavorite(this, '2510.20965v1', 'SutureBot: A Precision Framework & Benchmark For Autonomous End-to-End Suturing')" title="添加到收藏夹">☆ 收藏</button>
