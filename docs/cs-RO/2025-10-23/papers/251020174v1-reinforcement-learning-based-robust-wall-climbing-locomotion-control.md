...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20174v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20174v1', 'Reinforcement Learning-based Robust Wall Climbing Locomotion Controller in Ferromagnetic Environment')" title="添加到收藏夹">☆ 收藏</button>
