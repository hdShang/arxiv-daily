...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20490v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20490v1', 'Simultaneous Stiffness and Trajectory Optimization for Energy Minimization of Pick-and-Place Tasks of SEA-Actuated Parallel Kinematic Manipulators')" title="添加到收藏夹">☆ 收藏</button>
