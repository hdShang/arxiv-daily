...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20161v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.20161v1', 'PathFormer: A Transformer with 3D Grid Constraints for Digital Twin Robot-Arm Trajectory Generation')" title="添加到收藏夹">☆ 收藏</button>
