...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20407v1" onclick="toggleFavorite(this, '2510.20407v1', 'MR-UBi: Mixed Reality-Based Underwater Robot Arm Teleoperation System with Reaction Torque Indicator via Bilateral Control')" title="添加到收藏夹">☆ 收藏</button>
