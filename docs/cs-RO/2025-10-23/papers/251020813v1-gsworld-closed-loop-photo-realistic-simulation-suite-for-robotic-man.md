...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20813v1" onclick="toggleFavorite(this, '2510.20813v1', 'GSWorld: Closed-Loop Photo-Realistic Simulation Suite for Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
