...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.20328v1" onclick="toggleFavorite(this, '2510.20328v1', 'MemER: Scaling Up Memory for Robot Control via Experience Retrieval')" title="添加到收藏夹">☆ 收藏</button>
