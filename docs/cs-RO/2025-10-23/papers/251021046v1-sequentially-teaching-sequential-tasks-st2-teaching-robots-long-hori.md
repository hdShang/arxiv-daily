...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21046v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21046v1', 'Sequentially Teaching Sequential Tasks $(ST)^2$: Teaching Robots Long-horizon Manipulation Skills')" title="添加到收藏夹">☆ 收藏</button>
