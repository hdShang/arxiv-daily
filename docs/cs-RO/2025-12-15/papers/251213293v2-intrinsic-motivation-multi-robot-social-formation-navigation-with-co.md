...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13293v2" onclick="toggleFavorite(this, '2512.13293v2', 'Intrinsic-Motivation Multi-Robot Social Formation Navigation with Coordinated Exploration')" title="添加到收藏夹">☆ 收藏</button>
