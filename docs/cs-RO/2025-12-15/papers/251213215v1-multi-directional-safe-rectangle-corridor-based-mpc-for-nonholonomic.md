...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13215v1" onclick="toggleFavorite(this, '2512.13215v1', 'Multi-directional Safe Rectangle Corridor-Based MPC for Nonholonomic Robots Navigation in Cluttered Environment')" title="添加到收藏夹">☆ 收藏</button>
