...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13514v1" onclick="toggleFavorite(this, '2512.13514v1', 'Reinforcement Learning based 6-DoF Maneuvers for Microgravity Intravehicular Docking: A Simulation Study with Int-Ball2 in ISS-JEM')" title="添加到收藏夹">☆ 收藏</button>
