...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12987v1" onclick="toggleFavorite(this, '2512.12987v1', 'Tackling Snow-Induced Challenges: Safe Autonomous Lane-Keeping with Robust Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
