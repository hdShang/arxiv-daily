...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13090v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.13090v1', 'Multi-Robot Motion Planning from Vision and Language using Heat-Inspired Diffusion')" title="添加到收藏夹">☆ 收藏</button>
