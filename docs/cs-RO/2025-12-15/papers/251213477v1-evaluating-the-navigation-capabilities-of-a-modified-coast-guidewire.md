...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13477v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.13477v1', 'Evaluating the Navigation Capabilities of a Modified COAST Guidewire Robot in an Anatomical Phantom Model')" title="添加到收藏夹">☆ 收藏</button>
