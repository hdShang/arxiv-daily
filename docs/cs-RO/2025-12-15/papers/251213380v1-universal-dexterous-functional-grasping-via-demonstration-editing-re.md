...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13380v1" onclick="toggleFavorite(this, '2512.13380v1', 'Universal Dexterous Functional Grasping via Demonstration-Editing Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
