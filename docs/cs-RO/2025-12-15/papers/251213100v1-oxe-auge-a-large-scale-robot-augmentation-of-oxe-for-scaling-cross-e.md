...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13100v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.13100v1', 'OXE-AugE: A Large-Scale Robot Augmentation of OXE for Scaling Cross-Embodiment Policy Learning')" title="添加到收藏夹">☆ 收藏</button>
