...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13170v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.13170v1', 'Iterative Tuning of Nonlinear Model Predictive Control for Robotic Manufacturing Tasks')" title="添加到收藏夹">☆ 收藏</button>
