...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13304v1" onclick="toggleFavorite(this, '2512.13304v1', 'Humanoid Robot Running Through Random Stepping Stones and Jumping Over Obstacles: Step Adaptation Using Spring-Mass Trajectories')" title="添加到收藏夹">☆ 收藏</button>
