...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01483v1" onclick="toggleFavorite(this, '2510.01483v1', 'VL-KnG: Visual Scene Understanding for Navigation Goal Identification using Spatiotemporal Knowledge Graphs')" title="添加到收藏夹">☆ 收藏</button>
