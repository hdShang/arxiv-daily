...
<div class="paper-toolbar">
  ...
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01389v1" 
            onclick="toggleFavorite(this, '2510.01389v1', 'INSIGHT: INference-time Sequence Introspection for Generating Help Triggers in Vision-Language-Action Models')" title="收藏">
      ☆ 收藏
    </button>
