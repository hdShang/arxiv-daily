...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00491v1" onclick="toggleFavorite(this, '2510.00491v1', 'From Human Hands to Robot Arms: Manipulation Skills Transfer via Trajectory Alignment')" title="添加到收藏夹">☆ 收藏</button>
