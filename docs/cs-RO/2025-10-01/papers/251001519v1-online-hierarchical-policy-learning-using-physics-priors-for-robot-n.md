...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01519v1" onclick="toggleFavorite(this, '2510.01519v1', 'Online Hierarchical Policy Learning using Physics Priors for Robot Navigation in Unknown Environments')" title="添加到收藏夹">☆ 收藏</button>
