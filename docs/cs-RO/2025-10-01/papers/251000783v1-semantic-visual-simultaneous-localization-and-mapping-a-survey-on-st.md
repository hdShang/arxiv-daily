...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00783v1" onclick="toggleFavorite(this, '2510.00783v1', 'Semantic Visual Simultaneous Localization and Mapping: A Survey on State of the Art, Challenges, and Future Directions')" title="添加到收藏夹">☆ 收藏</button>
