...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.01068" target="_blank" class="toolbar-btn">arXiv: 2510.01068v1</a>
    <a href="https://arxiv.org/pdf/2510.01068.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01068v1" 
            onclick="toggleFavorite(this, '2510.01068v1', 'Compose Your Policies! Improving Diffusion-based or Flow-based Robot Policies via Test-time Distribution-level Composition')" title="收藏">
      ☆ 收藏
    </button>
