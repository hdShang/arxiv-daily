...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01068v1" onclick="toggleFavorite(this, '2510.01068v1', 'Compose Your Policies! Improving Diffusion-based or Flow-based Robot Policies via Test-time Distribution-level Composition')" title="添加到收藏夹">☆ 收藏</button>
