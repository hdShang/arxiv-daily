...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01438v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01438v2', 'Differentiable Skill Optimisation for Powder Manipulation in Laboratory Automation')" title="添加到收藏夹">☆ 收藏</button>
