...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00573v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.00573v1', 'GRITS: A Spillage-Aware Guided Diffusion Policy for Robot Food Scooping Tasks')" title="添加到收藏夹">☆ 收藏</button>
