...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.00703v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.00703v1', 'MultiPhysio-HRC: Multimodal Physiological Signals Dataset for industrial Human-Robot Collaboration')" title="添加到收藏夹">☆ 收藏</button>
