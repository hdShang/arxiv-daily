...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01348v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01348v1', 'Kilometer-Scale GNSS-Denied UAV Navigation via Heightmap Gradients: A Winning System from the SPRIN-D Challenge')" title="添加到收藏夹">☆ 收藏</button>
