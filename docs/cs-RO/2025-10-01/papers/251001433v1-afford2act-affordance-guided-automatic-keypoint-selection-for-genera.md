...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01433v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01433v1', 'AFFORD2ACT: Affordance-Guided Automatic Keypoint Selection for Generalizable and Lightweight Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
