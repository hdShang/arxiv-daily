...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01388v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01388v1', 'VENTURA: Adapting Image Diffusion Models for Unified Task Conditioned Navigation')" title="添加到收藏夹">☆ 收藏</button>
