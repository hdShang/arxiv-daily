...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01404v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01404v1', 'How Well do Diffusion Policies Learn Kinematic Constraint Manifolds?')" title="添加到收藏夹">☆ 收藏</button>
