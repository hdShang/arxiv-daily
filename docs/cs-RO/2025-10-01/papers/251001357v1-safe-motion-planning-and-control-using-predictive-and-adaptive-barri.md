...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01357v1" onclick="toggleFavorite(this, '2510.01357v1', 'Safe Motion Planning and Control Using Predictive and Adaptive Barrier Methods for Autonomous Surface Vessels')" title="添加到收藏夹">☆ 收藏</button>
