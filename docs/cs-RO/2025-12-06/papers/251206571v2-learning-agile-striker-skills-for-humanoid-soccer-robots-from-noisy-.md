...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06571v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06571v2', 'Learning Agile Striker Skills for Humanoid Soccer Robots from Noisy Sensory Input')" title="添加到收藏夹">☆ 收藏</button>
