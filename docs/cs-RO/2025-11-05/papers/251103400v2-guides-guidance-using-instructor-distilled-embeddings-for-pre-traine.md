...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03400v2" onclick="toggleFavorite(this, '2511.03400v2', 'GUIDES: Guidance Using Instructor-Distilled Embeddings for Pre-trained Robot Policy Enhancement')" title="添加到收藏夹">☆ 收藏</button>
