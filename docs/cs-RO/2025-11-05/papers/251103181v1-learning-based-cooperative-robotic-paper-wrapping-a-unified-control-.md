...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03181v1" onclick="toggleFavorite(this, '2511.03181v1', 'Learning-based Cooperative Robotic Paper Wrapping: A Unified Control Policy with Residual Force Control')" title="添加到收藏夹">☆ 收藏</button>
