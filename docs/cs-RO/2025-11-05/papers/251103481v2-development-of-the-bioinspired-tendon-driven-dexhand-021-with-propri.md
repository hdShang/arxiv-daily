...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03481v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.03481v2', 'Development of the Bioinspired Tendon-Driven DexHand 021 with Proprioceptive Compliance Control')" title="添加到收藏夹">☆ 收藏</button>
