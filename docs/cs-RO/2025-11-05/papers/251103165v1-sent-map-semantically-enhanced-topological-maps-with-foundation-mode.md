...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03165v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.03165v1', 'SENT Map -- Semantically Enhanced Topological Maps with Foundation Models')" title="添加到收藏夹">☆ 收藏</button>
