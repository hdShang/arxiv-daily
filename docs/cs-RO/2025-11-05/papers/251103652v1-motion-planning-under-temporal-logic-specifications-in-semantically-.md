...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03652v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.03652v1', 'Motion Planning Under Temporal Logic Specifications In Semantically Unknown Environments')" title="添加到收藏夹">☆ 收藏</button>
