...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03167v1" onclick="toggleFavorite(this, '2511.03167v1', 'Learning Natural and Robust Hexapod Locomotion over Complex Terrains via Motion Priors based on Deep Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
