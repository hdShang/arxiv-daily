...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.05832" class="toolbar-btn" target="_blank">📄 arXiv: 2505.05832v1</a>
  <a href="https://arxiv.org/pdf/2505.05832.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.05832v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.05832v1', 'Augmented Body Communicator: Enhancing daily body expression for people with upper limb limitations through LLM and a robotic arm')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的机器人手臂主要用于功能性任务，未能有效支持上肢功能受限者的社交表达需求。
2. 本文提出了一种增强身体交流系统，结合机器人手臂与大型语言模型，支持用户设计动作并提供上下文相关建议。
3. 用户测试结果显示，该系统显著提高了参与者的自我表达能力，表明其在社交互动中的有效性。
