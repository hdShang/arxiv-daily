...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.14340v1" onclick="toggleFavorite(this, '2512.14340v1', 'Field evaluation and optimization of a lightweight lidar-based UAV navigation system for dense boreal forest environments')" title="添加到收藏夹">☆ 收藏</button>
