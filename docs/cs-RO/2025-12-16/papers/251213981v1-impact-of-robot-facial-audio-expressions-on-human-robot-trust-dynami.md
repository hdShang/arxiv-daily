...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.13981v1" onclick="toggleFavorite(this, '2512.13981v1', 'Impact of Robot Facial-Audio Expressions on Human Robot Trust Dynamics and Trust Repair')" title="添加到收藏夹">☆ 收藏</button>
