...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06378v1" onclick="toggleFavorite(this, '2511.06378v1', 'ArtReg: Visuo-Tactile based Pose Tracking and Manipulation of Unseen Articulated Objects')" title="添加到收藏夹">☆ 收藏</button>
