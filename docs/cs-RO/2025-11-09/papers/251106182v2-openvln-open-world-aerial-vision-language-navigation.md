...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06182v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06182v2', 'OpenVLN: Open-world Aerial Vision-Language Navigation')" title="添加到收藏夹">☆ 收藏</button>
