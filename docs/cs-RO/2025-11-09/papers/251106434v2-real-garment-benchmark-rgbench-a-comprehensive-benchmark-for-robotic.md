...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06434v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06434v2', 'Real Garment Benchmark (RGBench): A Comprehensive Benchmark for Robotic Garment Manipulation featuring a High-Fidelity Scalable Simulator')" title="添加到收藏夹">☆ 收藏</button>
