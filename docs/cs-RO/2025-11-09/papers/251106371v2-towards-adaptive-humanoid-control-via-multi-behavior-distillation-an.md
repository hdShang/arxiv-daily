...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06371v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06371v2', 'Towards Adaptive Humanoid Control via Multi-Behavior Distillation and Reinforced Fine-Tuning')" title="添加到收藏夹">☆ 收藏</button>
