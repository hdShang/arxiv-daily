...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06385v1" onclick="toggleFavorite(this, '2511.06385v1', 'From Demonstrations to Safe Deployment: Path-Consistent Safety Filtering for Diffusion Policies')" title="添加到收藏夹">☆ 收藏</button>
