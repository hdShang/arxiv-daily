...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06465v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.06465v1', 'Sim-to-Real Transfer in Deep Reinforcement Learning for Bipedal Locomotion')" title="添加到收藏夹">☆ 收藏</button>
