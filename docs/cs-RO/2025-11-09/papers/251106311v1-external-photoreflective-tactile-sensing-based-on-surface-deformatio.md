...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06311v1" onclick="toggleFavorite(this, '2511.06311v1', 'External Photoreflective Tactile Sensing Based on Surface Deformation Measurement')" title="添加到收藏夹">☆ 收藏</button>
