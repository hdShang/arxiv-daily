...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06202v1" onclick="toggleFavorite(this, '2511.06202v1', 'ExpReS-VLA: Specializing Vision-Language-Action Models Through Experience Replay and Retrieval')" title="添加到收藏夹">☆ 收藏</button>
