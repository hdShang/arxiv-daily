...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08583v1" onclick="toggleFavorite(this, '2511.08583v1', 'SeFA-Policy: Fast and Accurate Visuomotor Policy Learning with Selective Flow Alignment')" title="添加到收藏夹">☆ 收藏</button>
