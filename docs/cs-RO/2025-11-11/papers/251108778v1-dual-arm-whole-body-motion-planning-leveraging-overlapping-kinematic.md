...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08778v1" onclick="toggleFavorite(this, '2511.08778v1', 'Dual-Arm Whole-Body Motion Planning: Leveraging Overlapping Kinematic Chains')" title="添加到收藏夹">☆ 收藏</button>
