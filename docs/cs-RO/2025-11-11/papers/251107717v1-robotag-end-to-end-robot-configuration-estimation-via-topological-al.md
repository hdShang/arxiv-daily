...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07717v1" onclick="toggleFavorite(this, '2511.07717v1', 'RoboTAG: End-to-end Robot Configuration Estimation via Topological Alignment Graph')" title="添加到收藏夹">☆ 收藏</button>
