...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08732v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08732v1', 'Intuitive Programming, Adaptive Task Planning, and Dynamic Role Allocation in Human-Robot Collaboration')" title="添加到收藏夹">☆ 收藏</button>
