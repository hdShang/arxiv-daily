...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07720v1" onclick="toggleFavorite(this, '2511.07720v1', 'A QP Framework for Improving Data Collection: Quantifying Device-Controller Performance in Robot Teleoperation')" title="添加到收藏夹">☆ 收藏</button>
