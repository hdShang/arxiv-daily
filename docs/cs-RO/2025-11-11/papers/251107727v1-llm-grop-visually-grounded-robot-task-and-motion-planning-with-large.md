...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07727v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07727v1', 'LLM-GROP: Visually Grounded Robot Task and Motion Planning with Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
