...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08454v1" onclick="toggleFavorite(this, '2511.08454v1', 'Intuitive control of supernumerary robotic limbs through a tactile-encoded neural interface')" title="添加到收藏夹">☆ 收藏</button>
