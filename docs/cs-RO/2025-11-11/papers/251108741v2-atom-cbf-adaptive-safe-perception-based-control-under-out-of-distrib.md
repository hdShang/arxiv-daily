...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08741v2" onclick="toggleFavorite(this, '2511.08741v2', 'ATOM-CBF: Adaptive Safe Perception-Based Control under Out-of-Distribution Measurements')" title="添加到收藏夹">☆ 收藏</button>
