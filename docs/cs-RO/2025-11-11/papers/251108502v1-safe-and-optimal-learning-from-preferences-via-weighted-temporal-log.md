...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08502v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08502v1', 'Safe and Optimal Learning from Preferences via Weighted Temporal Logic with Applications in Robotics and Formula 1')" title="添加到收藏夹">☆ 收藏</button>
