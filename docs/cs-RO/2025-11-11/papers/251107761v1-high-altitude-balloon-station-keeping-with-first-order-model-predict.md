...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07761v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07761v1', 'High-Altitude Balloon Station-Keeping with First Order Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
