...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2508.09700" class="toolbar-btn" target="_blank">📄 arXiv: 2508.09700v1</a>
  <a href="https://arxiv.org/pdf/2508.09700.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2508.09700v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2508.09700v1', 'Immersive Teleoperation of Beyond-Human-Scale Robotic Manipulators: Challenges and Future Directions')" title="添加到收藏夹">☆ 收藏</button>
...
1. 超人规模机器人遥操作面临的核心问题包括操作员安全、感知运动不匹配和身体感缺失等挑战。
2. 论文提出通过重新设计沉浸式接口，优化触觉和视觉反馈来提升人机协作的安全性和有效性。
3. 实验结果显示，外骨骼控制设置在操作员的感知运动一致性和安全性方面优于传统操纵杆设置。
