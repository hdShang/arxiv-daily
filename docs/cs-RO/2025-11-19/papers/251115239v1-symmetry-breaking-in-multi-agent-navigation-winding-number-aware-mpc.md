...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15239v1" onclick="toggleFavorite(this, '2511.15239v1', 'Symmetry-Breaking in Multi-Agent Navigation: Winding Number-Aware MPC with a Learned Topological Strategy')" title="添加到收藏夹">☆ 收藏</button>
