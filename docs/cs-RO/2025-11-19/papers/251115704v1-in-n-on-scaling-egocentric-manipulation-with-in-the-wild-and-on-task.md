...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15704v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15704v1', 'In-N-On: Scaling Egocentric Manipulation with in-the-wild and on-task Data')" title="添加到收藏夹">☆ 收藏</button>
