...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15414v1" onclick="toggleFavorite(this, '2511.15414v1', 'RRT*former: Environment-Aware Sampling-Based Motion Planning using Transformer')" title="添加到收藏夹">☆ 收藏</button>
