...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15358v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15358v1', 'Platform-Agnostic Reinforcement Learning Framework for Safe Exploration of Cluttered Environments with Graph Attention')" title="添加到收藏夹">☆ 收藏</button>
