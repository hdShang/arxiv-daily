...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15532v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15532v1', 'NMPC-based Motion Planning with Adaptive Weighting for Dynamic Object Interception')" title="添加到收藏夹">☆ 收藏</button>
