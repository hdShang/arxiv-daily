...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15614v1" onclick="toggleFavorite(this, '2511.15614v1', 'Optimus-Q: Utilizing Federated Learning in Adaptive Robots for Intelligent Nuclear Power Plant Operations through Quantum Cryptography')" title="添加到收藏夹">☆ 收藏</button>
