...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15284v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.15284v1', 'Path Planning through Multi-Agent Reinforcement Learning in Dynamic Environments')" title="添加到收藏夹">☆ 收藏</button>
