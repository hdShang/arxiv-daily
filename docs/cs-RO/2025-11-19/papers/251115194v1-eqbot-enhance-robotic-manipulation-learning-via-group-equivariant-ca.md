...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15194v1" onclick="toggleFavorite(this, '2511.15194v1', 'Eq.Bot: Enhance Robotic Manipulation Learning via Group Equivariant Canonicalization')" title="添加到收藏夹">☆ 收藏</button>
