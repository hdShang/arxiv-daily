...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16524v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16524v1', 'Semi-Peaucellier Linkage and Differential Mechanism for Linear Pinching and Self-Adaptive Grasping')" title="添加到收藏夹">☆ 收藏</button>
