...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16435v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16435v1', 'What Questions Should Robots Be Able to Answer? A Dataset of User Questions for Explainable Robotics')" title="添加到收藏夹">☆ 收藏</button>
