...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16308v1" onclick="toggleFavorite(this, '2510.16308v1', 'SPOT: Sensing-augmented Trajectory Planning via Obstacle Threat Modeling')" title="添加到收藏夹">☆ 收藏</button>
