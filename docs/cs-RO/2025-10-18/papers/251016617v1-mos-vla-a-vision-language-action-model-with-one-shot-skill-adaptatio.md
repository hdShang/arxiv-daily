...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16617v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.16617v1', 'MoS-VLA: A Vision-Language-Action Model with One-Shot Skill Adaptation')" title="添加到收藏夹">☆ 收藏</button>
