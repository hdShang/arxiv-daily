...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.20503" class="toolbar-btn" target="_blank">📄 arXiv: 2505.20503v1</a>
  <a href="https://arxiv.org/pdf/2505.20503.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.20503v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.20503v1', 'Embodied AI with Foundation Models for Mobile Service Robots: A Systematic Review')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的移动服务机器人在复杂动态环境中执行任务时，面临多模态传感器融合和实时决策等挑战。
2. 论文提出将基础模型与具身人工智能结合，探索其在实时传感器融合和自适应任务执行中的应用。
3. 通过系统回顾，识别出基础模型在服务机器人中的关键挑战，并展示其在实际应用中的变革性影响。
