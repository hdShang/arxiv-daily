...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10960v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10960v1', 'Game-Theoretic Risk-Shaped Reinforcement Learning for Safe Autonomous Driving')" title="添加到收藏夹">☆ 收藏</button>
