...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11542v1" onclick="toggleFavorite(this, '2510.11542v1', 'NaviGait: Navigating Dynamically Feasible Gait Libraries using Deep Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
