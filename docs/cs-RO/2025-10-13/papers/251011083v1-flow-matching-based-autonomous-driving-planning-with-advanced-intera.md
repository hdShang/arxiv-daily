...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11083v1" onclick="toggleFavorite(this, '2510.11083v1', 'Flow Matching-Based Autonomous Driving Planning with Advanced Interactive Behavior Modeling')" title="添加到收藏夹">☆ 收藏</button>
