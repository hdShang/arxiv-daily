...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11103v1" onclick="toggleFavorite(this, '2510.11103v1', 'A Primer on SO(3) Action Representations in Deep Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
