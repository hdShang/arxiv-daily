...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11036v1" onclick="toggleFavorite(this, '2510.11036v1', 'XGrasp: Gripper-Aware Grasp Detection with Multi-Gripper Data Generation')" title="添加到收藏夹">☆ 收藏</button>
