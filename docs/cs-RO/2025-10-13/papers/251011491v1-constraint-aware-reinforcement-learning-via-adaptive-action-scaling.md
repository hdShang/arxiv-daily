...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11491v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11491v1', 'Constraint-Aware Reinforcement Learning via Adaptive Action Scaling')" title="添加到收藏夹">☆ 收藏</button>
