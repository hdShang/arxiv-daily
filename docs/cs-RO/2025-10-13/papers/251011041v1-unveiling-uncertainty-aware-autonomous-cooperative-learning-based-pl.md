...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11041v1" onclick="toggleFavorite(this, '2510.11041v1', 'Unveiling Uncertainty-Aware Autonomous Cooperative Learning Based Planning Strategy')" title="添加到收藏夹">☆ 收藏</button>
