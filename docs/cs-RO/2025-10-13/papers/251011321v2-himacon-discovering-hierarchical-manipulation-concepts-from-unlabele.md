...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11321v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11321v2', 'HiMaCon: Discovering Hierarchical Manipulation Concepts from Unlabeled Multi-Modal Data')" title="添加到收藏夹">☆ 收藏</button>
