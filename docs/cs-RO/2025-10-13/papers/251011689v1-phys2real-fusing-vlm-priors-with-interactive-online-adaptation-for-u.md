...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11689v1" onclick="toggleFavorite(this, '2510.11689v1', 'Phys2Real: Fusing VLM Priors with Interactive Online Adaptation for Uncertainty-Aware Sim-to-Real Manipulation')" title="添加到收藏夹">☆ 收藏</button>
