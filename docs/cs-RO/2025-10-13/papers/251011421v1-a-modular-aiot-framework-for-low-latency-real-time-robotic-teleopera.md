...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11421v1" onclick="toggleFavorite(this, '2510.11421v1', 'A Modular AIoT Framework for Low-Latency Real-Time Robotic Teleoperation in Smart Cities')" title="添加到收藏夹">☆ 收藏</button>
