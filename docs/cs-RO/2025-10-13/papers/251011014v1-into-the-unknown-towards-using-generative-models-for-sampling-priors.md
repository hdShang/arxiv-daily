...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11014v1" onclick="toggleFavorite(this, '2510.11014v1', 'Into the Unknown: Towards using Generative Models for Sampling Priors of Environment Uncertainty for Planning in Configuration Spaces')" title="添加到收藏夹">☆ 收藏</button>
