...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11474v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11474v2', 'Coordinated Strategies in Realistic Air Combat by Hierarchical Multi-Agent Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
