...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11258v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11258v1', 'DemoHLM: From One Demonstration to Generalizable Humanoid Loco-Manipulation')" title="添加到收藏夹">☆ 收藏</button>
