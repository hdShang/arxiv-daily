...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11401v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11401v1', 'Path and Motion Optimization for Efficient Multi-Location Inspection with Humanoid Robots')" title="添加到收藏夹">☆ 收藏</button>
