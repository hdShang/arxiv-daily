...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10912v2" onclick="toggleFavorite(this, '2510.10912v2', 'More than A Point: Capturing Uncertainty with Adaptive Affordance Heatmaps for Spatial Grounding in Robotic Tasks')" title="添加到收藏夹">☆ 收藏</button>
