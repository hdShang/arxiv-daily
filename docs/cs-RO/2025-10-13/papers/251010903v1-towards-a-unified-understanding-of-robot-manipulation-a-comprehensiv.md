...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10903v1" onclick="toggleFavorite(this, '2510.10903v1', 'Towards a Unified Understanding of Robot Manipulation: A Comprehensive Survey')" title="添加到收藏夹">☆ 收藏</button>
