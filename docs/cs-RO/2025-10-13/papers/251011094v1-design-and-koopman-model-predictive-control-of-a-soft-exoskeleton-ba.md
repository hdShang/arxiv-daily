...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.11094v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.11094v1', 'Design and Koopman Model Predictive Control of A Soft Exoskeleton Based on Origami-Inspired Pneumatic Actuator for Knee Rehabilitation')" title="添加到收藏夹">☆ 收藏</button>
