...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15111v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15111v1', 'BEV-Patch-PF: Particle Filtering with BEV-Aerial Feature Matching for Off-Road Geo-Localization')" title="添加到收藏夹">☆ 收藏</button>
