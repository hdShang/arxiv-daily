...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15309v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15309v1', 'GuangMing-Explorer: A Four-Legged Robot Platform for Autonomous Exploration in General Environments')" title="添加到收藏夹">☆ 收藏</button>
