...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15020v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15020v1', 'ISS Policy : Scalable Diffusion Policy with Implicit Scene Supervision')" title="添加到收藏夹">☆ 收藏</button>
