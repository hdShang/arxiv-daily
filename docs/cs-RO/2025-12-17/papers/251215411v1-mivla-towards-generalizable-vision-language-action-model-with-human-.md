...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15411v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15411v1', 'MiVLA: Towards Generalizable Vision-Language-Action Model with Human-Robot Mutual Imitation Pre-training')" title="添加到收藏夹">☆ 收藏</button>
