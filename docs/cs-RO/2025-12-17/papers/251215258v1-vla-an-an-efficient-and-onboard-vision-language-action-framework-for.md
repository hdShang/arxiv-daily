...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15258v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15258v1', 'VLA-AN: An Efficient and Onboard Vision-Language-Action Framework for Aerial Navigation in Complex Environments')" title="添加到收藏夹">☆ 收藏</button>
