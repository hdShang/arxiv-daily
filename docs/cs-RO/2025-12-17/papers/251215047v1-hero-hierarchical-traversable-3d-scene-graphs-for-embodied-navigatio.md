...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15047v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15047v1', 'HERO: Hierarchical Traversable 3D Scene Graphs for Embodied Navigation Among Movable Obstacles')" title="添加到收藏夹">☆ 收藏</button>
