...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.15692v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.15692v1', 'mimic-video: Video-Action Models for Generalizable Robot Control Beyond VLAs')" title="添加到收藏夹">☆ 收藏</button>
