...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26837v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26837v1', 'Force Characterization of Insect-Scale Aquatic Propulsion Based on Fluid-Structure Interaction')" title="添加到收藏夹">☆ 收藏</button>
