...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25548v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25548v1', 'Using VLM Reasoning to Constrain Task and Motion Planning')" title="添加到收藏夹">☆ 收藏</button>
