...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25713v1" onclick="toggleFavorite(this, '2510.25713v1', 'Robotic Assistant: Completing Collaborative Tasks with Dexterous Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
