...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25850v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25850v1', 'Debate2Create: Robot Co-design via Large Language Model Debates')" title="添加到收藏夹">☆ 收藏</button>
