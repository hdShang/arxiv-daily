...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25335v1" onclick="toggleFavorite(this, '2510.25335v1', 'An approach for combining transparency and motion assistance of a lower body exoskeleton')" title="添加到收藏夹">☆ 收藏</button>
