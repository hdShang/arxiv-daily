...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25233v1" onclick="toggleFavorite(this, '2510.25233v1', 'Hybrid Vision Servoing with Depp Alignment and GRU-Based Occlusion Recovery')" title="添加到收藏夹">☆ 收藏</button>
