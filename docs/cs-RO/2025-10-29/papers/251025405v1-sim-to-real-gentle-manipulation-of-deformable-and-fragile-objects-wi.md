...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25405v1" onclick="toggleFavorite(this, '2510.25405v1', 'Sim-to-Real Gentle Manipulation of Deformable and Fragile Objects with Stress-Guided Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
