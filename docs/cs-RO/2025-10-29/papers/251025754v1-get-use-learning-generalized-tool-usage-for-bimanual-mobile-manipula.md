...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25754v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25754v1', 'GET-USE: Learning Generalized Tool Usage for Bimanual Mobile Manipulation via Simulated Embodiment Extensions')" title="添加到收藏夹">☆ 收藏</button>
