...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25280v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.25280v1', 'Development of Implicit-Explicit Control Based Amphibious Centipede-Type Robot and Evaluation of its Mobile Performance')" title="添加到收藏夹">☆ 收藏</button>
