...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.25634v1" onclick="toggleFavorite(this, '2510.25634v1', 'Learning to Plan & Schedule with Reinforcement-Learned Bimanual Robot Skills')" title="添加到收藏夹">☆ 收藏</button>
