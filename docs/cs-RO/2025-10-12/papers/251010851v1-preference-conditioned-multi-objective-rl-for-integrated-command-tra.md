...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10851v1" onclick="toggleFavorite(this, '2510.10851v1', 'Preference-Conditioned Multi-Objective RL for Integrated Command Tracking and Force Compliance in Humanoid Locomotion')" title="添加到收藏夹">☆ 收藏</button>
