...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10759v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10759v1', 'Gain Tuning Is Not What You Need: Reward Gain Adaptation for Constrained Locomotion Learning')" title="添加到收藏夹">☆ 收藏</button>
