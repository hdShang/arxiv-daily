...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10731v1" onclick="toggleFavorite(this, '2510.10731v1', 'Controllable Generative Trajectory Prediction via Weak Preference Alignment')" title="添加到收藏夹">☆ 收藏</button>
