...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10567v1" onclick="toggleFavorite(this, '2510.10567v1', 'Reinforcement Learning-based Dynamic Adaptation for Sampling-Based Motion Planning in Agile Autonomous Driving')" title="添加到收藏夹">☆ 收藏</button>
