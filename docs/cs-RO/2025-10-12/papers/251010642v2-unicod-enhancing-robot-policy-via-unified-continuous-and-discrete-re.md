...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10642v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10642v2', 'UniCoD: Enhancing Robot Policy via Unified Continuous and Discrete Representation Learning')" title="添加到收藏夹">☆ 收藏</button>
