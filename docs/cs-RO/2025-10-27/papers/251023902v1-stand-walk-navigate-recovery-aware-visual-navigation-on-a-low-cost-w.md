...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23902v1" onclick="toggleFavorite(this, '2510.23902v1', 'Stand, Walk, Navigate: Recovery-Aware Visual Navigation on a Low-Cost Wheeled Quadruped')" title="添加到收藏夹">☆ 收藏</button>
