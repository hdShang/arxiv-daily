...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23386v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23386v1', 'Full-Dynamics Real-Time Nonlinear Model Predictive Control of Heavy-Duty Hydraulic Manipulator for Trajectory Tracking Tasks')" title="添加到收藏夹">☆ 收藏</button>
