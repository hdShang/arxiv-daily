...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23119v1" onclick="toggleFavorite(this, '2510.23119v1', 'OmniDexGrasp: Generalizable Dexterous Grasping via Foundation Model and Force Feedback')" title="添加到收藏夹">☆ 收藏</button>
