...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23258v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23258v1', 'Deep Active Inference with Diffusion Policy and Multiple Timescale World Model for Real-World Exploration and Navigation')" title="添加到收藏夹">☆ 收藏</button>
