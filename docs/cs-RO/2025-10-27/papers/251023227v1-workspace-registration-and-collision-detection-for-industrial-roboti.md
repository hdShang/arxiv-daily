...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23227v1" onclick="toggleFavorite(this, '2510.23227v1', 'Workspace Registration and Collision Detection for Industrial Robotics Applications')" title="添加到收藏夹">☆ 收藏</button>
