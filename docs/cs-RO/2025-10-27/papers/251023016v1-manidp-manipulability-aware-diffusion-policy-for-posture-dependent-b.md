...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23016v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23016v1', 'ManiDP: Manipulability-Aware Diffusion Policy for Posture-Dependent Bimanual Manipulation')" title="添加到收藏夹">☆ 收藏</button>
