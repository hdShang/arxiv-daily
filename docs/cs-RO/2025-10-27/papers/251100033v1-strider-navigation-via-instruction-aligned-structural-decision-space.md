...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00033v1" onclick="toggleFavorite(this, '2511.00033v1', 'STRIDER: Navigation via Instruction-Aligned Structural Decision Space Optimization')" title="添加到收藏夹">☆ 收藏</button>
