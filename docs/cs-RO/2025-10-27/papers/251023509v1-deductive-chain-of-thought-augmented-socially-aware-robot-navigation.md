...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23509v1" onclick="toggleFavorite(this, '2510.23509v1', 'Deductive Chain-of-Thought Augmented Socially-aware Robot Navigation World Model')" title="添加到收藏夹">☆ 收藏</button>
