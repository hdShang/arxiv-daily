...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23521v1" onclick="toggleFavorite(this, '2510.23521v1', 'Explicit Memory through Online 3D Gaussian Splatting Improves Class-Agnostic Video Segmentation')" title="添加到收藏夹">☆ 收藏</button>
