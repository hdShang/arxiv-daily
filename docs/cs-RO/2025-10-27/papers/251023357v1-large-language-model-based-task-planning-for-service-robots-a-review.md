...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23357v1" onclick="toggleFavorite(this, '2510.23357v1', 'Large language model-based task planning for service robots: A review')" title="添加到收藏夹">☆ 收藏</button>
