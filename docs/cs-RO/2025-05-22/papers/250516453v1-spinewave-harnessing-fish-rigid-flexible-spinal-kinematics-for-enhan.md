...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.16453" class="toolbar-btn" target="_blank">📄 arXiv: 2505.16453v1</a>
  <a href="https://arxiv.org/pdf/2505.16453.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.16453v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.16453v1', 'SpineWave: Harnessing Fish Rigid-Flexible Spinal Kinematics for Enhancing Biomimetic Robotic Locomotion')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有水下机器人在灵活性和能耗方面存在不足，难以适应复杂的水下环境。
2. SpineWave采用仿生设计，结合刚柔结构和进化算法，优化游泳性能。
3. 实验结果显示，SpineWave在多项测试中表现出色，具备良好的环境适应能力。
