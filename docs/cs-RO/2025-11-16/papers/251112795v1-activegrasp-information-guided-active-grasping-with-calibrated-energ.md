...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12795v1" onclick="toggleFavorite(this, '2511.12795v1', 'ActiveGrasp: Information-Guided Active Grasping with Calibrated Energy-based Model')" title="添加到收藏夹">☆ 收藏</button>
