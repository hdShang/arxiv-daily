...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12650v1" onclick="toggleFavorite(this, '2511.12650v1', 'Task-Aware Morphology Optimization of Planar Manipulators via Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
