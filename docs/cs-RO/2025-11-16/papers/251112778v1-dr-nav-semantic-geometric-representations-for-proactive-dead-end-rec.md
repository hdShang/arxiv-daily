...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12778v1" onclick="toggleFavorite(this, '2511.12778v1', 'DR. Nav: Semantic-Geometric Representations for Proactive Dead-End Recovery and Navigation')" title="添加到收藏夹">☆ 收藏</button>
