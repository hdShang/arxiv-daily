...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26040v1" onclick="toggleFavorite(this, '2510.26040v1', 'Accelerating Real-World Overtaking in F1TENTH Racing Employing Reinforcement Learning Methods')" title="添加到收藏夹">☆ 收藏</button>
