...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26362v1" onclick="toggleFavorite(this, '2510.26362v1', 'Cooperative Task Spaces for Multi-Arm Manipulation Control based on Similarity Transformations')" title="添加到收藏夹">☆ 收藏</button>
