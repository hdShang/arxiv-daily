...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26358v1" onclick="toggleFavorite(this, '2510.26358v1', 'AgriGS-SLAM: Orchard Mapping Across Seasons via Multi-View Gaussian Splatting SLAM')" title="添加到收藏夹">☆ 收藏</button>
