...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26670v1" onclick="toggleFavorite(this, '2510.26670v1', 'Hybrid Consistency Policy: Decoupling Multi-Modal Diversity and Real-Time Efficiency in Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
