...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26142v1" onclick="toggleFavorite(this, '2510.26142v1', 'Adaptive Trajectory Refinement for Optimization-based Local Planning in Narrow Passages')" title="添加到收藏夹">☆ 收藏</button>
