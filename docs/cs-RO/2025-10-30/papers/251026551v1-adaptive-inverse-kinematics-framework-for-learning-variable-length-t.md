...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26551v1" onclick="toggleFavorite(this, '2510.26551v1', 'Adaptive Inverse Kinematics Framework for Learning Variable-Length Tool Manipulation in Robotics')" title="添加到收藏夹">☆ 收藏</button>
