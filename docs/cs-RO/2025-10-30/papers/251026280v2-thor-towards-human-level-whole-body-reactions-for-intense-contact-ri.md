...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26280v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.26280v2', 'Thor: Towards Human-Level Whole-Body Reactions for Intense Contact-Rich Environments')" title="添加到收藏夹">☆ 收藏</button>
