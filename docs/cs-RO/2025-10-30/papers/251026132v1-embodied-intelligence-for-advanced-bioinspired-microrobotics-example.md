...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26132v1" onclick="toggleFavorite(this, '2510.26132v1', 'Embodied Intelligence for Advanced Bioinspired Microrobotics: Examples and Insights')" title="添加到收藏夹">☆ 收藏</button>
