...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26139v1" onclick="toggleFavorite(this, '2510.26139v1', 'Kinodynamic Task and Motion Planning using VLM-guided and Interleaved Sampling')" title="添加到收藏夹">☆ 收藏</button>
