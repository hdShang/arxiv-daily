...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26536v1" onclick="toggleFavorite(this, '2510.26536v1', 'RoboOS-NeXT: A Unified Memory-based Framework for Lifelong, Scalable, and Robust Multi-Robot Collaboration')" title="添加到收藏夹">☆ 收藏</button>
