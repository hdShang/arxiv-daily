...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27033v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.27033v1', 'A Multi-Modal Neuro-Symbolic Approach for Spatial Reasoning-Based Visual Grounding in Robotics')" title="添加到收藏夹">☆ 收藏</button>
