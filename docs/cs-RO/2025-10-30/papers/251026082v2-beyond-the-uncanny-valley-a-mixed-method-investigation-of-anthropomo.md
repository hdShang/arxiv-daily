...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.26082v2" onclick="toggleFavorite(this, '2510.26082v2', 'Beyond the Uncanny Valley: A Mixed-Method Investigation of Anthropomorphism in Protective Responses to Robot Abuse')" title="添加到收藏夹">☆ 收藏</button>
