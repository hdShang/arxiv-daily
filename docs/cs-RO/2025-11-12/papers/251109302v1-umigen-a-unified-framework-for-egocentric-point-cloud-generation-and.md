...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09302v1" onclick="toggleFavorite(this, '2511.09302v1', 'UMIGen: A Unified Framework for Egocentric Point Cloud Generation and Cross-Embodiment Robotic Imitation Learning')" title="添加到收藏夹">☆ 收藏</button>
