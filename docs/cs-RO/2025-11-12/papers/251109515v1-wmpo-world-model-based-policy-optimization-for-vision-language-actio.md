...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09515v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09515v1', 'WMPO: World Model-based Policy Optimization for Vision-Language-Action Models')" title="添加到收藏夹">☆ 收藏</button>
