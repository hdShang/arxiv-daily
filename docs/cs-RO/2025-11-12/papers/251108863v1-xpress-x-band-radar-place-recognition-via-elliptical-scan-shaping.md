...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08863v1" onclick="toggleFavorite(this, '2511.08863v1', 'XPRESS: X-Band Radar Place Recognition via Elliptical Scan Shaping')" title="添加到收藏夹">☆ 收藏</button>
