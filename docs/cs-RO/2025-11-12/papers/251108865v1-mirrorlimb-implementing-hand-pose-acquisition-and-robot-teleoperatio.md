...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08865v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08865v1', 'MirrorLimb: Implementing hand pose acquisition and robot teleoperation based on RealMirror')" title="添加到收藏夹">☆ 收藏</button>
