...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.09091" class="toolbar-btn" target="_blank">📄 arXiv: 2511.09091v2</a>
  <a href="https://arxiv.org/pdf/2511.09091.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09091v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09091v2', 'APEX: Action Priors Enable Efficient Exploration for Robust Motion Tracking on Legged Robots')" title="添加到收藏夹">☆ 收藏</button>
