...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09727v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09727v1', 'Baby Sophia: A Developmental Approach to Self-Exploration through Self-Touch and Hand Regard')" title="添加到收藏夹">☆ 收藏</button>
