...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08935v1" onclick="toggleFavorite(this, '2511.08935v1', 'Expand Your SCOPE: Semantic Cognition over Potential-Based Exploration for Embodied Visual Navigation')" title="添加到收藏夹">☆ 收藏</button>
