...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09072v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09072v1', 'SMF-VO: Direct Ego-Motion Estimation via Sparse Motion Fields')" title="添加到收藏夹">☆ 收藏</button>
