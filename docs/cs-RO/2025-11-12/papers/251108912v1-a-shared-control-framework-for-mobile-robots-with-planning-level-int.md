...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.08912v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.08912v1', 'A Shared Control Framework for Mobile Robots with Planning-Level Intention Prediction')" title="添加到收藏夹">☆ 收藏</button>
