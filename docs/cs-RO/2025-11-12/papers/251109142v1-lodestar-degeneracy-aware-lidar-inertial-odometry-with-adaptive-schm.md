...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09142v1" onclick="toggleFavorite(this, '2511.09142v1', 'LODESTAR: Degeneracy-Aware LiDAR-Inertial Odometry with Adaptive Schmidt-Kalman Filter and Data Exploitation')" title="添加到收藏夹">☆ 收藏</button>
