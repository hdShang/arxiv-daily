...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09141v1" onclick="toggleFavorite(this, '2511.09141v1', 'RGMP: Recurrent Geometric-prior Multimodal Policy for Generalizable Humanoid Robot Manipulation')" title="添加到收藏夹">☆ 收藏</button>
