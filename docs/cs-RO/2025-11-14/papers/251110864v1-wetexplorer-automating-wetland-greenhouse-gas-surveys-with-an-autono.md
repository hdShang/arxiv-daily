...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10864v1" onclick="toggleFavorite(this, '2511.10864v1', 'WetExplorer: Automating Wetland Greenhouse-Gas Surveys with an Autonomous Mobile Robot')" title="添加到收藏夹">☆ 收藏</button>
