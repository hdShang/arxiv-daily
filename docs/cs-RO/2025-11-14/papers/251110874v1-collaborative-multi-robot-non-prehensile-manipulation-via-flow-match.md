...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10874v1" onclick="toggleFavorite(this, '2511.10874v1', 'Collaborative Multi-Robot Non-Prehensile Manipulation via Flow-Matching Co-Generation')" title="添加到收藏夹">☆ 收藏</button>
