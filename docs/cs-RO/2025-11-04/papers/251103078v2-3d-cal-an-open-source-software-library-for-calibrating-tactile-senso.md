...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03078v2" onclick="toggleFavorite(this, '2511.03078v2', '3D Cal: An Open-Source Software Library for Calibrating Tactile Sensors')" title="添加到收藏夹">☆ 收藏</button>
