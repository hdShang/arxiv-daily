...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02294v1" onclick="toggleFavorite(this, '2511.02294v1', 'SuckTac: Camera-based Tactile Sucker for Unstructured Surface Perception and Interaction')" title="添加到收藏夹">☆ 收藏</button>
