...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.02342v2" onclick="toggleFavorite(this, '2511.02342v2', 'Whole-body motion planning and safety-critical control for aerial manipulation')" title="添加到收藏夹">☆ 收藏</button>
