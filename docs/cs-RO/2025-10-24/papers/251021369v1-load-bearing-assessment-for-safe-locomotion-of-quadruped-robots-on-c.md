...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21369v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21369v1', 'Load-bearing Assessment for Safe Locomotion of Quadruped Robots on Collapsing Terrain')" title="添加到收藏夹">☆ 收藏</button>
