...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21609v1" onclick="toggleFavorite(this, '2510.21609v1', 'Enhancing Tactile-based Reinforcement Learning for Robotic Control')" title="添加到收藏夹">☆ 收藏</button>
