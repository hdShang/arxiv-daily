...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21571v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21571v1', 'Scalable Vision-Language-Action Model Pretraining for Robotic Manipulation with Real-Life Human Activity Videos')" title="添加到收藏夹">☆ 收藏</button>
