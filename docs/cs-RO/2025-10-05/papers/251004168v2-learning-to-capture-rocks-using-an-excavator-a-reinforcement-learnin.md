...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04168v2" onclick="toggleFavorite(this, '2510.04168v2', 'Learning to Capture Rocks using an Excavator: A Reinforcement Learning Approach with Guiding Reward Formulation')" title="添加到收藏夹">☆ 收藏</button>
