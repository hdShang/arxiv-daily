...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04171v1" onclick="toggleFavorite(this, '2510.04171v1', 'VBM-NET: Visual Base Pose Learning for Mobile Manipulation using Equivariant TransporterNet and GNNs')" title="添加到收藏夹">☆ 收藏</button>
