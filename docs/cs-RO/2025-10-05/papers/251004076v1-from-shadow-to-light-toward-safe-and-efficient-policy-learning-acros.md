...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04076v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04076v1', 'From Shadow to Light: Toward Safe and Efficient Policy Learning Across MPC, DeePC, RL, and LLM Agents')" title="添加到收藏夹">☆ 收藏</button>
