...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04190v1" onclick="toggleFavorite(this, '2510.04190v1', 'Zenbo Patrol: A Social Assistive Robot Based on Multimodal Deep Learning for Real-time Illegal Parking Recognition and Notification')" title="添加到收藏夹">☆ 收藏</button>
