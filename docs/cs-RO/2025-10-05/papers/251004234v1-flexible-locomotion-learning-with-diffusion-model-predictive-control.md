...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04234v1" onclick="toggleFavorite(this, '2510.04234v1', 'Flexible Locomotion Learning with Diffusion Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
