...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04041v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.04041v1', 'SITCOM: Scaling Inference-Time COMpute for VLAs')" title="添加到收藏夹">☆ 收藏</button>
