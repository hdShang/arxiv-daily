...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.04353v1" onclick="toggleFavorite(this, '2510.04353v1', 'Stability-Aware Retargeting for Humanoid Multi-Contact Teleoperation')" title="添加到收藏夹">☆ 收藏</button>
