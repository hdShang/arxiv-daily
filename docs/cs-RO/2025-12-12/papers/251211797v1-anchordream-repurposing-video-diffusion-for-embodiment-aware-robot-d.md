...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11797v1" onclick="toggleFavorite(this, '2512.11797v1', 'AnchorDream: Repurposing Video Diffusion for Embodiment-Aware Robot Data Synthesis')" title="添加到收藏夹">☆ 收藏</button>
