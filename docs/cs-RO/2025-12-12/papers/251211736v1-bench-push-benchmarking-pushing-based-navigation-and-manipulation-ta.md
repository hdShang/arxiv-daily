...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11736v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11736v1', 'Bench-Push: Benchmarking Pushing-based Navigation and Manipulation Tasks for Mobile Robots')" title="添加到收藏夹">☆ 收藏</button>
