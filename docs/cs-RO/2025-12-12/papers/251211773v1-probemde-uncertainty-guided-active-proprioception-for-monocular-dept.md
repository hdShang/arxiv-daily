...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11773v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11773v1', 'ProbeMDE: Uncertainty-Guided Active Proprioception for Monocular Depth Estimation in Surgical Robotics')" title="添加到收藏夹">☆ 收藏</button>
