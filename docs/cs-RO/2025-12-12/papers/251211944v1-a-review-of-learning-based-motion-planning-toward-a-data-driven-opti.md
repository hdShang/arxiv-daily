...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11944v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11944v1', 'A Review of Learning-Based Motion Planning: Toward a Data-Driven Optimal Control Approach')" title="添加到收藏夹">☆ 收藏</button>
