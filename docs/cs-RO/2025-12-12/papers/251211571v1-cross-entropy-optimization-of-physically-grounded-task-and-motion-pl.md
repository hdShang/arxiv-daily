...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11571v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11571v1', 'Cross-Entropy Optimization of Physically Grounded Task and Motion Plans')" title="添加到收藏夹">☆ 收藏</button>
