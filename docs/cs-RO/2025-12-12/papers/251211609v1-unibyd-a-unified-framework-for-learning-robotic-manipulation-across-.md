...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11609v1" onclick="toggleFavorite(this, '2512.11609v1', 'UniBYD: A Unified Framework for Learning Robotic Manipulation Across Embodiments Beyond Imitation of Human Demonstrations')" title="添加到收藏夹">☆ 收藏</button>
