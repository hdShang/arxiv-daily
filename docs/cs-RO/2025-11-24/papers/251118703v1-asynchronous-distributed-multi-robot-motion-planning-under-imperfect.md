...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18703v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.18703v1', 'Asynchronous Distributed Multi-Robot Motion Planning Under Imperfect Communication')" title="添加到收藏夹">☆ 收藏</button>
