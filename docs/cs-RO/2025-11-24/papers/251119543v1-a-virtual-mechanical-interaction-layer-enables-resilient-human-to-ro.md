...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19543v1" onclick="toggleFavorite(this, '2511.19543v1', 'A Virtual Mechanical Interaction Layer Enables Resilient Human-to-Robot Object Handovers')" title="添加到收藏夹">☆ 收藏</button>
