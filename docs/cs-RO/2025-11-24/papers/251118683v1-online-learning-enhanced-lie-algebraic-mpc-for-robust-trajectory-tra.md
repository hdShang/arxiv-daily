...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18683v1" onclick="toggleFavorite(this, '2511.18683v1', 'Online Learning-Enhanced Lie Algebraic MPC for Robust Trajectory Tracking of Autonomous Surface Vehicles')" title="添加到收藏夹">☆ 收藏</button>
