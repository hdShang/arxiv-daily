...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19031v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19031v2', 'Multi-Agent Monocular Dense SLAM With 3D Reconstruction Priors')" title="添加到收藏夹">☆ 收藏</button>
