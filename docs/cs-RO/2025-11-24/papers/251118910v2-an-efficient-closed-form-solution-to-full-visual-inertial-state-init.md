...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18910v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.18910v2', 'An Efficient Closed-Form Solution to Full Visual-Inertial State Initialization')" title="添加到收藏夹">☆ 收藏</button>
