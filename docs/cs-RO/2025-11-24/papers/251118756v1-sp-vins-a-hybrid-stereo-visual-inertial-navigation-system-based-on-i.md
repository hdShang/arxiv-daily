...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18756v1" onclick="toggleFavorite(this, '2511.18756v1', 'SP-VINS: A Hybrid Stereo Visual Inertial Navigation System based on Implicit Environmental Map')" title="添加到收藏夹">☆ 收藏</button>
