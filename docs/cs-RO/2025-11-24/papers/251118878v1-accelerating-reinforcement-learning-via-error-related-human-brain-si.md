...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18878v1" onclick="toggleFavorite(this, '2511.18878v1', 'Accelerating Reinforcement Learning via Error-Related Human Brain Signals')" title="添加到收藏夹">☆ 收藏</button>
