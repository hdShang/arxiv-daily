...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00062v1" onclick="toggleFavorite(this, '2512.00062v1', 'SpeedAug: Policy Acceleration via Tempo-Enriched Policy and RL Fine-Tuning')" title="添加到收藏夹">☆ 收藏</button>
