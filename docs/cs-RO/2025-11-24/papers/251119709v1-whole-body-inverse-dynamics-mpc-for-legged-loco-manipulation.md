...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19709v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19709v1', 'Whole-Body Inverse Dynamics MPC for Legged Loco-Manipulation')" title="添加到收藏夹">☆ 收藏</button>
