...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18702v1" onclick="toggleFavorite(this, '2511.18702v1', 'CNN-Based Camera Pose Estimation and Localisation of Scan Images for Aircraft Visual Inspection')" title="添加到收藏夹">☆ 收藏</button>
