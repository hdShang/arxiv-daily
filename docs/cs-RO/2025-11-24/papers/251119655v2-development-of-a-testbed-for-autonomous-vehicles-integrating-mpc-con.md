...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19655v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.19655v2', 'Development of a Testbed for Autonomous Vehicles: Integrating MPC Control with Monocular Camera Lane Detection')" title="添加到收藏夹">☆ 收藏</button>
