...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18950v1" onclick="toggleFavorite(this, '2511.18950v1', 'Compressor-VLA: Instruction-Guided Visual Token Compression for Efficient Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
