...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05443v1" onclick="toggleFavorite(this, '2510.05443v1', 'AD-NODE: Adaptive Dynamics Learning with Neural ODEs for Mobile Robots Control')" title="添加到收藏夹">☆ 收藏</button>
