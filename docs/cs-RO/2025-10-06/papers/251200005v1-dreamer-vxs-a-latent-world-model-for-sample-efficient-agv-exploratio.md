...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00005v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00005v1', 'DREAMer-VXS: A Latent World Model for Sample-Efficient AGV Exploration in Stochastic, Unobserved Environments')" title="添加到收藏夹">☆ 收藏</button>
