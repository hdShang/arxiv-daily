...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05001v1" onclick="toggleFavorite(this, '2510.05001v1', 'Walking, Rolling, and Beyond: First-Principles and RL Locomotion on a TARS-Inspired Robot')" title="添加到收藏夹">☆ 收藏</button>
