...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05382v1" onclick="toggleFavorite(this, '2510.05382v1', 'A multi-modal tactile fingertip design for robotic hands to enhance dexterous manipulation')" title="添加到收藏夹">☆ 收藏</button>
