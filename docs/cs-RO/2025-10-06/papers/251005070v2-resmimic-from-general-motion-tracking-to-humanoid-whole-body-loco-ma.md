...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05070v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.05070v2', 'ResMimic: From General Motion Tracking to Humanoid Whole-body Loco-Manipulation via Residual Learning')" title="添加到收藏夹">☆ 收藏</button>
