...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13459v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13459v1', 'Contact-Safe Reinforcement Learning with ProMP Reparameterization and Energy Awareness')" title="添加到收藏夹">☆ 收藏</button>
