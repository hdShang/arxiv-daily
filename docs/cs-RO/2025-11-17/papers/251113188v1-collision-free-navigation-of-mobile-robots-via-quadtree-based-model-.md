...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13188v1" onclick="toggleFavorite(this, '2511.13188v1', 'Collision-Free Navigation of Mobile Robots via Quadtree-Based Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
