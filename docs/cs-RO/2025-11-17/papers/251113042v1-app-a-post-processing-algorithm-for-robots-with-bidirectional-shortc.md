...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13042v1" onclick="toggleFavorite(this, '2511.13042v1', 'APP: A* Post-Processing Algorithm for Robots with Bidirectional Shortcut and Path Perturbation')" title="添加到收藏夹">☆ 收藏</button>
