...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12912v1" onclick="toggleFavorite(this, '2511.12912v1', 'DiffuDepGrasp: Diffusion-based Depth Noise Modeling Empowers Sim2Real Robotic Grasping')" title="添加到收藏夹">☆ 收藏</button>
