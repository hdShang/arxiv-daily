...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12972v1" onclick="toggleFavorite(this, '2511.12972v1', 'SplatSearch: Instance Image Goal Navigation for Mobile Robots using 3D Gaussian Splatting and Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
