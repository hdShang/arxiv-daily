...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13327v1" onclick="toggleFavorite(this, '2511.13327v1', 'ZeroDexGrasp: Zero-Shot Task-Oriented Dexterous Grasp Synthesis with Prompt-Based Multi-Stage Semantic Reasoning')" title="添加到收藏夹">☆ 收藏</button>
