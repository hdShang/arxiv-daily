...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13312v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13312v1', 'EL3DD: Extended Latent 3D Diffusion for Language Conditioned Multitask Manipulation')" title="添加到收藏夹">☆ 收藏</button>
