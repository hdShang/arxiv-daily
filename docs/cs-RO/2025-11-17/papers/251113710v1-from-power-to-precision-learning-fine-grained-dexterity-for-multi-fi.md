...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13710v1" onclick="toggleFavorite(this, '2511.13710v1', 'From Power to Precision: Learning Fine-grained Dexterity for Multi-fingered Robotic Hands')" title="添加到收藏夹">☆ 收藏</button>
