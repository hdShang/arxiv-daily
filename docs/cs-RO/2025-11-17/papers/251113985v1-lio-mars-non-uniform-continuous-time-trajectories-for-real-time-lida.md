...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13985v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13985v1', 'LIO-MARS: Non-uniform Continuous-time Trajectories for Real-time LiDAR-Inertial-Odometry')" title="添加到收藏夹">☆ 收藏</button>
