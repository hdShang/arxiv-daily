...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2511.13048" class="toolbar-btn" target="_blank">📄 arXiv: 2511.13048v1</a>
  <a href="https://arxiv.org/pdf/2511.13048.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13048v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.13048v1', 'Unidirectional-Road-Network-Based Global Path Planning for Cleaning Robots in Semi-Structured Environments')" title="添加到收藏夹">☆ 收藏</button>
