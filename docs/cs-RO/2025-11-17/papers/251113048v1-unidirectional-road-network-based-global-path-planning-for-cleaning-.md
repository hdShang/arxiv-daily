...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.13048v1" onclick="toggleFavorite(this, '2511.13048v1', 'Unidirectional-Road-Network-Based Global Path Planning for Cleaning Robots in Semi-Structured Environments')" title="添加到收藏夹">☆ 收藏</button>
