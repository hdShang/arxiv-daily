...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12984v1" onclick="toggleFavorite(this, '2511.12984v1', 'CUTE-Planner: Confidence-aware Uneven Terrain Exploration Planner')" title="添加到收藏夹">☆ 收藏</button>
