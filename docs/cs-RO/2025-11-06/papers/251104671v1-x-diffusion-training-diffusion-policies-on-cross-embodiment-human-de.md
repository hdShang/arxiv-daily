...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04671v1" onclick="toggleFavorite(this, '2511.04671v1', 'X-Diffusion: Training Diffusion Policies on Cross-Embodiment Human Demonstrations')" title="添加到收藏夹">☆ 收藏</button>
