...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04758v1" onclick="toggleFavorite(this, '2511.04758v1', 'ScheduleStream: Temporal Planning with Samplers for GPU-Accelerated Multi-Arm Task and Motion Planning & Scheduling')" title="添加到收藏夹">☆ 收藏</button>
