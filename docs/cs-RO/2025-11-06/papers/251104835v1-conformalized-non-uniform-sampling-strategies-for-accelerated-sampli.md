...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04835v1" onclick="toggleFavorite(this, '2511.04835v1', 'Conformalized Non-uniform Sampling Strategies for Accelerated Sampling-based Motion Planning')" title="添加到收藏夹">☆ 收藏</button>
