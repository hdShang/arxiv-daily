...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04180v2" onclick="toggleFavorite(this, '2511.04180v2', 'PUL-SLAM: Path-Uncertainty Co-Optimization with Lightweight Stagnation Detection for Efficient Robotic Exploration')" title="添加到收藏夹">☆ 收藏</button>
