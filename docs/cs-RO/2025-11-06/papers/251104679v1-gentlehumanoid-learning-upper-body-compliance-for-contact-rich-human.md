...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04679v1" onclick="toggleFavorite(this, '2511.04679v1', 'GentleHumanoid: Learning Upper-body Compliance for Contact-rich Human and Object Interaction')" title="添加到收藏夹">☆ 收藏</button>
