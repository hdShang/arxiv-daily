...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04665v2" onclick="toggleFavorite(this, '2511.04665v2', 'Real-to-Sim Robot Policy Evaluation with Gaussian Splatting Simulation of Soft-Body Interactions')" title="添加到收藏夹">☆ 收藏</button>
