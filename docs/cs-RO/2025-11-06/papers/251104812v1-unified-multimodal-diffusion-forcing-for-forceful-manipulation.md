...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04812v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.04812v1', 'Unified Multimodal Diffusion Forcing for Forceful Manipulation')" title="添加到收藏夹">☆ 收藏</button>
