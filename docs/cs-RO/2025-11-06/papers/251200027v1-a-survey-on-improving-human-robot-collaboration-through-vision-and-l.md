...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00027v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00027v1', 'A Survey on Improving Human Robot Collaboration through Vision-and-Language Navigation')" title="添加到收藏夹">☆ 收藏</button>
