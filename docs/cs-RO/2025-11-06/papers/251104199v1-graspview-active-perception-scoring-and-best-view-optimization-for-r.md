...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04199v1" onclick="toggleFavorite(this, '2511.04199v1', 'GraspView: Active Perception Scoring and Best-View Optimization for Robotic Grasping in Cluttered Environments')" title="添加到收藏夹">☆ 收藏</button>
