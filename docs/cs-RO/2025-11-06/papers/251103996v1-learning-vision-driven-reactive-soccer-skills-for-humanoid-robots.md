...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.03996v1" onclick="toggleFavorite(this, '2511.03996v1', 'Learning Vision-Driven Reactive Soccer Skills for Humanoid Robots')" title="添加到收藏夹">☆ 收藏</button>
