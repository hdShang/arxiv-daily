...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.04109v1" onclick="toggleFavorite(this, '2511.04109v1', 'CBMC-V3: A CNS-inspired Control Framework Towards Manipulation Agility with SNN')" title="添加到收藏夹">☆ 收藏</button>
