...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20394v1" onclick="toggleFavorite(this, '2511.20394v1', 'Improved adaptive wind driven optimization algorithm for real-time path planning')" title="添加到收藏夹">☆ 收藏</button>
