...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00076v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00076v1', 'Arcadia: Toward a Full-Lifecycle Framework for Embodied Lifelong Learning')" title="添加到收藏夹">☆ 收藏</button>
