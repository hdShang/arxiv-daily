...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20299v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20299v1', 'How Robot Kinematics Influence Human Performance in Virtual Robot-to-Human Handover Tasks')" title="添加到收藏夹">☆ 收藏</button>
