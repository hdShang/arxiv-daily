...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.19859v1" onclick="toggleFavorite(this, '2511.19859v1', 'Unifying Perception and Action: A Hybrid-Modality Pipeline with Implicit Visual Chain-of-Thought for Robotic Action Generation')" title="添加到收藏夹">☆ 收藏</button>
