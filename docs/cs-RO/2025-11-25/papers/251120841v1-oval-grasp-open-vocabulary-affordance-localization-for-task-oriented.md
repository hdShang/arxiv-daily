...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20841v1" onclick="toggleFavorite(this, '2511.20841v1', 'OVAL-Grasp: Open-Vocabulary Affordance Localization for Task Oriented Grasping')" title="添加到收藏夹">☆ 收藏</button>
