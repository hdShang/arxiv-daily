...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.20496v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.20496v1', 'Metric, inertially aligned monocular state estimation via kinetodynamic priors')" title="添加到收藏夹">☆ 收藏</button>
