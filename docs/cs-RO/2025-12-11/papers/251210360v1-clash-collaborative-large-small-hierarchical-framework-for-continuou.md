...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10360v1" onclick="toggleFavorite(this, '2512.10360v1', 'CLASH: Collaborative Large-Small Hierarchical Framework for Continuous Vision-and-Language Navigation')" title="添加到收藏夹">☆ 收藏</button>
