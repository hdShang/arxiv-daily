...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10349v1" onclick="toggleFavorite(this, '2512.10349v1', 'Design and Validation of an Under-actuated Robotic Finger with Synchronous Tendon Routing')" title="添加到收藏夹">☆ 收藏</button>
