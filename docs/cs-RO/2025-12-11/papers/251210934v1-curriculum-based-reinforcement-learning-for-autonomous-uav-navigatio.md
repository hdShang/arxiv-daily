...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10934v1" onclick="toggleFavorite(this, '2512.10934v1', 'Curriculum-Based Reinforcement Learning for Autonomous UAV Navigation in Unknown Curved Tubular Conduit')" title="添加到收藏夹">☆ 收藏</button>
