...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10540v1" onclick="toggleFavorite(this, '2512.10540v1', 'Mr. Virgil: Learning Multi-robot Visual-range Relative Localization')" title="添加到收藏夹">☆ 收藏</button>
