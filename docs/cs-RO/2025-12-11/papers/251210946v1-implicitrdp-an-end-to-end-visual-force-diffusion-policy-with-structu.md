...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10946v1" onclick="toggleFavorite(this, '2512.10946v1', 'ImplicitRDP: An End-to-End Visual-Force Diffusion Policy with Structural Slow-Fast Learning')" title="添加到收藏夹">☆ 收藏</button>
