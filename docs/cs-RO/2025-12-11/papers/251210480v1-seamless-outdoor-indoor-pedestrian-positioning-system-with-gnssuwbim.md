...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10480v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10480v1', 'Seamless Outdoor-Indoor Pedestrian Positioning System with GNSS/UWB/IMU Fusion: A Comparison of EKF, FGO, and PF')" title="添加到收藏夹">☆ 收藏</button>
