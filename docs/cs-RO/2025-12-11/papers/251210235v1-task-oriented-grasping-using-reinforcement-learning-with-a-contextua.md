...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10235v1" onclick="toggleFavorite(this, '2512.10235v1', 'Task-Oriented Grasping Using Reinforcement Learning with a Contextual Reward Machine')" title="添加到收藏夹">☆ 收藏</button>
