...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10481v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.10481v1', 'Contact SLAM: An Active Tactile Exploration Policy Based on Physical Reasoning Utilized in Robotic Fine Blind Manipulation Tasks')" title="添加到收藏夹">☆ 收藏</button>
