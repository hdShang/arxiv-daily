...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2505.13722" class="toolbar-btn" target="_blank">📄 arXiv: 2505.13722v1</a>
  <a href="https://arxiv.org/pdf/2505.13722.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2505.13722v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2505.13722v1', 'Practice Makes Perfect: A Study of Digital Twin Technology for Assembly and Problem-solving using Lunar Surface Telerobotics')" title="添加到收藏夹">☆ 收藏</button>
...
1. 现有的机器人系统在极端环境下的自主操作能力有限，导致需要人类的遥控和监督，增加了任务的复杂性和风险。
2. 本研究提出了一种虚拟现实数字双胞胎系统，旨在通过模拟环境来训练人类操作员，提高遥控机器人的效率和准确性。
3. 实验结果表明，使用数字双胞胎系统的操作员在任务完成时间和错误率上均有显著改善，同时认知负荷和情境意识也得到了提升。
