...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11824v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.11824v1', 'ReGlove: A Soft Pneumatic Glove for Activities of Daily Living Assistance via Wrist-Mounted Vision')" title="添加到收藏夹">☆ 收藏</button>
