...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16158v1" onclick="toggleFavorite(this, '2511.16158v1', 'MagBotSim: Physics-Based Simulation and Reinforcement Learning Environments for Magnetic Robotics')" title="添加到收藏夹">☆ 收藏</button>
