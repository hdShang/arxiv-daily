...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16048v1" onclick="toggleFavorite(this, '2511.16048v1', 'Semantic Glitch: Agency and Artistry in an Autonomous Pixel Cloud')" title="添加到收藏夹">☆ 收藏</button>
