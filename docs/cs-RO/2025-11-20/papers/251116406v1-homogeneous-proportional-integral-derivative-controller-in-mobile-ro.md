...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16406v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16406v1', 'Homogeneous Proportional-Integral-Derivative Controller in Mobile Robotic Manipulators')" title="添加到收藏夹">☆ 收藏</button>
