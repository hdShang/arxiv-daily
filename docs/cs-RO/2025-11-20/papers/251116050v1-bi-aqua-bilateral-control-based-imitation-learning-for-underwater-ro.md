...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16050v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16050v1', 'Bi-AQUA: Bilateral Control-Based Imitation Learning for Underwater Robot Arms via Lighting-Aware Action Chunking with Transformers')" title="添加到收藏夹">☆ 收藏</button>
