...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16372v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16372v2', 'Flow-Aided Flight Through Dynamic Clutters From Point To Motion')" title="添加到收藏夹">☆ 收藏</button>
