...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.15995v1" onclick="toggleFavorite(this, '2511.15995v1', 'PushingBots: Collaborative Pushing via Neural Accelerated Combinatorial Hybrid Optimization')" title="添加到收藏夹">☆ 收藏</button>
