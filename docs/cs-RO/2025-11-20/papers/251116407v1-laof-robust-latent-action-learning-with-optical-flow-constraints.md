...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.16407v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.16407v1', 'LAOF: Robust Latent Action Learning with Optical Flow Constraints')" title="添加到收藏夹">☆ 收藏</button>
