...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22740v1" onclick="toggleFavorite(this, '2510.22740v1', 'Policies over Poses: Reinforcement Learning based Distributed Pose-Graph Optimization for Multi-Robot SLAM')" title="添加到收藏夹">☆ 收藏</button>
