...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22699v1" onclick="toggleFavorite(this, '2510.22699v1', 'RL-AVIST: Reinforcement Learning for Autonomous Visual Inspection of Space Targets')" title="添加到收藏夹">☆ 收藏</button>
