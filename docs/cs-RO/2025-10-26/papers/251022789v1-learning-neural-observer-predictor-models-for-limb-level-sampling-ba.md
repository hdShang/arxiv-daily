...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22789v1" onclick="toggleFavorite(this, '2510.22789v1', 'Learning Neural Observer-Predictor Models for Limb-level Sampling-based Locomotion Planning')" title="添加到收藏夹">☆ 收藏</button>
