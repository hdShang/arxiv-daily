...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22524v1" onclick="toggleFavorite(this, '2510.22524v1', 'Ant-inspired Walling Strategies for Scalable Swarm Separation: Reinforcement Learning Approaches Based on Finite State Machines')" title="添加到收藏夹">☆ 收藏</button>
