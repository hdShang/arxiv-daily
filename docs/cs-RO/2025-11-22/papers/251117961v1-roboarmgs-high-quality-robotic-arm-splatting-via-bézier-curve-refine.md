...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17961v1" onclick="toggleFavorite(this, '2511.17961v1', 'RoboArmGS: High-Quality Robotic Arm Splatting via Bézier Curve Refinement')" title="添加到收藏夹">☆ 收藏</button>
