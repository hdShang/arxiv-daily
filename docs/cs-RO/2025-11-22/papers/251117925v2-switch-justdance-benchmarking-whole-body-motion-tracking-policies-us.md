...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17925v2" onclick="toggleFavorite(this, '2511.17925v2', 'Switch-JustDance: Benchmarking Whole Body Motion Tracking Policies Using a Commercial Console Game')" title="添加到收藏夹">☆ 收藏</button>
