...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18140v1" onclick="toggleFavorite(this, '2511.18140v1', 'Observer Actor: Active Vision Imitation Learning with Sparse View Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
