...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18183v1" onclick="toggleFavorite(this, '2511.18183v1', 'Off-Road Navigation via Implicit Neural Representation of Terrain Traversability')" title="添加到收藏夹">☆ 收藏</button>
