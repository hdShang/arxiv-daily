...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18085v2" onclick="toggleFavorite(this, '2511.18085v2', 'Continually Evolving Skill Knowledge in Vision Language Action Model')" title="添加到收藏夹">☆ 收藏</button>
