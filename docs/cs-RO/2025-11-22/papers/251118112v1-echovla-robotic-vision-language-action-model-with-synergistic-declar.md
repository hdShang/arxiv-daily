...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18112v1" onclick="toggleFavorite(this, '2511.18112v1', 'EchoVLA: Robotic Vision-Language-Action Model with Synergistic Declarative Memory for Mobile Manipulation')" title="添加到收藏夹">☆ 收藏</button>
