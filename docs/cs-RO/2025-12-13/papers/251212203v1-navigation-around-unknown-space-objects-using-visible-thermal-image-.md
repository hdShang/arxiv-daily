...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12203v1" onclick="toggleFavorite(this, '2512.12203v1', 'Navigation Around Unknown Space Objects Using Visible-Thermal Image Fusion')" title="添加到收藏夹">☆ 收藏</button>
