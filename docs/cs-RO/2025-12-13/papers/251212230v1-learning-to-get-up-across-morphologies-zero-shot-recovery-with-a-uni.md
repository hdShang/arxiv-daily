...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12230v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.12230v1', 'Learning to Get Up Across Morphologies: Zero-Shot Recovery with a Unified Humanoid Policy')" title="添加到收藏夹">☆ 收藏</button>
