...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12427v1" onclick="toggleFavorite(this, '2512.12427v1', 'Unifying Quadrotor Motion Planning and Control by Chaining Different Fidelity Models')" title="添加到收藏夹">☆ 收藏</button>
