...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12233v1" onclick="toggleFavorite(this, '2512.12233v1', 'Robust Underwater Localization of Buoyancy Driven microFloats Using Acoustic Time-of-Flight Measurements')" title="添加到收藏夹">☆ 收藏</button>
