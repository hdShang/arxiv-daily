...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.12320v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.12320v1', 'Programmable Deformation Design of Porous Soft Actuator through Volumetric-Pattern-Induced Anisotropy')" title="添加到收藏夹">☆ 收藏</button>
