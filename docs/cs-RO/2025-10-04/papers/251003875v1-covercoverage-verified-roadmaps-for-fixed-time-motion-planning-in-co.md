...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03875v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03875v1', 'COVER:COverage-VErified Roadmaps for Fixed-time Motion Planning in Continuous Semi-Static Environments')" title="添加到收藏夹">☆ 收藏</button>
