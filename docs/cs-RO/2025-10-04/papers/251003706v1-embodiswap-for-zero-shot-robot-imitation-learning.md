...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03706v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03706v1', 'EmbodiSwap for Zero-Shot Robot Imitation Learning')" title="添加到收藏夹">☆ 收藏</button>
