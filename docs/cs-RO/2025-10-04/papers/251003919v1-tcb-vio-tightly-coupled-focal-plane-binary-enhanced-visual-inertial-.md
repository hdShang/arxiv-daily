...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03919v1" onclick="toggleFavorite(this, '2510.03919v1', 'TCB-VIO: Tightly-Coupled Focal-Plane Binary-Enhanced Visual Inertial Odometry')" title="添加到收藏夹">☆ 收藏</button>
