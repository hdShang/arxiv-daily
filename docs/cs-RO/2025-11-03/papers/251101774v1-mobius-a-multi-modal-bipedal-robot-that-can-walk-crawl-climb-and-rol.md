...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01774v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01774v1', 'MOBIUS: A Multi-Modal Bipedal Robot that can Walk, Crawl, Climb, and Roll')" title="添加到收藏夹">☆ 收藏</button>
