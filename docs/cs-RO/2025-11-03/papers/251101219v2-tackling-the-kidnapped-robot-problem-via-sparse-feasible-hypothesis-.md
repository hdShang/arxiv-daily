...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01219v2" onclick="toggleFavorite(this, '2511.01219v2', 'Tackling the Kidnapped Robot Problem via Sparse Feasible Hypothesis Sampling and Reliable Batched Multi-Stage Inference')" title="添加到收藏夹">☆ 收藏</button>
