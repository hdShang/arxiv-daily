...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01186v1" onclick="toggleFavorite(this, '2511.01186v1', 'LiDAR-VGGT: Cross-Modal Coarse-to-Fine Fusion for Globally Consistent and Metric-Scale Dense Mapping')" title="添加到收藏夹">☆ 收藏</button>
