...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01177v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01177v2', 'Scaling Cross-Embodiment World Models for Dexterous Manipulation')" title="添加到收藏夹">☆ 收藏</button>
