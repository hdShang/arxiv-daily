...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01520v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01520v1', 'Phy-Tac: Toward Human-Like Grasping via Physics-Conditioned Tactile Goals')" title="添加到收藏夹">☆ 收藏</button>
