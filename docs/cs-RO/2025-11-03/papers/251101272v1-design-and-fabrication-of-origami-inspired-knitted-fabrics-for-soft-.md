...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01272v1" onclick="toggleFavorite(this, '2511.01272v1', 'Design and Fabrication of Origami-Inspired Knitted Fabrics for Soft Robotics')" title="添加到收藏夹">☆ 收藏</button>
