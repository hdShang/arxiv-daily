...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01770v1" onclick="toggleFavorite(this, '2511.01770v1', 'Lightweight Learning from Actuation-Space Demonstrations via Flow Matching for Whole-Body Soft Robotic Grasping')" title="添加到收藏夹">☆ 收藏</button>
