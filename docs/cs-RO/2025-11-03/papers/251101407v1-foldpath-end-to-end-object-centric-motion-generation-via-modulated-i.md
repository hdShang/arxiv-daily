...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01407v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01407v1', 'FoldPath: End-to-End Object-Centric Motion Generation via Modulated Implicit Paths')" title="添加到收藏夹">☆ 收藏</button>
