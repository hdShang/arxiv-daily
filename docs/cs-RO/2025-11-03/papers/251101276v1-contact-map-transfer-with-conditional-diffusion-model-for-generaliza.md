...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01276v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.01276v1', 'Contact Map Transfer with Conditional Diffusion Model for Generalizable Dexterous Grasp Generation')" title="添加到收藏夹">☆ 收藏</button>
