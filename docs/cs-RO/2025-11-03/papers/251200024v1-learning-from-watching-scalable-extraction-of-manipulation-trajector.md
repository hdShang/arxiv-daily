...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00024v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00024v1', 'Learning from Watching: Scalable Extraction of Manipulation Trajectories from Human Videos')" title="添加到收藏夹">☆ 收藏</button>
