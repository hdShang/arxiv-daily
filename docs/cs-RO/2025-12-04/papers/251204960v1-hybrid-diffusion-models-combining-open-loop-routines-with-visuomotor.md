...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04960v1" onclick="toggleFavorite(this, '2512.04960v1', 'Hybrid-Diffusion Models: Combining Open-loop Routines with Visuomotor Diffusion Policies')" title="添加到收藏夹">☆ 收藏</button>
