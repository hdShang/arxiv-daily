...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05008v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05008v1', 'Contact-Implicit Modeling and Simulation of a Snake Robot on Compliant and Granular Terrain')" title="添加到收藏夹">☆ 收藏</button>
