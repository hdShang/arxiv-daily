...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04446v1" onclick="toggleFavorite(this, '2512.04446v1', 'Vision-Language-Action Models for Selective Robotic Disassembly: A Case Study on Critical Component Extraction from Desktops')" title="添加到收藏夹">☆ 收藏</button>
