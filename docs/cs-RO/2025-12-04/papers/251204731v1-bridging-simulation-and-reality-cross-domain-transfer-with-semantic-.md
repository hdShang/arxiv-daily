...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04731v1" onclick="toggleFavorite(this, '2512.04731v1', 'Bridging Simulation and Reality: Cross-Domain Transfer with Semantic 2D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
