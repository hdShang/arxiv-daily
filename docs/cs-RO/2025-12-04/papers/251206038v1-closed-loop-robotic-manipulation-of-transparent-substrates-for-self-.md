...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06038v1" onclick="toggleFavorite(this, '2512.06038v1', 'Closed-Loop Robotic Manipulation of Transparent Substrates for Self-Driving Laboratories using Deep Learning Micro-Error Correction')" title="添加到收藏夹">☆ 收藏</button>
