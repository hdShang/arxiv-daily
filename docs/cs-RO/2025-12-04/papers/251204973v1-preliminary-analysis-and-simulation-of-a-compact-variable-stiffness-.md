...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04973v1" onclick="toggleFavorite(this, '2512.04973v1', 'Preliminary Analysis and Simulation of a Compact Variable Stiffness Wrist')" title="添加到收藏夹">☆ 收藏</button>
