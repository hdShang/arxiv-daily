...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04381v1" onclick="toggleFavorite(this, '2512.04381v1', 'FALCON: Actively Decoupled Visuomotor Policies for Loco-Manipulation with Foundation-Model-Based Coordination')" title="添加到收藏夹">☆ 收藏</button>
