...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04373v1" onclick="toggleFavorite(this, '2512.04373v1', 'Vertical Planetary Landing on Sloped Terrain Using Optical Flow Divergence Estimates')" title="添加到收藏夹">☆ 收藏</button>
