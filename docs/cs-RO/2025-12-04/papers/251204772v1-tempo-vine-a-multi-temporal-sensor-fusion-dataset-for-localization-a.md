...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04772v1" onclick="toggleFavorite(this, '2512.04772v1', 'TEMPO-VINE: A Multi-Temporal Sensor Fusion Dataset for Localization and Mapping in Vineyards')" title="添加到收藏夹">☆ 收藏</button>
