...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05211v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.05211v1', 'Wake Vectoring for Efficient Morphing Flight')" title="添加到收藏夹">☆ 收藏</button>
