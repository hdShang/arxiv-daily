...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06207v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06207v1', 'Where to Fly, What to Send: Communication-Aware Aerial Support for Ground Robots')" title="添加到收藏夹">☆ 收藏</button>
