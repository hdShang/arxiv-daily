...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06112v2" onclick="toggleFavorite(this, '2512.06112v2', 'WAM-Flow: Parallel Coarse-to-Fine Motion Planning via Discrete Flow Matching for Autonomous Driving')" title="添加到收藏夹">☆ 收藏</button>
