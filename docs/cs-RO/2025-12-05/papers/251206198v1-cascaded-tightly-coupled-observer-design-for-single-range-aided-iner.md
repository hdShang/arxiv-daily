...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06198v1" onclick="toggleFavorite(this, '2512.06198v1', 'Cascaded Tightly-Coupled Observer Design for Single-Range-Aided Inertial Navigation')" title="添加到收藏夹">☆ 收藏</button>
