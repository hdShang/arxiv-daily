...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.05955v1" onclick="toggleFavorite(this, '2512.05955v1', 'SIMPACT: Simulation-Enabled Action Planning using Vision-Language Models')" title="添加到收藏夹">☆ 收藏</button>
