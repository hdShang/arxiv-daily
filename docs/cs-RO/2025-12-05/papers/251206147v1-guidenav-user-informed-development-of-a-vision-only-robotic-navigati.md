...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06147v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.06147v1', 'GuideNav: User-Informed Development of a Vision-Only Robotic Navigation Assistant For Blind Travelers')" title="添加到收藏夹">☆ 收藏</button>
