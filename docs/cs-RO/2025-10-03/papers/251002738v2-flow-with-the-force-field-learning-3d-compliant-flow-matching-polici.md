...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02738v2" onclick="toggleFavorite(this, '2510.02738v2', 'Flow with the Force Field: Learning 3D Compliant Flow Matching Policies from Force and Demonstration-Guided Simulation Data')" title="添加到收藏夹">☆ 收藏</button>
