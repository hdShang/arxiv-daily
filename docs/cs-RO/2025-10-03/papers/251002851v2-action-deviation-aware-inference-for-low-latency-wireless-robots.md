...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02851v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02851v2', 'Action Deviation-Aware Inference for Low-Latency Wireless Robots')" title="添加到收藏夹">☆ 收藏</button>
