...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03460v1" onclick="toggleFavorite(this, '2510.03460v1', 'Warm-Starting Optimization-Based Motion Planning for Robotic Manipulators via Point Cloud-Conditioned Flow Matching')" title="添加到收藏夹">☆ 收藏</button>
