...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.03460" target="_blank" class="toolbar-btn">arXiv: 2510.03460v1</a>
    <a href="https://arxiv.org/pdf/2510.03460.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03460v1" 
            onclick="toggleFavorite(this, '2510.03460v1', 'Warm-Starting Optimization-Based Motion Planning for Robotic Manipulators via Point Cloud-Conditioned Flow Matching')" title="收藏">
      ☆ 收藏
    </button>
