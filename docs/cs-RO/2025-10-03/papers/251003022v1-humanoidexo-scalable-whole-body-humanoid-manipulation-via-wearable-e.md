...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03022v1" onclick="toggleFavorite(this, '2510.03022v1', 'HumanoidExo: Scalable Whole-Body Humanoid Manipulation via Wearable Exoskeleton')" title="添加到收藏夹">☆ 收藏</button>
