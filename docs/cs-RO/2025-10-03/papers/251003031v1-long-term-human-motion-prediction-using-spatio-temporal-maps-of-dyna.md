...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03031v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03031v1', 'Long-Term Human Motion Prediction Using Spatio-Temporal Maps of Dynamics')" title="添加到收藏夹">☆ 收藏</button>
