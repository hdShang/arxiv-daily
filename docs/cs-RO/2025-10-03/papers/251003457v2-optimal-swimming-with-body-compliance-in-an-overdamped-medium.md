...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03457v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.03457v2', 'Optimal swimming with body compliance in an overdamped medium')" title="添加到收藏夹">☆ 收藏</button>
