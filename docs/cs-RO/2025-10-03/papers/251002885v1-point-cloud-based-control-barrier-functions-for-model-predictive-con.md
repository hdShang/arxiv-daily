...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02885v1" onclick="toggleFavorite(this, '2510.02885v1', 'Point Cloud-Based Control Barrier Functions for Model Predictive Control in Safety-Critical Navigation of Autonomous Mobile Robots')" title="添加到收藏夹">☆ 收藏</button>
