...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00375v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00375v1', 'DPNet: Doppler LiDAR Motion Planning for Highly-Dynamic Environments')" title="添加到收藏夹">☆ 收藏</button>
