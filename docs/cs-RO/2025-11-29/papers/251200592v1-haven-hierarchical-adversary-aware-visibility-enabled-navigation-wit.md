...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00592v1" onclick="toggleFavorite(this, '2512.00592v1', 'HAVEN: Hierarchical Adversary-aware Visibility-Enabled Navigation with Cover Utilization using Deep Transformer Q-Networks')" title="添加到收藏夹">☆ 收藏</button>
