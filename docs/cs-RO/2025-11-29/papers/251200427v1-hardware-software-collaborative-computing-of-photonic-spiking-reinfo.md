...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00427v1" onclick="toggleFavorite(this, '2512.00427v1', 'Hardware-Software Collaborative Computing of Photonic Spiking Reinforcement Learning for Robotic Continuous Control')" title="添加到收藏夹">☆ 收藏</button>
