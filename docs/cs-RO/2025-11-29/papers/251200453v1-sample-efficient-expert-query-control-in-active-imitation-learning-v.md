...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00453v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00453v1', 'Sample-Efficient Expert Query Control in Active Imitation Learning via Conformal Prediction')" title="添加到收藏夹">☆ 收藏</button>
