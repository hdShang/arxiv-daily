...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06608v1" onclick="toggleFavorite(this, '2512.06608v1', 'A New Trajectory-Oriented Approach to Enhancing Comprehensive Crowd Navigation Performance')" title="添加到收藏夹">☆ 收藏</button>
