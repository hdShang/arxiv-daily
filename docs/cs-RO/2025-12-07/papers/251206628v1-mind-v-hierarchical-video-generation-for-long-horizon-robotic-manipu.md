...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.06628v1" onclick="toggleFavorite(this, '2512.06628v1', 'MIND-V: Hierarchical Video Generation for Long-Horizon Robotic Manipulation with RL-based Physical Alignment')" title="添加到收藏夹">☆ 收藏</button>
