...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.09613" class="toolbar-btn" target="_blank">📄 arXiv: 2509.09613v2</a>
  <a href="https://arxiv.org/pdf/2509.09613.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.09613v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.09613v2', 'MOFU: Development of a MOrphing Fluffy Unit with Expansion and Contraction Capabilities and Evaluation of the Animacy of Its Movements')" title="添加到收藏夹">☆ 收藏</button>
...
**关键词**: `社交机器人` `治疗机器人` `拟人化感知` `形变机器人` `Jitterbug机构`

## 📋 核心要点

1. 现有社交和治疗机器人研究较少关注生物体常见的整体体积变化运动对拟人化感知的影响。
2. MOFU机器人通过Jitterbug机构实现膨胀收缩，结合差速轮驱动，探索体积变化运动对拟人化感知的影响。
3. 实验表明，膨胀收缩和旋转运动均能独立提升拟人化感知，且与移动结合时效果更佳。

## 📝 摘要（中文）

本研究旨在探索机器人整体体积变化运动对人类拟人化感知的影响。为此，我们开发了一种名为MOFU（MOrphing Fluffy Unit）的移动机器人，它能够通过内置的单个电机实现整体的膨胀和收缩。MOFU采用Jitterbug几何变换机制，仅用一个驱动器即可实现直径从约210毫米到280毫米的平滑变化，并配备差速两轮驱动机构用于移动。我们进行了一项在线调查，使用MOFU行为的视频，并通过Godspeed问卷系列评估了感知的拟人化程度。结果表明，膨胀收缩和旋转运动都能独立地提高感知的拟人化程度。当膨胀收缩与移动相结合时，拟人化评分高于单独移动。这些结果表明，整体体积变化运动可以增强机器人中感知的拟人化程度，表明物理体积变化是未来社交和治疗机器人的一个重要设计元素。

## 🔬 方法详解

**问题定义**：现有社交机器人设计主要集中在类人外观或基于关节的运动，忽略了生物体常见的整体体积变化运动。因此，如何利用整体体积变化来增强机器人的拟人化感知是一个待解决的问题。现有方法缺乏对这种运动方式的系统研究和应用。

**核心思路**：本研究的核心思路是通过设计一种能够进行整体膨胀和收缩运动的机器人，并结合其他运动方式，来探索这种体积变化运动对人类拟人化感知的影响。通过实验验证，旨在证明体积变化是提升机器人拟人化程度的一个有效途径。

**技术框架**：MOFU机器人的整体框架包括以下几个主要部分：
1. **Jitterbug机构**：用于实现机器人的膨胀和收缩运动。
2. **单个电机**：驱动Jitterbug机构，实现平滑的直径变化。
3. **差速两轮驱动机构**：用于机器人的移动。
4. **蓬松外壳**：包裹整个机器人，增强其亲和力。
5. **在线调查**：通过Godspeed问卷系列评估人类对MOFU行为的拟人化感知。

**关键创新**：本研究的关键创新在于：
1. **将Jitterbug机构应用于机器人设计，实现整体体积的膨胀和收缩运动。** 这种运动方式不同于传统的基于关节的运动，更接近于某些生物的运动方式。
2. **系统地研究了整体体积变化运动对人类拟人化感知的影响。** 通过实验数据证明了这种运动方式可以有效提升机器人的拟人化程度。

**关键设计**：MOFU的关键设计包括：
1. **Jitterbug机构的参数设计**：确保膨胀和收缩运动的平滑性和稳定性。
2. **电机控制策略**：实现精确的直径控制。
3. **蓬松外壳的选择**：选择柔软、亲肤的材料，增强机器人的亲和力。
4. **Godspeed问卷系列的选择**：选择合适的问卷来评估拟人化感知。

## 📊 实验亮点

实验结果表明，MOFU的膨胀收缩运动和旋转运动都能独立地提高人类对其拟人化程度的感知。当膨胀收缩与移动相结合时，拟人化评分显著高于单独移动的情况。这表明整体体积变化运动是增强机器人拟人化感知的一个重要因素，为未来的社交和治疗机器人设计提供了新的思路。

## 🎯 应用场景

该研究成果可应用于社交机器人、治疗机器人等领域，通过赋予机器人整体体积变化的能力，增强其与人类的情感连接，提高互动效果。例如，在儿童陪伴、老年人关怀、心理治疗等场景中，具有体积变化能力的机器人可能更容易获得用户的信任和喜爱，从而发挥更大的作用。未来，可以进一步探索更复杂的形变模式和运动方式，提升机器人的智能化和情感化水平。
