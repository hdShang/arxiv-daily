...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22860v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22860v1', 'MARVO: Marine-Adaptive Radiance-aware Visual Odometry')" title="添加到收藏夹">☆ 收藏</button>
