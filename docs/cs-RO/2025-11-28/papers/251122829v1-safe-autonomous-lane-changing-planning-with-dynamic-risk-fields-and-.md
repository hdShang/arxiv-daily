...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22829v1" onclick="toggleFavorite(this, '2511.22829v1', 'Safe Autonomous Lane Changing: Planning with Dynamic Risk Fields and Time-Varying Convex Space Generation')" title="添加到收藏夹">☆ 收藏</button>
