...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.10116v1" onclick="toggleFavorite(this, '2512.10116v1', 'Fast Functionally Redundant Inverse Kinematics for Robotic Toolpath Optimisation in Manufacturing Tasks')" title="添加到收藏夹">☆ 收藏</button>
