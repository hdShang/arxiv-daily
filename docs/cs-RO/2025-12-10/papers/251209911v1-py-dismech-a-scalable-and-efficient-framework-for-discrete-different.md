...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09911v1" onclick="toggleFavorite(this, '2512.09911v1', 'Py-DiSMech: A Scalable and Efficient Framework for Discrete Differential Geometry-Based Modeling and Control of Soft Robots')" title="添加到收藏夹">☆ 收藏</button>
