...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09608v1" onclick="toggleFavorite(this, '2512.09608v1', 'Super4DR: 4D Radar-centric Self-supervised Odometry and Gaussian-based Map Optimization')" title="添加到收藏夹">☆ 收藏</button>
