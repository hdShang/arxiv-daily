...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09851v1" onclick="toggleFavorite(this, '2512.09851v1', 'Simultaneous Tactile-Visual Perception for Learning Multimodal Robot Manipulation')" title="添加到收藏夹">☆ 收藏</button>
