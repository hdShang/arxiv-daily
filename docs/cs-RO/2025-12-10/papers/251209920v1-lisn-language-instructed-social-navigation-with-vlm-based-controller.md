...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09920v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.09920v1', 'LISN: Language-Instructed Social Navigation with VLM-based Controller Modulating')" title="添加到收藏夹">☆ 收藏</button>
