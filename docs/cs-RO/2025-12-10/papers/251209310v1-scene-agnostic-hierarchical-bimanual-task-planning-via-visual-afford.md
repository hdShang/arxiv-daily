...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09310v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.09310v1', 'Scene-agnostic Hierarchical Bimanual Task Planning via Visual Affordance Reasoning')" title="添加到收藏夹">☆ 收藏</button>
