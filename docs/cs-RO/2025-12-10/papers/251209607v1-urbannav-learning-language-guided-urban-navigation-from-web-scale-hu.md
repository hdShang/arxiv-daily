...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09607v1" onclick="toggleFavorite(this, '2512.09607v1', 'UrbanNav: Learning Language-Guided Urban Navigation from Web-Scale Human Trajectories')" title="添加到收藏夹">☆ 收藏</button>
