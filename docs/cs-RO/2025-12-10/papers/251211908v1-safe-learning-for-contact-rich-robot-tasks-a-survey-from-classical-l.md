...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11908v1" onclick="toggleFavorite(this, '2512.11908v1', 'Safe Learning for Contact-Rich Robot Tasks: A Survey from Classical Learning-Based Methods to Safe Foundation Models')" title="添加到收藏夹">☆ 收藏</button>
