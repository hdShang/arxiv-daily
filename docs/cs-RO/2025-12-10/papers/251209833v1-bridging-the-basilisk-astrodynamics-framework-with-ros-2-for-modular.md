...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09833v1" onclick="toggleFavorite(this, '2512.09833v1', 'Bridging the Basilisk Astrodynamics Framework with ROS 2 for Modular Spacecraft Simulation and Hardware Integration')" title="添加到收藏夹">☆ 收藏</button>
