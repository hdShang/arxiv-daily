...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.11903v1" onclick="toggleFavorite(this, '2512.11903v1', 'Aion: Towards Hierarchical 4D Scene Graphs with Temporal Flow Dynamics')" title="添加到收藏夹">☆ 收藏</button>
