...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09798v1" onclick="toggleFavorite(this, '2512.09798v1', 'High-Resolution Water Sampling via a Solar-Powered Autonomous Surface Vehicle')" title="添加到收藏夹">☆ 收藏</button>
