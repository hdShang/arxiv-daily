...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09297v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.09297v1', 'One-Shot Real-World Demonstration Synthesis for Scalable Bimanual Manipulation')" title="添加到收藏夹">☆ 收藏</button>
