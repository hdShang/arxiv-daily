...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.09656v1" onclick="toggleFavorite(this, '2512.09656v1', 'ReMoSPLAT: Reactive Mobile Manipulation Control on a Gaussian Splat')" title="添加到收藏夹">☆ 收藏</button>
