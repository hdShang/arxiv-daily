...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22043v1" onclick="toggleFavorite(this, '2511.22043v1', 'SwordRiding: A Unified Navigation Framework for Quadrotors in Unknown Complex Environments via Online Guiding Vector Fields')" title="添加到收藏夹">☆ 收藏</button>
