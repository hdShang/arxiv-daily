...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22780v1" onclick="toggleFavorite(this, '2511.22780v1', 'Distracted Robot: How Visual Clutter Undermine Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
