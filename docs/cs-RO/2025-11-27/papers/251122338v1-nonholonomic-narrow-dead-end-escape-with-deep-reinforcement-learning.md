...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22338v1" onclick="toggleFavorite(this, '2511.22338v1', 'Nonholonomic Narrow Dead-End Escape with Deep Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
