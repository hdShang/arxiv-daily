...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22744v1" onclick="toggleFavorite(this, '2511.22744v1', 'Beyond Egocentric Limits: Multi-View Depth-Based Learning for Robust Quadrupedal Locomotion')" title="添加到收藏夹">☆ 收藏</button>
