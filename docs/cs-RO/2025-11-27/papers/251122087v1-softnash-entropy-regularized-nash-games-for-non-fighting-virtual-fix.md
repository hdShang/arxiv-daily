...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22087v1" onclick="toggleFavorite(this, '2511.22087v1', 'SoftNash: Entropy-Regularized Nash Games for Non-Fighting Virtual Fixtures')" title="添加到收藏夹">☆ 收藏</button>
