...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22100v1" onclick="toggleFavorite(this, '2511.22100v1', 'Design of an Adaptive Modular Anthropomorphic Dexterous Hand for Human-like Manipulation')" title="添加到收藏夹">☆ 收藏</button>
