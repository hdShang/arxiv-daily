...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22773v1" onclick="toggleFavorite(this, '2511.22773v1', 'CAPE: Context-Aware Diffusion Policy Via Proximal Mode Expansion for Collision Avoidance')" title="添加到收藏夹">☆ 收藏</button>
