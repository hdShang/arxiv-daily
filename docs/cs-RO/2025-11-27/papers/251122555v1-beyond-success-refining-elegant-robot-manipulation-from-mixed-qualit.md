...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22555v1" onclick="toggleFavorite(this, '2511.22555v1', 'Beyond Success: Refining Elegant Robot Manipulation from Mixed-Quality Data via Just-in-Time Intervention')" title="添加到收藏夹">☆ 收藏</button>
