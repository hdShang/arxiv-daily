...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22445v1" onclick="toggleFavorite(this, '2511.22445v1', 'Visual-Geometry Diffusion Policy: Robust Generalization via Complementarity-Aware Multimodal Fusion')" title="添加到收藏夹">☆ 收藏</button>
