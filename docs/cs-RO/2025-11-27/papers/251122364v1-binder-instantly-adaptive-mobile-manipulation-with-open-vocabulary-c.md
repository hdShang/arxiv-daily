...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22364v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22364v1', 'BINDER: Instantly Adaptive Mobile Manipulation with Open-Vocabulary Commands')" title="添加到收藏夹">☆ 收藏</button>
