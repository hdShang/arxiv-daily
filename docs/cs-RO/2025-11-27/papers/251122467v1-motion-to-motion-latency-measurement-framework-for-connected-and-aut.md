...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.22467v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.22467v1', 'Motion-to-Motion Latency Measurement Framework for Connected and Autonomous Vehicle Teleoperation')" title="添加到收藏夹">☆ 收藏</button>
