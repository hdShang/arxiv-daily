...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00021v1" onclick="toggleFavorite(this, '2512.00021v1', 'Foundation Models for Trajectory Planning in Autonomous Driving: A Review of Progress and Open Challenges')" title="添加到收藏夹">☆ 收藏</button>
