...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.27178v1" onclick="toggleFavorite(this, '2510.27178v1', 'MobiDock: Design and Control of A Modular Self Reconfigurable Bimanual Mobile Manipulator via Robotic Docking')" title="添加到收藏夹">☆ 收藏</button>
