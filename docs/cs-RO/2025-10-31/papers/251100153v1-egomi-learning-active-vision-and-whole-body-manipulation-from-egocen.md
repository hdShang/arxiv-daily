...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00153v1" onclick="toggleFavorite(this, '2511.00153v1', 'EgoMI: Learning Active Vision and Whole-Body Manipulation from Egocentric Human Demonstrations')" title="添加到收藏夹">☆ 收藏</button>
