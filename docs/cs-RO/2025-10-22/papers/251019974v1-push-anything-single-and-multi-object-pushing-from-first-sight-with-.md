...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19974v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19974v1', 'Push Anything: Single- and Multi-Object Pushing From First Sight with Contact-Implicit MPC')" title="添加到收藏夹">☆ 收藏</button>
