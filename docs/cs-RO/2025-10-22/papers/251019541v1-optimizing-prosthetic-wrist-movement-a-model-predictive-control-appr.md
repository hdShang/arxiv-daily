...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19541v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19541v1', 'Optimizing Prosthetic Wrist Movement: A Model Predictive Control Approach')" title="添加到收藏夹">☆ 收藏</button>
