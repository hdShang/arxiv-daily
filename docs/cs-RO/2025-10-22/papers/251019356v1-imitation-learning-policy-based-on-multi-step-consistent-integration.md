...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19356v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.19356v1', 'Imitation Learning Policy based on Multi-Step Consistent Integration Shortcut Model')" title="添加到收藏夹">☆ 收藏</button>
