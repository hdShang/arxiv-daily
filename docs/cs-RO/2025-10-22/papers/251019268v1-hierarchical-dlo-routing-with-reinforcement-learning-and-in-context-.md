...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19268v1" onclick="toggleFavorite(this, '2510.19268v1', 'Hierarchical DLO Routing with Reinforcement Learning and In-Context Vision-language Models')" title="添加到收藏夹">☆ 收藏</button>
