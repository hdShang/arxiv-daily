...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19364v1" onclick="toggleFavorite(this, '2510.19364v1', 'ProTerrain: Probabilistic Physics-Informed Rough Terrain World Modeling')" title="添加到收藏夹">☆ 收藏</button>
