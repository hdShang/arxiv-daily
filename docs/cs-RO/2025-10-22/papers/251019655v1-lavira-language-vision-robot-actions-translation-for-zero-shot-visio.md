...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.19655v1" onclick="toggleFavorite(this, '2510.19655v1', 'LaViRA: Language-Vision-Robot Actions Translation for Zero-Shot Vision Language Navigation in Continuous Environments')" title="添加到收藏夹">☆ 收藏</button>
