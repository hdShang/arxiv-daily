...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00512v1" onclick="toggleFavorite(this, '2511.00512v1', 'Descriptive Model-based Learning and Control for Bipedal Locomotion')" title="添加到收藏夹">☆ 收藏</button>
