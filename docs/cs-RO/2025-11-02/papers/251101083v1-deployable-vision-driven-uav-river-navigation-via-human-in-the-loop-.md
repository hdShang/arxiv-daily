...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.01083v1" onclick="toggleFavorite(this, '2511.01083v1', 'Deployable Vision-driven UAV River Navigation via Human-in-the-loop Preference Alignment')" title="添加到收藏夹">☆ 收藏</button>
