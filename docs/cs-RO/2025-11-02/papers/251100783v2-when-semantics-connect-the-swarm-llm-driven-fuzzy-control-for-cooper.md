...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00783v2" onclick="toggleFavorite(this, '2511.00783v2', 'When Semantics Connect the Swarm: LLM-Driven Fuzzy Control for Cooperative Multi-Robot Underwater Coverage')" title="添加到收藏夹">☆ 收藏</button>
