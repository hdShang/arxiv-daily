...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00998v1" onclick="toggleFavorite(this, '2511.00998v1', 'GauDP: Reinventing Multi-Agent Collaboration through Gaussian-Image Synergy in Diffusion Policies')" title="添加到收藏夹">☆ 收藏</button>
