...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00814v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00814v1', 'Real-Time Learning of Predictive Dynamic Obstacle Models for Robotic Motion Planning')" title="添加到收藏夹">☆ 收藏</button>
