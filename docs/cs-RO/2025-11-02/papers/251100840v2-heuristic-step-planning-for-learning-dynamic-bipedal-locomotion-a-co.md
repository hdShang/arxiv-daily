...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00840v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.00840v2', 'Heuristic Step Planning for Learning Dynamic Bipedal Locomotion: A Comparative Study of Model-Based and Model-Free Approaches')" title="添加到收藏夹">☆ 收藏</button>
