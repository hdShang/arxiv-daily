...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12184v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12184v1', 'Variable Impedance Control for Floating-Base Supernumerary Robotic Leg in Walking Assistance')" title="添加到收藏夹">☆ 收藏</button>
