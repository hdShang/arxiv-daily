...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12160v1" onclick="toggleFavorite(this, '2511.12160v1', 'Game-Theoretic Safe Multi-Agent Motion Planning with Reachability Analysis for Dynamic and Uncertain Environments (Extended Version)')" title="添加到收藏夹">☆ 收藏</button>
