...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12390v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.12390v1', 'Learning Adaptive Neural Teleoperation for Humanoid Robots: From Inverse Kinematics to End-to-End Control')" title="添加到收藏夹">☆ 收藏</button>
