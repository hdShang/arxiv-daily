...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12148v1" onclick="toggleFavorite(this, '2511.12148v1', 'Towards Obstacle-Avoiding Control of Planar Snake Robots Exploring Neuro-Evolution of Augmenting Topologies')" title="添加到收藏夹">☆ 收藏</button>
