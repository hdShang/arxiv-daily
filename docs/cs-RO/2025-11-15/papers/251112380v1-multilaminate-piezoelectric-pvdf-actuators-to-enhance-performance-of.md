...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12380v1" onclick="toggleFavorite(this, '2511.12380v1', 'Multilaminate piezoelectric PVDF actuators to enhance performance of soft micro robots')" title="添加到收藏夹">☆ 收藏</button>
