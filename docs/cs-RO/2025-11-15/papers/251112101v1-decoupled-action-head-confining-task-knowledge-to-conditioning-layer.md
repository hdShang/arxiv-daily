...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12101v1" onclick="toggleFavorite(this, '2511.12101v1', 'Decoupled Action Head: Confining Task Knowledge to Conditioning Layers')" title="添加到收藏夹">☆ 收藏</button>
