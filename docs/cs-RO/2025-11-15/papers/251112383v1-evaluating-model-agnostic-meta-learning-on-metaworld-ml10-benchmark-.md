...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.12383v1" onclick="toggleFavorite(this, '2511.12383v1', 'Evaluating Model-Agnostic Meta-Learning on MetaWorld ML10 Benchmark: Fast Adaptation in Robotic Manipulation Tasks')" title="添加到收藏夹">☆ 收藏</button>
