...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21169v1" onclick="toggleFavorite(this, '2511.21169v1', 'Kinematics-Aware Multi-Policy Reinforcement Learning for Force-Capable Humanoid Loco-Manipulation')" title="添加到收藏夹">☆ 收藏</button>
