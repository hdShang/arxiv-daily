...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21203v2" onclick="toggleFavorite(this, '2511.21203v2', 'Transformer Driven Visual Servoing and Dual Arm Impedance Control for Fabric Texture Matching')" title="添加到收藏夹">☆ 收藏</button>
