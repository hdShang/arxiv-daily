...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21557v1" onclick="toggleFavorite(this, '2511.21557v1', 'VacuumVLA: Boosting VLA Capabilities via a Unified Suction and Gripping Tool for Complex Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
