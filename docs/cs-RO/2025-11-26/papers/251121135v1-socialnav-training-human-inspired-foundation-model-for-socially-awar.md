...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21135v1" onclick="toggleFavorite(this, '2511.21135v1', 'SocialNav: Training Human-Inspired Foundation Model for Socially-Aware Embodied Navigation')" title="添加到收藏夹">☆ 收藏</button>
