...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.21083v1" onclick="toggleFavorite(this, '2511.21083v1', 'Dual-Agent Reinforcement Learning for Adaptive and Cost-Aware Visual-Inertial Odometry')" title="添加到收藏夹">☆ 收藏</button>
