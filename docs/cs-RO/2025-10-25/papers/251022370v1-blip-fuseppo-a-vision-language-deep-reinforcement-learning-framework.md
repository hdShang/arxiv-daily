...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22370v1" onclick="toggleFavorite(this, '2510.22370v1', 'BLIP-FusePPO: A Vision-Language Deep Reinforcement Learning Framework for Lane Keeping in Autonomous Vehicles')" title="添加到收藏夹">☆ 收藏</button>
