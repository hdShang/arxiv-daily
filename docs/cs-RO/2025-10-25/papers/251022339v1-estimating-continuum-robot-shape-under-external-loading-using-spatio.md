...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22339v1" onclick="toggleFavorite(this, '2510.22339v1', 'Estimating Continuum Robot Shape under External Loading using Spatiotemporal Neural Networks')" title="添加到收藏夹">☆ 收藏</button>
