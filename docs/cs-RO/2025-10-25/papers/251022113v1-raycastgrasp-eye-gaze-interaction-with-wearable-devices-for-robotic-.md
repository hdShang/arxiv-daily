...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22113v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22113v1', 'RaycastGrasp: Eye-Gaze Interaction with Wearable Devices for Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
