...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22313v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22313v1', 'Breaking the Static Assumption: A Dynamic-Aware LIO Framework Via Spatio-Temporal Normal Analysis')" title="添加到收藏夹">☆ 收藏</button>
