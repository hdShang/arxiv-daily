...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.22204v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.22204v1', 'Bridging Perception and Reasoning: Dual-Pipeline Neuro-Symbolic Landing for UAVs in Cluttered Environments')" title="添加到收藏夹">☆ 收藏</button>
