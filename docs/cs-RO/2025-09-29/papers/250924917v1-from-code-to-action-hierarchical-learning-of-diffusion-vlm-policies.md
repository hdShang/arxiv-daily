...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2509.24917" class="toolbar-btn" target="_blank">📄 arXiv: 2509.24917v1</a>
  <a href="https://arxiv.org/pdf/2509.24917.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2509.24917v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2509.24917v1', 'From Code to Action: Hierarchical Learning of Diffusion-VLM Policies')" title="添加到收藏夹">☆ 收藏</button>
...
1. 机器人操作的模仿学习面临泛化能力有限和数据稀缺的挑战，尤其是在复杂的长时程任务中。
2. 论文提出一种分层框架，利用VLM生成代码并结合扩散策略，将任务分解为可执行的子程序，提升泛化能力。
3. 该方法通过实验验证了其有效性，实现了可解释的策略分解，并提高了泛化能力，同时支持对高级规划和低级控制的独立评估。
