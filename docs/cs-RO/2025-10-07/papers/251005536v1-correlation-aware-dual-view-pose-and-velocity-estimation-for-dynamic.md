...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05536v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.05536v1', 'Correlation-Aware Dual-View Pose and Velocity Estimation for Dynamic Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
