...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.05547v1" onclick="toggleFavorite(this, '2510.05547v1', 'ARRC: Advanced Reasoning Robot Control - Knowledge-Driven Autonomous Manipulation Using Retrieval-Augmented Generation')" title="添加到收藏夹">☆ 收藏</button>
