...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21771v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21771v1', 'Improving the performance of AI-powered Affordable Robotics for Assistive Tasks')" title="添加到收藏夹">☆ 收藏</button>
