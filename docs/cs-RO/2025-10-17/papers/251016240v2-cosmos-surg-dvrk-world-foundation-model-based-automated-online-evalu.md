...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16240v2" onclick="toggleFavorite(this, '2510.16240v2', 'Cosmos-Surg-dVRK: World Foundation Model-based Automated Online Evaluation of Surgical Robot Policy Learning')" title="添加到收藏夹">☆ 收藏</button>
