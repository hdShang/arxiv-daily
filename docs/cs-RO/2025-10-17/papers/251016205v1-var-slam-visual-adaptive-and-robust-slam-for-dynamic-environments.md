...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16205v1" onclick="toggleFavorite(this, '2510.16205v1', 'VAR-SLAM: Visual Adaptive and Robust SLAM for Dynamic Environments')" title="添加到收藏夹">☆ 收藏</button>
