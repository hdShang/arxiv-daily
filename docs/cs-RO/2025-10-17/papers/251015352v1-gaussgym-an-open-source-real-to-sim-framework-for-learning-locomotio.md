...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15352v1" onclick="toggleFavorite(this, '2510.15352v1', 'GaussGym: An open-source real-to-sim framework for learning locomotion from pixels')" title="添加到收藏夹">☆ 收藏</button>
