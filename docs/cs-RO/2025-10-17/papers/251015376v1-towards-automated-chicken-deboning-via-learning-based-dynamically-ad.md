...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15376v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.15376v1', 'Towards Automated Chicken Deboning via Learning-based Dynamically-Adaptive 6-DoF Multi-Material Cutting')" title="添加到收藏夹">☆ 收藏</button>
