...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15626v2" onclick="toggleFavorite(this, '2510.15626v2', 'Adaptive Legged Locomotion via Online Learning for Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
