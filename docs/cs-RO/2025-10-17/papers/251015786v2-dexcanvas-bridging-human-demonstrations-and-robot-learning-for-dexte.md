...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.15786v2" onclick="toggleFavorite(this, '2510.15786v2', 'DexCanvas: Bridging Human Demonstrations and Robot Learning for Dexterous Manipulation')" title="添加到收藏夹">☆ 收藏</button>
