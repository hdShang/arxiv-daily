...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17143v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17143v1', 'Decentralized Real-Time Planning for Multi-UAV Cooperative Manipulation via Imitation Learning')" title="添加到收藏夹">☆ 收藏</button>
