...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17950v1" onclick="toggleFavorite(this, '2510.17950v1', 'RoboChallenge: Large-scale Real-robot Evaluation of Embodied Policies')" title="添加到收藏夹">☆ 收藏</button>
