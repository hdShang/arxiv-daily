...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17541v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17541v1', 'Distributed Spatial-Temporal Trajectory Optimization for Unmanned-Aerial-Vehicle Swarm')" title="添加到收藏夹">☆ 收藏</button>
