...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17150v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17150v2', 'OmniVIC: A Self-Improving Variable Impedance Controller with Vision-Language In-Context Learning for Safe Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
