...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18085v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.18085v1', 'R2BC: Multi-Agent Imitation Learning from Single-Agent Demonstrations')" title="添加到收藏夹">☆ 收藏</button>
