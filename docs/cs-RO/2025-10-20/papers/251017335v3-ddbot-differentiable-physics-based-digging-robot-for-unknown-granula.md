...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17335v3" onclick="toggleFavorite(this, '2510.17335v3', 'DDBot: Differentiable Physics-based Digging Robot for Unknown Granular Materials')" title="添加到收藏夹">☆ 收藏</button>
