...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17086v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.17086v1', 'Learning to Design Soft Hands using Reward Models')" title="添加到收藏夹">☆ 收藏</button>
