...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17369v1" onclick="toggleFavorite(this, '2510.17369v1', 'Bridging Embodiment Gaps: Deploying Vision-Language-Action Models on Soft Robots')" title="添加到收藏夹">☆ 收藏</button>
