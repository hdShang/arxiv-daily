...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.18002v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.18002v1', 'Humanoid Goalkeeper: Learning from Position Conditioned Task-Motion Constraints')" title="添加到收藏夹">☆ 收藏</button>
