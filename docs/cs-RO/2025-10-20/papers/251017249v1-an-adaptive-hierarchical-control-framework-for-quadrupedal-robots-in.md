...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17249v1" onclick="toggleFavorite(this, '2510.17249v1', 'An adaptive hierarchical control framework for quadrupedal robots in planetary exploration')" title="添加到收藏夹">☆ 收藏</button>
