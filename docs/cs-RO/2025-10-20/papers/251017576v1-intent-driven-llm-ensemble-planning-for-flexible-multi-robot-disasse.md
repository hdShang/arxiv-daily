...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17576v1" onclick="toggleFavorite(this, '2510.17576v1', 'Intent-Driven LLM Ensemble Planning for Flexible Multi-Robot Disassembly: Demonstration on EV Batteries')" title="添加到收藏夹">☆ 收藏</button>
