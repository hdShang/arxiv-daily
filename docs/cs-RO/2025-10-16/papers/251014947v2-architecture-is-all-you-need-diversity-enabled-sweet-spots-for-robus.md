...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14947v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14947v2', 'Architecture Is All You Need: Diversity-Enabled Sweet Spots for Robust Humanoid Locomotion')" title="添加到收藏夹">☆ 收藏</button>
