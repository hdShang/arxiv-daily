...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14851v1" onclick="toggleFavorite(this, '2510.14851v1', 'SADCHER: Scheduling using Attention-based Dynamic Coalitions of Heterogeneous Robots in Real-Time')" title="添加到收藏夹">☆ 收藏</button>
