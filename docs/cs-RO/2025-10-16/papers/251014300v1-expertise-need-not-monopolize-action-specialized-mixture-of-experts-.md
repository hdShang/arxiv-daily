...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14300v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14300v1', 'Expertise need not monopolize: Action-Specialized Mixture of Experts for Vision-Language-Action Learning')" title="添加到收藏夹">☆ 收藏</button>
