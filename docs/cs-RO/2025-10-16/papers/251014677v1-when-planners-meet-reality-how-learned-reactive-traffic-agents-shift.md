...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14677v1" onclick="toggleFavorite(this, '2510.14677v1', 'When Planners Meet Reality: How Learned, Reactive Traffic Agents Shift nuPlan Benchmarks')" title="添加到收藏夹">☆ 收藏</button>
