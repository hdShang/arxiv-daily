...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14643v1" onclick="toggleFavorite(this, '2510.14643v1', 'Generative Models From and For Sampling-Based MPC: A Bootstrapped Approach For Adaptive Contact-Rich Manipulation')" title="添加到收藏夹">☆ 收藏</button>
