...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14454v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14454v1', 'Towards Adaptable Humanoid Control via Adaptive Motion Tracking')" title="添加到收藏夹">☆ 收藏</button>
