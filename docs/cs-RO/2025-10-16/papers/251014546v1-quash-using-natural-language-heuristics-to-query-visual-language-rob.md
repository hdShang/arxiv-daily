...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14546v1" onclick="toggleFavorite(this, '2510.14546v1', 'QuASH: Using Natural-Language Heuristics to Query Visual-Language Robotic Maps')" title="添加到收藏夹">☆ 收藏</button>
