...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14615v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14615v1', 'Accelerated Multi-Modal Motion Planning Using Context-Conditioned Diffusion Models')" title="添加到收藏夹">☆ 收藏</button>
