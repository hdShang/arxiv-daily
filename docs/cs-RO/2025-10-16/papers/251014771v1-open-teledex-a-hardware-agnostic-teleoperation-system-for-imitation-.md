...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14771v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14771v1', 'Open TeleDex: A Hardware-Agnostic Teleoperation System for Imitation Learning based Dexterous Manipulation')" title="添加到收藏夹">☆ 收藏</button>
