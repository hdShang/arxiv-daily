...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14930v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14930v2', 'VT-Refine: Learning Bimanual Assembly with Visuo-Tactile Feedback via Simulation Fine-Tuning')" title="添加到收藏夹">☆ 收藏</button>
