...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14959v2" onclick="toggleFavorite(this, '2510.14959v2', 'CBF-RL: Safety Filtering Reinforcement Learning in Training with Control Barrier Functions')" title="添加到收藏夹">☆ 收藏</button>
