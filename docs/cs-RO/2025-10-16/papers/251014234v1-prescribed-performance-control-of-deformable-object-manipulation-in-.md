...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14234v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14234v1', 'Prescribed Performance Control of Deformable Object Manipulation in Spatial Latent Space')" title="添加到收藏夹">☆ 收藏</button>
