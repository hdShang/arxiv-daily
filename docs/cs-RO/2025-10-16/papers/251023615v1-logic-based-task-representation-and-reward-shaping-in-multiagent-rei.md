...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23615v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23615v1', 'Logic-based Task Representation and Reward Shaping in Multiagent Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
