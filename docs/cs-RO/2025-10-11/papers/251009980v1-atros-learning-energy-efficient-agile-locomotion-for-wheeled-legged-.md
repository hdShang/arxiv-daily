...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09980v1" onclick="toggleFavorite(this, '2510.09980v1', 'ATRos: Learning Energy-Efficient Agile Locomotion for Wheeled-legged Robots')" title="添加到收藏夹">☆ 收藏</button>
