...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21758v3" onclick="toggleFavorite(this, '2510.21758v3', 'Taxonomy and Trends in Reinforcement Learning for Robotics and Control Systems: A Structured Review')" title="添加到收藏夹">☆ 收藏</button>
