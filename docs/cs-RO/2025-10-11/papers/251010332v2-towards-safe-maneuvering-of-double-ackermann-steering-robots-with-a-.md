...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10332v2" onclick="toggleFavorite(this, '2510.10332v2', 'Towards Safe Maneuvering of Double-Ackermann-Steering Robots with a Soft Actor-Critic Framework')" title="添加到收藏夹">☆ 收藏</button>
