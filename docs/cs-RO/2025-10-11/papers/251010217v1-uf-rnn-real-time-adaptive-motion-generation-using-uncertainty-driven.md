...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10217v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.10217v1', 'UF-RNN: Real-Time Adaptive Motion Generation Using Uncertainty-Driven Foresight Prediction')" title="添加到收藏夹">☆ 收藏</button>
