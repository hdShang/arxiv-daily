...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10346v1" onclick="toggleFavorite(this, '2510.10346v1', 'sqrtVINS: Robust and Ultrafast Square-Root Filter-based 3D Motion Tracking')" title="添加到收藏夹">☆ 收藏</button>
