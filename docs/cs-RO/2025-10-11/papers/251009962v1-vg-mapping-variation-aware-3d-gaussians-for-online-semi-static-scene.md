...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09962v1" onclick="toggleFavorite(this, '2510.09962v1', 'VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping')" title="添加到收藏夹">☆ 收藏</button>
