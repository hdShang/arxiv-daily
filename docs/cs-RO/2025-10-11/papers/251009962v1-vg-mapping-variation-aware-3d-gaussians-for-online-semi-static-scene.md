...
<div class="paper-toolbar">
  <div class="toolbar-left">
    <a href="https://arxiv.org/abs/2510.09962" target="_blank" class="toolbar-btn">arXiv: 2510.09962v1</a>
    <a href="https://arxiv.org/pdf/2510.09962.pdf" target="_blank" class="toolbar-btn">PDF</a>
  </div>
  <div class="toolbar-right">
    <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09962v1" 
            onclick="toggleFavorite(this, '2510.09962v1', 'VG-Mapping: Variation-Aware 3D Gaussians for Online Semi-static Scene Mapping')" title="收藏">
      ☆ 收藏
    </button>
