...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.10206v1" onclick="toggleFavorite(this, '2510.10206v1', 'It Takes Two: Learning Interactive Whole-Body Control Between Humanoid Robots')" title="添加到收藏夹">☆ 收藏</button>
