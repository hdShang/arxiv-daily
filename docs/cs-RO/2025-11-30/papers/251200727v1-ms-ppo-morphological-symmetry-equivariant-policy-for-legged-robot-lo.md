...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00727v1" onclick="toggleFavorite(this, '2512.00727v1', 'MS-PPO: Morphological-Symmetry-Equivariant Policy for Legged Robot Locomotion')" title="添加到收藏夹">☆ 收藏</button>
