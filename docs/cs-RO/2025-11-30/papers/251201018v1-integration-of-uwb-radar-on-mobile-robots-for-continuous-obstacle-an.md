...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.01018v1" onclick="toggleFavorite(this, '2512.01018v1', 'Integration of UWB Radar on Mobile Robots for Continuous Obstacle and Environment Mapping')" title="添加到收藏夹">☆ 收藏</button>
