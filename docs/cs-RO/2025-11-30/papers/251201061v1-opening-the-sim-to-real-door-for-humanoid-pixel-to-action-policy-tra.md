...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.01061v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.01061v1', 'Opening the Sim-to-Real Door for Humanoid Pixel-to-Action Policy Transfer')" title="添加到收藏夹">☆ 收藏</button>
