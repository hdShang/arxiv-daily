...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.01052v1" onclick="toggleFavorite(this, '2512.01052v1', 'Autonomous Grasping On Quadruped Robot With Task Level Interaction')" title="添加到收藏夹">☆ 收藏</button>
