...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00907v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.00907v2', 'Magnetic Tactile-Driven Soft Actuator for Intelligent Grasping and Firmness Evaluation')" title="添加到收藏夹">☆ 收藏</button>
