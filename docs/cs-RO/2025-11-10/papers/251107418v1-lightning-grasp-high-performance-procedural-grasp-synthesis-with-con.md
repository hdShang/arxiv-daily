...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07418v1" onclick="toggleFavorite(this, '2511.07418v1', 'Lightning Grasp: High Performance Procedural Grasp Synthesis with Contact Fields')" title="添加到收藏夹">☆ 收藏</button>
