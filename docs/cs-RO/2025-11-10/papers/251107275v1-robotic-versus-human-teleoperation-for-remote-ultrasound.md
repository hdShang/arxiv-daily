...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07275v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07275v1', 'Robotic versus Human Teleoperation for Remote Ultrasound')" title="添加到收藏夹">☆ 收藏</button>
