...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06745v1" onclick="toggleFavorite(this, '2511.06745v1', 'Physically-Grounded Goal Imagination: Physics-Informed Variational Autoencoder for Self-Supervised Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
