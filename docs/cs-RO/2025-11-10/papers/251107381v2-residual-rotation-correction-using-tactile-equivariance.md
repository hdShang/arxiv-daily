...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07381v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.07381v2', 'Residual Rotation Correction using Tactile Equivariance')" title="添加到收藏夹">☆ 收藏</button>
