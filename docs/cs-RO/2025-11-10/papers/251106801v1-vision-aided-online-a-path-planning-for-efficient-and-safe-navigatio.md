...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06801v1" onclick="toggleFavorite(this, '2511.06801v1', 'Vision-Aided Online A* Path Planning for Efficient and Safe Navigation of Service Robots')" title="添加到收藏夹">☆ 收藏</button>
