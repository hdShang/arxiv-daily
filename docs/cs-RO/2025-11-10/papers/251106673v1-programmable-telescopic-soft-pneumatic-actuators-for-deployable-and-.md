...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.06673v1" onclick="toggleFavorite(this, '2511.06673v1', 'Programmable Telescopic Soft Pneumatic Actuators for Deployable and Shape Morphing Soft Robots')" title="添加到收藏夹">☆ 收藏</button>
