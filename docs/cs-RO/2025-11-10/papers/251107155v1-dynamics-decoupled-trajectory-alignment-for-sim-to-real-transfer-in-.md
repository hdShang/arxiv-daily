...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.07155v1" onclick="toggleFavorite(this, '2511.07155v1', 'Dynamics-Decoupled Trajectory Alignment for Sim-to-Real Transfer in Reinforcement Learning for Autonomous Driving')" title="添加到收藏夹">☆ 收藏</button>
