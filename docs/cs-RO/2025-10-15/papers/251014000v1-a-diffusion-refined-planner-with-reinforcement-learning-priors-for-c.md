...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14000v1" onclick="toggleFavorite(this, '2510.14000v1', 'A Diffusion-Refined Planner with Reinforcement Learning Priors for Confined-Space Parking')" title="添加到收藏夹">☆ 收藏</button>
