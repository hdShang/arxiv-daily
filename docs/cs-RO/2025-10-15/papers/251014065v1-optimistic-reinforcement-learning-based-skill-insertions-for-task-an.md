...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.14065v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.14065v1', 'Optimistic Reinforcement Learning-Based Skill Insertions for Task and Motion Planning')" title="添加到收藏夹">☆ 收藏</button>
