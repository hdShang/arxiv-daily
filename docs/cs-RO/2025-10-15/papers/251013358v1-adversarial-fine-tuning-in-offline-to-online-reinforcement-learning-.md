...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13358v1" onclick="toggleFavorite(this, '2510.13358v1', 'Adversarial Fine-tuning in Offline-to-Online Reinforcement Learning for Robust Robot Control')" title="添加到收藏夹">☆ 收藏</button>
