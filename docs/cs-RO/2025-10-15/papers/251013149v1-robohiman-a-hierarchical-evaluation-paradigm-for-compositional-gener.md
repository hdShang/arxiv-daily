...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13149v1" onclick="toggleFavorite(this, '2510.13149v1', 'RoboHiMan: A Hierarchical Evaluation Paradigm for Compositional Generalization in Long-Horizon Manipulation')" title="添加到收藏夹">☆ 收藏</button>
