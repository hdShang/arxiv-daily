...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13284v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13284v1', 'ALOHA2 Robot Kitchen Application Scenario Reproduction Report')" title="添加到收藏夹">☆ 收藏</button>
