...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13553v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13553v2', 'Hoecken-D Hand: A Novel Robotic Hand for Linear Parallel Pinching and Self-Adaptive Grasping')" title="添加到收藏夹">☆ 收藏</button>
