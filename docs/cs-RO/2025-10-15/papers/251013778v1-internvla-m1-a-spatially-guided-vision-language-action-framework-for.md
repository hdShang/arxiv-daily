...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.13778v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.13778v1', 'InternVLA-M1: A Spatially Guided Vision-Language-Action Framework for Generalist Robot Policy')" title="添加到收藏夹">☆ 收藏</button>
