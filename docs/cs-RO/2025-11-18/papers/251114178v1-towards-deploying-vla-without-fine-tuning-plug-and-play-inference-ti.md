...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14178v1" onclick="toggleFavorite(this, '2511.14178v1', 'Towards Deploying VLA without Fine-Tuning: Plug-and-Play Inference-Time VLA Policy Steering via Embodied Evolutionary Diffusion')" title="添加到收藏夹">☆ 收藏</button>
