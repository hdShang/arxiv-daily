...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14625v1" onclick="toggleFavorite(this, '2511.14625v1', 'Gallant: Voxel Grid-based Humanoid Locomotion and Local-navigation across 3D Constrained Terrains')" title="添加到收藏夹">☆ 收藏</button>
