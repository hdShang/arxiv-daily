...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00049v1" onclick="toggleFavorite(this, '2512.00049v1', 'Socially aware navigation for mobile robots: a survey on deep reinforcement learning approaches')" title="添加到收藏夹">☆ 收藏</button>
