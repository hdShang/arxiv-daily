...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00050v1" onclick="toggleFavorite(this, '2512.00050v1', 'Reinforcement Learning from Implicit Neural Feedback for Human-Aligned Robot Control')" title="添加到收藏夹">☆ 收藏</button>
