...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.17603v1" onclick="toggleFavorite(this, '2511.17603v1', 'Translating Cultural Choreography from Humanoid Forms to Robotic Arm')" title="添加到收藏夹">☆ 收藏</button>
