...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14341v1" onclick="toggleFavorite(this, '2511.14341v1', 'Going Places: Place Recognition in Artificial and Natural Systems')" title="添加到收藏夹">☆ 收藏</button>
