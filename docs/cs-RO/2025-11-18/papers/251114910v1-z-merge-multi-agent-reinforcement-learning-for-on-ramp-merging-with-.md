...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14910v1" onclick="toggleFavorite(this, '2511.14910v1', 'Z-Merge: Multi-Agent Reinforcement Learning for On-Ramp Merging with Zone-Specific V2X Traffic Information')" title="添加到收藏夹">☆ 收藏</button>
