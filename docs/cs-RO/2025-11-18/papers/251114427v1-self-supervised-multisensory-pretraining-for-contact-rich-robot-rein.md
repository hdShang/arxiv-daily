...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14427v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.14427v1', 'Self-Supervised Multisensory Pretraining for Contact-Rich Robot Reinforcement Learning')" title="添加到收藏夹">☆ 收藏</button>
