...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14139v1" onclick="toggleFavorite(this, '2511.14139v1', 'FlexiCup: Wireless Multimodal Suction Cup with Dual-Zone Vision-Tactile Sensing')" title="添加到收藏夹">☆ 收藏</button>
