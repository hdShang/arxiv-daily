...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14756v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.14756v1', 'HMC: Learning Heterogeneous Meta-Control for Contact-Rich Loco-Manipulation')" title="添加到收藏夹">☆ 收藏</button>
