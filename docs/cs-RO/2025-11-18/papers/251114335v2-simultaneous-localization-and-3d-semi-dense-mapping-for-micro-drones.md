...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14335v2" onclick="toggleFavorite(this, '2511.14335v2', 'Simultaneous Localization and 3D-Semi Dense Mapping for Micro Drones Using Monocular Camera and Inertial Sensors')" title="添加到收藏夹">☆ 收藏</button>
