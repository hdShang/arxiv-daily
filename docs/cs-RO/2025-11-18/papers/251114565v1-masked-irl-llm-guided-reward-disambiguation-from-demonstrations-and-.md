...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.14565v1" onclick="toggleFavorite(this, '2511.14565v1', 'Masked IRL: LLM-Guided Reward Disambiguation from Demonstrations and Language')" title="添加到收藏夹">☆ 收藏</button>
