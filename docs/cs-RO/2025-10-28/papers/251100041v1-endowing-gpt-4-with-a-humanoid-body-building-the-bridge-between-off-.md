...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.00041v1" onclick="toggleFavorite(this, '2511.00041v1', 'Endowing GPT-4 with a Humanoid Body: Building the Bridge Between Off-the-Shelf VLMs and the Physical World')" title="添加到收藏夹">☆ 收藏</button>
