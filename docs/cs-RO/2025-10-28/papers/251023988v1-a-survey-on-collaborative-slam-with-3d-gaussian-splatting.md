...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.23988v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.23988v1', 'A Survey on Collaborative SLAM with 3D Gaussian Splatting')" title="添加到收藏夹">☆ 收藏</button>
