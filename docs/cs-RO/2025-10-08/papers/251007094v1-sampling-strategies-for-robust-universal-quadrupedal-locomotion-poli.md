...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07094v1" onclick="toggleFavorite(this, '2510.07094v1', 'Sampling Strategies for Robust Universal Quadrupedal Locomotion Policies')" title="添加到收藏夹">☆ 收藏</button>
