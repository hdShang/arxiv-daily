...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06717v1" onclick="toggleFavorite(this, '2510.06717v1', 'SanDRA: Safe Large-Language-Model-Based Decision Making for Automated Vehicles Using Reachability Analysis')" title="添加到收藏夹">☆ 收藏</button>
