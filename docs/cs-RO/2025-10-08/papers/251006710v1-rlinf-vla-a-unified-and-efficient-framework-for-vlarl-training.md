...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.06710v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.06710v1', 'RLinf-VLA: A Unified and Efficient Framework for VLA+RL Training')" title="添加到收藏夹">☆ 收藏</button>
