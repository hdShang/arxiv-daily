...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07030v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07030v1', 'Diffusing Trajectory Optimization Problems for Recovery During Multi-Finger Manipulation')" title="添加到收藏夹">☆ 收藏</button>
