...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07134v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07134v1', 'TrackVLA++: Unleashing Reasoning and Memory Capabilities in VLA Models for Embodied Visual Tracking')" title="添加到收藏夹">☆ 收藏</button>
