...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07067v1" onclick="toggleFavorite(this, '2510.07067v1', 'Bring the Apple, Not the Sofa: Impact of Irrelevant Context in Embodied AI Commands on VLA Models')" title="添加到收藏夹">☆ 收藏</button>
