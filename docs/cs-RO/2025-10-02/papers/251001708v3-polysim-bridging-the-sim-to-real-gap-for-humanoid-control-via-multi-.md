...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2510.01708" class="toolbar-btn" target="_blank">📄 arXiv: 2510.01708v3</a>
  <a href="https://arxiv.org/pdf/2510.01708.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01708v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01708v3', 'PolySim: Bridging the Sim-to-Real Gap for Humanoid Control via Multi-Simulator Dynamics Randomization')" title="添加到收藏夹">☆ 收藏</button>
