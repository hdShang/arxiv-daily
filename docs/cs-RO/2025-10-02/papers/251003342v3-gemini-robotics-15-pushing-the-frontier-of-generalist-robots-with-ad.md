...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.03342v3" onclick="toggleFavorite(this, '2510.03342v3', 'Gemini Robotics 1.5: Pushing the Frontier of Generalist Robots with Advanced Embodied Reasoning, Thinking, and Motion Transfer')" title="添加到收藏夹">☆ 收藏</button>
