...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02614v2" onclick="toggleFavorite(this, '2510.02614v2', 'UMI-on-Air: Embodiment-Aware Guidance for Embodiment-Agnostic Visuomotor Policies')" title="添加到收藏夹">☆ 收藏</button>
