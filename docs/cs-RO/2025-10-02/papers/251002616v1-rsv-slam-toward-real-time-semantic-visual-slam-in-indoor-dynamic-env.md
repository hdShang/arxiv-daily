...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02616v1" onclick="toggleFavorite(this, '2510.02616v1', 'RSV-SLAM: Toward Real-Time Semantic Visual SLAM in Indoor Dynamic Environments')" title="添加到收藏夹">☆ 收藏</button>
