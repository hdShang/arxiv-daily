...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02298v1" onclick="toggleFavorite(this, '2510.02298v1', 'ARMADA: Autonomous Online Failure Detection and Human Shared Control Empower Scalable Real-world Deployment and Adaptation')" title="添加到收藏夹">☆ 收藏</button>
