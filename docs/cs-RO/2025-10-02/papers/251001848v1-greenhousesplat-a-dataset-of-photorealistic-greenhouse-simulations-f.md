...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01848v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01848v1', 'GreenhouseSplat: A Dataset of Photorealistic Greenhouse Simulations for Mobile Robotics')" title="添加到收藏夹">☆ 收藏</button>
