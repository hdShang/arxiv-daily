...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02584v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.02584v1', 'Efficient Optimal Path Planning in Dynamic Environments Using Koopman MPC')" title="添加到收藏夹">☆ 收藏</button>
