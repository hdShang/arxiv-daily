...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.02248v1" onclick="toggleFavorite(this, '2510.02248v1', 'Performance-Guided Refinement for Visual Aerial Navigation using Editable Gaussian Splatting in FalconGym 2.0')" title="添加到收藏夹">☆ 收藏</button>
