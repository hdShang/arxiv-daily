...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01843v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01843v1', 'Like Playing a Video Game: Spatial-Temporal Optimization of Foot Trajectories for Controlled Football Kicking in Bipedal Robots')" title="添加到收藏夹">☆ 收藏</button>
