...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01603v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01603v2', 'MiniBEE: A New Form Factor for Compact Bimanual Dexterity')" title="添加到收藏夹">☆ 收藏</button>
