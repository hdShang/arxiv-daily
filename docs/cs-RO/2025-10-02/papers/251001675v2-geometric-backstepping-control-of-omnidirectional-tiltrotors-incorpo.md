...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01675v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.01675v2', 'Geometric Backstepping Control of Omnidirectional Tiltrotors Incorporating Servo-Rotor Dynamics for Robustness against Sudden Disturbances')" title="添加到收藏夹">☆ 收藏</button>
