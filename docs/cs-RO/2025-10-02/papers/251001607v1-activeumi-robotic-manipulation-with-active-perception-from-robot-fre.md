...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.01607v1" onclick="toggleFavorite(this, '2510.01607v1', 'ActiveUMI: Robotic Manipulation with Active Perception from Robot-Free Human Demonstrations')" title="添加到收藏夹">☆ 收藏</button>
