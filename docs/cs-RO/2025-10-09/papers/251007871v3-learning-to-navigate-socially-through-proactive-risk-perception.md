...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07871v3" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07871v3', 'Learning to Navigate Socially Through Proactive Risk Perception')" title="添加到收藏夹">☆ 收藏</button>
