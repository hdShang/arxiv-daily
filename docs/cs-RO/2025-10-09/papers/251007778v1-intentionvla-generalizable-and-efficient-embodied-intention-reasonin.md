...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07778v1" onclick="toggleFavorite(this, '2510.07778v1', 'IntentionVLA: Generalizable and Efficient Embodied Intention Reasoning for Human-Robot Interaction')" title="添加到收藏夹">☆ 收藏</button>
