...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08754v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08754v1', 'Whole Body Model Predictive Control for Spin-Aware Quadrupedal Table Tennis')" title="添加到收藏夹">☆ 收藏</button>
