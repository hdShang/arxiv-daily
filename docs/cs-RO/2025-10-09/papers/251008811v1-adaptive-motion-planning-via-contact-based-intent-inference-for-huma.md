...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08811v1" onclick="toggleFavorite(this, '2510.08811v1', 'Adaptive Motion Planning via Contact-Based Intent Inference for Human-Robot Collaboration')" title="添加到收藏夹">☆ 收藏</button>
