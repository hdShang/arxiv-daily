...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07975v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07975v1', 'Executable Analytic Concepts as the Missing Link Between VLM Insight and Precise Manipulation')" title="添加到收藏夹">☆ 收藏</button>
