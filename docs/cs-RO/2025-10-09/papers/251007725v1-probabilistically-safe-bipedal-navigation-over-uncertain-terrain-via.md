...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07725v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07725v1', 'Probabilistically-Safe Bipedal Navigation over Uncertain Terrain via Conformal Prediction and Contraction Analysis')" title="添加到收藏夹">☆ 收藏</button>
