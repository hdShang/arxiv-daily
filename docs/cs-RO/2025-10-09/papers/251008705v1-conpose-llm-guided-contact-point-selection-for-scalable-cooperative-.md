...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08705v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08705v1', 'ConPoSe: LLM-Guided Contact Point Selection for Scalable Cooperative Object Pushing')" title="添加到收藏夹">☆ 收藏</button>
