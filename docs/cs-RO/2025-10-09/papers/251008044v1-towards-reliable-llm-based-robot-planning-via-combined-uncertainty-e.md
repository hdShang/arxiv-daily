...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08044v1" onclick="toggleFavorite(this, '2510.08044v1', 'Towards Reliable LLM-based Robot Planning via Combined Uncertainty Estimation')" title="添加到收藏夹">☆ 收藏</button>
