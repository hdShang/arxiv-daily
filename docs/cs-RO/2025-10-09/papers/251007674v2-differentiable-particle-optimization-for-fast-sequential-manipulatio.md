...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07674v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07674v2', 'Differentiable Particle Optimization for Fast Sequential Manipulation')" title="添加到收藏夹">☆ 收藏</button>
