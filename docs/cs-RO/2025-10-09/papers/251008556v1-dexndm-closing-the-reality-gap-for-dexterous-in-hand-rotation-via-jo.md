...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08556v1" onclick="toggleFavorite(this, '2510.08556v1', 'DexNDM: Closing the Reality Gap for Dexterous In-Hand Rotation via Joint-Wise Neural Dynamics Model')" title="添加到收藏夹">☆ 收藏</button>
