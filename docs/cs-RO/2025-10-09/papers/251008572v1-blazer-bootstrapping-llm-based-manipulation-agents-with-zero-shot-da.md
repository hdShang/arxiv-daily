...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08572v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08572v1', 'BLAZER: Bootstrapping LLM-based Manipulation Agents with Zero-Shot Data Generation')" title="添加到收藏夹">☆ 收藏</button>
