...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07700v1" onclick="toggleFavorite(this, '2510.07700v1', 'EB-MBD: Emerging-Barrier Model-Based Diffusion for Safe Trajectory Optimization in Highly Constrained Environments')" title="添加到收藏夹">☆ 收藏</button>
