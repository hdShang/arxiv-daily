...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.07865v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.07865v1', 'DM1: MeanFlow with Dispersive Regularization for 1-Step Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
