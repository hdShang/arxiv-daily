...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08022v1" onclick="toggleFavorite(this, '2510.08022v1', 'FastUMI-100K: Advancing Data-driven Robotic Manipulation with a Large-scale UMI-style Dataset')" title="添加到收藏夹">☆ 收藏</button>
