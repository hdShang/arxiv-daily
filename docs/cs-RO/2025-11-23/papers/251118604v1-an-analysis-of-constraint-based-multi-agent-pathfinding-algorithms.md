...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18604v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.18604v1', 'An Analysis of Constraint-Based Multi-Agent Pathfinding Algorithms')" title="添加到收藏夹">☆ 收藏</button>
