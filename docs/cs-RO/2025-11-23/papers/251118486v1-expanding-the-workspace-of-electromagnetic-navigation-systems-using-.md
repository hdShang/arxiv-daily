...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18486v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.18486v1', 'Expanding the Workspace of Electromagnetic Navigation Systems Using Dynamic Feedback for Single- and Multi-agent Control')" title="添加到收藏夹">☆ 收藏</button>
