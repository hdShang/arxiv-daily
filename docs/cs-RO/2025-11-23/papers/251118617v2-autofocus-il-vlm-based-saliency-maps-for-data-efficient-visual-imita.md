...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18617v2" onclick="toggleFavorite(this, '2511.18617v2', 'AutoFocus-IL: VLM-based Saliency Maps for Data-Efficient Visual Imitation Learning without Extra Human Annotations')" title="添加到收藏夹">☆ 收藏</button>
