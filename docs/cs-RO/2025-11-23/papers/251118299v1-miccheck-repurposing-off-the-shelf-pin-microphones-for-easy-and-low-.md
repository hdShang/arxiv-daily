...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18299v1" onclick="toggleFavorite(this, '2511.18299v1', 'MicCheck: Repurposing Off-the-Shelf Pin Microphones for Easy and Low-Cost Contact Sensing')" title="添加到收藏夹">☆ 收藏</button>
