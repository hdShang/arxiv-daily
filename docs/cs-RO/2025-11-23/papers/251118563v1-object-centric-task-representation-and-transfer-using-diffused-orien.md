...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18563v1" onclick="toggleFavorite(this, '2511.18563v1', 'Object-centric Task Representation and Transfer using Diffused Orientation Fields')" title="添加到收藏夹">☆ 收藏</button>
