...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18374v1" onclick="toggleFavorite(this, '2511.18374v1', 'Explicit Bounds on the Hausdorff Distance for Truncated mRPI Sets via Norm-Dependent Contraction Rates')" title="添加到收藏夹">☆ 收藏</button>
