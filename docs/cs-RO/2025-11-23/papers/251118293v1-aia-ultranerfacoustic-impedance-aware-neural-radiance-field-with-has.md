...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.18293v1" onclick="toggleFavorite(this, '2511.18293v1', 'AIA-UltraNeRF:Acoustic-Impedance-Aware Neural Radiance Field with Hash Encodings for Robotic Ultrasound Reconstruction and Localization')" title="添加到收藏夹">☆ 收藏</button>
