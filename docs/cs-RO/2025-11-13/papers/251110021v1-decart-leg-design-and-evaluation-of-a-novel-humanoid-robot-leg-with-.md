...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10021v1" onclick="toggleFavorite(this, '2511.10021v1', 'DecARt Leg: Design and Evaluation of a Novel Humanoid Robot Leg with Decoupled Actuation for Agile Locomotion')" title="添加到收藏夹">☆ 收藏</button>
