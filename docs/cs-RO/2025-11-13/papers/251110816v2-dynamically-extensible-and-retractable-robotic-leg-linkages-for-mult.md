...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10816v2" onclick="toggleFavorite(this, '2511.10816v2', 'Dynamically Extensible and Retractable Robotic Leg Linkages for Multi-task Execution in Search and Rescue Scenarios')" title="添加到收藏夹">☆ 收藏</button>
