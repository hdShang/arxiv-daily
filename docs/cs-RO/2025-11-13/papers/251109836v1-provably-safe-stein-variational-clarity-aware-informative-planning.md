...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09836v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09836v1', 'Provably Safe Stein Variational Clarity-Aware Informative Planning')" title="添加到收藏夹">☆ 收藏</button>
