...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.09932v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2511.09932v1', 'A Study on Enhancing the Generalization Ability of Visuomotor Policies via Data Augmentation')" title="添加到收藏夹">☆ 收藏</button>
