...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2511.10087v1" onclick="toggleFavorite(this, '2511.10087v1', 'Opinion: Towards Unified Expressive Policy Optimization for Robust Robot Learning')" title="添加到收藏夹">☆ 收藏</button>
