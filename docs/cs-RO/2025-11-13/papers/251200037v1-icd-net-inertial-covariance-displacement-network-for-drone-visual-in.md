...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.00037v1" onclick="toggleFavorite(this, '2512.00037v1', 'ICD-Net: Inertial Covariance Displacement Network for Drone Visual-Inertial SLAM')" title="添加到收藏夹">☆ 收藏</button>
