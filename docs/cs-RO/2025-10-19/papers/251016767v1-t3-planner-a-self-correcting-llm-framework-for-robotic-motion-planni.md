...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.16767v1" onclick="toggleFavorite(this, '2510.16767v1', 'T3 Planner: A Self-Correcting LLM Framework for Robotic Motion Planning with Temporal Logic')" title="添加到收藏夹">☆ 收藏</button>
