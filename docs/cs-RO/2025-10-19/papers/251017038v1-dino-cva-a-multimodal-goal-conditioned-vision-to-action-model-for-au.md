...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.17038v1" onclick="toggleFavorite(this, '2510.17038v1', 'DINO-CVA: A Multimodal Goal-Conditioned Vision-to-Action Model for Autonomous Catheter Navigation')" title="添加到收藏夹">☆ 收藏</button>
