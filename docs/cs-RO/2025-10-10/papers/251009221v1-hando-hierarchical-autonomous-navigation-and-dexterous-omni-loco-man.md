...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09221v1" onclick="toggleFavorite(this, '2510.09221v1', 'HANDO: Hierarchical Autonomous Navigation and Dexterous Omni-loco-manipulation')" title="添加到收藏夹">☆ 收藏</button>
