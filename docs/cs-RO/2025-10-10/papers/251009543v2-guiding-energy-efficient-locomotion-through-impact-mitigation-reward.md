...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09543v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09543v2', 'Guiding Energy-Efficient Locomotion through Impact Mitigation Rewards')" title="添加到收藏夹">☆ 收藏</button>
