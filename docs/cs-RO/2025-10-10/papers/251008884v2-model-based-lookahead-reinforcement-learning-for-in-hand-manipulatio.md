...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.08884v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.08884v2', 'Model-Based Lookahead Reinforcement Learning for in-hand manipulation')" title="添加到收藏夹">☆ 收藏</button>
