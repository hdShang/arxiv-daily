...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09209v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09209v1', 'PLEXUS Hand: Lightweight Four-Motor Prosthetic Hand Enabling Precision-Lateral Dexterous Manipulation')" title="添加到收藏夹">☆ 收藏</button>
