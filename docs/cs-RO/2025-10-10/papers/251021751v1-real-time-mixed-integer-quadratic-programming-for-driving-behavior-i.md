...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.21751v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.21751v1', 'Real-time Mixed-Integer Quadratic Programming for Driving Behavior-Inspired Speed Bump Optimal Trajectory Planning')" title="添加到收藏夹">☆ 收藏</button>
