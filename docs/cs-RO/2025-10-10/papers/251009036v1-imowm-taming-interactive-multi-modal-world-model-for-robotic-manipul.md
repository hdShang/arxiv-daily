...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09036v1" onclick="toggleFavorite(this, '2510.09036v1', 'iMoWM: Taming Interactive Multi-Modal World Model for Robotic Manipulation')" title="添加到收藏夹">☆ 收藏</button>
