...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09323v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2510.09323v1', 'Parametrized Topological Complexity for a Multi-Robot System with Variable Tasks')" title="添加到收藏夹">☆ 收藏</button>
