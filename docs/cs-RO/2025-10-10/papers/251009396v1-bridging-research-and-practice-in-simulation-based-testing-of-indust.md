...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09396v1" onclick="toggleFavorite(this, '2510.09396v1', 'Bridging Research and Practice in Simulation-based Testing of Industrial Robot Navigation Systems')" title="添加到收藏夹">☆ 收藏</button>
