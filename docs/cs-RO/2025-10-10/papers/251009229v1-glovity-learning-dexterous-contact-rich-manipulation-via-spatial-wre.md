...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2510.09229v1" onclick="toggleFavorite(this, '2510.09229v1', 'Glovity: Learning Dexterous Contact-Rich Manipulation via Spatial Wrench Feedback Teleoperation System')" title="添加到收藏夹">☆ 收藏</button>
