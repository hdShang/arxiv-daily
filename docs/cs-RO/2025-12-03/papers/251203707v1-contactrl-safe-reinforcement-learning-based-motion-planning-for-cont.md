...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03707v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03707v1', 'ContactRL: Safe Reinforcement Learning based Motion Planning for Contact based Human Robot Collaboration')" title="添加到收藏夹">☆ 收藏</button>
