...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03756v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03756v1', 'Prediction-Driven Motion Planning: Route Integration Strategies in Attention-Based Prediction Models')" title="添加到收藏夹">☆ 收藏</button>
