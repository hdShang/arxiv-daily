...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03630v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03630v1', 'Multimodal Control of Manipulators: Coupling Kinematics and Vision for Self-Driving Laboratory Operations')" title="添加到收藏夹">☆ 收藏</button>
