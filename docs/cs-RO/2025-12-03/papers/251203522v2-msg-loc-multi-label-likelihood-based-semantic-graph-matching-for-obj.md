...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03522v2" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03522v2', 'MSG-Loc: Multi-Label Likelihood-based Semantic Graph Matching for Object-Level Global Localization')" title="添加到收藏夹">☆ 收藏</button>
