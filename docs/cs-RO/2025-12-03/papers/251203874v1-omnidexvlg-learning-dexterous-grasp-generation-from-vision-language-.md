...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03874v1" onclick="toggleFavorite(this, '2512.03874v1', 'OmniDexVLG: Learning Dexterous Grasp Generation from Vision Language Model-Guided Grasp Semantics, Taxonomy and Functional Affordance')" title="添加到收藏夹">☆ 收藏</button>
