...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04308v1" onclick="toggleFavorite(this, '2512.04308v1', 'ResponsibleRobotBench: Benchmarking Responsible Robot Manipulation using Multi-modal Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
