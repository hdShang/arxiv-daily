...
<div class="paper-toolbar">
  <a href="https://arxiv.org/abs/2512.04308" class="toolbar-btn" target="_blank">📄 arXiv: 2512.04308v1</a>
  <a href="https://arxiv.org/pdf/2512.04308.pdf" class="toolbar-btn" target="_blank">📥 PDF</a>
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.04308v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.04308v1', 'ResponsibleRobotBench: Benchmarking Responsible Robot Manipulation using Multi-modal Large Language Models')" title="添加到收藏夹">☆ 收藏</button>
