...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03958v2" onclick="toggleFavorite(this, '2512.03958v2', 'MDE-AgriVLN: Agricultural Vision-and-Language Navigation with Monocular Depth Estimation')" title="添加到收藏夹">☆ 收藏</button>
