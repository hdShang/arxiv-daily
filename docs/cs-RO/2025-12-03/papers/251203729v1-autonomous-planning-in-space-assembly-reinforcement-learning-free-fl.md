...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03729v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03729v1', 'Autonomous Planning In-space Assembly Reinforcement-learning free-flYer (APIARY) International Space Station Astrobee Testing')" title="添加到收藏夹">☆ 收藏</button>
