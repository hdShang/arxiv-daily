...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03556v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03556v1', 'RoboScape-R: Unified Reward-Observation World Models for Generalizable Robotics Training via RL')" title="添加到收藏夹">☆ 收藏</button>
