...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03772v1" onclick="toggleFavorite(this, '2512.03772v1', 'Bayesian Optimization for Automatic Tuning of Torque-Level Nonlinear Model Predictive Control')" title="添加到收藏夹">☆ 收藏</button>
