...
<div class="paper-toolbar">
  ...
  <button class="toolbar-btn favorite-btn" data-arxiv-id="2512.03913v1" data-paper-url="__CURRENT_PAGE__" onclick="toggleFavorite(this, '2512.03913v1', 'Hierarchical Vision Language Action Model Using Success and Failure Demonstrations')" title="添加到收藏夹">☆ 收藏</button>
